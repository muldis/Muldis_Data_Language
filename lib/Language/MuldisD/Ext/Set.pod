...
This document is Language::MuldisD::Ext::Set version 0.19.1.
...
This current C<Set> document describes the system-defined I<Muldis D
Set Extension>, which consists of generic operators that are specific to the
