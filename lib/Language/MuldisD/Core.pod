...
=item C<sys.Core.Set.maybe_reduction of Some.ScaTupRel (Set $topic,
Cat.NameChain $func, Tuple $assuming)>

This function is exactly the same as C<sys.Core.Set.reduction> except that
it does not take a C<$assuming> argument, and it results in a C<Maybe> of
...
=item C<sys.Core.Seq.maybe_reduction of Some.ScaTupRel (Seq $topic,
Cat.NameChain $func, Tuple $assuming)>
...
=item C<sys.Core.Bag.maybe_reduction of Some.ScaTupRel (Bag $topic,
Cat.NameChain $func, Tuple $assuming)>
