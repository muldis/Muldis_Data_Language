...
=head2 C<sys.Core.Cat.E.EK>

A C<Cat.E.EK> (expression kind) is an enumeration consisting of the 8
values C<Cat.E.EK:default> (default value of expression's type),
...
C<Cat.E.EK:param> (value of expression-containing function parameter),
C<Cat.E.EK:func> (result of function invocation, or inlining of function
body).  Its default value is C<Cat.E.EK:scalar>.
...
Iff C<kind> is C<Cat.E.EK.(|quasi_)(tuple|relation)>, then the expression
...
=item C<sys.Core.Tuple.rename of Tuple (RO: Tuple $topic,
...
=item C<sys.Core.Tuple.project of Tuple (RO: Tuple $topic,
...
=item C<sys.Core.Tuple.remove of Tuple (RO: Tuple $topic,
Cat.SetOfShortName $attrs)>
...
=item C<sys.Core.Tuple.wrap of Tuple (RO: Tuple $topic, Cat.SetOfShortName
