...
of a B<D> language.  Its default and minimum value is C<Bool:false>; its
maximum value is C<Bool.true>.  The cardinality of this type is 2.
...
=item C<sys.rtn.Universal.equal of Bool (RO: Some.Universal $v1,
Some.Universal $v2)>
...
=item C<sys.rtn.Universal.not_equal of Bool (RO: Some.Universal $v1,
Some.Universal $v2)>
