...
C<Rat>, C<Blob>, C<Text>, C<Cat.Name>, C<Cat.NameChain>, C<Cat.E_TK>,
C<Cat.E_TDM>, C<Cat.E_EK>, ...
...
$rebase_radix, PInt $rebase_max_denom, Cat.E_RM $rebase_round)>
...
PInt $rebase_max_denom, Cat.E_RM $rebase_round)>
...
=item C<sys.Core.Rat.Int_from_Rat of Int (Rat $rat, Cat.E_RM $round)>
...
determined by the rounding method specified by the C<$round> argument.
