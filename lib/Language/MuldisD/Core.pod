...
=item C<sys.Core.Tuple.wrap of Tuple (Tuple $topic, Cat.SetOfName
...
=item C<sys.Core.Tuple.unwrap of Tuple (Tuple $topic, Cat.Name
$outer)>
...
Cat.SetOfName $inner, Cat.Name $outer)>
