...
as determined by applying the C<Tuple>-returning function named in its
...
and second tuples have no attribute names in common, and the result tuple
is derived by joining the tuples together.

=item C<sys.Core.Relation.summary>

I<TODO.>

=item C<sys.Core.Relation.substitution>
