...
=item C<sys.Core.Ordered.min of Ordered (Set{Ordered} $topic)>
...
=item C<sys.Core.Ordered.max of Ordered (Set{Ordered} $topic)>
...
=item C<sys.Core.Ordered.maybe_min of Maybe{Ordered} (Set{Ordered} $topic)>
...
=item C<sys.Core.Ordered.maybe_max of Maybe{Ordered} (Set{Ordered} $topic)>
