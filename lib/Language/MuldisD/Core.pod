...
=item C<sys.Core.Int.Int_from_NEText of Int (NEText $text, Cat.PInt2_36
$radix)>
...
=item C<sys.Core.Int.NEText_from_Int of NEText (Int $int, Cat.PInt2_36
$radix)>
...
=item C<sys.Core.Rat.Rat_from_NEText of Rat (NEText $text, Cat.PInt2_36
$radix)>
...
=item C<sys.Core.Rat.NEText_from_Rat of NEText (Rat $rat, Cat.PInt2_36
$radix)>
...
=item C<sys.Core.Blob.Blob_from_Text of Blob (Text $text, Cat.PInt1_4
$size)>
...
=item C<sys.Core.Blob.Text_from_Blob of Text (Blob $blob, Cat.PInt1_4
$size)>
