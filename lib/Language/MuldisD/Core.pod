...
relationships:
    ...
    sys.Core.Universal.Universal
        ...
        sys.Core.QuasiRelation.QuasiRelation
            sys.Core.QuasiSet.QuasiSet
                sys.Core.QuasiMaybe.QuasiMaybe
            sys.Core.QuasiSeq.QuasiSeq
            sys.Core.QuasiBag.QuasiBag

Note that C<sys.Core.Empty.Empty> is a proper subtype of all of the other types
    ...
    sys.Core.Universal.Universal
                ...
                sys.Core.Int.Int
                    sys.Core.UInt.UInt
                        sys.Core.PInt.PInt
                            ...
                            sys.Core.PInt.PInt1_4
                            sys.Core.PInt.PInt2_36
        ...
        sys.Core.Relation.Relation
            sys.Core.Set.Set
                ...
                sys.Core.SetOfBool.SetOfBool
                sys.Core.SetOfInt.SetOfInt
                sys.Core.SetOfRat.SetOfRat
                sys.Core.SetOfBlob.SetOfBlob
                sys.Core.SetOfText.SetOfText

                # The following are all nonscalar type factories.

                sys.Core.SetOfRelation.SetOfRelation

                sys.Core.Maybe.Maybe

                    # The following are all regular maybe types.

                    sys.Core.MaybeOfBool.MaybeOfBool
                    sys.Core.MaybeOfInt.MaybeOfInt
                    sys.Core.MaybeOfRat.MaybeOfRat
                    sys.Core.MaybeOfBlob.MaybeOfBlob
                    sys.Core.MaybeOfText.MaybeOfText

            sys.Core.Seq.Seq

                # The following are all regular sequence types.

                sys.Core.SeqOfBool.SeqOfBool
                sys.Core.SeqOfInt.SeqOfInt
                sys.Core.SeqOfRat.SeqOfRat
                sys.Core.SeqOfBlob.SeqOfBlob
                sys.Core.SeqOfText.SeqOfText

            sys.Core.Bag.Bag

                # The following are all regular bag types.

                sys.Core.BagOfBool.BagOfBool
                sys.Core.BagOfInt.BagOfInt
                sys.Core.BagOfRat.BagOfRat
                sys.Core.BagOfBlob.BagOfBlob
                sys.Core.BagOfText.BagOfText

                # The following are all nonscalar type factories.

                sys.Core.BagOfRelation.BagOfRelation
        ...
        sys.Core.QuasiRelation.QuasiRelation
            sys.Core.QuasiSet.QuasiSet
                ...
                sys.Core.QuasiSetOfRelation.QuasiSetOfRelation

Note that, in later operator documentation, if you see something like
C<Foo{Bar}> as a declared type, it corresponds to C<sys.Core.FooOfBar.FooOfBar>.
...
routine that is used on 2 values of a C<sys.Core.Ordered.Ordered> subtype.  Its
...
=item C<sys.Core.Database.Database>
...
=item C<sys.Core.QuasiSet.QuasiSet>
...
=item C<sys.Core.QuasiMaybe.QuasiMaybe>
...
=item C<sys.Core.QuasiSeq.QuasiSeq>
...
=item C<sys.Core.QuasiBag.QuasiBag>
...
=item C<sys.Core.QuasiSetOfRelation.QuasiSetOfRelation>
...
=item C<sys.Core.Cat.ShortNameSet>

A C<Cat.ShortNameSet> is a C<Set> of C<Cat.ShortName>.

=item C<sys.Core.Cat.AttrRenameMap>
...
=item C<sys.Core.Universal.is_equal of Bool (RO: Some.Universal $v1,
Some.Universal $v2)>
...
=item C<sys.Core.Universal.is_not_equal of Bool (RO: Some.Universal $v1,
Some.Universal $v2)>
...
=item C<sys.Core.Universal.is_value_of_type of Bool (RO: Cat.LongName $type,
Universal $v)>
...
=item C<sys.Core.Universal.treat of Some.Universal (RO: Cat.LongName $as,
Some.Universal $v)>
...
=item C<sys.Core.Universal.default of Some.Universal (RO: Cat.LongName $of)>
...
=item C<sys.Core.Ordered.compare of Order (RO: Some.Ordered $v1,
Some.Ordered $v2)>
...
=item C<sys.Core.Ordered.reverse_compare of Order (RO: Some.Ordered $v1,
Some.Ordered $v2)>

This function is exactly the same as C<sys.Core.Ordered.compare> except that
it results in the reverse value when given the same arguments.  It is a
short-hand for applying C<sys.Core.Order.reverse> to the result of
C<sys.Core.Ordered.compare> with the same arguments.

=item C<sys.Core.Ordered.is_increase of Bool (RO: Some.Ordered $v1,
Some.Ordered $v2)>
...
=item C<sys.Core.Ordered.is_decrease of Bool (RO: Some.Ordered $v1,
Some.Ordered $v2)>
...
=item C<sys.Core.Ordered.min of Some.Ordered (RO: Set{Some.Ordered} $topic)>
...
=item C<sys.Core.Ordered.max of Some.Ordered (RO: Set{Some.Ordered} $topic)>
...
=item C<sys.Core.Ordered.maybe_min of Maybe{Some.Ordered} (RO:
...
=item C<sys.Core.Ordered.maybe_max of Maybe{Some.Ordered} (RO:
Set{Some.Ordered} $topic)>

This function is to C<sys.Core.Ordered.max> as C<sys.Core.Ordered.maybe_min>
is to C<sys.Core.Ordered.min>.
...
=item C<sys.Core.Bool.false of Bool ()>

This selector function results in the C<Bool:false> value.

=item C<sys.Core.Bool.true of Bool ()>
...
=item C<sys.Core.Bool.not of Bool (RO: Bool $topic)>

This function results in the logical I<not> of its argument.

=item C<sys.Core.Bool.and of Bool (RO: Set{Bool} $topic)>
...
=item C<sys.Core.Bool.or of Bool (RO: Set{Bool} $topic)>
...
=item C<sys.Core.Bool.xor of Bool (RO: Bag{Bool} $topic)>
...
=item C<sys.Core.Order.reverse of Order (RO: Order $topic)>
...
=item C<sys.Core.Int.abs of UInt (RO: Int $topic)>

This function results in the absolute value of its argument.

=item C<sys.Core.Int.sum of Int (RO: Bag{Int} $addends)>
...
=item C<sys.Core.Int.difference of Int (RO: Int $minuend, Int $subtrahend)>

This function results in the difference when its C<$subtrahend> argument is
subtracted from its C<$minuend> argument.

=item C<sys.Core.Int.product of Int (RO: Bag{Int} $factors)>
...
=item C<sys.Core.Int.quotient of Int (RO: Int $dividend, Int $divisor)>
...
=item C<sys.Core.Int.remainder of UInt (RO: Int $dividend, Int $divisor)>

This function results in the remainder when its C<$dividend> argument is
divided by its C<$divisor> argument using integer division.  This function
will fail if C<$divisor> is zero.

=item C<sys.Core.Int.maybe_quotient of Maybe{Int} (RO: Int $dividend, Int
$divisor)>

This function is exactly the same as C<sys.Core.Int.quotient> except that it
results in a C<Maybe> of what is otherwise the result, and that result has
zero elements if C<$divisor> is zero.

=item C<sys.Core.Int.maybe_remainder of Maybe{UInt} (RO: Int $dividend, Int
$divisor)>
...
=item C<sys.Core.Int.range of Int (RO: Set{Int} $topic)>
...
=item C<sys.Core.Int.median of Set{Int} (RO: Bag{Int} $topic)>
...
=item C<sys.Core.Int.mode of Set{Int} (RO: Bag{Int} $topic)>
...
=item C<sys.Core.Int.power of Int (RO: Int $radix, UInt $exponent)>
...
=item C<sys.Core.Int.Int_from_NEText of Int (RO: NEText $text, PInt2_36
$radix)>
...
=item C<sys.Core.Int.NEText_from_Int of NEText (RO: Int $int, PInt2_36
$radix)>
...
=item C<sys.Core.Int.Int_from_Blob_S_VBE of Int (RO: NEBlob $blob)>
...
=item C<sys.Core.Int.Blob_S_VBE_from_Int of NEBlob (RO: Int $int)>
...
=item C<sys.Core.Int.Int_from_Blob_U_VBE of UInt (RO: NEBlob $blob)>

This function is the same as C<sys.Core.Int.Int_from_Blob_S_VBE> but that it
does unsigned integers.

=item C<sys.Core.Int.Blob_U_VBE_from_Int of UInt (RO: NEBlob $blob)>

This function is the same as C<sys.Core.Int.Blob_S_VBE_from_Int> but that it
does unsigned integers.
...
=item C<sys.Core.Rat.Rat_from_Int_pair of Rat (RO: Int $numerator, PInt
$denominator)>
...
=item C<sys.Core.Rat.numerator of Int (RO: Rat $topic)>
...
=item C<sys.Core.Rat.denominator of PInt (RO: Rat $topic)>
...
=item C<sys.Core.Rat.abs of URat (RO: Rat $topic)>

This function results in the absolute value of its argument.

=item C<sys.Core.Rat.sum of Rat (RO: Bag{Rat} $addends)>
...
=item C<sys.Core.Rat.difference of Rat (RO: Rat $minuend, Rat $subtrahend)>

This function results in the difference when its C<$subtrahend> argument is
subtracted from its C<$minuend> argument.

=item C<sys.Core.Rat.product of Rat (RO: Bag{Rat} $factors)>
...
=item C<sys.Core.Rat.quotient of Rat (RO: Rat $dividend, Rat $divisor)>

This function results in the quotient when its C<$dividend> argument is
divided by its C<$divisor> argument using rational division.  This function
will fail if C<$divisor> is zero.

=item C<sys.Core.Rat.maybe_quotient of Maybe{Rat} (RO: Rat $dividend, Rat
$divisor)>

This function is exactly the same as C<sys.Core.Rat.quotient> except that it
results in a C<Maybe> of what is otherwise the result, and that result has
zero elements if C<$divisor> is zero.

=item C<sys.Core.Rat.range of Rat (RO: Set{Rat} $topic)>

This function results in the difference between the lowest and highest
element values of its argument.  If C<$topic> has zero values, then
C<range> results in the rational zero.

=item C<sys.Core.Rat.mean of Rat (RO: Bag{Rat} $topic)>
...
=item C<sys.Core.Rat.maybe_mean of Maybe{Rat} (RO: Bag{Rat} $topic)>

This function is exactly the same as C<sys.Core.Rat.mean> except that it
results in a C<Maybe> of what is otherwise the result, and that result has
zero elements if C<$topic> has zero values.

=item C<sys.Core.Rat.median of Set{Rat} (RO: Bag{Rat} $topic)>
...
=item C<sys.Core.Rat.mean_of_median of Rat (RO: Bag{Rat} $topic)>
...
=item C<sys.Core.Rat.mode of Set{Rat} (RO: Bag{Rat} $topic)>
...
=item C<sys.Core.Rat.power of PRat (RO: PRat $radix, Rat $exponent)>
...
=item C<sys.Core.Rat.log of Rat (RO: PRat $topic, PRat $radix, PInt
...
=item C<sys.Core.Rat.natural_power of PRat (RO: Rat $exponent, PInt
$rebase_radix, PInt $rebase_max_denom, Cat.RoundMeth $rebase_round)>
...
=item C<sys.Core.Rat.natural_log of Rat (RO: PRat $topic, PInt
$rebase_radix, PInt $rebase_max_denom, Cat.RoundMeth $rebase_round)>
...
=item C<sys.Core.Rat.Rat_from_NEText of Rat (RO: NEText $text, PInt2_36
$radix)>
...
=item C<sys.Core.Rat.NEText_from_Rat of NEText (RO: Rat $rat, PInt2_36
$radix)>
...
=item C<sys.Core.Rat.Rat_from_Int of Rat (RO: Int $int)>

This selector function results in the C<Rat> value that is conceptually
equal to its C<Int> argument.

=item C<sys.Core.Rat.round_half_up of Int (RO: Rat $topic)>
...
=item C<sys.Core.Rat.round_to_even of Int (RO: Rat $topic)>
...
=item C<sys.Core.Rat.round_to_floor of Int (RO: Rat $topic)>
...
=item C<sys.Core.Rat.round_to_ceiling of Int (RO: Rat $topic)>

This rounding function results in the integer that is either equal to its
argument or that is the nearest integer that is below the argument.

=item C<sys.Core.Rat.round_to_zero of Int (RO: Rat $topic)>
...
=item C<sys.Core.Rat.rebase of Rat (RO: Rat $topic, PInt $radix, PInt
...
=item C<sys.Core.Blob.catenate of Blob (RO: Seq{Blob} $topic)>
...
=item C<sys.Core.Blob.repeat of Blob (RO: Blob $topic, UInt $count)>

This function results in the catenation of C<$count> instances of
C<$topic>.

=item C<sys.Core.Blob.length_in_bits of UInt (RO: Blob $topic)>

This function results in the length of its argument in bits.

=item C<sys.Core.Blob.contains of Bool (RO: Blob $look_in, Blob $look_for,
...
=item C<sys.Core.Blob.not of Blob (RO: Blob $topic)>

This function results in the bitwise I<not> of its argument.

=item C<sys.Core.Blob.and of Blob (RO: Set{Blob} $topic)>
...
=item C<sys.Core.Blob.or of Blob (RO: Set{Blob} $topic)>
...
=item C<sys.Core.Blob.xor of Blob (RO: Bag{Blob} $topic)>
...
=item C<sys.Core.Blob.Blob_from_Text of Blob (RO: Text $text, PInt1_4
$size)>
...
=item C<sys.Core.Blob.Text_from_Blob of Text (RO: Blob $blob, PInt1_4
$size)>
...
=item C<sys.Core.Text.catenate of Text (RO: Seq{Text} $topic)>
...
=item C<sys.Core.Text.repeat of Text (RO: Text $topic, UInt $count)>

This function results in the catenation of C<$count> instances of
C<$topic>.

=item C<sys.Core.Text.length_in_nfd_graphs of UInt (RO: Text $topic)>

This function results in the length of its argument in Unicode
Normalization Form D graphemes.

=item C<sys.Core.Text.length_in_nfc_graphs of UInt (RO: Text $topic)>

This function results in the length of its argument in Unicode
Normalization Form C graphemes.

=item C<sys.Core.Text.length_in_nfd_codes of UInt (RO: Text $topic)>

This function results in the length of its argument in Unicode
Normalization Form D code points.

=item C<sys.Core.Text.length_in_nfc_codes of UInt (RO: Text $topic)>

This function results in the length of its argument in Unicode
Normalization Form C code points.

=item C<sys.Core.Text.contains of Bool (RO: Text $look_in, Text $look_for,
Bool $fixed_start, Bool $fixed_end)>
...
=item C<sys.Core.Text.fold_case_to_upper (RO: Text $topic)>

This function results in the transformation of its argument where any Latin
letters are folded to (capital) uppercase.

=item C<sys.Core.Text.fold_case_to_lower (RO: Text $topic)>

This function results in the transformation of its argument where any Latin
letters are folded to (small) lowercase.

=item C<sys.Core.Text.trim_whitespace (RO: Text $topic)>
...
=item C<sys.Core.Tuple.degree of UInt (RO: Tuple $topic)>

This function results in the degree of its argument (that is, the count of
attributes it has).

=item C<sys.Core.Tuple.rename of Tuple (RO: Tuple $topic, Cat.AttrRenameMap
$map)>
...
=item C<sys.Core.Tuple.project of Tuple (RO: Tuple $topic, Cat.ShortNameSet
$attrs)>
...
=item C<sys.Core.Tuple.remove of Tuple (RO: Tuple $topic, Cat.ShortNameSet
$attrs)>
...
=item C<sys.Core.Tuple.wrap of Tuple (RO: Tuple $topic, Cat.ShortNameSet
...
=item C<sys.Core.Tuple.unwrap of Tuple (RO: Tuple $topic, Cat.ShortName
$outer)>
...
=item C<sys.Core.Tuple.product of Tuple (RO: QuasiSet{Tuple} $topic)>
...
=head2 Functions for sys.Core.Relation.Relation Having Single Input Relations

=over

=item C<sys.Core.Relation.degree of UInt (RO: Relation $topic)>

This function results in the degree of its argument (that is, the count of
attributes it has).

=item C<sys.Core.Relation.cardinality of UInt (RO: Relation $topic)>

This function results in the cardinality of its argument (that is, the
count of tuples its body has).

=item C<sys.Core.Relation.is_empty of Bool (RO: Relation $topic)>
...
=item C<sys.Core.Relation.is_not_empty of Bool (RO: Relation $topic)>
...
=item C<sys.Core.Relation.exists of Bool (RO: Relation $r, Tuple $t)>
...
=item C<sys.Core.Relation.Tuple_from_Relation of Tuple (RO: Relation
$topic)>
...
=item C<sys.Core.Relation.Relation_from_Tuple of Relation (RO: Tuple
$topic)>

This function results in the C<Relation> value those body has just the one
C<Tuple> that is its argument.

=item C<sys.Core.Relation.insert of Relation (RO: Relation $r, Tuple $t)>
...
=item C<sys.Core.Relation.delete of Relation (RO: Relation $r, Tuple $t)>
...
=item C<sys.Core.Relation.evacuate of Relation (RO: Relation $topic)>

This function results in a C<Relation> that has the same heading as its
argument, but with an empty body.

=item C<sys.Core.Relation.not of Relation (RO: Relation $topic)>
...
=item C<sys.Core.Relation.rename of Relation (RO: Relation $topic,
...
=item C<sys.Core.Relation.project of Relation (RO: Relation $topic,
...
=item C<sys.Core.Relation.remove of Relation (RO: Relation $topic,
Cat.ShortNameSet $attrs)>

This function is the same as C<sys.Core.Tuple.remove> but that it operates
on and results in a C<Relation> rather than a C<Tuple>.

=item C<sys.Core.Relation.wrap of Relation (RO: Relation $topic,
...
=item C<sys.Core.Relation.unwrap of Relation (RO: Relation $topic,
Cat.ShortName $outer)>

This function is the inverse of C<sys.Core.Relation.wrap> as
C<sys.Core.Tuple.unwrap> is to C<sys.Core.Tuple.wrap>.

=item C<sys.Core.Relation.group of Relation (RO: Relation $topic,
Cat.ShortNameSet $inner, Cat.ShortName $outer)>

I<TODO.>

=item C<sys.Core.Relation.ungroup of Relation (RO: Relation $topic,
Cat.ShortName $outer)>

I<TODO.>

=item C<sys.Core.Relation.tclose of Relation (RO: Relation $topic)>
...
=item C<sys.Core.Relation.restrict of Relation (RO: Relation $topic,
...
=item C<sys.Core.Relation.extend of Relation (RO: Relation $topic,
Cat.LongName $func, Tuple $assuming)>
...
=head2 Functions for sys.Core.Relation.Relation Having Multiple Input Relations

=over

=item C<sys.Core.Relation.contains of Bool (RO: Relation $look_in, Relation
$look_for)>
...
=item C<sys.Core.Relation.union of Relation (RO: Set{Relation} $topic)>
...
=item C<sys.Core.Relation.exclusion of Relation (RO: Bag{Relation} $topic)>
...
=item C<sys.Core.Relation.intersection of Relation (RO: Set{Relation}
$topic)>
...
=item C<sys.Core.Relation.difference of Relation (RO: Relation $source,
Relation $filter)>
...
=item C<sys.Core.Relation.semidifference of Relation (RO: Relation $source,
Relation $filter)>
...
=item C<sys.Core.Relation.semijoin of Relation (RO: Relation $source,
Relation $filter)>
...
=item C<sys.Core.Relation.join of Relation (RO: QuasiSet{Relation} $topic)>
...
=item C<sys.Core.Relation.product of Relation (RO: QuasiSet{Relation}
$topic)>
...
=item C<sys.Core.Relation.compose of Relation (RO: Relation $r1, Relation
$r2)>
...
=item C<sys.Core.Relation.quotient of Relation (RO: Relation $dividend,
Relation $divisor)>
