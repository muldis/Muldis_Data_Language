...
This document is Language::MuldisD::Grammar version 0.10.0.
...
correctly.  Any remaining errors should be corrected as soon as possible.
    ...
    # grammar MuldisD:auth<cpan:DUNCAND>:ver<0.10.0>;
    grammar MuldisD-0.10.0-cpan:DUNCAND;
...
The following are fragments of actual Concrete Muldis D code.
    ...
    Just:'fed.the_db.gene.person_death_date':{ Text:'2003.07.24' }
