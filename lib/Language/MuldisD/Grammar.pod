...
This document is Language::MuldisD::Grammar version 0.3.0.
...
correctly.  Any remaining errors should be corrected as soon as possible.
    ...
    token relation_typed_attr { <cat_short_name> <pair_sep> <relation> }
    ...
    token attr { <cat_short_name> <pair_sep> <literal> }
    ...
    token sys_type_name { <quoted_text_str> }
