...
This document is Language::MuldisD::SeeAlso version 0.3.3.
...
manner of speaking, such that users would typically specify Abstract Muldis
...
(L<http://www.pugscode.org/>) in its C<ext/> directory.  Over the long
...
Language::MuldisD is Copyright © 2002-2008, Darren Duncan.
