...
This document is Language::MuldisD::PerlHosted version 0.6.0.
...
of the 7 values C<special>, C<scalar>, C<tuple>, C<relation>, C<quasi_tuple>,
C<quasi_relation>, C<remnant>.
...
directly mapping the payload.  The payload must be a Perl C<Str> having one
of the 10 values C<default>, C<scalar>, C<tuple>, C<relation>,
