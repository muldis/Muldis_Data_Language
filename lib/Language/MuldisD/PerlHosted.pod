...
This document is Language::MuldisD::PerlHosted version 0.1.0.
...
This node is interpreted as a Muldis D C<sys.Core.Bool.Bool> value as follows:
...
This node is interpreted as a Muldis D C<sys.Core.Order.Order> value as follows:
...
This node is interpreted as a Muldis D C<sys.Core.Int.Int> value as follows:
...
=head2 sys.Core.UInt.UInt

This node type represents an unsigned / non-negative integer value; it is
interpreted as a Muldis D C<sys.Core.UInt.UInt>.  Its format is the same as for
C<sys.Core.Int.Int> but that the node type is 'UInt', its formats are
...
=head2 sys.Core.PInt.PInt

This node type represents a positive integer value; it is interpreted as a
Muldis D C<sys.Core.PInt.PInt>.  Its format is the same as for C<sys.Core.UInt.UInt>
...
This node is interpreted as a Muldis D C<sys.Core.Rat.Rat> value as follows:
...
=head2 sys.Core.URat.URat

This node type represents a unsigned / non-negative rational value; it is
interpreted as a Muldis D C<sys.Core.URat.URat>.  Its format is the same as for
C<sys.Core.Rat.Rat> but that the node type is 'URat', its formats are
...
=head2 sys.Core.PRat.PRat

This node type represents a positive rational value; it is interpreted as a
Muldis D C<sys.Core.PRat.PRat>.  Its format is the same as for C<sys.Core.URat.URat>
but that the node type is 'PRat', formats 'prat', and the payload may not
be C<0>.
...
This node is interpreted as a Muldis D C<sys.Core.Blob.Blob> value as follows:
...
=head2 sys.Core.NEBlob.NEBlob

This node type represents a non-empty bit-string value; it is interpreted
as a Muldis D C<sys.Core.NEBlob.NEBlob>.  Its format is the same as for
...
This node is interpreted as a Muldis D C<sys.Core.Text.Text> value by directly
...
=head2 sys.Core.NEText.NEText

This node type represents a non-empty bit-string value; it is interpreted
as a Muldis D C<sys.Core.NEText.NEText>.  Its format is the same as for
C<sys.Core.Text.Text> but that the node type is 'Text', and the payload may not
be the empty string.
...
=head2 sys.Core.Database.Database

This node type represents a database value; it is interpreted as a Muldis D
C<sys.Core.Database.Database>.  Its format is the same as for C<sys.Core.Tuple.Tuple> but
...
This node is interpreted as a Muldis D C<sys.Core.Relation.Relation> value whose
...
This node is interpreted as a Muldis D C<sys.Core.Set.Set> value whose heading
...
=head2 sys.Core.Maybe.Maybe

This node type represents a maybe value; it is interpreted as a Muldis D
C<sys.Core.Maybe.Maybe>.  Its format is the same as for C<sys.Core.Set.Set> but that
...
This node is interpreted as a Muldis D C<sys.Core.Seq.Seq> value whose heading
...
This node is interpreted as a Muldis D C<sys.Core.Bag.Bag> value whose heading
