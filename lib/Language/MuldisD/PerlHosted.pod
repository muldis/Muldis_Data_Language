...
interpreted as a Muldis D C<sys.Core.Int.UInt>.  Its format is the same as for
...
Muldis D C<sys.Core.Int.PInt>.  Its format is the same as for C<sys.Core.Int.UInt>
...
interpreted as a Muldis D C<sys.Core.Rat.URat>.  Its format is the same as for
...
Muldis D C<sys.Core.Rat.PRat>.  Its format is the same as for C<sys.Core.Rat.URat>
