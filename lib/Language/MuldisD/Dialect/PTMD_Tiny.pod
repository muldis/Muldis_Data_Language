...
This document is Language::MuldisD::Dialect::PTMD_Tiny version 0.12.0.
...
execution.  Any remaining errors should be corrected as soon as possible.
    ...
    # grammar Muldis_D_PTMD_Tiny:auth<cpan:DUNCAND>:ver<0.12.0>;
    grammar Muldis_D_PTMD_Tiny-0.12.0-cpan:DUNCAND;
