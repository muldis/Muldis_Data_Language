...
This document is Language::MuldisD version 0.22.0.
...
C<Muldis_D:'cpan:DUNCAND':'0.22.0'>.  It is the official/original (not
embraced and extended) Muldis D language specification by the authority
Darren Duncan (C<cpan:DUNCAND>), version C<0.22.0> (this number matches the
