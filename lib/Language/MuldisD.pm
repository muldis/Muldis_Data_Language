...
This document is Language::MuldisD version 0.12.0.
...
specification it contains is C<MuldisD:'cpan:DUNCAND':'0.12.0'>.  It is the
...
C<0.12.0> (this number matches the VERSION pod in this file).  Any modified
