...
{ package Muldis::DB::Validator; # module
    ...
    use Muldis::DB::AST qw(newQuasiSetSel);
...
sub _scenario_foods_suppliers_shipments {
    ...
    my $sca_type_Text
        = Muldis::DB::AST::TypeInvoNQ->new({ 'kind' => 'Scalar', 'spec' => $tynm_Text });
    my $sca_type_UInt
        = Muldis::DB::AST::TypeInvoNQ->new({ 'kind' => 'Scalar', 'spec' => $tynm_UInt });

    my $qrel_type_Relation
        = Muldis::DB::AST::TypeInvoAQ->new({ 'kind' => 'Any', 'spec' => 'Relation' });
    ...
    my $opnm_rel_asn = Muldis::DB::AST::EntityName->new({
        'text' => 'sys.rtn.Relation.assign' });
    my $opnm_rel_jn  = Muldis::DB::AST::EntityName->new({
        'text' => 'sys.rtn.Relation.join' });
    my $opnm_rel_sjn = Muldis::DB::AST::EntityName->new({
        ...
        'stmts' => [
            Muldis::DB::AST::ProcInvo->new({
                ...
                'upd_args' => Muldis::DB::AST::ExprDict->new({ 'map' => [
                    [$anm_target, Muldis::DB::AST::VarInvo->new({
                        'v' => $pnm_matched_suppl})],
                ] }),
                'ro_args' => Muldis::DB::AST::ExprDict->new({ 'map' => [
    ...
    $desi_colour->store_ast({
        'val_ast' => Muldis::DB::AST::TextLit->new({ 'v' => 'orange' }) });
