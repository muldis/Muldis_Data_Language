...
=head2 < before
    ...
    ::MD::"<" ::= function --> Boolean <-- (Orderable, Orderable)
        : (topic --> \$in_order and topic --> \$"!=");

    ::MD::before ::= synonym of "<";
...
=head2 in_order (Enumerable)

    ::MD::in_order::Enumerable ::= function virtual
...
=head2 in_order (Integral)

    ::MD::in_order::Integral ::= function virtual
        --> Boolean <-- (Integral, Integral)
        implements 1::Enumerable;
...
=head2 .? has_item
    ...
    ::MD::has_item ::= synonym of ".?";

I<TODO.>

=head2 .! item_or_void

    ::MD::".!"::"" ::= function --> Any <-- (Accessible, Any)
        : (topic --> \$".?" ?? topic --> \$"." !! \(\Void));

    ::MD::item_or_void ::= synonym of ".!";
...
=head2 . (Arrayish)
    ...
    ::MD::"."::Arrayish ::= function virtual
        --> Any <-- (Arrayish, Integral)
        implements 1::"";
...
=head2 . (Array)
    ...
    ::MD::"."::Array ::= function --> Any <-- (Array, Integer)
        implements 1::Arrayish
...
=head2 .? (Array)
    ...
    ::MD::".?"::Array ::= function --> Boolean <-- (Array, Integer)
        implements 1::Arrayish
...
=head2 .> field
    ...
    ::MD::".>" ::= function --> Any <-- (Structure, SC_Field_Name)
...
=head2 .>? has_field
    ...
    ::MD::".>?" ::= function --> Boolean <-- (Structure, SC_Field_Name)
...
=head2 ^> on_fields
    ...
    ::MD::"^>" ::= function --> Structure <-- (Structure, SC_Field_Names)
        (...);

    ::MD::on_fields ::= synonym of "^>";
...
=head2 -^> but_fields
    ...
    ::MD::but_fields ::= synonym of "^>";

I<TODO.>

=head2 ^>? has_fields

    ::MD::"^>?" ::= function --> Boolean <-- (Structure, SC_Signature)
        (...);

    ::MD::has_fields ::= synonym of "^>";
...
=head2 ^ (Tuple)
    ...
    ::MD::"^"::Tuple ::= function --> Tuple <-- (Tuple, SC_Field_Names)
        implements 1::""
        (\\0 .> \1 ^> \\1);
...
=head2 ^? (Tuple)
    ...
    ::MD::"^?"::Tuple ::= function --> Boolean <-- (Tuple, SC_Signature)
        implements 1::""
        (\\0 .> \1 ^>? \\1);
