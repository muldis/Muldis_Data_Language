...
The function C<succ::Boolean> implements the C<Bicessable> virtual
...
C<Bicessable> virtual function C<succ> for the composing type C<Integral>.
Other programming languages may name their corresponding operators
I<increment>.
...
The function C<succ::Integer> implements the C<Bicessable>/C<Integral>
