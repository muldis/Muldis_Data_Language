...
for C<Enumerable> types in general, the terms just mean prior or next
...
=head2 Boolean Bool
    ...
    ::MD::Boolean::"" ::= selection where (topic -->^ FDN__isa_Boolean)
        default (False)
        composes {Enumerable, Boolable and_provides_its_default};
...
=head2 Integral
    ...
    ::MD::Integral ::= interface
        composes {Enumerable and_provides_its_default,
            Numeric and_provides_its_default}
...
C<Enumerable> virtual function C<pred> for the composing type C<Integral>. 
Other programming languages may name their corresponding operators
I<decrement>.
...
C<Enumerable> virtual function C<succ> for the composing type C<Integral>. 
Other programming languages may name their corresponding operators
I<increment>.
...
The function C<pred::Integer> implements the C<Enumerable>/C<Integral>
...
The function C<succ::Integer> implements the C<Enumerable>/C<Integral>
