...
and Structure due to overlap and conflicting meaning with some other composers;
Attributive and Structure instead have their own different-named versions of the Boolable ops.)>
...
=head2 -
    ...
    ::MD::"-" ::= function --> Numeric <-- {(Numeric), (Numeric, Numeric)}
        : (topic --> (Structure_degree(topic) = 1 ?? \@opposite !! \@minus));
...
Composed by: Positional (Array, String, etc), Setty (Set, Relation), Baggy (Bag, Tuple_Bag).
...
=head2 any there_exists ∃
    ...
    ::MD::any::"" ::= function virtual
        --> Boolean <-- (Homogeneous, SC_Primed_Func_Ref);
...
=head2 all for_all ∀
    ...
    ::MD::all ::= function --> Boolean <-- (Homogeneous, SC_Primed_Func_Ref)
...
=head2 where
    ...
    ::MD::where::"" ::= function virtual
        --> Homogeneous <-- (Homogeneous, SC_Primed_Func_Ref);

I<TODO.  The primed-func-ref is expected to be a Structure with 2 fields
named 'func' and 'args', which are a SC_Reference and a Structure respectively.
The 'args' can be any Structure that doesn't have a '0' field.
The function referenced by 'func' is expected to take a Structure argument
whose '0' field is a member of the collection and whose other fields match
those given in 'args'.>
...
=head2 reduce
    ...
    ::MD::reduce::"" ::= function virtual
        --> Any <-- (Homogeneous, SC_Primed_Func_Ref);

I<TODO.  The primed-func-ref is expected to be a Structure with 2 fields
named 'func' and 'args', which are a SC_Reference and a Structure respectively.
The 'args' can be any Structure that doesn't have either '0' or '1' fields.
The function referenced by 'func' is expected to take a Structure argument
whose '0' and '1' fields are members of the collection and whose other fields match
those given in 'args'.
...
=head2 any (Array)
    ...
    ::MD::any::Array ::= function --> Boolean <-- (Array, SC_Primed_Func_Ref)
        implements 1::""
...
=head2 where (Array)
    ...
    ::MD::where::Array ::= function --> Array <-- (Array, SC_Primed_Func_Ref)
        implements 1::""
...
=head2 map (Array)
    ...
    ::MD::map::Array ::= function --> Array <-- (Array, SC_Primed_Func_Ref)
        implements 1::""
...
=head2 reduce (Array)
    ...
    ::MD::reduce::Array ::= function --> Any <-- (Array, SC_Primed_Func_Ref)
        implements 1::""
...
=head1 ASSOCIATIVE DATA TYPES

=head2 Associative

    ::MD::Associative ::= interface;

I<TODO.  For types that support key-based lookup of values;
for collections of key-asset pairs where all keys are distinct;
for collections you can enumerate with no canonical order.
Currently Associative is just semantic, not adding its own API.
Composed by: Setty (Set, Relation), Baggy (Bag, Tuple_Bag), Dictionary, etc.>
...
=head2 Set_Inf Set
    ...
    ::MD::Set_Inf ::= selection of Structure
        where (topic has_just_fields \(constant (\Set), \@Bag) and ...)
        default ({})
        composes Setty and_provides_its_default;

    ::MD::Set ::= synonym of Set_Inf;
...
=head2 unnest (Set)
    ...
    ::MD::unnest::Set ::= function --> Set <-- (Set)
        implements 1::""
        requires (...)
        : (\(\Set, \\0 field \1 ->unnest));

I<TODO.>

=head2 any (Set)

    ::MD::any::Set ::= function --> Boolean <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (\\0 field \1 any \\1);
...
=head2 where (Set)
    ...
    ::MD::where::Set ::= function --> Set <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (\(\Set, \\0 field \1 where \\1));

I<TODO.>

=head2 map (Set)

    ::MD::map::Set ::= function --> Set <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (\(\Set, \\0 field \1 map \\1));
...
=head2 reduce (Set)
    ...
    ::MD::reduce::Set ::= function --> Any <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (\(\Set, \\0 field \1 reduce \\1));

I<TODO.>

=head1 BAGGY DATA TYPES
...
I<TODO.  For collections of weighted objects;
for collections of key-quantity pairs.
Composed by: Bag, Tuple_Bag.>
...
=head2 any (Bag)
    ...
    ::MD::any::Bag ::= function --> Boolean <-- (Bag, SC_Primed_Func_Ref)
        implements 1::""
        : (topic -->^ FDN__Bag_any);
...
=head2 where (Bag)
    ...
    ::MD::where::Bag ::= function --> Bag <-- (Bag, SC_Primed_Func_Ref)
        implements 1::""
...
=head2 map (Bag)
    ...
    ::MD::map::Bag ::= function --> Bag <-- (Bag, SC_Primed_Func_Ref)
        implements 1::""
        : (topic -->^ FDN__Bag_map);
...
=head2 reduce (Bag)
    ...
    ::MD::reduce::Bag ::= function --> Any <-- (Bag, SC_Primed_Func_Ref)
        implements 1::""
...
=head2 Excuse::No_Such_Field

    ::MD::Excuse::No_Such_Field ::= constant (\@0) composes Excuse;
...
=head2 Structure_degree
    ...
    ::MD::Structure_degree ::= function --> Integer_NN <-- (Structure)
...
=head2 field_or_excuse

    ::MD::field_or_excuse ::= function --> Any <-- (Structure, SC_Field_Name)
        : (topic --> \@has_field ?? topic --> \@field !! Excuse::No_Such_Field());
...
=head2 any_fields
    ...
    ::MD::any_fields ::= function --> Boolean <-- (Structure, SC_Primed_Func_Ref)
        : (topic -->^ FDN__Structure_any_fields);

I<TODO.>

=head2 none_of_fields

    ::MD::none_of_fields ::= function negates any_fields;

I<TODO.>

=head2 all_fields

    ::MD::all_fields ::= function --> Boolean <-- (Structure, SC_Primed_Func_Ref)
        : (\\0 none_of_fields negated_func(of : \\1, passing_args : \@(0)));

I<TODO.>

=head2 fields_where

    ::MD::fields_where ::= function --> Structure <-- (Structure, SC_Primed_Func_Ref)
        : (topic -->^ FDN__Structure_fields_where);

I<TODO.>

=head2 fields_map

    ::MD::fields_map ::= function --> Structure <-- (Structure, SC_Primed_Func_Ref)
        : (topic -->^ FDN__Structure_fields_map);

I<TODO.>

=head2 fields_reduce

    ::MD::fields_reduce ::= function --> Any <-- (Structure, SC_Primed_Func_Ref)
        : (topic -->^ FDN__Structure_fields_reduce);
...
=head2 degree (Tuple)
    ...
    ::MD::degree::Tuple ::= function --> Integer_NN <-- (Tuple)
        implements 1::""
        : (Structure_degree(\\0 field \1));

I<TODO.>

=head2 attr . (Tuple)

    ::MD::attr ::= function --> Any <-- (Tuple, SC_Field_Name)
        requires (topic --> \@has_attr)
        : (\\0 field \1 field \\1);

    ::MD::"."::Tuple ::= function --> Any <-- (Tuple, SC_Field_Name)
        implements 1::""
        requires (topic --> \@has_attr)
        : (topic --> \@attr);
...
=head2 has_attr .? (Tuple)
    ...
    ::MD::has_attr ::= function --> Boolean <-- (Tuple, SC_Field_Name)
        : (\\0 field \1 has_field \\1);

    ::MD::".?"::Tuple ::= function --> Boolean <-- (Tuple, SC_Field_Name)
        implements 1::""
        : (topic --> \@has_attr);
...
=head2 attr_or_excuse .! (Tuple)
    ...
    ::MD::attr_or_excuse ::= function --> Any <-- (Tuple, SC_Field_Name)
...
=head2 extend (Tuple)
    ...
    ::MD::extend::Tuple ::= function --> Tuple <-- (Tuple, Tuple)
        ...
        requires (...)
        is {associative,commutative} identity (\%())
        : (\(\Tuple, (\\0 field \1) Structure_extend (\\1 field \1)));
...
=head2 has_just_attrs (Tuple)
    ...
    ::MD::has_just_attrs::Tuple ::= function --> Boolean <-- (Tuple, SC_Signature)
        implements 1::""
        : (\\0 field \1 has_just_fields \\1);

I<TODO.>

=head2 any_attrs

    ::MD::any_attrs ::= function --> Boolean <-- (Tuple, SC_Primed_Func_Ref)
        : (\\0 field \1 any_fields \\1);
...
=head2 all_attrs
    ...
    ::MD::all_attrs ::= function --> Boolean <-- (Tuple, SC_Primed_Func_Ref)
...
=head2 attrs_where
    ...
    ::MD::attrs_where ::= function --> Tuple <-- (Tuple, SC_Primed_Func_Ref)
        : (\(\Tuple, \\0 field \1 fields_where \\1));

I<TODO.>

=head2 attrs_map

    ::MD::attrs_map ::= function --> Tuple <-- (Tuple, SC_Primed_Func_Ref)
        : (\(\Tuple, \\0 field \1 fields_map \\1));

I<TODO.>

=head2 attrs_reduce

    ::MD::attrs_reduce ::= function --> Any <-- (Tuple, SC_Primed_Func_Ref)
        : (\\0 field \1 fields_reduce \\1);
...
=head2 Relation_Inf Relation
    ...
    ::MD::Relation_Inf ::= selection of Structure
        where (topic has_just_fields \(constant (\Relation), \@Structure) ...)
        default (\?%{})
        composes {Setty, Attributive};

    ::MD::Relation ::= synonym of Relation_Inf;
...
=head2 Tuple_Bag_Inf Tuple_Bag
    ...
    ::MD::Tuple_Bag_Inf ::= selection of Structure
        where (topic has_just_fields \(constant (\Tuple_Bag), \@Structure) ...)
        default (\+%{})
        composes {Baggy, Attributive};
...
=head2 negated_func
    ...
    ::MD::negated_func ::= function --> SC_Primed_Func_Ref
        <-- (of : SC_Primed_Func_Ref, passing_args : SC_Field_Names)
    : (
        (function : (
            not(
                (
                    \\of field args
                        Structure_extend (topic on_fields \\passing_args)
                ) --> (\\of field func)
            )
        )) assuming topic
    );

I<TODO.  This expects the original function is from Structure to Boolean.>
