...
=head2 Excuse::No_Such_Item

    ::MD::Excuse::No_Such_Item ::= constant (\@0) composes Excuse;
...
=head2 item_or_excuse .!

    ::MD::item_or_excuse ::= function --> Any <-- (Accessible, Any)
        : (topic --> \@has_item ?? topic --> \@item !! Excuse::No_Such_Item());

    ::MD::".!" ::= alias of item_or_excuse;
...
=head2 Positional
    ...
    ::MD::Positional ::= interface
        ...
        requires_implements {item,has_item,so,count,has,nest,unnest,any,where,map,reduce,
...
=head2 item (Array)
    ...
    ::MD::item::Array ::= function --> Any <-- (Array, Integer_NN)
        implements 1::""
        requires (topic --> \@has_item)
...
=head2 has_item (Array)
    ...
    ::MD::has_item::Array ::= function --> Boolean <-- (Array, Integer_NN)
        implements 1::""
