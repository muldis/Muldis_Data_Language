...
=head2 Round_Meth
    ...
    ::MD::Round_Meth ::= type
        union {Round_Down,Round_Up
            ,Round_To_Zero,Round_To_Inf
            ,Round_Half_Down,Round_Half_Up
            ,Round_Half_To_Zero,Round_Half_To_Inf
            ,Round_Half_Even}
        default Round_To_Zero();

    ::MD::Round_Down         ::= constant \Round_Down;
    ::MD::Round_Up           ::= constant \Round_Up;
    ::MD::Round_To_Zero      ::= constant \Round_To_Zero;
    ::MD::Round_To_Inf       ::= constant \Round_To_Inf;
    ::MD::Round_Half_Down    ::= constant \Round_Half_Down;
    ::MD::Round_Half_Up      ::= constant \Round_Half_Up;
    ::MD::Round_Half_To_Zero ::= constant \Round_Half_To_Zero;
    ::MD::Round_Half_To_Inf  ::= constant \Round_Half_To_Inf;
    ::MD::Round_Half_Even    ::= constant \Round_Half_Even;
