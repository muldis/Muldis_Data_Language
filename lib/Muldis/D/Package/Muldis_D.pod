...
The function C<same> aka C<=> results in C<True> iff its 2 arguments are
exactly the same value, and C<False> otherwise.  Other programming
languages may name their corresponding operators I<==> or I<===> or I<eq>.
...
arguments are exactly the same value, and C<True> otherwise.  Other
...
argument is I<before> its C<1> argument.  Other programming languages may
name this operator I<lt>.
...
argument is I<after> its C<1> argument.  Other programming languages may
name this operator I<gt>.
...
value.  Other programming languages may name this operator I<le>.
...
value.  Other programming languages may name this operator I<ge>.
...
any number of sequenced values in order to pick the one that sorts
