...
=head2 Fraction_Inf Fraction Int

    ::MD::Fraction_Inf ::= binder
    {
        ...
        (
            ...
            then
                topic.\numerator coprime topic\.denominator
            else
                False
        );
    };

    ::MD::Fraction ::= alias of Fraction_Inf;

The selection contract C<Fraction_Inf> aka C<Fraction> is infinite.  A
        ...
        <-- \.0.\denominator = (\.1.\denominator)
         ...
         !!
          (
            ...
            <-- in_order(
                \.0.\numerator * div(common_d, \.0.\denominator, To_Zero()),
                \.1.\numerator * div(common_d, \.1.\denominator, To_Zero()),
            );
          )
    );
...
This function implements the C<Fractional> virtual function C<to_Fraction> for
...
=head2 integral_divided_by (Fraction)
    ...
    : (
        ...
        n0 ::= (\.0.\numerator * div(d, \.0.\denominator, To_Zero()));
        n1 ::= (\.1.\numerator * div(d, \.1.\denominator, To_Zero()));
        <-- if \.1 = 0.0 then Excuse::Div_By_Zero()
