...
named 'func' and 'args', which are a SC_Reference and a Tuple respectively.
...
=head2 Set_Inf Set
    ...
    ::MD::Set_Inf ::= selection of Capsule
        where (Capsule::tag(topic) = \Set and (Capsule::asset(topic) isa \@Bag) ...)
        default ({})
...
=head2 nest (Set)
    ...
    ::MD::nest::Set ::= function --> Set <-- (Set)
        implements 1::""
        requires (...)
        : (Capsule::select(\Set, Capsule::asset(\\0) ->nest));
...
=head2 unnest (Set)
    ...
    ::MD::unnest::Set ::= function --> Set <-- (Set)
        implements 1::""
        requires (...)
        : (Capsule::select(\Set, Capsule::asset(\\0) ->unnest));
...
=head2 where (Set)
    ...
    ::MD::where::Set ::= function --> Set <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (Capsule::select(\Set, Capsule::asset(\\0) where \\1));
...
=head2 map (Set)
    ...
    ::MD::map::Set ::= function --> Set <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (Capsule::select(\Set, Capsule::asset(\\0) map \\1));
...
=head2 reduce (Set)
    ...
    ::MD::reduce::Set ::= function --> Any <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (Capsule::select(\Set, Capsule::asset(\\0) reduce \\1));
...
=head2 on ^ project
    ...
    ::MD::on::"" ::= function virtual
        --> Attributive <-- (Attributive, SC_Attr_Names)
        requires (...);
...
=head2 attr . (Tuple)
    ...
    ::MD::attr ::= function --> Any <-- (Tuple, SC_Attr_Name)
        requires (topic --> \@has_attr)
        : (topic -->^ FDN__Tuple_attr);

    ::MD::"."::Tuple ::= function --> Any <-- (Tuple, SC_Attr_Name)
        implements 1::""
        requires (topic --> \@has_attr)
        : (topic --> \@attr);
...
=head2 has_attr .? (Tuple)
    ...
    ::MD::has_attr ::= function --> Boolean <-- (Tuple, SC_Attr_Name)
        : (topic -->^ FDN__Tuple_has_attr);

    ::MD::".?"::Tuple ::= function --> Boolean <-- (Tuple, SC_Attr_Name)
        implements 1::""
        : (topic --> \@has_attr);
...
=head2 attr_or_excuse .! (Tuple)
    ...
    ::MD::attr_or_excuse ::= function --> Any <-- (Tuple, SC_Attr_Name)
...
=head2 on (Tuple)
    ...
    ::MD::on::Tuple ::= function --> Tuple <-- (Tuple, SC_Attr_Names)
        implements 1::""
        requires (...)
        : (topic -->^ FDN__Tuple_on);
...
=head2 but (Tuple)
    ...
    ::MD::but::Tuple ::= function --> Tuple <-- (Tuple, SC_Attr_Names)
        implements 1::""
        requires (...)
...
=head2 Relation_Inf Relation
    ...
    ::MD::Relation_Inf ::= selection of Capsule
        where (Capsule::tag(topic) = \Relation and (Capsule::asset(topic) isa \@Tuple) ...)
        default (\?%{})
...
=head2 Tuple_Bag_Inf Tuple_Bag
    ...
    ::MD::Tuple_Bag_Inf ::= selection of Capsule
        where (Capsule::tag(topic) = \Relation and (Capsule::asset(topic) isa \@Tuple_Bag) ...)
        default (\+%{})
...
=head2 Capsule
    ...
    ::MD::Capsule::"" ::= selection where (topic -->^ FDN__isa_Capsule)
        default (Capsule::select(False, False));
...
=head2 Capsule::select

    ::MD::Capsule::select ::= function --> Capsule <-- (Any, Any)
...
=head2 Capsule::tag
    ...
    ::MD::Capsule::tag ::= function --> Any <-- (Capsule)
...
=head2 Capsule::asset
    ...
    ::MD::Capsule::asset ::= function --> Any <-- (Capsule)
...
=head2 negated_func
    ...
    ::MD::negated_func ::= function --> SC_Primed_Func_Ref
        <-- (of : SC_Primed_Func_Ref, passing_args : SC_Attr_Names)
    : (
        (function : (
            not(
