...
=head2 Homogeneous
    ...
    ::MD::Homogeneous::"" ::= interface
        composes Boolable
        requires_implements {so,count,has,nest,unnest,where,map,reduce,...};
...
=head2 Positional
    ...
    ::MD::Positional ::= interface
        ...
        requires_implements {item,has_item,so,count,has,nest,unnest,where,map,reduce,
            catenate,first_nonmatching_index,...};
...
=head2 in_order (Positional)
    ...
    ::MD::in_order::Positional ::= function
        ...
        implements 1::""
    : (
        i ::= topic --> \@first_nonmatching_index;
      <--
        if not \\0 .? i then
            e1 ::= True
...
=head2 first_nonmatching_index

    ::MD::first_nonmatching_index::"" ::= function virtual
...
=head2 reduce (Array)
    ...
    ::MD::reduce::Array ::= function --> Array <-- (Array, SC_Primed_Func_Ref)
        implements 1::""
...
=head2 first_nonmatching_index (Array)

    ::MD::first_nonmatching_index::Array ::= function
        --> Integer_NN <-- (Array, Array)
        implements 1::""
        is commutative
        : (topic -->^ FDN__Array_first_nonmatching_index);
...
=head2 reduce (Set)
    ...
    ::MD::reduce::Set ::= function --> Set <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
...
=head2 reduce (Bag)
    ...
    ::MD::reduce::Bag ::= function --> Bag <-- (Bag, SC_Primed_Func_Ref)
        implements 1::""
