...
arguments are exactly the same value, and C<True> otherwise.
...
=head2 Tuple_Bag_Inf Tuple_Bag
    ...
    ::MD::Tuple_Bag_Inf::_Asset ::= selection of Tuple where
    (
...
=head2 Source_Code::Package
    ...
    ::MD::Source_Code::Package::_Asset ::= selection of Tuple where
    (
        if
            topic ^?= \%(
...
=head2 Source_Code::Pkg_Decl_Map
    ...
    ::MD::Source_Code::Pkg_Decl_Map::"" ::= selection of Capsule
        where (Capsule_has_tag_asset( topic, \Pkg_Decl_Map, \@1::_Asset ))
        default (select_Capsule( \Pkg_Decl_Map, 1::_Asset() ));

    ::MD::Source_Code::Pkg_Decl_Map::_Asset ::= selection of Tuple
