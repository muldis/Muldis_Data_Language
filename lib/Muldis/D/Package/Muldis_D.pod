...
=head2 Set_Inf Set
    ...
    ::MD::Set_Inf ::= selection of Capsule
        where (Capsule_tag(topic) = \Set and (Capsule_asset(topic) isa \@Bag) ...)
        default ({})
...
=head2 nest (Set)
    ...
    ::MD::nest::Set ::= function --> Set <-- (Set)
        implements 1::""
        requires (...)
        : (Capsule_select(\Set, Capsule_asset(\\0) ->nest));
...
=head2 unnest (Set)
    ...
    ::MD::unnest::Set ::= function --> Set <-- (Set)
        implements 1::""
        requires (...)
        : (Capsule_select(\Set, Capsule_asset(\\0) ->unnest));
...
=head2 where (Set)
    ...
    ::MD::where::Set ::= function --> Set <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (Capsule_select(\Set, Capsule_asset(\\0) where \\1));
...
=head2 map (Set)
    ...
    ::MD::map::Set ::= function --> Set <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (Capsule_select(\Set, Capsule_asset(\\0) map \\1));
...
=head2 reduce (Set)
    ...
    ::MD::reduce::Set ::= function --> Any <-- (Set, SC_Primed_Func_Ref)
        implements 1::""
        : (Capsule_select(\Set, Capsule_asset(\\0) reduce \\1));
...
=head2 Relation_Inf Relation
    ...
    ::MD::Relation_Inf ::= selection of Capsule
        where (Capsule_tag(topic) = \Relation and (Capsule_asset(topic) isa \@Tuple) ...)
        default (\?%{})
...
=head2 Tuple_Bag_Inf Tuple_Bag
    ...
    ::MD::Tuple_Bag_Inf ::= selection of Capsule
        where (Capsule_tag(topic) = \Relation and (Capsule_asset(topic) isa \@Tuple_Bag) ...)
        default (\+%{})
...
=head2 Capsule
    ...
    ::MD::Capsule ::= selection where (topic -->^ FDN__isa_Capsule)
        default (Capsule_select(False, False));
...
=head2 Capsule_select
    ...
    ::MD::Capsule_select ::= function --> Capsule <-- (Any, Any)
