...
=head2 min
    ...
    ::MD::min ::= function --> Orderable <-- (Orderable, Orderable)
        is {commutative,associative,idempotent} identity \(\"+Inf")
        : (topic --> in_order ?? \\0 !! \\1);
...
=head2 in_order (Integer_Inf)

    ::MD::in_order::Integer_Inf ::= function
        --> Boolean <-- (Integer_Inf, Integer_Inf)
        implements 1::""
        : (topic -->^ FDN__Integers_in_order);

I<TODO.>

=head2 pred (Integer_Inf)

    ::MD::pred::Integer_Inf ::= function --> Integer_Inf <-- (Integer_Inf)
        implements 1::""
        : (\\0 - 1);

I<TODO.>

=head2 succ (Integer_Inf)

    ::MD::succ::Integer_Inf ::= function --> Integer_Inf <-- (Integer_Inf)
        implements 1::""
        : (\\0 + 1);

I<TODO.>

=head2 is_zero (Integer_Inf)

    ::MD::is_zero::Integer_Inf ::= function --> Boolean <-- (Integer_Inf)
        implements 1::""
        : (\\0 = 0);
...
Foundation type I<FDN__Bag_Inf>.  An C<Bag_Inf> value is ...
...
Foundation type I<FDN__Structure_Inf>.  An C<Structure_Inf> value is ...
