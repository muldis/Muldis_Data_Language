...
The function C<so::Numerical> ...  This function implements the C<Boolable>
virtual function C<so> aka C<?> for the composing type C<Numerical>.
...
=head2 reciprocal
    ...
    ::MD::reciprocal::"" ::= function virtual --> Numerical <-- (Numerical)
        requires (?\.0);
...
=head2 plus +
    ...
    ::MD::plus::"" ::= function virtual --> Numerical <-- (Numerical, Numerical);
...
=head2 minus
    ...
    ::MD::minus::"" ::= function virtual --> Numerical <-- (Numerical, Numerical);

I<TODO.>

=head2 -

    ::MD::"-" ::= function --> Numerical <-- {(Numerical), (Numerical, Numerical)}
...
=head2 modulus_minus abs_minus |-|
    ...
    ::MD::modulus_minus ::= function --> Numerical <-- (Numerical, Numerical)
        : (modulus topic --> \@minus);
...
=head2 times *
    ...
    ::MD::times::"" ::= function virtual --> Numerical <-- (Numerical, Numerical);
...
=head2 whole_divide div
    ...
    ::MD::whole_divide::"" ::= function virtual
        --> Numerical <-- (Numerical, Numerical, Round_Meth)
        requires (?\.1);
...
=head2 divide_and_modulo
    ...
    ::MD::divide_and_modulo::"" ::= function
        --> (Numerical, Numerical) <-- (Numerical, Numerical, Round_Meth)
        requires (?\.1)
        : (\%(topic --> \@div, topic --> \@mod));
