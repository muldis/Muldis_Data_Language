...
=head2 Collective
    ...
    ::MD::Collective::"" ::= type abstract
        composes Boolable
        requires_implements {is_empty,count,has,group,ungroup,where,map,reduce,...};

I<TODO.>

=head2 so (Collective)

    ::MD::so::Collective ::= function --> Boolean <-- (Collective)
        implements 1::""
        : (\\0->is_empty->not);
...
=head2 is_empty !?
    ...
    ::MD::is_empty::"" ::= function virtual --> Boolean <-- (Collective);

    ::MD::"!?" ::= synonym of is_empty;
...
=head2 count cardinality #
    ...
    ::MD::cardinality ::= synonym of count;
    ::MD::"#"         ::= synonym of count;
...
=head2 not_has ∌
    ...
    ::MD::not_has ::= function --> Boolean <-- (Collective, Any)
        : (not topic --> \@has);

    ::MDS::"∌" ::= synonym of not_has;

I<TODO.>

=head2 in ∈

    ::MD::in ::= function --> Boolean <-- (Any, Collective)
        : (\\1 has \\0);
...
=head2 not_in ∉
    ...
    ::MD::not_in ::= function --> Boolean <-- (Any, Collective)
        : (\\1 not_has \\0);

    ::MDS::"∉" ::= synonym of not_in;
...
=head2 Structure_is_nullary !?^>
    ...
    ::MD::Structure_is_nullary ::= function --> Boolean <-- (Structure)
        : (topic = \());

    ::MD::"!?^>" ::= synonym of Structure_is_nullary;
...
=head2 Structure_extend +^>
    ...
    ::MD::Structure_extend ::= function --> Boolean <-- (Structure, Structure)
        requires (...)
        is {associative,commutative} identity \()
        : (topic -->^ FDN__Structure_extend);

    ::MD::"+^>" ::= synonym of Structure_extend;
...
=head2 Attributive
    ...
    ::MD::Attributive ::= type abstract
        requires_implements {is_nullary,degree,on,but,extend,has_attrs,has_just_attrs};

I<TODO.>

=head2 has_any_attrs ?^

    ::MD::has_any_attrs ::= function --> Boolean <-- (Attributive):
        : (\\0->is_nullary->not);
...
=head2 is_nullary !?^
    ...
    ::MD::is_nullary::"" ::= function virtual --> Boolean <-- (Attributive);

    ::MD::"!?^" ::= synonym of is_nullary;
...
=head2 is_nullary (Tuple)

    ::MD::is_nullary::Tuple ::= function --> Boolean <-- (Tuple)
        implements 1::""
        : (topic = \%());
