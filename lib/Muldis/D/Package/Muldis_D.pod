...
=head2 ".>"
    ...
    ::MD::".>" ::= function --> Any <-- (Structure, SC_Name)
...
=head2 ".>?"
    ...
    ::MD::".>?" ::= function --> Boolean <-- (Structure, SC_Name)
...
=head2 Tuple_Inf Tuple
    ...
    ::MD::Tuple_Inf ::= type of Structure where ...
        default \%()
...
=head2 "." (Tuple)
    ...
    ::MD::"."::Tuple ::= function --> Any <-- (Tuple, SC_Name)
        implements 1::""
        (\\0 .> \1 .> \\1);
...
=head2 ".?" (Tuple)
    ...
    ::MD::".?"::Tuple ::= function --> Boolean <-- (Tuple, SC_Name)
        implements 1::""
        (\\0 .> \1 .>? \\1);
