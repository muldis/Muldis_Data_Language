...
Baggy (Bag, Tuple_Bag), Dictionary, etc.
...
I<TODO.  For collections of distinct weighted objects;
...
=head2 Tuple_Bag_Inf Tuple_Bag
    ...
    ::MD::Tuple_Bag_Inf ::= selection of Capsule
        where (Capsule::tag(topic) = \Tuple_Bag and (Capsule::asset(topic) isa \@Tuple) ...)
        default (\+%{})
