...
=head2 before <
    ...
    ::MD::before ::= function mirrors after;
...
=head2 after_or_same >= ≥
    ...
    ::MD::after_or_same ::= function mirrors before_or_same;
...
=head2 not_in ∉
    ...
    ::MD::not_in ::= function mirrors not_has;
