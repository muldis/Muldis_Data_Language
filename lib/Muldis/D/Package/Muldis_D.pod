...
they are not defined to do that in general for other numeric types.

=head2 pred

    ::MD::pred::"" ::= function virtual --> {Enumerable, Neg_Inf} <-- (Enumerable);

    ::MD::"--" ::= alias of pred;

The virtual function C<pred> aka C<--> results in the I<predecessor> value
of its C<0> argument, or in C<Neg_Inf> if there is none.  Other programming
languages may name their corresponding operators I<decrement>.

=head2 succ

    ::MD::succ::"" ::= function virtual --> {Enumerable, Pos_Inf} <-- (Enumerable);

    ::MD::"++" ::= alias of succ;

The virtual function C<succ> aka C<++> results in the I<successor> value
of its C<0> argument, or in C<Pos_Inf> if there is none.  Other programming
...
function C<pred> aka C<--> for the composing type C<Boolean>.
...
function C<succ> aka C<++> for the composing type C<Boolean>.
...
function C<pred> aka C<--> for the composing type C<Integer>.
...
function C<succ> aka C<++> for the composing type C<Integer>.
