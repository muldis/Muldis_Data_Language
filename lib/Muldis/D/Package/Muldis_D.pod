...
=head2 Capsule::has_tag_asset

    ::MD::Capsule::has_tag_asset ::= function
        --> Boolean <-- (Capsule, Any, Reference)
        : (Capsule::tag(\.0) = \.1 and (Capsule::asset(\.0) isa \.2));
...
=head2 Source_Code::Package_List
    ...
    ::MD::Source_Code::Package_List::"" ::= selection of Capsule
        where (Capsule::has_tag_asset( topic, \Package_List, \@Package_List::Asset ))
        default (Capsule::select( \Package_List, [] ));

    ::MD::Source_Code::Package_List::Asset ::= selection of Array
...
=head2 Source_Code::Package
    ...
    ::MD::Source_Code::Package::"" ::= selection of Capsule
        where (Capsule::has_tag_asset( topic, \Package, \@Package::Asset ))
        default (Capsule::select( \Package, Package::Asset() ));

    ::MD::Source_Code::Package::Asset ::= selection of Tuple
        where (...);
...
=head2 Source_Code::Annotation::Comment
    ...
    ::MD::Source_Code::Annotation::Comment ::= selection of Capsule
        where (Capsule::tag(topic) = \Comment
            and (Capsule::asset(topic) isa \@Text))
        default (\~?'')
        composes Annotation;
