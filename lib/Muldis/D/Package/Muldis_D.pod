...
=head2 Set_Inf Set
    ...
    ::MD::Set_Inf::"" ::= selection of Capsule
        where (Capsule_has_tag_asset( topic, \Set, \@Set_Inf::_Asset ))
        default ({})
...
=head2 Relation_Inf Relation
    ...
    ::MD::Relation_Inf::"" ::= selection of Capsule
        where (Capsule_has_tag_asset( topic, \Relation, \@Relation_Inf::_Asset ))
        default (\?%{})
...
=head2 Tuple_Bag_Inf Tuple_Bag
    ...
    ::MD::Tuple_Bag_Inf::"" ::= selection of Capsule
        where (Capsule_has_tag_asset( topic, \Tuple_Bag, \@Tuple_Bag_Inf::_Asset ))
        default (\+%{})
...
=head2 Source_Code::Package_List
    ...
    ::MD::Source_Code::Package_List::"" ::= selection of Capsule
        where (Capsule_has_tag_asset( topic, \Package_List, \@Package_List::_Asset ))
...
=head2 Source_Code::Package
    ...
    ::MD::Source_Code::Package::"" ::= selection of Capsule
        where (Capsule_has_tag_asset( topic, \Package, \@Package::_Asset ))
        default (select_Capsule( \Package, Package::_Asset() ));
