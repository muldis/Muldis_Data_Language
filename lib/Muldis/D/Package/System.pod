...
=head1 SYNOPSIS
 ...
 MCP version https://muldis.com 0.201.0 MCP
 MCP script Unicode 2.1 UTF-8 MCP
 MCP syntax Muldis_D_Plain_Text https://muldis.com 0.201.0 MCP
 MCP model Muldis_Data_Language https://muldis.com 0.201.0 MCP
 Muldis_Content_Predicate`
 (\Package : (
    identity : (
...
C<System https://muldis.com 0.201.0> which provides the common core
