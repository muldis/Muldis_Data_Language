...
similar concept; this is something in common with the Perl 6 (Raku) language.
...
characterized by an arbitrarily-long sequence of Unicode 11.0 standard
...
an arbitrarily-long sequence of Unicode 11.0 standard I<character
...
A Perl 6 (Raku) corresponding operator has the name "assuming".>
