...
=head2 has_n (Set)
    ...
    has_n::Set : function returns Boolean matches (Set, Any, Integer_NN)
        implements 1::""
        map (has_n::(unwrap::(args.\0), args.\1, args.\2)),
...
=head2 multiplicity (Set)
    ...
    multiplicity::Set : function returns Integer_NN matches (Set, Any)
        implements 1::""
        map (unwrap::(args.\0) multiplicity args.\1),
...
=head2 subset_of (Set)
    ...
    subset_of::Set : function returns Boolean matches (Set, Set)
        implements 1::""
        map (unwrap::(args.\0) subset_of unwrap::(args.\1)),
...
=head2 overlaps_members (Set)
    ...
    overlaps_members::Set : function returns Boolean matches (Set, Set)
        implements 1::""
        is_commutative
        map (unwrap::(args.\0) overlaps_members unwrap::(args.\1)),
...
=head2 disjoint_members (Set)
    ...
    disjoint_members::Set : function returns Boolean matches (Set, Set)
        implements 1::""
        is_commutative
        map (unwrap::(args.\0) disjoint_members unwrap::(args.\1)),
...
=head2 insert_n (Set)
    ...
    insert_n::Set : function returns Set matches (Set, Any, Integer_NN)
        ...
        map (args.\0 has args.\1 or args.\2 = 0 :? args.\0
            :! \Set wrap insert_n::(unwrap::(args.\0), args.\1, 1)),
...
=head2 remove_n (Set)
    ...
    remove_n::Set : function returns Set matches (Set, Any, Integer_NN)
        implements 1::""
        map (\Set wrap remove_n::(unwrap::(args.\0), args.\1, args.\2)),
...
=head2 except (Set)
        ...
        implements 1::""
        map (\Set wrap (unwrap::(args.\0) except unwrap::(args.\1))),
...
=head2 intersect (Set)
    ...
    intersect::Set : function returns Set matches (Set, Set)
        implements 1::""
        is_associative is_commutative is_idempotent
        map (\Set wrap (unwrap::(args.\0) intersect unwrap::(args.\1))),
...
=head2 union (Set)
    ...
    union::Set : function returns Set matches (Set, Set)
        implements 1::""
        is_associative is_commutative is_idempotent identity ({})
        map (\Set wrap (unwrap::(args.\0) union unwrap::(args.\1))),
...
=head2 exclusive (Set)
    ...
    exclusive::Set : function returns Set matches (Set, Set)
        ...
        map (\Set wrap (unwrap::(args.\0) exclusive unwrap::(args.\1))),
...
=head2 nest (Set)
    ...
    nest::Set : function returns Set matches (Set)
        implements 1::""
        accepts (...)
        map (\Set wrap (nest unwrap::(args.\0))),
...
=head2 unnest (Set)
    ...
    unnest::Set : function returns Set matches (Set)
        implements 1::""
        accepts (...)
        map (\Set wrap (unnest unwrap::(args.\0))),
...
=head2 where (Set)
    ...
    where::Set : function returns Set matches (Set, Signature)
        implements 1::""
        map (\Set wrap (unwrap::(args.\0) where args.\1)),
...
=head2 map (Set)
    ...
    map::Set : function returns Set matches (Set, Function_Call_But_0)
        implements 1::""
        map (\Set wrap (unwrap::(args.\0) map args.\1)),
...
=head2 reduce (Set)
    ...
    reduce::Set : function returns Any matches (Set, Function_Call_But_0_1)
        implements 1::""
        map (\Set wrap (unwrap::(args.\0) reduce args.\1)),
...
=head2 order_using (Set)
    ...
    order_using::Set : function returns Array matches (Set, Function_Call_But_0_1)
        implements 1::""
        map (\Set wrap (unwrap::(args.\0) order_using args.\1)),
