...
=head2 same =
        ...
        same : (\Function : (
            ...
            matches : (\@Any, \@Any),
            is_commutative : True,
            evaluates : (evaluates args --> \foundation::same()),
        )),
...
I<TODO.  Also define related Excuse::No_Identity_Element type.>
...
A Perl 6 corresponding operator has the name "assuming".>
