...
C<Homogeneous>, C<Discrete>, C<Positional>, C<Array>, C<String>,
...
=head2 Homogeneous
    ...
    ::MD::Homogeneous ::= interface
        ...
        requires_implements {so,empty
            ,has_n,multiplicity
            ,all_unique,unique
            ,subset_of,same_members,overlaps_members,disjoint_members,any
            ,insert_n,remove_n,member_plus,except,intersect,union,exclusive
...
C<Positional>, C<Array>, C<String>, C<Set>, C<Bag>,
...
=head2 Positional
    ...
    ::MD::Positional ::= interface
        ...
        requires_implements {so,empty
            ...
            ,catenate,replicate
            ,has_n,multiplicity
            ,all_unique,unique,any
            ,insert_n,remove_n,except,intersect,union,exclusive
            ,nest,unnest,where,map,reduce,...
