...
a member of a type named C<T> is C<T v> or C<T::(v)> or C<\T::() <-- (v,)>
...
The semantic type definer C<Excuse> is semifinite.  An C<Excuse> value is an
...
The singleton type definer C<Excuse::No_Reason> represents the C<Excuse> value which
...
This function has analogous stop-or-continue behavior to the Muldis D
...
minimum and maximum values of C<Orderable> are C<Excuse::Before_All_Others>
and C<Excuse::After_All_Others>, respectively; these 2 C<Excuse> values are
...
primary reason for having these values C<Excuse::Before_All_Others> and
C<Excuse::After_All_Others> is so Muldis D has an easy consistent way to
...
C<Excuse::Before_All_Others>, C<Excuse::After_All_Others>, C<Bicessable>,
C<Boolean>, C<Integral>, C<Integer>, C<Fractional>, C<Fraction>,
C<Stringy>, C<Bits>, C<Blob>, C<Textual>, C<Text>, C<Positional>, C<Array>,
C<String>, C<Tuple_Array>.

=head2 Excuse::Before_All_Others
...
The singleton type definer C<Excuse::Before_All_Others> represents a type-agnostic
...
defined in other, not-C<Core>, Muldis D packages for the relevant domains.

=head2 Excuse::After_All_Others
...
The singleton type definer C<Excuse::After_All_Others> represents a type-agnostic
...
=head2 in_order (Excuse::Before_All_Others, Excuse::After_All_Others)
...
function C<in_order> for the composing types C<Excuse::Before_All_Others>
and C<Excuse::After_All_Others>, specifically for comparing either value
...
argument, or in C<Excuse::After_All_Others> if there is none.  Other
...
C<Excuse::After_All_Others> if there is none.
...
argument, or in C<Excuse::Before_All_Others> if there is none.  Other
...
its C<0> argument, where N is its C<1> argument, or in
C<Excuse::Before_All_Others> if there is none.
...
=head2 Boolean
        ...
        Boolean : (\Function : (
            ...
            evaluates : (args --> \foundation::is_a_Boolean::()),
            default : False,
        )),
...
=head2 Round_Meth::Attr_Name

        Round_Meth::Attr_Name : (\Function : (
            is_type_definer : True,
            evaluates : (Attr_Name args:.\0 and_then guard
                args:.\0 ⊆@ \@(Down,Up,To_Zero,To_Inf
...
The selection type definer C<Round_Meth::Attr_Name> represents the finite type
consisting just of the C<Attr_Name> values that are valid Capsule attribute
...
The singleton type definer C<Excuse::Div_By_Zero> represents the I<undefined> result of
...
The singleton type definer C<Excuse::Zero_To_The_Zero> represents the I<undefined> result
...
The selection type definer C<Integral::NN> represents the infinite type
...
The selection type definer C<Integral::P> represents the infinite type
consisting just of the C<Integral::NN> values that are positive.  Its
...
argument, or in C<Excuse::Before_All_Others> if there is none.  It is an integral numeric
...
or in C<Excuse::After_All_Others> if there is none.  It is an integral numeric specific
...
=head2 Integer
        ...
        Integer::"" : (\Function : (
            ...
            evaluates : (args --> \foundation::is_a_Integer::()),
            default : 0,
        )),
...
=head2 Integer::NN
        ...
        Integer::NN : (\Function : (
            is_type_definer : True,
            evaluates : (Integer args:.\0 and_then guard args:.\0 >= 0),
        )),

The selection type definer C<Integer::NN> represents the infinite type
...
=head2 Integer::P
        ...
        Integer::P : (\Function : (
            is_type_definer : True,
            evaluates : (Integer::NN::(args:.\0) and_then guard args:.\0 > 0),
            default : 1,
        )),

The selection type definer C<Integer::P> represents the infinite type consisting
just of the C<Integer::NN> values that are positive.  Its default and minmum
...
The selection type definer C<Fractional::NN> represents the infinite type
...
=head2 Fraction::NN
        ...
        Fraction::NN : (\Function : (
            is_type_definer : True,
            evaluates : (Fraction args:.\0 and_then guard args:.\0 >= 0.0),
        )),

The selection type definer C<Fraction::NN> represents the infinite type
...
The singleton type definer C<Excuse::No_Empty_Value> represents the I<undefined> result
...
=head2 String::Bits
        ...
        String::Bits : (\Function : (
            is_type_definer : True,
            evaluates : (String args:.\0 and_then guard
                args:.\0 all \in::( 1: 0..1 )),
        )),

The selection type definer C<String::Bits> represents the infinite type
...
=head2 String::Octets
        ...
        String::Octets : (\Function : (
            is_type_definer : True,
            evaluates : (String args:.\0 and_then guard
                args:.\0 all \in::( 1: 0..255 )),
        )),

The selection type definer C<String::Octets> represents the infinite type
consisting just of the C<String> values for which every one of their member
...
The selection type definer C<Text> is infinite.  A C<Text> value is an
...
it happens, C<Maximal_Chars> is formally a proper superset of Unicode 9.0,
...
The selection type definer C<String::Maximal_Chars> is an alias of C<String>
...
The selection type definer C<Text::Unicode> represents the infinite type
...
=head2 String::Unicode_Codes
        ...
        String::Unicode_Codes : (\Function : (
            is_type_definer : True,
            evaluates : (String::Maximal_Chars::(args:.\0) and_then guard
                args:.\0 all \in::( 1: ?..{0..0xD7FF,0xE000..0x10FFFF} )),
        )),

The selection type definer C<String::Unicode_Codes> represents the infinite type
consisting just of the C<String> values for which every one of their member
...
=head2 String::ASCII_Chars
        ...
        String::ASCII_Chars : (\Function : (
            is_type_definer : True,
            evaluates : (String::Unicode_Codes::(args:.\0) and_then guard
                args:.\0 all \in::( 1: 0..127 )),
        )),

The selection type definer C<String::ASCII_Chars> represents the infinite type
consisting just of the C<String> values for which every one of their member
...
I<TODO.  The function-call is expected to be a Capsule with 2 attributes
...
The singleton type definer C<Excuse::No_Such_Ord_Pos> represents the I<undefined> result of
...
=head2 Array
        ...
        Array::"" : (\Function : (
            ...
            evaluates : (args --> \foundation::is_a_Array::()),
            default : [],
        )),
...
=head2 String
        ...
        String::"" : (\Function : (
            is_type_definer : True,
            evaluates : (Array args:.\0 and_then guard args:.\0 all \Integer::()),
        )),

The selection type definer C<String> represents the infinite type consisting
...
nor anything else, simply an arbitrarily-long ordered sequence of generic
integers.  A C<String> value is isomorphic to an C<Attr_Name> value, and
values of proper subtypes of C<String> are isomorphic to C<Bits> and
C<Blob> and C<Text> values.
...
The singleton type definer C<Array::Empty> aka C<~∅> represents the only zero-member
C<Array> value, C<[]>.
...
The singleton type definer C<Set::Empty> aka C<?∅> represents the only zero-member
C<Set> value, C<{}>.
...
=head2 Bag
        ...
        Bag::"" : (\Function : (
            is_type_definer : True,
            composes : {\@Discrete},
            evaluates : (args --> \foundation::is_a_Bag::()),
            default : {0:0},
        )),
...
The singleton type definer C<Bag::Empty> aka C<+∅> represents the only zero-member
C<Bag> value, C<{0:0}>.
...
The singleton type definer C<Excuse::No_Such_Attr_Name> represents the I<undefined>
...
The singleton type definer C<Excuse::Not_Same_Heading> represents the I<undefined> result
...
=head2 Tuple
        ...
        Tuple::"" : (\Function : (
            ...
            evaluates : (args --> \foundation::is_a_Tuple::()),
            default : (),
        )),
...
The singleton type definer C<Tuple::D0> represents the only zero-attribute
C<Tuple> value.
...
=head2 Tuple::D1
        ...
        Tuple::D1 : (\Function : (
            is_type_definer : True,
            evaluates : (Tuple args:.\0 and_then guard is_unary args:.\0),
            default : (False,),
        )),

The selection type definer C<Tuple::D1> represents the infinite type consisting
...
The function C<D1> results in the C<Tuple::D1> value whose sole attribute's
...
when the C<0> and C<1> arguments have the same I<heading>; it is an
C<Excuse> otherwise.  This function implements the C<Homogeneous> virtual
...
I<defined> when the 2 arguments have the same I<heading>; it is an
C<Excuse> otherwise.  This function implements the C<Homogeneous> virtual
...
2 arguments have the same I<heading>; it is an C<Excuse> otherwise.  This
...
I<heading>; it is an C<Excuse> otherwise.  This function implements the
...
same I<heading>; it is an C<Excuse> otherwise. This function implements the
...
arguments have the same I<heading>; it is an C<Excuse> otherwise.  This
...
is an C<Excuse> otherwise.  This function implements the C<Unionable>
...
only I<defined> when the 2 arguments have the same I<heading>; it is an
C<Excuse> otherwise.  This function implements the C<Unionable> virtual
...
the same I<heading>; it is an C<Excuse> otherwise.  This function
...
The singleton type definer C<Tuple_Array::D0C0> represents the only zero-attribute,
zero-tuple C<Tuple_Array> value.

=head2 Tuple_Array::D0C1
...
The singleton type definer C<Tuple_Array::D0C1> represents the only zero-attribute,
...
The singleton type definer C<Relation::D0C0> represents the only
...
The singleton type definer C<Relation::D0C1> represents the only
...
The singleton type definer C<Tuple_Bag::D0C0> represents the only zero-attribute,
zero-tuple C<Tuple_Bag> value.

=head2 Tuple_Bag::D0C1
...
The singleton type definer C<Tuple_Bag::D0C1> represents the only zero-attribute,
...
=head2 Capsule
        ...
        Capsule : (\Function : (
            is_type_definer : True,
            evaluates : (args --> \foundation::is_a_Capsule::()),
            default : (False : ()),
        )),

The selection type definer C<Capsule> represents the infinite Muldis D
Foundation type C<foundation::Capsule>.  An C<Capsule> value is ...

A C<Capsule> value consists of a I<label> paired with a set of 0..N
I<attributes> where that set must be represented by a C<Tuple>.  While
conceptually a C<Capsule> could pair a I<label> with an I<asset> of any
...
default attribute name for a single-attribute C<Capsule> is C<0> when there
isn't an actual meaningful name to give it.

Given that almost every selection type definer is a subset of C<Capsule>, the
latter intentionally does not compose any interface type definers, and also
does not have any of its own C<Core> package operators, so to minimize
interference with other types' interfaces.

Generic means for selecting C<Capsule> values in terms of a
I<label>/I<attributes> pair, or for extracting the I<label> or
I<attributes> of a C<Capsule>, are provided by dedicated language
expression node types and concrete syntax (and Foundation functions).

=head1 REFERENCE DATA TYPES

=head2 Reference

        Reference::"" : (\Function : (
            is_type_definer : True,
            evaluates : (args --> \foundation::is_a_Reference::()),
            default : () --> \foundation::default_Reference::(),
        )),

The selection type definer C<Reference> represents the infinite Muldis D
Foundation type C<foundation::Reference>.  A C<Reference> value is an opaque and
transient reference to a Muldis D I<variable> (the latter being a container
for an appearance of a value).  The identity of a C<Reference> is just the
identity of the (anonymous) variable that it points to, which is the
latter's address; when C<same> is given two C<Reference> arguments it will
result in C<True> iff they both point to the same variable.  Selection of a
C<Reference> value is formally a non-deterministic niladic operation, and
can only be performed in a I<procedure>, not in a I<function>.  Selecting a
C<Reference> value will create a new variable which it points to, and the
variable will be destroyed automatically when that C<Reference> value is no
longer in use by the program.  Only a procedure may use a C<Reference> to
access (read or mutate) the latter's variable; a function may only pass
around a C<Reference> it is given or compare two (that they point to the
same variable or not), and can not access the variable behind it.  The
default value of C<Reference> is implementation-defined.

As a function only can perceive a C<Reference> as a generic identifier, it
doesn't make sense to subtype or constrain a C<Reference> as if it were the
type of the underlying variable's current value.  However, a C<Reference>
...
to read the variable behind a Reference, with a special expression node,
...
Reference into regular values if it expects to be non-deterministic.  Or
...
References) while the other isn't.  The former can then also do certain
...
RECURSIVELY FOLLOW A STRUCTURE AND REPLACE ALL HANDLES WITH THE VALUES OF
THEIR VARIABLES AT THAT TIME (THIS OP SHOULD BE CHEAP).  Regular deref
...
I<<TODO, other notes.  A C<Reference> value also carries meta-data such as
...
elements is a Reference, then via that indirection one can have an
...
can be emulated or interfaced without too much indirection.  The default
value of C<Reference> is one that explicitly doesn't point to any variable.
...
represented by C<Reference> values.  The generic assignment syntax C<:=>
takes a C<Reference> as its left-hand argument and updates the variable
...
=head2 External
        ...
        External::"" : (\Function : (
            is_type_definer : True,
            evaluates : (args --> \foundation::is_a_External::()),
...
=head2 Source_Code::Package::Identity
...
=head2 Source_Code::Package::Foundation
...
=head2 Source_Code::Package::Base_Name

        Source_Code::Package::Base_Name : (\Function : (
            is_type_definer : True,
            evaluates : (Attr_Name_List args:.\0 and_then guard
                so args:.\0 and args:.\0 ∌ \""),
        )),

I<TODO.>

=head2 Source_Code::Package::Canon_Authority

        Source_Code::Package::Canon_Authority : (\Function : (
            is_type_definer : True,
            evaluates : (Text args:.\0 and_then guard so args:.\0),
        )),

I<TODO.>

=head2 Source_Code::Package::Canon_Version_Number
...
=head2 Source_Code::Package::Entry_Point

        Source_Code::Package::Entry_Point : (\Function : (
            is_type_definer : True,
            evaluates : (Absolute_Name args:.\0)
        )),

I<TODO.  This type is subject to be expanded to some collection or have alternatives.>

=head2 Source_Code::Package::Floating

        Source_Code::Package::Floating : (\Function : (
            is_type_definer : True,
            evaluates : (Set args:.\0 and_then guard
                args:.\0 all \Absolute_Name::()),
        )),

I<TODO.>

=head2 Source_Code::Package::Folder

        Source_Code::Package::Folder : (\Function : (
            is_type_definer : True,
            evaluates : (Tuple args:.\0 and_then guard
                args:.\0 all_attr_assets {\Package::Folder::(), \Material::()}),
        )),

I<TODO.>

=head2 Source_Code::Material

        Source_Code::Material : (\Function : (
            is_type_definer : True,
            evaluates : (args:.\0 is_a {\@Alias, \@Function, \@Procedure}),
            default : ...,
        )),

=head2 Source_Code::Alias
        ...
        Source_Code::Procedure : (\Function : (
            ...
            evaluates : (
                ...
                and_then guard args:.\0:> is_a (\@Signature::Tuple_Attrs_Match : (
                    virtual : (type : \Boolean::(), optional : True),
                    matches : (type : \Signature::Tuple_Attrs_Match_Simple(), optional : True),
                    updates : (type : \Heading::(), optional : True),  `TODO: Or keyword "source".`
                    implements : (type : ..., optional : True),
                    overrides : (type : ..., optional : True),
                    accepts : (type : \Expression::(), optional : True),
                    intends : (type : \Expression::(), optional : True),
                    vars : (type : \Signature::Tuple_Attrs_Match_Simple(), optional : True),
...
=head2 Source_Code::Signature

        Source_Code::Signature::"" : (\Function : (
            is_type_definer : True,
            evaluates : (args:.\0 is_a {
                \@Function_Call_But_0,
                \@folder::Disjunction,
...
=head2 Source_Code::Signature::Disjunction

        Source_Code::Signature::Disjunction : (\Function : (
            is_type_definer : True,
            evaluates : (Set args:.\0 and_then guard
                args:.\0 all \Signature::()),
        )),

I<TODO.>

=head2 Source_Code::Signature::Tuple_Attrs_Match_Simple

        Source_Code::Signature::Tuple_Attrs_Match_Simple : (\Function : (
            is_type_definer : True,
            evaluates : (Tuple args:.\0 and_then guard
                args:.\0 all_attr_assets \Signature::()),
        )),

I<TODO.>

=head2 Source_Code::Signature::Tuple_Attrs_Match
...
=head2 Source_Code::Expression
        ...
        Source_Code::Expression::"" : (\Function : (
            ...
            evaluates : (args:.\0 is_a {
                ...
                \@folder::And_Then,
                \@folder::Or_Else,
                \@folder::Given_When_Default,
                \@folder::Guard,
            }),
            default : (\@folder::Literal : (False,)),
        )),
...
=head2 Source_Code::Expression::Compound

        Source_Code::Expression::Compound : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
                ...
                and_then guard
                    ...
                    and
                    (args:.\0:>.\0 where \folder::Returns() pipe singular)
            ),
            default : (\@material : ({},)),
        )),

I<TODO.  This represents a compound expression, which consists of a single
"returns" component plus a list of 0..N lexically labelled expressions,
written in Plain_Text with special syntax example `(x ::= y+3; returns 2*x)`.>

=head2 Source_Code::Expression::Returns

        Source_Code::Expression::Returns : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
            ...
            default : (\@material : ((\@folder::Literal : (False,)),)),
        )),

I<TODO.  This represents the sole "returns" component of a compound expression.>

=head2 Source_Code::Expression::Labelling

        Source_Code::Expression::Labelling : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a lexically labelled expression,
written in Plain_Text with special syntax example `foo ::= 42`.>

=head2 Source_Code::Expression::Embedding

        Source_Code::Expression::Embedding : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a logical embedding of an expression at this
spot that was previously declared with a Labelling, written in Plain_Text
as an unqualified alphanumeric or quoted identifier example `foo`.
Note that it is an error for a Labelling to contain any Embedding referring
to itself, either directly or indirectly.>

=head2 Source_Code::Expression::Literal

        Source_Code::Expression::Literal : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::Expression::Args

        Source_Code::Expression::Args : (\Function : (
            is_type_definer : True,
            constant : \@material,
        )),
...
=head2 Source_Code::Expression::Evaluates

        Source_Code::Expression::Evaluates : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
            ...
            default : (\@material : ((\@folder::Embedding : (\"",)),)),
        )),
...
See also Routine_Call or its replacement which defines the type of X.>

=head2 Source_Code::Expression::If_Then_Else

        Source_Code::Expression::If_Then_Else : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
            ...
            default : (\@material : ((\@folder::Literal : (False,)),
                (\@folder::Literal : (False,)), (\@folder::Literal : (False,)))),
        )),

I<TODO.  This represents an if-then-else expression,
written in Plain_Text with special syntax example `if P then X else Y`.>

=head2 Source_Code::Expression::And_Then

        Source_Code::Expression::And_Then : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::Expression::Or_Else

        Source_Code::Expression::Or_Else : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::Expression::Given_When_Default

        Source_Code::Expression::Given_When_Default : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::Expression::When_Then

        Source_Code::Expression::When_Then : (\Function : (
            is_type_definer : True,
            evaluates : (
                Set args:.\0
                and_then guard args:.\0 all (
                    0 : \Expression::(),
                    1 : \Expression::(),
                )
            ),
...
I<TODO.  This represents part of a given-when-default expression.>

=head2 Source_Code::Expression::Guard

        Source_Code::Expression::Guard : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::Statement::Compound

        Source_Code::Statement::Compound : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
                ...
                and_then guard args:.\0:>.\0 all \Statement::()
            ),
            default : (\@material : ([],)),
        )),

I<TODO.  This represents a compound statement, which consists of
an ordered list of 0..N statements, which optionally may be iterated,
written in Plain_Text with special syntax example `[var x; x := 42; print(x);]`.>

=head2 Source_Code::Statement::Labelling

        Source_Code::Statement::Labelling : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
            ...
            default : (\@material : (\"", (\@folder::Compound : ([],)))),
        )),

I<TODO.  This represents a lexically labelled statement,
written in Plain_Text with special syntax example `foo ::= ...`.>

=head2 Source_Code::Statement::Embedding

        Source_Code::Statement::Embedding : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a logical embedding of a statement at this
spot that was previously declared with a Labelling, written in Plain_Text
as an unqualified alphanumeric or quoted identifier example `foo`.
Note that it is an error for a Labelling to contain any Embedding referring
to itself, either directly or indirectly.>

=head2 Source_Code::Statement::Performs

        Source_Code::Statement::Performs : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
            ...
            default : (\@material : ((\@Expression::Embedding : (\"",)),)),
        )),
...
=head2 Source_Code::Statement::If_Then_Else

        Source_Code::Statement::If_Then_Else : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
            ...
            default : (\@material : ((\@Expression::Literal : (False,)),
                (\@folder::Compound : ([],)), (\@folder::Compound : ([],)))),
        )),
...
=head2 Source_Code::Statement::Given_When_Default

        Source_Code::Statement::Given_When_Default : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::Statement::When_Then

        Source_Code::Statement::When_Then : (\Function : (
            is_type_definer : True,
            evaluates : (
                Set args:.\0
                and_then guard args:.\0 all (
            ...
            default : ((\@Expression::Literal : (False,)),
                (\@folder::Compound : ([],))),
        )),

I<TODO.  This represents part of a given-when-default statement.>

=head2 Source_Code::Statement::Leave

        Source_Code::Statement::Leave : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents an instruction to abnormally exit the compound
statement defined by a specified parent node (a normal exit is to simply
execute to the end of the compound statement); a Labelling applied to the
compound statement in question allows it to be controlled in this way;
written in Plain_Text with special syntax example `leave foo`.>

=head2 Source_Code::Statement::Iterate

        Source_Code::Statement::Iterate : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
continue execution at the start of, the compound
statement defined by a specified parent node; a Labelling applied to the
compound statement in question allows it to be controlled in this way;
written in Plain_Text with special syntax example `iterate foo`.>

=head2 Source_Code::Statement::Variable

        Source_Code::Statement::Variable : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a lexically labelled variable reference
which can then be bound to one or more variables to facilitate work with
those variables.  Either this or another thing might be for binding to
other things such handles to processes or whatever.  A generic paradigm
is that one uses message passing to talk to anything with a handle.>
...
=head2 Source_Code::Attr_Name
        ...
        Source_Code::Attr_Name : (\Function : (
            is_type_definer : True,
            evaluates : (Heading args:.\0 and_then guard is_unary args:.\0),
        )),

I<TODO.>

=head2 Source_Code::Attr_Name_List

        Source_Code::Attr_Name_List : (\Function : (
            is_type_definer : True,
            evaluates : (Array args:.\0 and_then guard
                args:.\0 all \Attr_Name::()),
        )),

I<TODO.>

=head2 Source_Code::Local_Name

        Source_Code::Local_Name : (\Function : (
            is_type_definer : True,
            evaluates : (Attr_Name_List args:.\0 and_then guard
                so args:.\0 and_then guard
                    given args:.\0.0
...
=head2 Source_Code::Absolute_Name
...
=head2 Source_Code::Routine_Call

        Source_Code::Routine_Call : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
                and_then guard args:.\0:> is_a (
                    routine : {\Absolute_Name::(), \Function::(), \Procedure::()},
                    args : \Tuple::(),
                    context : ...,
                )
            ),
            default : (\@material : (
                routine : (\Function : (evaluates : (False))),
                args : (),
                context : ...,
            )),
        )),

I<TODO.  This represents a specification of a routine invocation,
and names or defines the routine to invoke and
also defines the arguments to pass to said routine while invoking it,
written in Plain_Text with special syntax example `\foo::()` or `\(...)` or `\[...]`.
Note, this type is subject to be rewritten as a group of types.>

I<The 'context' component or its replacements would, as applicable,
give the fully-qualified name of the material in which the routine being
invoked was either defined or called from, and also a copy of the package
source or current Package_Tree for said.>

I<TODO.  We maybe also want a 'context' expression node or such that gives
us package source for ourselves maybe?>
...
=head2 Source_Code::Signature_to_Function_Call_But_0
...
MDSL is Copyright © 2002-2017, Muldis Data Systems, Inc.
