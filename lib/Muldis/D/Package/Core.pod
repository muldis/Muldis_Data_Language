...
C<String>, C<Set>, C<Bag>, C<Relational>, C<Relation>, C<Tuple_Bag>,
C<Interval>.
...
C<Relation>, C<Tuple_Bag>, C<Interval>.
...
C<Positional>, C<Array>, C<String>, C<Set>, C<Bag>, C<Relational>,
C<Relation>, C<Tuple_Bag>, I<TODO>.  A key type
...
C<Array>, C<String>, C<Set>, C<Bag>, C<Relational>, C<Relation>,
C<Tuple_Bag>.
...
function C<in_order> for the composing type C<Positional>.  This function
...
C<Tuple>, C<Relational>, C<Relation>, C<Tuple_Bag>.
...
=head2 Relation
    ...
    ::MD::Relation ::= binder
    {
        "" ::= selection of Capsule
            ...
            default (\?%())
            composes {Relational and_provides_its_default, Setty};
