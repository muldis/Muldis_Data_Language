...
=head2 Fraction
    ...
    ::MD::Fraction ::= selection of Capsule
        where (has_wrapped::( args.\0, \Fraction, (function : (
            if
                args.\0 is_a (
                    numerator : \Integer::(),
    ...
    : (
        ...
        result_chars ::= (
            given #repl_chars
                ...
                when 1 then
                    src_octets
                        map (function : (args.\0 in 0..127 ?? args.\0 !! args.\1))
                            \<-- (1 : repl_chars.0,)
                default
                    src_octets
                        map (function : (args.\0 in 0..127 ?? [args.\0] !! args.\1))
...
=head2 squish
    ...
    ::MD::squish ::= function --> Positional <-- (Positional)
        : (args.\0 map (function : (( group : args.\0, member : False )))
            ->nest map (function : (args.\0.\group)));
...
=head2 Set
    ...
    ::MD::Set ::= selection of Capsule
        where (has_wrapped::( args.\0, \Set,
            (function : (if Bag args.\0 then all_unique args.\0 else False)) ))
        default ({})
...
=head2 all_attr_assets
    ...
    ::MD::all_attr_assets ::= function --> Boolean <-- (Tuple, Signature)
        : (args.\0 all_attrs (function : ((args.\1) <-- (args.\0.\asset,)))
...
The interface contract C<Relational> is infinite.  A C<Relational> value is
...
=head2 can_project_matching (Relational)
    ...
    ::MD::can_project_matching::Relational ::= function
        ...
        implements 2::""
        : (if args.\0 @? (args.\1)
            then |(args.\0) all (function : (args.\0 %= @(args.\1) = (args.\1))) \<-- (1 : args.\1,)
            else False);
...
=head2 Tuple_Array
    ...
    ::MD::Tuple_Array ::= selection of Capsule
        where (has_wrapped::( args.\0, \Tuple_Array, (function : (
            if args.\0 is_a ( heading : \Heading::(), body : \Array::() ) then
                if args.\0.\body all \Tuple::() then
                    args.\0.\body all (function : (@(args.\0) = (args.\1))) \<-- (args.\0.\heading)
                else
                    False
            else
                False
...
=head2 Relation
    ...
    ::MD::Relation ::= selection of Capsule
        where (has_wrapped::( args.\0, \Relation, (function : (
...
=head2 Tuple_Bag
    ...
    ::MD::Tuple_Bag ::= selection of Capsule
        where (has_wrapped::( args.\0, \Tuple_Bag, (function : (
...
=head2 Interval_Set
    ...
    ::MD::Interval_Set ::= selection of Capsule
        where (has_wrapped::( args.\0, \Interval_Set,
            (function : (if Interval_Bag args.\0 then all_unique args.\0 else False)) ))
        default (...)
...
=head2 Interval_Bag
    ...
    ::MD::Interval_Bag ::= selection of Capsule
        where (has_wrapped::( args.\0, \Interval_Bag, (function : (
...
=head2 Quantity
    ...
    ::MD::Quantity ::= selection of Capsule
        where (has_wrapped::( args.\0, \Quantity, (function : (
...
=head2 Source_Code::Signature_to_Function_Call_But_0
    ...
    : (
        if Function_Call_But_0 args.\0 then
            ...
            (function : (args.\1 any (function : (args.\1 is_a args.\0)) \<-- (1 : args.\0)))
                \<-- (1 : args.\0)
            ...
            (function : (
                if Tuple args.\0 then
                    if args.\0 =@ (args.\1) then
                        args.\0 all_attrs
                            (function : (args.\0.\asset is_a args.\1.(args.\0.\name))) \<-- ( 1: args.\1, )
                    else
                        False
                else
                    False
