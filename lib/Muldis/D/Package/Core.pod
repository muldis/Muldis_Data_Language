...
=head2 subset_of (Array)

    ::MD::subset_of::Array ::= function --> Boolean <-- (Array, Array)
        implements 2::""
        : (topic -->^ FDN__Array_subset_of);

The function C<subset_of::Array> results in C<True> iff the multiset of
