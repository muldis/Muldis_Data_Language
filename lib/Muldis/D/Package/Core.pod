...
C<Fractional>, C<Fraction>, C<Blob>, C<Text>, C<Positional>, C<Array>,
C<String>.
...
C<Numerical>, C<Integral>, C<Integer>, C<Fractional>, C<Fraction>, C<Blob>,
C<Text>, C<Homogeneous>, C<Discrete>, C<Positional>, C<Array>, C<String>,
C<Setty>, C<Set>, C<Bag>, C<Relational>, C<Relation>, C<Tuple_Bag>,
C<Interval>.
...
elements where each element lives at a distinct index.  In contrast,
...
=head2 Positional
    ...
    ::MD::Positional ::= interface
        composes {Orderable, Accessible, Discrete and_provides_its_default, ...}
        requires_implements {so
            ,empty,count,elem,has_index,has,nest,unnest,any,where,map,reduce,...
            ,count
...
just of the C<Array> values having just C<Integer> elements.  A C<String>
...
of C<String> are isomorphic to C<Blob> and C<Text> values.
...
arrays, or octet arrays with names like I<byte[]> or I<bytea>, or character
...
=head2 Source_Code::Annotation::Internal_Comment

    ::MD::Source_Code::Annotation::Internal_Comment ::= selection of Capsule
        where (has_wrapped( topic, \@0, \@Text ))
        default (\~?'')
        composes Annotation;
