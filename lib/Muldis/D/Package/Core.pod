...
The selection contract C<Round_Meth::Attr_Name> represents the finite type
...
Given that almost every selection contract is a subset of C<Capsule>, the
latter intentionally does not compose any interface contracts, and also
...
=head2 Source_Code::Function
        ...
        Source_Code::Function : (\Function : (
            ...
            evaluates : \(
                Capsule args:.\0
                and_then guard args:.\0:< = \Function
                and_then guard args:.\0:> is_a (\@Signature::Tuple_Attrs_Match : (
                    is_type_definer : (type : \Boolean::(), optional : True),
                    is_generalization : (type : \Boolean::(), optional : True),
                    composes : (type : ..., optional : True),  `set of 0..N type name`
                    provides_default_for : (type : ..., optional : True),  `subset 0..M of prior set`
                    constant : (type : \Function_Body::(), optional : True),
                    ...
                    accepts : (type : \Function_Body::(), optional : True),
                    intends : (type : \Function_Body::(), optional : True),
                    ...
                    identity : (type : \Function_Body::(), optional : True),  `iff two-sided identity element exists`
                    left_identity : (type : \Function_Body::(), optional : True),  `iff only left-identity element exists`
                    right_identity : (type : \Function_Body::(), optional : True),  `iff only right-identity element exists`
                    repeater : (type : ..., optional : True),
                    evaluates : (type : \Function_Body::(), optional : True),
                    default : (type : \Function_Body::(), optional : True),
                ))
            ),
            default : ...,
        )),
...
I<TODO.  A "constant" always has a "value" attribute and optionally has a
"composes" attribute; it is always lacking in the other attributes.
An "interface contract" always has a True "is_generalization" attribute and
optionally has a "composes" attribute; it is always lacking in the other attributes.
A "selection contract" always lacks an "is_generalization" attribute
(or has a False one) and always lacks a "value" attribute; it may have any
of the other attributes.>

I<TODO.  Re-add the 'folded' of a 'constant' into an expression type or such.>

=head2 Source_Code::Function_Body

        Source_Code::Function_Body : (\Function : (
            is_type_definer : True,
            evaluates : \(
                Capsule args:.\0
                and_then guard args:.\0:< = \Function_Body
                and_then guard args:.\0:> is_a (
...
=head2 Source_Code::Procedure_Body
        ...
        Source_Code::Procedure_Body : (\Function : (
            is_type_definer : True,
            evaluates : \(
                Capsule args:.\0
                and_then guard args:.\0:< = \Procedure_Body
                and_then guard args:.\0:> is_a (
                    root_stmt : \Statement::(),
...
=head2 Source_Code::Named_Expr_List
        ...
        Source_Code::Named_Expr_List : (\Function : (
            is_type_definer : True,
            evaluates : \(Tuple args:.\0 and_then guard
                args:.\0 .!? \"" and args:.\0 all_attr_assets \Expression::()),
        )),
...
=head2 Source_Code::Expression
        ...
        Source_Code::Expression : (\Function : (
            is_type_definer : True,
            evaluates : \(args:.\0 is_a {
                \@Expr_Name_Expr, \@Naming_Expr, \@Annotating_Expr
                , ...
...
=head2 Source_Code::Named_Stmt_List
        ...
        Source_Code::Named_Stmt_List : (\Function : (
            is_type_definer : True,
            evaluates : \(Tuple args:.\0 and_then guard
                args:.\0 .!? \"" and args:.\0 all_attr_assets \Statement::()),
        )),
