...
minimum and maximum values of C<Orderable> are C<Orderable::Neg_Inf> and C<Orderable::Pos_Inf>,
...
these values C<Orderable::Neg_Inf> and C<Orderable::Pos_Inf> is so Muldis D has an easy
...
C<Orderable> is composed, directly or indirectly, by: C<Orderable::Neg_Inf>,
C<Orderable::Pos_Inf>, C<Bicessable>, C<Boolean>, C<Integral>, C<Integer>,
C<Fractional>, C<Fraction>, C<Stringy>, C<Bits>, C<Blob>, C<Textual>,
C<Text>, C<Positional>, C<Array>, C<String>, C<Tuple_Array>.

=head2 Orderable::Neg_Inf -∞

        Orderable::Neg_Inf : \Constant >:< ( composes : {\@Orderable, \@Excuse} ),

        Unicode_Aliases::"-∞" : \Alias >:< ( of : \@Orderable::Neg_Inf ),

The constant C<Orderable::Neg_Inf> aka C<-∞> represents the type-agnostic concept of
...
=head2 Orderable::Pos_Inf +∞

        Orderable::Pos_Inf : \Constant >:< ( composes : {\@Orderable, \@Excuse} ),

        Unicode_Aliases::"+∞" : \Alias >:< ( of : \@Orderable::Pos_Inf ),

The constant C<Orderable::Pos_Inf> aka C<-∞> represents the type-agnostic concept of
...
=head2 in_order (Orderable::Neg_Inf, Orderable::Pos_Inf)

        in_order::Neg_Inf_L : \Function >:< (
            returns : \@Boolean,
            matches : (\@Orderable::Neg_Inf, \@Orderable),
            implements : \@folder::"",
            map : \(True),
        ),
        ...
        in_order::Neg_Inf_R : \Function >:< (
            returns : \@Boolean,
            matches : (\@Orderable, \@Orderable::Neg_Inf),
            implements : \@folder::"",
            map : \(args.\0 = (args.\1)),
        ),
        ...
        in_order::Pos_Inf_L : \Function >:< (
            returns : \@Boolean,
            matches : (\@Orderable::Pos_Inf, \@Orderable),
            implements : \@folder::"",
            map : \(args.\0 = (args.\1)),
        ),
        ...
        in_order::Pos_Inf_R : \Function >:< (
            returns : \@Boolean,
            matches : (\@Orderable, \@Orderable::Pos_Inf),
            implements : \@folder::"",
            map : \(True),
        ),
...
virtual function C<in_order> for the composing types C<Orderable::Neg_Inf> and
C<Orderable::Pos_Inf>, specifically for comparing either value with any C<Orderable>.
...
=head2 succ
        ...
        succ : \Function >:< (
            returns : {\@Successable, \@Orderable::Pos_Inf},
            matches : (\@Successable),
            map : \(args.\0 nth_succ 1),
        ),

The function C<succ> results in the I<successor> value of its
C<0> argument, or in C<Orderable::Pos_Inf> if there is none.  Other programming
...
its C<0> argument, where N is its C<1> argument, or in C<Orderable::Pos_Inf> if there
is none.
...
=head2 pred
        ...
        pred : \Function >:< (
            returns : {\@Bicessable, \@Orderable::Neg_Inf},
            matches : (\@Bicessable),
            map : \(args.\0 nth_pred 1),
        ),

The function C<pred> results in the I<predecessor> value of its
C<0> argument, or in C<Orderable::Neg_Inf> if there is none.  Other programming
...
its C<0> argument, where N is its C<1> argument, or in C<Orderable::Neg_Inf> if there
is none.
...
=head2 nth_pred (Boolean)
        ...
        nth_pred::Boolean : \Function >:< (
            returns : {\@False, \@Orderable::Neg_Inf},
...
=head2 nth_succ (Boolean)
        ...
        nth_succ::Boolean : \Function >:< (
            returns : {\@True, \@Orderable::Pos_Inf},
            matches : (\@Boolean, \@Integer::NN),
            implements : \@folder::"",
...
=head2 --
        ...
        "--" : \Function >:< (
            returns : {\@Integral, \@Orderable::Neg_Inf},
            matches : (\@Integral),
            map : \(pred args.\0),
        ),

The function C<--> results in the I<predecessor> value of its C<0>
argument, or in C<Orderable::Neg_Inf> if there is none.  It is an integral numeric
...
=head2 ++
        ...
        "++" : \Function >:< (
            returns : {\@Integral, \@Orderable::Pos_Inf},
            matches : (\@Integral),
            map : \(succ args.\0),
        ),

The function C<++> results in the I<successor> value of its C<0> argument,
or in C<Orderable::Pos_Inf> if there is none.  It is an integral numeric specific
...
=head2 index_succ_all_matches (Array)
        ...
        index_succ_all_matches::Array : \Function >:< (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(args --> \foundation::Array_index_succ_all_matches::()),
        ),
...
=head2 Source_Code::Package::Canon_Authority
        ...
        Source_Code::Package::Canon_Authority : \Alias >:< (
            of : \@Attr_Name,
            where : \(args.\0 != \""),
        ),
