...
=head2 Source_Code::Compound

        Source_Code::Compound : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
                ...
                and_then guard
                    ...
                    and
                    (args:.\0:>.\0 where \Returns::() pipe singular)
            ),
            default : (\@material : ({},)),
        )),
...
=head2 Source_Code::Returns

        Source_Code::Returns : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::Factor

        Source_Code::Factor : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
=head2 Source_Code::If_Then_Else_Expr
...
=head2 Source_Code::Given_When_Default_Expr
...
=head2 Source_Code::If_Then_Else_Stmt
...
=head2 Source_Code::Given_When_Default_Stmt
