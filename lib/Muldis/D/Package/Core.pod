...
=head1 SYNOPSIS
 ...
 meta script 'Unicode 10.0 UTF-8'
 (\Package : (
    identity : (
...
=head2 Text Text::Unicode
        ...
        Text::"" : (\Function : (
            ...
            evaluates : (\@Signature::Capsule_Match : (
                label : \Text,
                attrs : (
                    unicode_codes : \String::Unicode_Codes(),
                ),
            )),
            default : '',
        )),
...
characterized by an arbitrarily-long sequence of Unicode 10.0 standard
I<character codepoints>, where each distinct codepoint corresponds to a
...
has its own canonical representation in terms of a C<String> value named
C<Unicode_Codes>.  The default value of C<Text>
...
This C<Text> subtype has its own canonical representation in terms of a
...
an arbitrarily-long sequence of Unicode 10.0 standard I<character
codepoints> but it is not a C<Text> value; every distinct I<attribute name>
...
characterized by an arbitrarily-long sequence of Unicode 10.0 standard
I<character codepoints> but it is not a
