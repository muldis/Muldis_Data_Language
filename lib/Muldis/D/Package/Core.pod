...
=head2 Source_Code::Expression::Factor

        Source_Code::Expression::Factor : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a lexically labelled expression factor,
written in Plain_Text with special syntax example `foo ::= 42`.>

=head2 Source_Code::Expression::Expansion

        Source_Code::Expression::Expansion : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
spot that was previously declared with a Factor, written in Plain_Text
...
=head2 Source_Code::Expression::Evaluates
        ...
        Source_Code::Expression::Evaluates : (\Function : (
            ...
            default : (\@material : ((\@folder::Expansion : (\"",)),)),
        )),
...
=head2 Source_Code::Statement::Factor

        Source_Code::Statement::Factor : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a lexically labelled statement factor,
written in Plain_Text with special syntax example `foo ::= ...`.>

=head2 Source_Code::Statement::Expansion

        Source_Code::Statement::Expansion : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a logical expansion of a statement factor at this
spot that was previously declared with a Factor, written in Plain_Text
as an unqualified alphanumeric or quoted identifier example `foo`.
Note that it is an error for a Factor to contain any Expansion referring
to itself, either directly or indirectly.>
...
=head2 Source_Code::Statement::Performs
        ...
        Source_Code::Statement::Performs : (\Function : (
            ...
            default : (\@material : ((\@Expression::Expansion : (\"",)),)),
        )),
...
execute to the end of the compound statement); a Factor applied to the
...
statement defined by a specified parent node; a Factor applied to the
compound statement in question allows it to be controlled in this way;
written in Plain_Text with special syntax example `iterate foo`.>

=head2 Source_Code::Statement::Declare

        Source_Code::Statement::Declare : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
...
I<TODO.  This represents a lexically labelled variable reference declaration
...
written in Plain_Text with special syntax example `declare foo`.>
