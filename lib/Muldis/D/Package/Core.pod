...
=head2 Capsule_Selector

        Capsule_Selector : (\Function : (
            is_type_definer : True,
            evaluates : (\@Signature::Capsule_Match : (
                label : \@material,
                attrs : (
...
I<TODO.  This represents a selection of a Capsule value in terms of a
                    ...
                    if Function_Call_But_0 sig then
                        ...
                        \(
                            ...
                            returns Capsule topic
                                ...
                                and_then guard topic:> is_a capsule_sig:.\attrs
                        ) <-- (:sig,)
                    else
