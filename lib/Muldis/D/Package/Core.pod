...
=head2 Excuse
        ...
        Excuse::"" : (\Function : (
            is_type_definer : True,
            evaluates : (\@Signature::Capsule_Match : (
                label : \Excuse,
                asset : (
                    0 : \Any(),
                ),
...
=head2 Source_Code::Procedure
        ...
        Source_Code::Procedure : (\Function : (
            ...
            evaluates : (\@Signature::Capsule_Match : (
                label : \Procedure,
                asset : (\@Signature::Tuple_Attrs_Match : (attrs : (
                    virtual : (type : \Boolean::(), optional : True),
                    matches : (type : \Signature::Tuple_Attrs_Match_Simple(), optional : True),
                    implements : (type : ..., optional : True),
                    overrides : (type : ..., optional : True),
...
=head2 Source_Code::Signature::Capsule_Match

        Source_Code::Signature::Capsule_Match : (\Function : (
            is_type_definer : True,
            evaluates : (\@Signature::Capsule_Match : (
                label : \Any::(),
                asset : \Signature::(),
        ...
        Source_Code::Signature_to_Function_Call_But_0 : (\Function : (
            ...
            evaluates : (
                ...
                returns
                    ...
                    else if Signature::Capsule_Match sig then guard
                        \(
                            topic       ::= args:.\0;
                            capsule_sig ::= args:.\sig:>;
                            returns Capsule topic
                                and_then guard topic:< = capsule_sig:.\label
                                and_then guard topic:> is_a capsule_sig:.\asset
                        ) \<-- (:sig,)
                    else
