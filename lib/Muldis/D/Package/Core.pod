...
=head2 Source_Code::Statement::Block

        Source_Code::Statement::Block : (\Function : (
            is_type_definer : True,
            evaluates : (
                Capsule args:.\0
                and_then guard args:.\0:< = \@material
                and_then guard args:.\0:> is_a (\@Signature::Tuple_Attrs_Match : (
                    0 : (type : \(
                        Array args:.\0
                        and_then guard args:.\0 all \Statement::()
                    )),
...
`[declare x; x := 42; print(x);]` or `do_work block [foo(); bar();]`.>
