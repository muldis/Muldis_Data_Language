...
=head2 Handle
        ...
        Handle : (\Function : (
            is_type_definer : True,
            evaluates : \foundation::is_a_Handle::(),
            default : () --> \foundation::default_Handle::(),
        )),
...
serves as its uniform resource identifier.
...
multiple relevant behaviors / can process applicable messages.
...
=head2 Variable
        ...
        Variable : (\Function : (
            is_type_definer : True,
            evaluates : \foundation::is_a_Variable::(),
            default : () --> \foundation::default_Variable::(),
        )),
...
default value of C<Variable> is implementation-defined.
...
value of C<Variable> is one that explicitly doesn't point to any variable.
...
represented by C<Variable> values.  The generic assignment syntax C<:=>
...
=head2 Process
        ...
        Process : (\Function : (
            is_type_definer : True,
            evaluates : \foundation::is_a_Process::(),
            default : () --> \foundation::default_Process::(),
        )),
...
language environment / DBMS / virtual machine.  Each Muldis D I<process>
...
=head2 Stream
        ...
        Stream : (\Function : (
            is_type_definer : True,
            evaluates : \foundation::is_a_Stream::(),
            default : () --> \foundation::default_Stream::(),
        )),
