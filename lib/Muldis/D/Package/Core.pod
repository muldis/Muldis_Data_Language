...
The function C<overlaps_string> results in C<True> iff, given I<X> as the
sequence of members of its argument C<0> and I<Y> as the sequence of
...
The function C<disjoint_string> results in C<True> iff the sequence of
members of its C<0> argument can not be overlapped with the sequence of
