...
=head2 String::Bits
    ...
    ::MD::String::Bits ::= selection of String
        where (\.0 all ((function : (\.0 in 0..1)) assuming ()));
...
=head2 String::Octets
    ...
    ::MD::String::Octets ::= selection of String
        where (\.0 all ((function : (\.0 in 0..255)) assuming ()));
...
=head2 Text::Unicode
    ...
    ::MD::Text::Unicode ::= selection of Text
        where (\.0->Text_from_Maximal_Chars is_a \@String::Unicode_Codes);
...
=head2 String::Unicode_Codes
    ...
    ::MD::String::Unicode_Codes ::= selection of String::Maximal_Chars
        where (\.0 all ((function : (\.0 in 0..0x10FFFF)) assuming ()));
...
=head2 Text::ASCII
    ...
    ::MD::Text::ASCII ::= selection of Text::Unicode
        where (\.0->Text_from_Unicode_Codes is_a \@String::ASCII_Chars);
...
=head2 String::ASCII_Chars
    ...
    ::MD::String::ASCII_Chars ::= selection of String::Unicode_Codes
        where (\.0 all ((function : (\.0 in 0..127)) assuming ()));
...
=head2 squish
    ...
    ::MD::squish ::= function --> Positional <-- (Positional)
        : (\.0 map ((function : (( group : \.0, member : False ))) assuming ())
            ->nest map ((function : (\.0.\group)) assuming ()));
...
=head2 String
    ...
    ::MD::String::"" ::= selection of Array where (\.0 all_is_a \@Integer);
...
=head2 Source_Code::Package_List
    ...
    ::MD::Source_Code::Package_List ::= selection of Array
        where (\.0 all_is_a (selection of {Package, Decoration} default Package::()));
...
=head2 Source_Code::Package
    ...
    ::MD::Source_Code::Package ::= binder
    {
        ...
        (
            ...
            then
                \.0.\uses attr_names_disjoint \.0.\identity
            else
                False
        );
    };
...
=head2 Source_Code::Pkg_Decl_Map
    ...
    ::MD::Source_Code::Pkg_Decl_Map ::= selection of Tuple
        where (\.0 all_attrs
            ((function : (\.asset is_a \@Pkg_Canon_Name)) assuming ()));
