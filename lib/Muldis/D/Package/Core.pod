...
=head2 min
    ...
    min : function returns Orderable matches (Orderable, Orderable)
        is_associative is_commutative is_idempotent identity (+∞)
...
=head2 asset
    ...
    asset::"" : function virtual returns Any matches (Successable),
...
The function C<succ> results in the I<successor> value of its
...
its C<0> argument, where N is its C<1> argument, or in C<Pos_Inf> if there
is none.
...
The function C<pred> results in the I<predecessor> value of its
...
its C<0> argument, where N is its C<1> argument, or in C<Neg_Inf> if there
is none.
...
=head2 to_Boolean so ?
    ...
    to_Boolean::"" : function virtual returns Boolean matches (Boolable),
...
=head2 and ∧
    ...
    and : function returns Boolean matches (Boolean, Boolean)
        is_associative is_commutative is_idempotent identity (True)
...
=head2 or ∨
    ...
    or : function returns Boolean matches (Boolean, Boolean)
        is_associative is_commutative is_idempotent identity (False)
...
=head2 xnor iff ↔
    ...
    xnor : function returns Boolean matches (Boolean, Boolean)
        is_associative is_commutative identity (True)
        map (args.\0 = (args.\1)),
...
=head2 xor ⊻ ↮
    ...
    xor : function negates xnor
        is_associative is_commutative identity (False),
...
=head2 to_Boolean (Numerical)
    ...
    to_Boolean::Numerical : function virtual returns Boolean matches (Numerical)
        implements 1::"",
...
=head2 zero
    ...
    zero::"" : function virtual returns Numerical matches (Numerical),
...
=head2 opposite
    ...
    opposite::"" : function virtual returns Numerical matches (Numerical),
...
=head2 modulus abs
    ...
    modulus::"" : function virtual returns Numerical matches (Numerical),
...
=head2 nearest_multiple_of round
    ...
    nearest_multiple_of : function
        ...
        map (if args.\1->is_zero then Excuse::Div_By_Zero()
...
=head2 fractional_divided_by / ÷ ∕
    ...
    fractional_divided_by::"" : function virtual
...
=head2 integral_divided_by div
    ...
    integral_divided_by::"" : function virtual
        returns {Numerical, Excuse::Div_By_Zero}
        matches (Numerical, Numerical, Round_Meth),
...
=head2 integral_power **
    ...
    integral_power::"" : function virtual
...
=head2 integral_nn_power power
    ...
    integral_nn_power::"" : function virtual
...
argument, or in C<Neg_Inf> if there is none.  It is an integral numeric
...
or in C<Pos_Inf> if there is none.  It is an integral numeric specific
...
=head2 to_Integer
    ...
    to_Integer::"" : function virtual returns Integer matches (Integral),
...
=head2 factorial
    ...
    factorial::"" : function virtual returns Integral_P matches (Integral_NN),
...
=head2 gcd greatest_common_divisor
    ...
    gcd : function returns Integral_P matches (Integral_NN, Integral_NN)
        is_associative is_commutative is_idempotent
        map ((if args.\1->is_zero then args.\0 else 0::(args.\1, mod::(args.\0, args.\1, To_Zero::())))
...
=head2 lcm least_common_multiple
    ...
    lcm : function returns Integral_NN matches (Integral_NN, Integral_NN)
        is_associative is_commutative is_idempotent
        map (if args.\0->is_zero or args.\1->is_zero then args.\0->zero
...
=head2 coprime
    ...
    coprime : function returns Boolean matches (Integral, Integral)
        map ((abs::(args.\0) gcd abs::(args.\1)) = (args.\0->zero->succ)),
...
=head2 plus (Integer)
    ...
    plus::Integer : function returns Integer matches (Integer, Integer)
        implements 1::""
        is_associative is_commutative identity (0)
...
=head2 times (Integer)
    ...
    times::Integer : function returns Integer matches (Integer, Integer)
        implements 1::""
        is_associative is_commutative identity (1)
...
=head2 to_Fraction
    ...
    to_Fraction::"" : function virtual returns Fraction matches (Fractional),
...
=head2 numerator
    ...
    numerator::"" : function virtual returns Integral matches (Fractional),
...
=head2 denominator
    ...
    denominator::"" : function virtual returns Integral_P matches (Fractional),
...
=head2 opposite (Fraction)
    ...
    opposite::Fraction : function returns Fraction matches (Fraction)
        implements 1::""
        map (-(args.\0->numerator) / (args.\0->denominator)),
...
=head2 modulus (Fraction)
    ...
    modulus::Fraction : function returns Fraction_NN matches (Fraction)
        implements 1::""
        map (abs::(args.\0->numerator) / (args.\0->denominator)),
...
=head2 plus (Fraction)
    ...
    plus::Fraction : function returns Fraction matches (Fraction, Fraction)
        implements 1::""
        is_associative is_commutative identity (0.0)
...
=head2 times (Fraction)
    ...
    times::Fraction : function returns Fraction matches (Fraction, Fraction)
        implements 1::""
        is_associative is_commutative identity (1.0)
        repeater integral_nn_power::Fraction
        map (((args.\0->numerator) * (args.\1->numerator))
            / ((args.\0->denominator) * (args.\1->denominator))),
...
=head2 times (Fraction, Integer)
    ...
    times::Fraction_Integer : function
        ...
        implements 1::""
        map (((args.\0->numerator) * (args.\1)) / (args.\0->denominator)),
...
=head2 to_Boolean (Emptyable) has_any_members
    ...
    to_Boolean::Emptyable : function virtual returns Boolean matches (Emptyable)
        implements 1::"",
...
=head2 overlaps_string
    ...
    overlaps_string::"" : function virtual
        returns Boolean matches (String, String)
        is_commutative,
...
=head2 disjoint_string
    ...
    disjoint_string::"" : function virtual
        returns Boolean matches (String, String)
        is_commutative,
...
=head2 in_order (Bits)
    ...
    in_order::Bits : function returns Boolean matches (Bits, Bits)
        implements 1::""
        map ((args.\0->Bits_to_String_Bits) in_order (args.\1->Bits_to_String_Bits)),
...
=head2 substring_of (Bits)
    ...
    substring_of::Bits : function returns Boolean matches (Bits, Bits)
        implements 1::""
        map ((args.\0->Bits_to_String_Bits) substring_of (args.\1->Bits_to_String_Bits)),
...
=head2 overlaps_string (Bits)
    ...
    overlaps_string::Bits : function returns Boolean matches (Bits, Bits)
        implements 1::""
        is_commutative
        map ((args.\0->Bits_to_String_Bits)
...
=head2 catenate (Bits)
    ...
    catenate::Bits : function returns Bits matches (Bits, Bits)
        implements 1::""
        is_associative identity (\~?'')
        repeater replicate::Bits
        map (Bits_from_String_Bits::((args.\0->Bits_to_String_Bits)
...
=head2 replicate (Bits)
    ...
    replicate::Bits : function returns Bits matches (Bits, Integer_NN)
        implements 1::""
        map (Bits_from_String_Bits::((args.\0->Bits_to_String_Bits) ~# (args.\1))),
...
=head2 in_order (Blob)
    ...
    in_order::Blob : function returns Boolean matches (Blob, Blob)
        implements 1::""
        map ((args.\0->Blob_to_Octets) in_order (args.\1->Blob_to_Octets)),
...
=head2 substring_of (Blob)
    ...
    substring_of::Blob : function returns Boolean matches (Blob, Blob)
        implements 1::""
        map ((args.\0->Blob_to_Octets) substring_of (args.\1->Blob_to_Octets)),
...
=head2 overlaps_string (Blob)
    ...
    overlaps_string::Blob : function returns Boolean matches (Blob, Blob)
        implements 1::""
        is_commutative
        map ((args.\0->Blob_to_Octets) overlaps_string (args.\1->Blob_to_Octets)),
...
=head2 disjoint_string (Blob)
    ...
    disjoint_string::Blob : function returns Boolean matches (Blob, Blob)
        implements 1::""
        is_commutative
        map ((args.\0->Blob_to_Octets) disjoint_string (args.\1->Blob_to_Octets)),
...
=head2 catenate (Blob)
    ...
    catenate::Blob : function returns Blob matches (Blob, Blob)
        ...
        map (Blob_from_Octets::((args.\0->Blob_to_Octets) ~ (args.\1->Blob_to_Octets))),
...
=head2 replicate (Blob)
    ...
    replicate::Blob : function returns Blob matches (Blob, Integer_NN)
        implements 1::""
        map (Blob_from_Octets::((args.\0->Blob_to_Octets) ~# (args.\1))),
...
=head2 to_Text
    ...
    to_Text::"" : function virtual returns Text matches (Textual),
...
=head2 in_order (Text)
    ...
    in_order::Text : function returns Boolean matches (Text, Text)
        implements 1::""
        map ((args.\0->Text_to_Maximal_Chars) in_order (args.\1->Text_to_Maximal_Chars)),
...
=head2 substring_of (Text)
    ...
    substring_of::Text : function returns Boolean matches (Text, Text)
        implements 1::""
        map ((args.\0->Text_to_Maximal_Chars)
...
=head2 catenate (Text)
    ...
    catenate::Text : function returns Text matches (Text, Text)
        ...
        map (Text_from_Maximal_Chars::((args.\0->Text_to_Maximal_Chars)
...
=head2 replicate (Text)
    ...
    replicate::Text : function returns Text matches (Text, Integer_NN)
        implements 1::""
        map (Text_from_Maximal_Chars::((args.\0->Text_to_Maximal_Chars) ~# (args.\1))),
...
=head2 Text_from_Unicode_Codes
    ...
    Text_from_Unicode_Codes : function
        ...
        map (args.\0->Text_from_Maximal_Chars),
...
=head2 Text_from_ASCII_Chars
    ...
    Text_from_ASCII_Chars : function
        ...
        map (args.\0->Text_from_Unicode_Codes),
...
=head2 Text_to_ASCII_Chars
    ...
    Text_to_ASCII_Chars : function
        ...
        map (args.\0->Text_to_Unicode_Codes),
...
=head2 Blob_is_ASCII
    ...
    Blob_is_ASCII : function returns Boolean matches (Blob)
        map (String::ASCII_Chars(args.\0->Blob_to_Octets)),
...
=head2 Text_to_ASCII_Blob
    ...
    Text_to_ASCII_Blob : function returns Blob matches (Text::ASCII)
        map (args.\0->Text_to_ASCII_Chars->Blob_from_Octets),
...
=head2 has_mapping_at .:?
    ...
    has_mapping_at::"" : function virtual
...
=head2 at .
    ...
    at::"" : function virtual returns Any matches (Accessible, Any)
        accepts (args.\0 .? (args.\1)),
...
=head2 maybe_at .!
    ...
    maybe_at::"" : function virtual returns Any matches (Accessible, Any),
...
=head2 shiftless_insert_at .+
    ...
    shiftless_insert_at::"" : function virtual
        returns Accessible matches (Accessible, (Any, Any))
...
=head2 shiftless_remove_at .-
    ...
    shiftless_remove_at::"" : function virtual
...
=head2 replace_or_insert_at .=+
    ...
    replace_or_insert_at::"" : function virtual
        returns Accessible matches (Accessible, (Any, Any)),
...
=head2 shiftless_maybe_remove_at .?-
    ...
    shiftless_maybe_remove_at::"" : function virtual
        returns Accessible matches (Accessible, Any),
...
=head2 singular
    ...
    singular::"" : function virtual returns Boolean matches (Homogeneous),
...
=head2 only_member
    ...
    only_member::"" : function virtual returns Any matches (Homogeneous)
...
=head2 all_unique
    ...
    all_unique::"" : function virtual returns Boolean matches (Homogeneous),
...
=head2 unique
    ...
    unique::"" : function virtual returns Homogeneous matches (Homogeneous),
...
=head2 overlaps_members
    ...
    overlaps_members::"" : function virtual
        returns Boolean matches (Homogeneous, Homogeneous)
        is_commutative,
...
=head2 disjoint_members
    ...
    disjoint_members::"" : function virtual
        returns Boolean matches (Homogeneous, Homogeneous)
        is_commutative,
...
=head2 nest group
    ...
    nest::"" : function virtual returns Unionable matches (Unionable)
        accepts (...),
...
=head2 unnest ungroup
    ...
    unnest::"" : function virtual returns Unionable matches (Unionable)
        accepts (...),
...
=head2 to_Set ?|
    ...
    to_Set::"" : function virtual returns Set matches (Discrete),
...
=head2 to_Bag +|
    ...
    to_Bag::"" : function virtual returns Bag matches (Discrete),
...
=head2 count cardinality #
    ...
    count::"" : function virtual returns Integer_NN matches (Discrete),
...
=head2 unique_count
    ...
    unique_count::"" : function virtual returns Integer_NN matches (Discrete),
...
=head2 subset_of (Positional)
    ...
    subset_of::Positional : function
        ...
        implements 1::""
        map ((args.\0->to_Bag) subset_of (args.\1->to_Bag)),
...
=head2 same_members (Positional)
    ...
    same_members::Positional : function
        ...
        implements 1::""
        is_commutative
        map ((args.\0->to_Bag) same_members (args.\1->to_Bag)),
...
=head2 overlaps_members (Positional)
    ...
    overlaps_members::Positional : function
        ...
        implements 1::""
        is_commutative
        map ((args.\0->to_Bag) overlaps_members (args.\1->to_Bag)),
...
=head2 disjoint_members (Positional)
    ...
    disjoint_members::Positional : function
        ...
        implements 1::""
        is_commutative
        map ((args.\0->to_Bag) disjoint_members (args.\1->to_Bag)),
...
=head2 to_Array ~|
    ...
    to_Array::"" : function virtual returns Array matches (Positional),
...
=head2 first_possible_index
    ...
    first_possible_index::"" : function virtual
...
=head2 index_succ_all_matches
    ...
    index_succ_all_matches::"" : function virtual
...
=head2 has_n (Set)
    ...
    has_n::Set : function returns Boolean matches (Set, Any, Integer_NN)
        implements 1::""
        map (has_n::(args.\0->unwrap, args.\1, args.\2)),
...
=head2 multiplicity (Set)
    ...
    multiplicity::Set : function returns Integer_NN matches (Set, Any)
        implements 1::""
        map (args.\0->unwrap multiplicity args.\1),
...
=head2 subset_of (Set)
    ...
    subset_of::Set : function returns Boolean matches (Set, Set)
        implements 1::""
        map ((args.\0->unwrap) subset_of (args.\1->unwrap)),
...
=head2 overlaps_members (Set)
    ...
    overlaps_members::Set : function returns Boolean matches (Set, Set)
        implements 1::""
        is_commutative
        map ((args.\0->unwrap) overlaps_members (args.\1->unwrap)),
...
=head2 disjoint_members (Set)
    ...
    disjoint_members::Set : function returns Boolean matches (Set, Set)
        implements 1::""
        is_commutative
        map ((args.\0->unwrap) disjoint_members (args.\1->unwrap)),
...
=head2 remove_n (Set)
    ...
    remove_n::Set : function returns Set matches (Set, Any, Integer_NN)
        implements 1::""
        map (\Set wrap remove_n::(args.\0->unwrap, args.\1, args.\2)),
...
=head2 except (Set)
        ...
        implements 1::""
        map (\Set wrap ((args.\0->unwrap) except (args.\1->unwrap))),
...
=head2 intersect (Set)
    ...
    intersect::Set : function returns Set matches (Set, Set)
        implements 1::""
        is_associative is_commutative is_idempotent
        map (\Set wrap ((args.\0->unwrap) intersect (args.\1->unwrap))),
...
=head2 union (Set)
    ...
    union::Set : function returns Set matches (Set, Set)
        implements 1::""
        is_associative is_commutative is_idempotent identity ({})
        map (\Set wrap ((args.\0->unwrap) union (args.\1->unwrap))),
...
=head2 exclusive (Set)
    ...
    exclusive::Set : function returns Set matches (Set, Set)
        implements 1::""
        is_associative is_commutative identity ({})
        map (\Set wrap ((args.\0->unwrap) exclusive (args.\1->unwrap))),
...
=head2 nest (Set)
    ...
    nest::Set : function returns Set matches (Set)
        implements 1::""
        accepts (...)
        map (\Set wrap (args.\0->unwrap->nest)),
...
=head2 unnest (Set)
    ...
    unnest::Set : function returns Set matches (Set)
        implements 1::""
        accepts (...)
        map (\Set wrap (args.\0->unwrap->unnest)),
...
=head2 where (Set)
    ...
    where::Set : function returns Set matches (Set, Signature)
        implements 1::""
        map (\Set wrap (args.\0->unwrap where args.\1)),
...
=head2 map (Set)
    ...
    map::Set : function returns Set matches (Set, Function_Call_But_0)
        implements 1::""
        map (\Set wrap (args.\0->unwrap map args.\1)),
...
=head2 reduce (Set)
    ...
    reduce::Set : function returns Any matches (Set, Function_Call_But_0_1)
        implements 1::""
        map (\Set wrap (args.\0->unwrap reduce args.\1)),
...
=head2 order_using (Set)
    ...
    order_using::Set : function returns Array matches (Set, Function_Call_But_0_1)
        implements 1::""
        map (\Set wrap (args.\0->unwrap order_using args.\1)),
...
=head2 has_any_attrs ?@
    ...
    has_any_attrs::"" : function virtual returns Boolean matches (Attributive),
...
=head2 nullary
    ...
    nullary::"" : function virtual returns Attributive matches (Attributive),
...
=head2 is_unary
    ...
    is_unary::"" : function virtual returns Boolean matches (Attributive),
...
=head2 degree #@
    ...
    degree::"" : function virtual returns Integer_NN matches (Attributive),
...
=head2 heading @
    ...
    heading::"" : function virtual returns Heading matches (Attributive),
...
=head2 can_project_matching %=?
    ...
    can_project_matching::"" : function virtual
...
=head2 to_Tuple %
    ...
    to_Tuple::"" : function virtual returns Tuple matches (Structural),
...
=head2 body |
    ...
    body::"" : function virtual returns Unionable matches (Relational),
...
=head2 select_Relational
    ...
    select_Relational::"" : function virtual
...
=head2 select_Relational (Tuple_Array)
    ...
    select_Relational::Tuple_Array : function
        ...
        implements 1::""
        map (\Tuple_Array wrap args %= \@(heading,body)),
...
=head2 select_Relational (Relation)
    ...
    select_Relational::Relation : function
        ...
        implements 1::""
        map (\Relation wrap args %= \@(heading,body)),
...
=head2 select_Relational (Tuple_Bag)
    ...
    select_Relational::Tuple_Bag : function
        ...
        implements 1::""
        map (\Tuple_Bag wrap args %= \@(heading,body)),
...
For similar reasons, the Capsule-specific operators are grouped under the
Capsule:: namespace to discourage their direct use in regular code on a
common basis versus using type-specific accessors; any users would either
have to prefix with Capsule:: or float that namespace to use them unqualified.

=head2 Capsule::wrap

    Capsule::wrap : function returns Capsule matches (Any, Any)
...
=head2 Capsule::wrapper
    ...
    Capsule::wrapper : function returns Any matches (Capsule)
...
=head2 Capsule::unwrap
    ...
    Capsule::unwrap : function returns Any matches (Capsule)
...
=head2 Capsule::has_wrapped
    ...
    Capsule::has_wrapped : function
        returns Boolean matches (Capsule, Any, Signature)
        map ((wrapper args.\0) = (args.\1) and
...
Foundation type I<FDN__Reference>.  A C<Reference> value is an opaque and
...
alias for (itself or) the used package.>

=head2 Source_Code::Pkg_Canon_Name
...
=head2 Source_Code::Fdn_Canon_Name
...
I<TODO.  Enumeration only exists as a Plain_Text shorthand.>
