...
This document is part of the human readable authoritative formal
specification of the B<Muldis D Standard Library> (B<MDSL>) primary
component of the B<Muldis D> language.  The B<MDSL> comprises a set of
Muldis D packages, each of which has its own fully-qualified name.

A directory of other B<MDSL> packages will be added with this paragraph
when they come to be defined; meanwhile there are none.
...
This file is part of the B<Muldis D Standard Library> (B<MDSL>), which is
both a formal specification and executable code, serving as a primary
component of the B<Muldis D> language specification.
