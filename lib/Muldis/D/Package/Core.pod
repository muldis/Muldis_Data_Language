...
=head2 same =
        ...
        same : function (
            returns : Boolean, matches : (Any, Any),
            is_commutative : True,
            map : (args -->^ FDN__same),
        ),
...
=head2 is_a
        ...
        is_a : function (
            returns : Boolean, matches : (Any, Signature),
...
=head2 in_order (Neg_Inf, Pos_Inf)
        ...
        in_order::Neg_Inf_L : function (
            returns : Boolean, matches : (Neg_Inf, Orderable),
            implements : 1::"",
            map : (True),
        ),

        in_order::Neg_Inf_R : function (
            returns : Boolean, matches : (Orderable, Neg_Inf),
            implements : 1::"",
            map : (args.\0 = (args.\1)),
        ),

        in_order::Pos_Inf_L : function (
            returns : Boolean, matches : (Pos_Inf, Orderable),
            implements : 1::"",
            map : (args.\0 = (args.\1)),
        ),

        in_order::Pos_Inf_R : function (
            returns : Boolean, matches : (Orderable, Pos_Inf),
            implements : 1::"",
            map : (True),
        ),
...
=head2 min
        ...
        min : function (
            returns : Orderable, matches : (Orderable, Orderable),
...
=head2 succ
        ...
        succ : function (
            returns : {Successable, Pos_Inf}, matches : (Successable),
...
=head2 pred
        ...
        pred : function (
            returns : {Bicessable, Neg_Inf}, matches : (Bicessable),
...
=head2 in_order (Boolean)
        ...
        in_order::Boolean : function (
            returns : Boolean, matches : (Boolean, Boolean),
            implements : 1::"",
...
=head2 asset (Boolean)
        ...
        asset::Boolean : function (
            returns : Boolean, matches : (Boolean),
            implements : 1::"",
            map : (args.\0),
        ),
...
=head2 to_Boolean (Numerical)
        ...
        to_Boolean::Numerical : function (
            virtual : True, returns : Boolean, matches : (Numerical),
            implements : 1::"",
        ),
...
=head2 --
        ...
        "--" : function (
            returns : {Integral, Neg_Inf}, matches : (Integral),
            map : (pred args.\0),
        ),
...
=head2 ++
        ...
        "++" : function (
            returns : {Integral, Pos_Inf}, matches : (Integral),
            map : (succ args.\0),
        ),
...
=head2 gcd greatest_common_divisor
        ...
        gcd : function (
            returns : Integral_P, matches : (Integral_NN, Integral_NN),
...
=head2 lcm least_common_multiple
        ...
        lcm : function (
            returns : Integral_NN, matches : (Integral_NN, Integral_NN),
            is_associative : True, is_commutative : True, is_idempotent : True,
...
=head2 coprime
        ...
        coprime : function (
            returns : Boolean, matches : (Integral, Integral),
...
=head2 in_order (Integer)
        ...
        in_order::Integer : function (
            returns : Boolean, matches : (Integer, Integer),
            implements : 1::"",
...
=head2 asset (Integer)
        ...
        asset::Integer : function (
            returns : Integer, matches : (Integer),
            implements : 1::"",
            map : (args.\0),
        ),
...
=head2 nth_pred (Integer)
        ...
        nth_pred::Integer : function (
            returns : Integer, matches : (Integer, Integer_NN),
...
=head2 to_Boolean (Integer)
        ...
        to_Boolean::Integer : function (
            returns : Boolean, matches : (Integer),
            implements : 1::"",
            map : (args.\0 != 0),
        ),
...
=head2 modulus (Integer)
        ...
        modulus::Integer : function (
            returns : Integer_NN, matches : (Integer),
            implements : 1::"",
...
=head2 plus (Integer)
        ...
        plus::Integer : function (
            returns : Integer, matches : (Integer, Integer),
            implements : 1::"",
...
=head2 factorial (Integer)
        ...
        factorial::Integer : function (
            returns : Integer_P, matches : (Integer_NN),
            implements : 1::"",
...
=head2 in_order (Fraction)
        ...
        in_order::Fraction : function (
            returns : Boolean, matches : (Fraction, Fraction),
            implements : 1::"",
            map : (
...
=head2 to_Boolean (Fraction)
        ...
        to_Boolean::Fraction : function (
            returns : Boolean, matches : (Fraction),
            implements : 1::"",
            map : (args.\0 != 0.0),
        ),
...
=head2 zero (Fraction)
        ...
        zero::Fraction : function (
            returns : Fraction, matches : (Fraction),
            implements : 1::"",
            map : (0.0),
        ),
...
=head2 modulus (Fraction)
        ...
        modulus::Fraction : function (
            returns : Fraction_NN, matches : (Fraction),
            implements : 1::"",
...
=head2 plus (Fraction)
        ...
        plus::Fraction : function (
            returns : Fraction, matches : (Fraction, Fraction),
            implements : 1::"",
...
=head2 numerator (Fraction)
        ...
        numerator::Fraction : function (
            returns : Integer, matches : (Fraction),
            map : (args.\0:>.\numerator),
        ),
...
=head2 denominator (Fraction)
        ...
        denominator::Fraction : function (
            returns : Integer_P, matches : (Fraction),
...
=head2 to_Boolean (Emptyable) has_any_members
        ...
        to_Boolean::Emptyable : function (
            virtual : True, returns : Boolean, matches : (Emptyable),
            implements : 1::"",
        ),
...
=head2 in_order (Bits)
        ...
        in_order::Bits : function (
            returns : Boolean, matches : (Bits, Bits),
            implements : 1::"",
...
=head2 catenate (Bits)
        ...
        catenate::Bits : function (
            returns : Bits, matches : (Bits, Bits),
            implements : 1::"",
...
=head2 replicate (Bits)
        ...
        replicate::Bits : function (
            returns : Bits, matches : (Bits, Integer_NN),
            implements : 1::"",
...
=head2 Bits_from_String_Bits
        ...
        Bits_from_String_Bits : function (
            returns : Bits, matches : (String::Bits),
            map : (\Bits >:< (args.\0)),
        ),
...
=head2 Bits_to_String_Bits
        ...
        Bits_to_String_Bits : function (
            returns : String::Bits, matches : (Bits),
            map : (args.\0:>),
        ),
...
=head2 in_order (Blob)
        ...
        in_order::Blob : function (
            returns : Boolean, matches : (Blob, Blob),
            implements : 1::"",
...
=head2 catenate (Blob)
        ...
        catenate::Blob : function (
            returns : Blob, matches : (Blob, Blob),
            implements : 1::"",
            is_associative : True, identity : (\~+''),
...
=head2 replicate (Blob)
        ...
        replicate::Blob : function (
            returns : Blob, matches : (Blob, Integer_NN),
            implements : 1::"",
...
=head2 Blob_from_Octets
        ...
        Blob_from_Octets : function (
            returns : Blob, matches : (String::Octets),
            map : (\Blob >:< (args.\0)),
        ),
...
=head2 Blob_to_Octets
        ...
        Blob_to_Octets : function (
            returns : String::Octets, matches : (Blob),
            map : (args.\0:>),
        ),
...
=head2 in_order (Text)
        ...
        in_order::Text : function (
            returns : Boolean, matches : (Text, Text),
            implements : 1::"",
...
=head2 catenate (Text)
        ...
        catenate::Text : function (
            returns : Text, matches : (Text, Text),
            implements : 1::"",
            is_associative : True, identity : (''),
...
=head2 replicate (Text)
        ...
        replicate::Text : function (
            returns : Text, matches : (Text, Integer_NN),
            implements : 1::"",
...
=head2 Text_to_UTF_8_Blob
        ...
        Text_to_UTF_8_Blob : function (
            returns : Blob, matches : (Text::Unicode),
            map : (...),
        ),
...
=head2 Text_to_ASCII_Blob
        ...
        Text_to_ASCII_Blob : function (
            returns : Blob, matches : (Text::ASCII),
...
=head2 at .
        ...
        at::"" : function (
            virtual : True, returns : Any, matches : (Accessible, Any),
            accepts : (args.\0 .? (args.\1)),
        ),
...
=head2 only_member
        ...
        only_member::"" : function (
            virtual : True, returns : Any, matches : (Homogeneous),
...
=head2 has ∋
        ...
        has : function (
            returns : Boolean, matches : (Homogeneous, Any),
...
=head2 insert
        ...
        insert : function (
            returns : Unionable, matches : (Unionable, Any),
...
=head2 nest group
        ...
        nest::"" : function (
            virtual : True, returns : Unionable, matches : (Unionable),
            accepts : (...),
        ),
...
=head2 order
        ...
        order : function (
            returns : Positional, matches : (Discrete),
...
=head2 singular (Positional)
        ...
        singular::Positional : function (
            returns : Boolean, matches : (Positional),
            implements : 1::"",
...
=head2 only_member (Positional)
        ...
        only_member::Positional : function (
            returns : Any, matches : (Positional),
            implements : 1::"",
            accepts : (singular args.\0),
            map : (first args.\0),
        ),
...
=head2 unique_count (Positional)
        ...
        unique_count::Positional : function (
            returns : Integer_NN, matches : (Positional),
            implements : 1::"",
...
=head2 squish
        ...
        squish : function (
            returns : Positional, matches : (Positional),
...
=head2 in_order (Array)
        ...
        in_order::Array : function (
            returns : Boolean, matches : (Array, Array),
            implements : 1::"",
            map : (
...
=head2 catenate (Array)
        ...
        catenate::Array : function (
            returns : Array, matches : (Array, Array),
            implements : 1::"",
            is_associative : True, identity : ([]),
...
=head2 replicate (Array)
        ...
        replicate::Array : function (
            returns : Array, matches : (Array, Integer_NN),
            implements : 1::"",
...
=head2 has_n (Array)
        ...
        has_n::Array : function (
            returns : Boolean, matches : (Array, Any, Integer_NN),
            implements : 1::"",
...
=head2 multiplicity (Array)
        ...
        multiplicity::Array : function (
            returns : Integer_NN, matches : (Array, Any),
            implements : 1::"",
...
=head2 any (Array)
        ...
        any::Array : function (
            returns : Boolean, matches : (Array, Signature),
            implements : 1::"",
...
=head2 insert_n (Array)
        ...
        insert_n::Array : function (
            returns : Array, matches : (Array, Any, Integer_NN),
            implements : 1::"",
...
=head2 where (Array)
        ...
        where::Array : function (
            returns : Array, matches : (Array, Signature),
            implements : 1::"",
            map : ((args.\0, Signature_to_Function_Call_But_0::(args.\1))
                -->^ FDN__Array_where),
        ),
...
=head2 map (Array)
        ...
        map::Array : function (
            returns : Array, matches : (Array, Function_Call_But_0),
            implements : 1::"",
...
=head2 reduce (Array)
        ...
        reduce::Array : function (
            returns : Any, matches : (Array, Function_Call_But_0_1),
            implements : 1::"",
...
=head2 count (Array)
        ...
        count::Array : function (
            returns : Integer_NN, matches : (Array),
            implements : 1::"",
...
=head2 order_using (Array)
        ...
        order_using::Array : function (
            returns : Array, matches : (Array, Function_Call_But_0_1),
            implements : 1::"",
...
=head2 at (Array)
        ...
        at::Array : function (
            returns : Any, matches : (Array, Integer_NN),
            implements : 1::"",
            accepts : (args.\0 .? (args.\1)),
...
=head2 has_n (Set)
        ...
        has_n::Set : function (
            returns : Boolean, matches : (Set, Any, Integer_NN),
            implements : 1::"",
...
=head2 multiplicity (Set)
        ...
        multiplicity::Set : function (
            returns : Integer_NN, matches : (Set, Any),
            implements : 1::"",
...
=head2 subset_of (Set)
        ...
        subset_of::Set : function (
            returns : Boolean, matches : (Set, Set),
            implements : 1::"",
...
=head2 any (Set)
        ...
        any::Set : function (
            returns : Boolean, matches : (Set, Signature),
            implements : 1::"",
...
=head2 insert_n (Set)
        ...
        insert_n::Set : function (
            returns : Set, matches : (Set, Any, Integer_NN),
            implements : 1::"",
...
=head2 where (Set)
        ...
        where::Set : function (
            returns : Set, matches : (Set, Signature),
            implements : 1::"",
...
=head2 map (Set)
        ...
        map::Set : function (
            returns : Set, matches : (Set, Function_Call_But_0),
            implements : 1::"",
...
=head2 reduce (Set)
        ...
        reduce::Set : function (
            returns : Any, matches : (Set, Function_Call_But_0_1),
            implements : 1::"",
...
=head2 count (Set)
        ...
        count::Set : function (
            returns : Integer_NN, matches : (Set),
            implements : 1::"",
            map : (count args.\0:>),
        ),
...
=head2 order_using (Set)
        ...
        order_using::Set : function (
            returns : Array, matches : (Set, Function_Call_But_0_1),
            implements : 1::"",
...
=head2 has_n (Bag)
        ...
        has_n::Bag : function (
            returns : Boolean, matches : (Bag, Any, Integer_NN),
            implements : 1::"",
...
=head2 multiplicity (Bag)
        ...
        multiplicity::Bag : function (
            returns : Integer_NN, matches : (Bag, Any),
            implements : 1::"",
...
=head2 subset_of (Bag)
        ...
        subset_of::Bag : function (
            returns : Boolean, matches : (Bag, Bag),
            implements : 1::"",
...
=head2 any (Bag)
        ...
        any::Bag : function (
            returns : Boolean, matches : (Bag, Signature),
            implements : 1::"",
...
=head2 insert_n (Bag)
        ...
        insert_n::Bag : function (
            returns : Bag, matches : (Bag, Any, Integer_NN),
            implements : 1::"",
...
=head2 where (Bag)
        ...
        where::Bag : function (
            returns : Bag, matches : (Bag, Signature),
            implements : 1::"",
...
=head2 map (Bag)
        ...
        map::Bag : function (
            returns : Bag, matches : (Bag, Function_Call_But_0),
            implements : 1::"",
...
=head2 reduce (Bag)
        ...
        reduce::Bag : function (
            returns : Any, matches : (Bag, Function_Call_But_0_1),
            implements : 1::"",
...
=head2 count (Bag)
        ...
        count::Bag : function (
            returns : Integer_NN, matches : (Bag),
            implements : 1::"",
...
=head2 order_using (Bag)
        ...
        order_using::Bag : function (
            returns : Array, matches : (Bag, Function_Call_But_0_1),
            implements : 1::"",
...
=head2 D1
        ...
        D1 : function (
            returns : Tuple_D1, matches : (Attr_Name, Any),
...
=head2 degree (Tuple)
        ...
        degree::Tuple : function (
            returns : Integer_NN, matches : (Tuple),
            implements : 1::"",
...
=head2 rename (Tuple)
        ...
        rename::Tuple : function (
            returns : Tuple, matches : (Tuple, Renaming),
            implements : 1::"",
            accepts : (...),
...
=head2 on (Tuple)
        ...
        on::Tuple : function (
            returns : Tuple, matches : (Tuple, Heading),
            implements : 1::"",
            accepts : (args.\0 @? (args.\1)),
...
=head2 update (Tuple)
        ...
        update::Tuple : function (
            returns : Tuple, matches : (Tuple, Tuple),
            implements : 1::"",
            accepts : (args.\0 @? (args.\1)),
...
=head2 at (Tuple)
        ...
        at::Tuple : function (
            returns : Any, matches : (Tuple, Attr_Name),
            implements : 1::"",
            accepts : (args.\0 .? (args.\1)),
...
=head2 any_attrs
        ...
        any_attrs : function (
            returns : Boolean, matches : (Tuple, Signature),
            map : ((args.\0, Signature_to_Function_Call_But_0::(args.\1))
...
=head2 attrs_where
        ...
        attrs_where : function (
            returns : Tuple, matches : (Tuple, Signature),
            map : ((args.\0, Signature_to_Function_Call_But_0::(args.\1))
...
=head2 attrs_map
        ...
        attrs_map : function (
            returns : Tuple, matches : (Tuple, Function_Call_But_0),
...
=head2 attrs_reduce
        ...
        attrs_reduce : function (
            returns : Any, matches : (Tuple, Function_Call_But_0_1),
...
=head2 to_Boolean (Relational)
        ...
        to_Boolean::Relational : function (
            returns : Boolean, matches : (Relational),
            implements : 1::"",
            map : (? |(args.\0)),
        ),
...
=head2 empty (Relational)
        ...
        empty::Relational : function (
            returns : Relational, matches : (Relational),
            implements : 1::"",
...
=head2 only_member (Relational)
        ...
        only_member::Relational : function (
            returns : Structural, matches : (Relational),
            implements : 1::"",
            accepts : (singular args.\0),
            map : (only_member |(args.\0)),
        ),
...
=head2 degree (Relational)
        ...
        degree::Relational : function (
            returns : Integer_NN, matches : (Relational),
            implements : 1::"",
            map : (degree @(args.\0)),
        ),
...
=head2 heading (Tuple_Array)
        ...
        heading::Tuple_Array : function (
            returns : Heading, matches : (Tuple_Array),
            implements : 1::"",
            map : (args.\0:>.\heading),
        ),
...
=head2 body (Tuple_Array)
        ...
        body::Tuple_Array : function (
            returns : Array, matches : (Tuple_Array),
            implements : 1::"",
            map : (args.\0:>.\body),
        ),
...
=head2 heading (Relation)
        ...
        heading::Relation : function (
            returns : Heading, matches : (Relation),
            implements : 1::"",
            map : (args.\0:>.\heading),
        ),
...
=head2 heading (Tuple_Bag)
        ...
        heading::Tuple_Bag : function (
            returns : Heading, matches : (Tuple_Bag),
            implements : 1::"",
            map : (args.\0:>.\heading),
        ),
...
=head2 wrap >:<
        ...
        wrap : function (
            returns : Capsule, matches : (Any, Any),
