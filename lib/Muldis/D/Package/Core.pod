...
=head2 Attributive
    ...
    ::MD::Attributive ::= interface
        requires_implements {has_any_attrs,nullary
            ,is_unary,only_attr_name,degree,heading
...
The function C<subheading_of> results in C<True> iff the heading of its
C<0> argument is a subset of the heading of its C<1> argument; otherwise it
results in C<False>.

=head2 superheading_of

    ::MD::superheading_of ::= function commutes subheading_of;

The function C<superheading_of> results in C<True> iff the heading of its
C<0> argument is a superset of the heading of its C<1> argument; otherwise
it results in C<False>.
...
The function C<same_heading> results in C<True> iff the heading of its C<0>
argument is the same as the heading of its C<1> argument; otherwise it
results in C<False>.
...
=head2 extend +^
    ...
    ::MD::extend::"" ::= function virtual
        ...
        requires (\<*args --> \disjoint_heading::())
        is {associative,commutative};
...
The function C<heading> results in the relational I<heading> of its C<0>
argument, that is its set of distinct attribute names.  This function
implements the C<Attributive> virtual function C<heading>
...
=head2 but (Tuple)
    ...
    ::MD::but::Tuple ::= function --> Tuple <-- (Tuple, Heading)
        implements 2::""
        requires (...)
        : (\<*args -->^ FDN__Tuple_but);
...
=head2 Tuple_Array
    ...
    ::MD::Tuple_Array ::= binder
    {
        ...
        _Asset ::= selection of Tuple where
        (
            if \<0 ^?= ( heading : \Heading::(), body : \Array::() ) then
...
=head2 Tuple_Bag
    ...
    ::MD::Tuple_Bag ::= binder
    {
        ...
        _Asset ::= selection of Tuple where
        (
            if \<0 ^?= ( heading : \Heading::(), body : \Bag::() ) then
                if \<<body all \Tuple::() then
                    \<<body all (function : (\"^?="::() \<-- \<<heading))
                else
                    False
