...
=head2 is_a
    ...
    ::MD::is_a ::= function --> Boolean <-- (Any, Signature)
        : (\<0 --> Signature_to_Function_Call_But_0::(\<1));
...
=head2 modulo mod
    ...
    ::MD::modulo ::= function
        ...
        <-- (Numerical, Numerical, Round_Meth)
        : (if \<1->is_zero then Excuse::Div_By_Zero()
            else \<0 - (\<0 nearest_multiple_of \<1));
...
=head2 Fraction
    ...
    ::MD::Fraction ::= selection of Capsule
        where (has_wrapped::( \<0, \Fraction, (function : (
            if
                \<0 is_a (
                    numerator : \Integer::(),
...
=head2 proper_substring_or_superstring
    ...
    ::MD::proper_substring_or_superstring ::= function
        ...
        is commutative
        : (\<0 != \<1 and (\<0 substring_or_superstring \<1));
...
=head2 substring_or_superstring
    ...
    ::MD::substring_or_superstring ::= function
        --> Boolean <-- (String, String)
        is commutative
        : ((\<0 substring_of \<1) or (\<0 superstring_of \<1));
...
=head2 String::Unicode_Codes
    ...
    ::MD::String::Unicode_Codes ::= selection of String::Maximal_Chars
        where (\<0 all \in::( 1: ?..{0..0xD7FF,0xE000..0x10FFFF} ));
...
=head2 proper_subset_or_superset
    ...
    ::MD::proper_subset_or_superset ::= function
        --> Boolean <-- (Homogeneous, Homogeneous)
        is commutative
        : (not (\<0 same_members \<1) and (\<0 subset_or_superset \<1));
...
=head2 subset_or_superset
    ...
    ::MD::subset_or_superset ::= function
        --> Boolean <-- (Homogeneous, Homogeneous)
        is commutative
        : ((\<0 subset_of \<1) or (\<0 superset_of \<1));
...
=head2 any (Array)
    ...
    ::MD::any::Array ::= function --> Boolean <-- (Array, Signature)
        implements 2::""
        : ((\<0, Signature_to_Function_Call_But_0::(\<1)) -->^ FDN__Array_any);
...
=head2 Set
    ...
    ::MD::Set ::= selection of Capsule
        where (has_wrapped::( \<0, \Set,
            (function : (if Bag \<0 then all_unique \<0 else False)) ))
        default ({})
...
=head2 any (Bag)
    ...
    ::MD::any::Bag ::= function --> Boolean <-- (Bag, Signature)
        implements 2::""
        : ((\<0, Signature_to_Function_Call_But_0::(\<1)) -->^ FDN__Bag_any);
...
=head2 where (Bag)
    ...
    ::MD::where::Bag ::= function --> Bag <-- (Bag, Signature)
        implements 2::""
        : ((\<0, Signature_to_Function_Call_But_0::(\<1)) -->^ FDN__Bag_where);
...
=head2 proper_subheading_or_superheading
    ...
    ::MD::proper_subheading_or_superheading ::= function
        --> Boolean <-- (Attributive, Attributive)
        is commutative
        : (@\<0 != @\<1 and (\<0 subheading_or_superheading \<1));
...
=head2 subheading_or_superheading
    ...
    ::MD::subheading_or_superheading ::= function
        --> Boolean <-- (Attributive, Attributive)
        is commutative
        : ((\<0 subheading_of \<1) or (\<0 superheading_of \<1));
...
=head2 all_attr_assets
    ...
    ::MD::all_attr_assets ::= function --> Boolean <-- (Tuple, Signature)
        : (\<0 all_attrs (function : (\<1 <-- (\<<asset,)))
            \<-- (1 : Signature_to_Function_Call_But_0::(\<1)));
...
=head2 empty (Relational)
    ...
    ::MD::empty::Relational ::= function --> Relational <-- (Relational)
        implements 2::""
        : (select_Relational::( like: \<0, heading: @\<0, body: empty |\<0 ));
...
=head2 unique (Relational)
    ...
    ::MD::unique::Relational ::= function --> Relational <-- (Relational)
        implements 2::""
        : (select_Relational::( like: \<0, heading: @\<0, body: unique |\<0 ));
...
=head2 overlaps_members (Relational)
    ...
    ::MD::overlaps_members::Relational ::= function
        ...
        implements 2::""
        is commutative
        : (if \<0 =@ \<1 then |\<0 overlaps_members |\<1
            else Excuse::Not_Same_Heading);
...
=head2 disjoint_members (Relational)
    ...
    ::MD::disjoint_members::Relational ::= function
        ...
        implements 2::""
        is commutative
        : (if \<0 =@ \<1 then |\<0 disjoint_members |\<1
            else Excuse::Not_Same_Heading);
...
=head2 insert_n (Relational)
    ...
    ::MD::insert_n::Relational ::= function
        ...
        <-- (Relational, Structural, Integer_NN)
        implements 2::""
        : (if \<0 =@ \<1 then select_Relational::
                ( like: \<0, heading: @\<0, body: insert_n::(|\<0, \<1, \<2) )
            else Excuse::Not_Same_Heading);
...
=head2 remove_n (Relational)
    ...
    ::MD::remove_n::Relational ::= function
        ...
        implements 2::""
        : (if \<0 =@ \<1 then select_Relational::
                ( like: \<0, heading: @\<0, body: remove_n::(|\<0, \<1, \<2) )
            else Excuse::Not_Same_Heading);
...
=head2 member_plus (Relational)
    ...
    ::MD::member_plus::Relational ::= function
        ...
        is associative
        : (if \<0 =@ \<1 then select_Relational::
                ( like: \<0, heading: @\<0, body: |\<0 member_plus |\<1 )
            else Excuse::Not_Same_Heading);
...
=head2 except (Relational)
    ...
    ::MD::except::Relational ::= function
        ...
        implements 2::""
        : (if \<0 =@ \<1 then select_Relational::
                ( like: \<0, heading: @\<0, body: |\<0 except |\<1 )
            else Excuse::Not_Same_Heading);
...
=head2 intersect (Relational)
    ...
    ::MD::intersect::Relational ::= function
        ...
        is {associative,idempotent}
        : (if \<0 =@ \<1 then select_Relational::
                ( like: \<0, heading: @\<0, body: |\<0 intersect |\<1 )
            else Excuse::Not_Same_Heading);
...
=head2 union (Relational)
    ...
    ::MD::union::Relational ::= function
        ...
        is idempotent
        : (if \<0 =@ \<1 then select_Relational::
                ( like: \<0, heading: @\<0, body: |\<0 union |\<1 )
            else Excuse::Not_Same_Heading);
...
=head2 exclusive (Relational)
    ...
    ::MD::exclusive::Relational ::= function
        ...
        is {associative,commutative}
        : (if \<0 =@ \<1 then select_Relational::
                ( like: \<0, heading: @\<0, body: |\<0 exclusive |\<1 )
            else Excuse::Not_Same_Heading);
...
=head2 where (Relational)
    ...
    ::MD::where::Relational ::= function
        ...
        implements 2::""
        : (select_Relational::( like: \<0, heading: @\<0, body: |\<0 where \<1 ));
...
=head2 rename (Relational)
    ...
    ::MD::rename::Relational ::= function
        ...
        implements 2::""
        requires (...)
        : (select_Relational::( like: \<0, heading: @\<0 rename \<1,
            body: |\<0 map \rename::(:<1) ));
...
=head2 on (Relational)
    ...
    ::MD::on::Relational ::= function
        ...
        implements 2::""
        requires (\<0 @? \<1)
        : (select_Relational::( like: \<0, heading: @\<0 on \<1,
            body: |\<0 map \on::(:<1) ));
...
=head2 update (Relational)
    ...
    ::MD::update::Relational ::= function
        ...
        implements 2::""
        requires (\<0 @? \<1)
        : (select_Relational::( like: \<0, heading: @\<0,
            body: |\<0 map \update::(:<1) ));
...
=head2 extend (Relational)
    ...
    ::MD::extend::Relational ::= function
        ...
        implements 2::""
        requires (\<0 disjoint_heading \<1)
        : (select_Relational::( like: \<0, heading: @\<0 extend \<1,
            body: |\<0 map \extend::(:<1) ));
...
=head2 Tuple_Array
    ...
    ::MD::Tuple_Array ::= selection of Capsule
        where (has_wrapped::( \<0, \Tuple_Array, (function : (
            if \<0 is_a ( heading : \Heading::(), body : \Array::() ) then
                if \<<body all \Tuple::() then
                    \<<body all (function : (@\<0 = \<1)) \<-- \<<heading
                else
                    False
            else
                False
...
=head2 Relation
    ...
    ::MD::Relation ::= selection of Capsule
        where (has_wrapped::( \<0, \Relation, (function : (
            if \<0 is_a ( heading : \Heading::(), body : \Set::() ) then
                if \<<body all \Tuple::() then
                    \<<body all (function : (@\<0 = \<1)) \<-- \<<heading
                else
                    False
...
=head2 Tuple_Bag
    ...
    ::MD::Tuple_Bag ::= selection of Capsule
        where (has_wrapped::( \<0, \Tuple_Bag, (function : (
            if \<0 is_a ( heading : \Heading::(), body : \Bag::() ) then
                if \<<body all \Tuple::() then
                    \<<body all (function : (@\<0 = \<1)) \<-- \<<heading
                else
                    False
...
=head2 Interval_Set
    ...
    ::MD::Interval_Set ::= selection of Capsule
        where (has_wrapped::( \<0, \Interval_Set,
            (function : (if Interval_Bag \<0 then all_unique \<0 else False)) ))
        default (...)
...
=head2 Interval_Bag
    ...
    ::MD::Interval_Bag ::= selection of Capsule
        where (has_wrapped::( \<0, \Interval_Bag, (function : (
            if Tuple_Bag \<0 then ... else False
        )) ))
        default (...)
...
=head2 Quantity
    ...
    ::MD::Quantity ::= selection of Capsule
        where (has_wrapped::( \<0, \Quantity, (function : (
            if Relation \<0 then ... else False
        )) ))
        default (...)
...
=head2 Capsule::has_wrapped
    ...
    ::MD::Capsule::has_wrapped ::= function
        ...
        : ((wrapper \<0) = \<1 and
            (unwrap \<0,) --> Signature_to_Function_Call_But_0::(\<2));
...
=head2 Source_Code::Package_List
    ...
    ::MD::Source_Code::Package_List ::= selection of Array
        where (\<0 all {\Package::(), \Decoration::()});
...
=head2 Source_Code::Pkg_Decl_Map
    ...
    ::MD::Source_Code::Pkg_Decl_Map ::= selection of Tuple
        where (\<0 .!? \"" and \<0 all_attr_assets \Pkg_Canon_Name::());
...
=head2 Source_Code::Pkg_Canon_Name
    ...
    (
        ...
        then
                #@\<<pkg_name_base >= 1 and \<<pkg_name_base ∌ \""
            and #@\<<pkg_name_ext  >= 2 and \<<pkg_name_ext  ∌ \""
        else
            False
    );
...
=head2 Source_Code::Folder
    ...
    ::MD::Source_Code::Folder ::= selection of Tuple
        where (\<0 all_attr_assets {\Folder::(), \Binder::()});
...
=head2 Source_Code::Binder
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Binder, \1::_Asset() ))
        ...
        _Materials ::= selection of Tuple
            where (\<0 .? \"" and \<0 all_attr_assets \Material::());
    };
...
=head2 Source_Code::Alias
    ...
    ::MD::Source_Code::Alias ::= selection of Capsule
        where (has_wrapped::( \<0, \Alias, \Identity_Identifier::() ))
...
=head2 Source_Code::Constant
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Constant, \1::_Asset() ))
...
=head2 Source_Code::Selection
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Selection, \1::_Asset() ))
...
=head2 Source_Code::Interface
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Interface, \1::_Asset() ))
...
=head2 Source_Code::Function
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Function, \1::_Asset() ))
...
=head2 Source_Code::Function_Body
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Function_Body, \1::_Asset() ))
...
=head2 Source_Code::Procedure
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Procedure, \1::_Asset() ))
...
=head2 Source_Code::Procedure_Body
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( \<0, \Procedure_Body, \1::_Asset() ))
...
=head2 Source_Code::Signature
    ...
    ::MD::Source_Code::Signature::"" ::= selection
        union {Boolean, Function_Call_But_0, 2::Set, 2::Tuple}
        default (True);
...
=head2 Source_Code::Signature::Tuple
    ...
    ::MD::Source_Code::Signature::Tuple ::= selection of Tuple
        where (\<0 all_attr_assets \Signature::());

I<TODO.>

=head2 Source_Code::Heading

    ::MD::Source_Code::Heading ::= selection of Signature::Tuple
        where (\<0 all_attr_assets \True::());
...
=head2 Source_Code::Named_Expr_List
    ...
    ::MD::Source_Code::Named_Expr_List ::= selection of Tuple
        where (\<0 .!? \"" and \<0 all_attr_assets \Expression::());
...
=head2 Source_Code::Named_Stmt_List
    ...
    ::MD::Source_Code::Named_Stmt_List ::= selection of Tuple
        where (\<0 .!? \"" and \<0 all_attr_assets \Statement::());
...
=head2 Source_Code::Signature_to_Function_Call_But_0
    ...
    : (
        if Boolean \<0 then
            \<0 ?? \True::() !! \False::()
        else if Function_Call_But_0 \<0 then
            \<0
        else if Signature::Set(\<0) then
            (function : (\<1 any (function : (\<1 is_a \<0)) \<-- (1 : \<0)))
                \<-- (1 : \<0)
        else if Signature::Tuple(\<0) then
            (function : (
                if Tuple \<0 then
                    if \<0 =@ \<1 then
                        \<0 all_attrs
                            (function : (\<<asset is_a \<1.\<<name)) \<-- (:<1,)
                    else
                        False
                else
                    False
