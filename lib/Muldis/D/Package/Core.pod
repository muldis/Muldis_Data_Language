...
=head2 Discrete
    ...
    ::MD::Discrete ::= interface
        ...
        requires_implements {so,empty
            ...
            ,member_plus,except,intersect,union,exclusive
            ,nest,unnest,any,where,map,reduce,...
            ,to_Set,to_Bag,count,unique_count,order_by};
...
=head2 order_by
    ...
    ::MD::order_by::"" ::= function virtual
        --> Positional <-- (Discrete, Primed_Func_Ref);

The virtual function C<order_by> results in the C<Positional> value that
...
=head2 order_by (Array)
    ...
    ::MD::order_by::Array ::= function --> Array <-- (Array, Primed_Func_Ref)
        implements 2::""
        : (topic -->^ FDN__Array_order_by);

The function C<order_by::Array> results in the C<Array> value that
represents the same multiset of members as its C<0> argument but that the
members are arranged into a sequence in accordance with a total order
defined by the function given in its C<1> argument.  This function
implements the C<Discrete> virtual function C<order_by> for the composing
type C<Array>.
...
=head2 order_by (Set)
    ...
    ::MD::order_by::Set ::= function --> Array <-- (Set, Primed_Func_Ref)
        implements 2::""
        : (\Set wrap (\.0->unwrap order_by \.1));

The function C<order_by::Set> results in the C<Array> value that represents
...
C<Discrete> virtual function C<order_by> for the composing type C<Set>.
...
=head2 order_by (Bag)
    ...
    ::MD::order_by::Bag ::= function --> Array <-- (Bag, Primed_Func_Ref)
        implements 2::""
        : (topic -->^ FDN__Bag_order_by);

The function C<order_by::Bag> results in the C<Array> value that represents
the same multiset of members as its C<0> argument but that the members are
arranged into a sequence in accordance with a total order defined by the
function given in its C<1> argument.  This function implements the
C<Discrete> virtual function C<order_by> for the composing type C<Bag>.
