...
=head2 Excuse_or_else coalesce

        Excuse_or_else : (\Function : (
            returns : \@Any,
            matches : (\@Any, \@Any),
            is_associative : True,
            is_idempotent : True,
        ...
        coalesce : (\Alias : ( of : \@Excuse_or_else )),

The function C<Excuse_or_else> aka C<coalesce> results in its C<0>
...
Other programming languages may name their corresponding operators
I<??> or I<//> or I<?:>.
I<Note, this function's name is a placeholder and subject to change.>

=head2 Excuse_and_then

        Excuse_and_then : (\Function : (
            returns : \@Any,
            matches : (\@Any, \@Any),
            is_associative : True,
            is_idempotent : True,
...
The function C<Excuse_and_then> results in its C<0> argument iff the latter is an
...
=head2 Round_Meth
        ...
        Round_Meth::"" : (\Function : (
            is_type_definer : True,
            where : \(Capsule args:.\0 and_then guard args:.\0:< = \@material
                and_then folder::Attr_Name(args:.\0:>)),
...
=head2 Round_Meth::Attr_Name
        ...
        Round_Meth::Attr_Name : (\Function : (
            is_type_definer : True,
            where : \(Attr_Name args:.\0 and_then guard
...
consisting just of the C<Attr_Name> values that are valid Capsule assets of
C<Round_Meth> values.
...
=head2 Integral::NN
        ...
        Integral::NN : (\Function : (
            is_type_definer : True,
            where : \(Integral args:.\0 and_then guard
                args:.\0 >= zero::(args:.\0)),
        )),
...
=head2 Integral::P
        ...
        Integral::P : (\Function : (
            is_type_definer : True,
            where : \(Integral::NN::(args:.\0) and_then guard
                args:.\0 > zero::(args:.\0)),
...
=head2 Integer::NN
        ...
        Integer::NN : (\Function : (
            is_type_definer : True,
            where : \(Integer args:.\0 and_then guard args:.\0 >= 0),
        )),
...
=head2 Integer::P
        ...
        Integer::P : (\Function : (
            is_type_definer : True,
            where : \(Integer::NN::(args:.\0) and_then guard args:.\0 > 0),
            default : 1,
        )),
...
=head2 Fractional::NN
        ...
        Fractional::NN : (\Function : (
            is_type_definer : True,
            where : \(Fractional args:.\0 and_then guard
                args:.\0 >= zero::(args:.\0)),
        )),
...
=head2 Fraction::NN
        ...
        Fraction::NN : (\Function : (
            is_type_definer : True,
            where : \(Fraction args:.\0 and_then guard args:.\0 >= 0.0),
        )),
...
=head2 Bits
        ...
        Bits : (\Function : (
            ...
            where : \(Capsule args:.\0 and_then guard args:.\0:< = \Bits
                and_then String::Bits(args:.\0:>)),
            default : \~?'',
        )),
...
=head2 String::Bits
        ...
        String::Bits : (\Function : (
            is_type_definer : True,
            where : \(String args:.\0 and_then guard
                args:.\0 all \in::( 1: 0..1 )),
        )),
...
=head2 Blob
        ...
        Blob : (\Function : (
            is_type_definer : True,
            composes : {\@Stringy},
            where : \(Capsule args:.\0 and_then guard args:.\0:< = \Blob
                and_then String::Octets(args:.\0:>)),
            default : \~+'',
        )),
...
=head2 Text
        ...
        Text::"" : (\Function : (
            ...
            where : \(Capsule args:.\0 and_then guard args:.\0:< = \Text
                and_then String::Maximal_Chars(args:.\0:>)),
            default : '',
        )),
...
=head2 Text::Unicode
        ...
        Text::Unicode : (\Function : (
            is_type_definer : True,
            where : \(Text args:.\0 and_then guard
...
=head2 String::Unicode_Codes
        ...
        String::Unicode_Codes : (\Function : (
            is_type_definer : True,
            where : \(String::Maximal_Chars::(args:.\0) and_then guard
...
=head2 Text::ASCII
        ...
        Text::ASCII : (\Function : (
            is_type_definer : True,
            where : \(Text::Unicode::(args:.\0) and_then guard
...
=head2 String::ASCII_Chars
        ...
        String::ASCII_Chars : (\Function : (
            is_type_definer : True,
            where : \(String::Unicode_Codes::(args:.\0) and_then guard
...
error closest to the start of the Blob; that is, chained Excuse_and_then() is
...
=head2 String
        ...
        String::"" : (\Function : (
            is_type_definer : True,
            where : \(Array args:.\0 and_then guard args:.\0 all \Integer::()),
        )),
...
=head2 Set
        ...
        Set::"" : (\Function : (
            ...
            where : \(
                ...
                and_then guard Bag args:.\0:>
                and_then guard all_unique args:.\0:>
            ),
            default : {},
        )),
...
=head2 Tuple::D1
        ...
        Tuple::D1 : (\Function : (
            is_type_definer : True,
            where : \(Tuple args:.\0 and_then guard is_unary args:.\0),
            default : (False,),
        )),
...
=head2 Interval
        ...
        Interval::"" : (\Function : (
            ...
            where : \(Capsule args:.\0 and_then guard args:.\0:< = \Interval
                and_then Interval::Attrs(args:.\0:>)),
...
=head2 Interval::Attrs
        ...
        Interval::Attrs : (\Function : (
            is_type_definer : True,
            where : \(Tuple args:.\0 and_then guard ...),
        )),
...
=head2 Interval_Set
        ...
        Interval_Set : (\Function : (
            ...
            where : \(
                ...
                and_then guard Interval_Bag args:.\0:>
                and_then guard all_unique args:.\0:>
            ),
            default : ...,
        )),
...
=head2 Interval_Bag
        ...
        Interval_Bag : (\Function : (
            ...
            where : \(
                ...
                and_then guard Tuple_Bag args:.\0:>
                and_then guard ...
            ),
            default : ...,
        )),
...
=head2 Quantity
        ...
        Quantity : (\Function : (
            ...
            where : \(
                ...
                and_then guard Relation args:.\0:>
                and_then guard ...
            ),
            default : ...,
        )),
...
=head2 Source_Code::Package::Base_Name
        ...
        Source_Code::Package::Base_Name : (\Function : (
            is_type_definer : True,
            where : \(Attr_Name_List args:.\0 and_then guard
...
=head2 Source_Code::Package::Canon_Authority
        ...
        Source_Code::Package::Canon_Authority : (\Function : (
            is_type_definer : True,
            where : \(Text args:.\0 and_then guard so args:.\0),
        )),
...
=head2 Source_Code::Package::Floating
        ...
        Source_Code::Package::Floating : (\Function : (
            is_type_definer : True,
            where : \(Set args:.\0 and_then guard
...
=head2 Source_Code::Material
        ...
        Source_Code::Material : (\Function : (
            is_type_definer : True,
            union : {\@Alias, \@Function, \@Procedure},
            default : ...,
        )),
...
=head2 Source_Code::Alias
        ...
        Source_Code::Alias : (\Function : (
            is_type_definer : True,
            where : \(Capsule args:.\0 and_then guard args:.\0:< = \Alias
                and_then Identity_Identifier::(args:.\0:>)),
...
=head2 Source_Code::Function
        ...
        Source_Code::Function : (\Function : (
            ...
            where : \(
                ...
                and_then guard args:.\0:> is_a (
                    is_type_definer : \Boolean::(),
                    is_generalization : \Boolean::(),
                    composes : ...,  `set of 0..N type name`
                    provides_default_for : ...,  `subset 0..M of prior set`
                    value : \Function_Body::(),
                    where : \Function_Body::(),
                    ...
                    is_associative : \Boolean::(),  `two-way associative`
                    is_commutative : \Boolean::(),
                    is_idempotent : \Boolean::(),
                    identity : \Function_Body::(),  `iff two-sided identity element exists`
                    left_identity : \Function_Body::(),  `iff only left-identity element exists`
                    right_identity : \Function_Body::(),  `iff only right-identity element exists`
                    repeater : ...,
...
=head2 Source_Code::Signature::Set
        ...
        Source_Code::Signature::Set : (\Function : (
            is_type_definer : True,
            where : \(Set args:.\0 and_then guard
...
=head2 Source_Code::Signature::Tuple
        ...
        Source_Code::Signature::Tuple : (\Function : (
            is_type_definer : True,
            where : \(Tuple args:.\0 and_then guard
...
=head2 Source_Code::Attr_Name
        ...
        Source_Code::Attr_Name : (\Function : (
            is_type_definer : True,
            where : \(Heading args:.\0 and_then guard is_unary args:.\0),
        )),
...
=head2 Source_Code::Attr_Name_List
        ...
        Source_Code::Attr_Name_List : (\Function : (
            is_type_definer : True,
            where : \(Array args:.\0 and_then guard
...
=head2 Source_Code::Absolute_Name
        ...
        Source_Code::Absolute_Name : (\Function : (
            is_type_definer : True,
            where : \(Local_Name args:.\0 and_then guard
        ...
        Source_Code::Signature_to_Function_Call_But_0 : (\Function : (
            ...
            evaluates : \(
                if Function_Call_But_0 args:.\0 then
                    ...
                    \(
                        Tuple args:.\0 and_then guard
                            args:.\0 =@ args:.\1 and_then guard
                                args:.\0 all_attrs
