...
This document is Muldis::D::Package::Muldis_D version 0.201.0.-9.
...
C<Muldis_D:"http://muldis.com":"0.201.0.-9"> which provides the common core
...
C<Muldis_D::Aliases:"http://muldis.com":"0.201.0.-9"> which adds trans-ASCII
...
From one source:
    ...
    package
    {
        identity MD ::= Muldis_D:"http://muldis.com":"0.201.0.-9";
        foundation "http://muldis.com":"0.201.0.-9";
...
From a separate source:
    ...
    package
    {
        identity MDA ::= Muldis_D::Aliases:"http://muldis.com":"0.201.0.-9";
        foundation "http://muldis.com":"0.201.0.-9";
        uses MD ::= Muldis_D:"http://muldis.com":"0.201.0.-9";
        floating {::MD, ::MDA};
        ...
