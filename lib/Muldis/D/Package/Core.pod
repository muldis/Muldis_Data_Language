...
C<Fractional>, C<Fraction>, C<Bits>, C<Blob>, C<Text>, C<Positional>,
C<Array>, C<String>.
...
C<Numerical>, C<Integral>, C<Integer>, C<Fractional>, C<Fraction>, C<Bits>,
C<Blob>, C<Text>, C<Homogeneous>, C<Discrete>, C<Positional>, C<Array>,
C<String>, C<Setty>, C<Set>, C<Bag>, C<Relational>, C<Relation>,
