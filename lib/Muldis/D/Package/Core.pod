...
C<String>, C<Set>, C<Bag>, C<Relational>, C<Discrete_Relational>,
...
C<Discrete_Relational>, C<Tuple_Array>, C<Relation>, C<Tuple_Bag>,
C<Intervalish>, C<Interval>, C<Unionable_Intervalish>, C<Interval_Set>,
C<Interval_Bag>.

=head2 Excuse::No_Empty_Value

    ::MD::Excuse::No_Empty_Value ::= constant (\@0) composes Excuse;
...
Composed by: Positional (Array, String,...), Structural (Tuple), Dictionary, etc.>
...
C<Relational>, C<Discrete_Relational>, C<Tuple_Array>, C<Relation>,
...
C<Positional>, C<Array>, C<String>, C<Set>, C<Bag>, C<Relational>,
C<Discrete_Relational>, C<Tuple_Array>, C<Relation>, C<Tuple_Bag>,
C<Unionable_Intervalish>, C<Interval_Set>, C<Interval_Bag>.  A key type
that composes C<Homogeneous> but not C<Unionable> is C<Interval>; use
C<Interval_Set> instead for its C<Unionable> closest analogy.
...
=head2 where
    ...
    ::MD::where::"" ::= function virtual
        --> Unionable <-- (Unionable, Primed_Func_Ref);
...
C<Array>, C<String>, C<Set>, C<Bag>, C<Relational>, C<Discrete_Relational>,
...
=head2 order
    ...
    ::MD::order ::= function --> Positional <-- (Discrete)
        : (\.0 order_using (\@in_order assuming ()));
...
=head2 order_using
    ...
    ::MD::order_using::"" ::= function virtual
        --> Positional <-- (Discrete, Primed_Func_Ref);
...
=head2 Positional
    ...
    ::MD::Positional ::= interface
        ...
        requires_implements {in_order,so,empty
            ...
            ,to_Array,elem,has_index,first_possible_index,slice_n,index_succ_all_matches,...};
...
=head2 elem . (Positional)
    ...
    ::MD::elem::"" ::= function virtual --> Any <-- (Positional, Integer)
        requires (topic --> \@has_index);

    ::MD::"."::Positional ::= function --> Any <-- (Positional, Integer)
        implements 2::""
        requires (topic --> \@has_index)
        : (topic --> \@elem);
...
=head2 has_index .? (Positional)
    ...
    ::MD::has_index::"" ::= function virtual --> Boolean <-- (Positional, Integer);

    ::MD::".?"::Positional ::= function --> Boolean <-- (Positional, Integer)
        implements 2::""
        : (topic --> \@has_index);
...
=head2 elem_or_excuse .! (Positional)
    ...
    ::MD::elem_or_excuse ::= function --> Any <-- (Positional, Integer)
...
=head2 order_using (Array)
    ...
    ::MD::order_using::Array ::= function --> Array <-- (Array, Primed_Func_Ref)
        implements 2::""
        : (topic -->^ FDN__Array_order_using);
...
=head2 order_using (Set)
    ...
    ::MD::order_using::Set ::= function --> Array <-- (Set, Primed_Func_Ref)
        implements 2::""
...
=head2 order_using (Bag)
    ...
    ::MD::order_using::Bag ::= function --> Array <-- (Bag, Primed_Func_Ref)
        implements 2::""
        : (topic -->^ FDN__Bag_order_using);
...
C<Tuple>, C<Relational>, C<Discrete_Relational>, C<Tuple_Array>,
...
=head2 Structural
    ...
    ::MD::Structural ::= interface
        ...
        requires_implements {...,attr,has_attr_name,...};
...
=head2 attr . (Structural)

    ::MD::attr::"" ::= function virtual --> Any <-- (Structural, Attr_Name)
        requires (topic --> \@has_attr_name);

    ::MD::"."::Structural ::= function --> Any <-- (Structural, Attr_Name)
        implements 2::""
        requires (topic --> \@has_attr_name)
        : (topic --> \@attr);
...
=head2 has_attr_name .? (Structural)

    ::MD::has_attr_name::"" ::= function virtual --> Boolean <-- (Structural, Attr_Name);

    ::MD::".?"::Structural ::= function --> Boolean <-- (Structural, Attr_Name)
        implements 2::""
        : (topic --> \@has_attr_name);

I<TODO.>

=head2 attr_or_excuse .! (Structural)

    ::MD::attr_or_excuse ::= function --> Any <-- (Structural, Attr_Name)
...
=head2 attr (Tuple)
    ...
    ::MD::attr::Tuple ::= function --> Any <-- (Tuple, Attr_Name)
        implements 2::""
        requires (topic --> \@has_attr_name)
...
=head2 has_attr_name (Tuple)
    ...
    ::MD::has_attr_name::Tuple ::= function --> Boolean <-- (Tuple, Attr_Name)
        implements 2::""
...
=head1 DISCRETE RELATIONAL DATA TYPES

=head2 Discrete_Relational

    ::MD::Discrete_Relational ::= interface
        composes {Relational and_provides_its_default, Discrete}
        requires_implements {...};

I<TODO.  Add this to the various composed-by lists if we keep it.>
...
=head2 Tuple_Array
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( topic, \Tuple_Array, \@1::_Asset ))
            default (~%())
            composes {Discrete_Relational, Positional};

        _Asset ::= selection of Tuple where
        (
            if topic ^?= ( heading : \@Attr_Names, body : \@Array ) then
...
=head2 Relation
    ...
    ::MD::Relation ::= binder
    {
        "" ::= selection of Capsule
            ...
            default (?%())
            composes {Discrete_Relational and_provides_its_default, Setty};
...
=head2 Interval
    ...
    ::MD::Interval ::= selection of Capsule
        where (has_wrapped::( topic, \Interval, \@Tuple::Interval ))
        default (Neg_Inf()..Pos_Inf())
...
=head2 Interval_Set
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( topic, \Interval_Set, \@1::_Asset ))
            default (...)
...
=head2 Interval_Bag
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( topic, \Interval_Bag, \@1::_Asset ))
            default (...)
...
=head2 Quantity
    ...
    {
        "" ::= selection of Capsule
            where (has_wrapped::( topic, \Quantity, \@1::_Asset ))
            default (...)
