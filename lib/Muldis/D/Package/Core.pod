...
I<TODO.  Fetch item at existing location.>

=head2 .?

    ::MD::".?"::"" ::= function virtual --> Boolean <-- (Accessible, Any);

I<TODO.  Check if location exists.>

=head2 .!

    ::MD::".!"::"" ::= function virtual --> Any <-- (Accessible, Any);

I<TODO.  Fetch item at existing location if latter exists or else give an Excuse.>
...
=head2 Positional
    ...
    ::MD::Positional ::= interface
        ...
        requires_implements {in_order,to_Boolean,empty
            ...
            ,to_Array,elem,first_possible_index,slice_n,index_succ_all_matches,...};
...
=head2 has_index .? (Positional)
    ...
    ::MD::has_index ::= function --> Boolean <-- (Positional, Integer)
...
=head2 elem_or_excuse .! (Positional)
    ...
    ::MD::elem_or_excuse ::= function --> Any <-- (Positional, Integer)
        : (\<*args --> \has_index::() ?? \<*args --> \elem::() !! Excuse::No_Such_Index());
...
=head2 attr_or_excuse .! (Structural)
    ...
    ::MD::attr_or_excuse ::= function --> Any <-- (Structural, Attr_Name)
        : (\<*args --> \has_attr_name::() ?? \<*args --> \attr::() !! Excuse::No_Such_Attr_Name());
