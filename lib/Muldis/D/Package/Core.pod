...
=head2 is_a
    ...
    ::MD::is_a ::= function --> Boolean <-- (Any, Signature)
...
=head2 succ
    ...
    ::MD::succ ::= function --> {Successable, Pos_Inf} <-- (Successable)
        : (args.\0 nth_succ 1);
...
=head2 pred
    ...
    ::MD::pred ::= function --> {Bicessable, Neg_Inf} <-- (Bicessable)
        : (args.\0 nth_pred 1);
...
=head2 nth_pred (Boolean)
    ...
    ::MD::nth_pred::Boolean ::= function
        --> {False, Neg_Inf} <-- (Boolean, Integer_NN)
        implements 2::""
...
=head2 nth_succ (Boolean)
    ...
    ::MD::nth_succ::Boolean ::= function
        --> {True, Pos_Inf} <-- (Boolean, Integer_NN)
        implements 2::""
...
=head2 --
    ...
    ::MD::"--" ::= function --> {Integral, Neg_Inf} <-- (Integral)
        : (pred args.\0);
...
=head2 ++
    ...
    ::MD::"++" ::= function --> {Integral, Pos_Inf} <-- (Integral)
        : (succ args.\0);
...
=head2 nth_pred (Integer)
    ...
    ::MD::nth_pred::Integer ::= function --> Integer <-- (Integer, Integer_NN)
...
=head2 nth_succ (Integer)
    ...
    ::MD::nth_succ::Integer ::= function --> Integer <-- (Integer, Integer_NN)
        implements 2::Integral
...
=head2 fractional_divided_by (Integer)
    ...
    : (
        ...
        return if d = 0 then Excuse::Div_By_Zero() else q;
...
=head2 integral_divided_by (Integer)
    ...
    : (
        ...
        return if divisor = 0 then Excuse::Div_By_Zero() else e1;
        ...
        e2 ::= (
            ...
            return rtz_remainder = 0 :? rtz_quotient :! e3;
        );
    ...
    : (
        <-- (args.\0->denominator) = (args.\1->denominator)
         ...
         :!
          (
            common_d ::= lcm::(args.\0->denominator, args.\1->denominator);
            return ((args.\0->numerator) * div::(common_d, args.\0->denominator, To_Zero::()))
                + ((args.\1->numerator) * div::(common_d, args.\1->denominator, To_Zero::()))
                / common_d;
          )
    );
...
=head2 integral_divided_by (Fraction)
    ...
    : (
        ...
        return if args.\1 = 0.0 then Excuse::Div_By_Zero()
...
=head2 Text_from_ASCII_Blob
    ...
    : (
        ...
        return if String::ASCII_Chars(octets)
...
=head2 Text_from_ASCII_Blob_with_repl_Text
    ...
    : (
        ...
        return result_chars->Text_from_ASCII_Chars;
    );
...
=head2 all for_all ∀
    ...
    ::MD::all ::= function --> Boolean <-- (Homogeneous, Signature)
        : (args.\0 none \not_is_a::( 1: args.\1 ));
...
=head2 replace_at (Positional)
    ...
    : (
        ...
        li ::= last_index src;
        emp ::= empty src;
        return (if ri > fi then slice_range::(src, fi, --ri) else emp)
            insert repl_member
...
=head2 shiftless_insert_at (Positional)
    ...
    ::MD::shiftless_insert_at::Positional ::= function
        --> Positional <-- (Positional, (Integer, Any))
        implements 2::""
        requires (args.\1.\0 = first_unused_index::(args.\0))
...
=head2 shiftless_remove_at (Positional)
    ...
    ::MD::shiftless_remove_at::Positional ::= function
        ...
        implements 2::""
        requires (args.\1 >= first_possible_index::(args.\0)
            and args.\1 = --first_unused_index::(args.\0))
        : (nonlast args.\0);
...
=head2 slice_range
    ...
    ::MD::slice_range ::= function
        ...
        requires (?(args.\0) and args.\1 >= first_possible_index::(args.\0)
...
=head2 any (Array)
    ...
    ::MD::any::Array ::= function --> Boolean <-- (Array, Signature)
        implements 2::""
...
=head2 where (Array)
    ...
    ::MD::where::Array ::= function --> Array <-- (Array, Signature)
        implements 2::""
        : ((args.\0, Signature_to_Function_Call_But_0::(args.\1))
            -->^ FDN__Array_where);
...
=head2 any (Set)
    ...
    ::MD::any::Set ::= function --> Boolean <-- (Set, Signature)
        implements 2::""
...
=head2 where (Set)
    ...
    ::MD::where::Set ::= function --> Set <-- (Set, Signature)
        implements 2::""
...
=head2 any (Bag)
    ...
    ::MD::any::Bag ::= function --> Boolean <-- (Bag, Signature)
        implements 2::""
...
=head2 where (Bag)
    ...
    ::MD::where::Bag ::= function --> Bag <-- (Bag, Signature)
        implements 2::""
...
=head2 extend %+
    ...
    ::MD::extend::"" ::= function virtual
        --> Attributive <-- (Attributive, Structural)
        requires (args.\0 disjoint_heading args.\1);
...
=head2 any_attrs
    ...
    ::MD::any_attrs ::= function --> Boolean <-- (Tuple, Signature)
        : ((args.\0, Signature_to_Function_Call_But_0::(args.\1))
...
=head2 all_attrs
    ...
    ::MD::all_attrs ::= function --> Boolean <-- (Tuple, Signature)
...
=head2 all_attr_assets
    ...
    ::MD::all_attr_assets ::= function --> Boolean <-- (Tuple, Signature)
...
=head2 attrs_where
    ...
    ::MD::attrs_where ::= function --> Tuple <-- (Tuple, Signature)
        : ((args.\0, Signature_to_Function_Call_But_0::(args.\1))
...
=head2 to_Boolean (Relational)
    ...
    ::MD::to_Boolean::Relational ::= function --> Boolean <-- (Relational)
        implements 2::""
        : (? |(args.\0));
...
=head2 empty (Relational)
    ...
    ::MD::empty::Relational ::= function --> Relational <-- (Relational)
        implements 2::""
...
=head2 singular (Relational)
    ...
    ::MD::singular::Relational ::= function --> Boolean <-- (Relational)
        implements 2::""
        : (singular |(args.\0));
...
=head2 only_member (Relational)
    ...
    ::MD::only_member::Relational ::= function --> Structural <-- (Relational)
        implements 2::""
        requires (singular args.\0)
        : (only_member |(args.\0));
...
=head2 has_n (Relational)
    ...
    ::MD::has_n::Relational ::= function
        --> {Boolean, Excuse::Not_Same_Heading}
        <-- (Relational, Structural, Integer_NN)
        implements 2::""
...
=head2 multiplicity (Relational)
    ...
    ::MD::multiplicity::Relational ::= function
        --> Integer_NN <-- (Relational, Structural)
        implements 2::""
...
=head2 all_unique (Relational)
    ...
    ::MD::all_unique::Relational ::= function --> Boolean <-- (Relational)
        implements 2::""
        : (all_unique |(args.\0));
...
=head2 unique (Relational)
    ...
    ::MD::unique::Relational ::= function --> Relational <-- (Relational)
        implements 2::""
...
=head2 subset_of (Relational)
    ...
    ::MD::subset_of::Relational ::= function
        --> {Boolean, Excuse::Not_Same_Heading} <-- (Relational, Relational)
        implements 2::""
...
=head2 insert_n (Relational)
    ...
    ::MD::insert_n::Relational ::= function
        --> {Relational, Excuse::Not_Same_Heading}
        <-- (Relational, Structural, Integer_NN)
        implements 2::""
...
=head2 member_plus (Relational)
    ...
    ::MD::member_plus::Relational ::= function
        --> {Relational, Excuse::Not_Same_Heading} <-- (Relational, Relational)
        implements 2::""
        is associative
        : (if args.\0 =@ (args.\1) then select_Relational::
...
=head2 nest (Relational)
    ...
    ::MD::nest::Relational ::= function --> Relational <-- (Relational)
        implements 2::""
        requires (...)
        : (...);
...
=head2 unnest (Relational)
    ...
    ::MD::unnest::Relational ::= function --> Relational <-- (Relational)
        implements 2::""
        requires (...)
        : (...);
...
=head2 map (Relational)
    ...
    ::MD::map::Relational ::= function
        --> Relational <-- (Relational, Function_Call_But_0)
        implements 2::""
        : (...);
...
=head2 reduce (Relational)
    ...
    ::MD::reduce::Relational ::= function
        --> Any <-- (Relational, Function_Call_But_0_1)
        implements 2::""
...
=head2 has_any_attrs (Relational)
    ...
    ::MD::has_any_attrs::Relational ::= function --> Boolean <-- (Relational)
        implements 2::""
        : (@(args.\0) != ());
...
=head2 nullary (Relational)
    ...
    ::MD::nullary::Relational ::= function --> Relational <-- (Relational)
        implements 2::""
        : (args.\0 on ());
...
=head2 is_unary (Relational)
    ...
    ::MD::is_unary::Relational ::= function --> Boolean <-- (Relational)
        implements 2::""
        : (is_unary @(args.\0));
...
=head2 degree (Relational)
    ...
    ::MD::degree::Relational ::= function --> Integer_NN <-- (Relational)
        implements 2::""
        : (degree @(args.\0));
...
=head2 rename (Relational)
    ...
    ::MD::rename::Relational ::= function
        --> Relational <-- (Relational, Renaming)
        implements 2::""
        requires (...)
...
=head2 update (Relational)
    ...
    ::MD::update::Relational ::= function
        --> Relational <-- (Relational, Structural)
        implements 2::""
        requires (args.\0 @? (args.\1))
...
=head2 body |
    ...
    ::MD::body::"" ::= function virtual --> Unionable <-- (Relational);
...
=head2 select_Relational
    ...
    ::MD::select_Relational::"" ::= function virtual
        --> {Relational, Excuse::...}
        <-- (like : Relational, heading : Heading, body : Unionable);
...
=head2 heading (Tuple_Array)
    ...
    ::MD::heading::Tuple_Array ::= function --> Heading <-- (Tuple_Array)
        implements 2::""
...
=head2 body (Tuple_Array)
    ...
    ::MD::body::Tuple_Array ::= function --> Array <-- (Tuple_Array)
        implements 2::""
        : (unwrap::(args.\0).\body);
...
=head2 select_Relational (Tuple_Array)
    ...
    ::MD::select_Relational::Tuple_Array ::= function
        --> {Relational, Excuse::...}
        <-- (like : Tuple_Array, heading : Heading, body : Array)
        implements 2::""
...
=head2 heading (Relation)
    ...
    ::MD::heading::Relation ::= function --> Heading <-- (Relation)
        implements 2::""
        : (unwrap::(args.\0).\heading);
...
=head2 body (Relation)
    ...
    ::MD::body::Relation ::= function --> Set <-- (Relation)
        implements 2::""
        : (unwrap::(args.\0).\body);
...
=head2 select_Relational (Relation)
    ...
    ::MD::select_Relational::Relation ::= function
        --> {Relational, Excuse::...}
        <-- (like : Relation, heading : Heading, body : Set)
        implements 2::""
...
=head2 heading (Tuple_Bag)
    ...
    ::MD::heading::Tuple_Bag ::= function --> Heading <-- (Tuple_Bag)
        implements 2::""
        : (unwrap::(args.\0).\heading);
...
=head2 body (Tuple_Bag)
    ...
    ::MD::body::Tuple_Bag ::= function --> Bag <-- (Tuple_Bag)
        implements 2::""
        : (unwrap::(args.\0).\body);
...
=head2 select_Relational (Tuple_Bag)
    ...
    ::MD::select_Relational::Tuple_Bag ::= function
        --> {Relational, Excuse::...}
        <-- (like : Tuple_Bag, heading : Heading, body : Bag)
        implements 2::""
...
=head2 Source_Code::Package_List
    ...
    ::MD::Source_Code::Package_List ::= selection of Array
        where (args.\0 all {\Package::(), \Decoration::()});
...
=head2 Source_Code::Package
    ...
    ::MD::Source_Code::Package ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Package, \1::_Asset() ))
        ...
        _Traits ::= selection of Tuple where
        (
            if
                args.\0 is_a (
...
=head2 Source_Code::Binder

    ::MD::Source_Code::Binder ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Binder, \1::_Asset() ))
            default (\Binder wrap 1::_Asset());

        _Asset ::= selection of Tuple where
        (
            args.\0 is_a (
                materials : \1::_Materials::(),
                annotation : \Any::(),
                decoration : \Any::(),
            )
        );

        _Materials ::= selection of Tuple
...
=head2 Source_Code::Constant
    ...
    ::MD::Source_Code::Constant ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Constant, \1::_Asset() ))
            default (\Constant wrap 1::_Asset());
...
=head2 Source_Code::Selection
    ...
    ::MD::Source_Code::Selection ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Selection, \1::_Asset() ))
            default (\Selection wrap 1::_Asset());
...
=head2 Source_Code::Interface
    ...
    ::MD::Source_Code::Interface ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Interface, \1::_Asset() ))
            default (\Interface wrap 1::_Asset());
...
=head2 Source_Code::Function
    ...
    ::MD::Source_Code::Function ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Function, \1::_Asset() ))
            default (\Function wrap 1::_Asset());
        ...
        (
            args.\0 is_a (
                ...
                returns : \Signature::(),  `Aka "-->" or "to".`
                matches : \Signature::Tuple(),  `Aka "<--" or "from" or "signature".`
                implements : ...,
                overrides : ...,
                accepts : \Function_Body::(),  `Aka "requires".`
...
=head2 Source_Code::Function_Body
    ...
    ::MD::Source_Code::Function_Body ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Function_Body, \1::_Asset() ))
            default (\Function_Body wrap 1::_Asset());
...
=head2 Source_Code::Procedure
    ...
    ::MD::Source_Code::Procedure ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Procedure, \1::_Asset() ))
            default (\Procedure wrap 1::_Asset());
        ...
        (
            args.\0 is_a (
                virtual : \Boolean::(),
                matches : \Signature::Tuple(),  `Aka "<-->" or "signature".`
...
=head2 Source_Code::Procedure_Body
    ...
    ::MD::Source_Code::Procedure_Body ::= binder
    {
        "" ::= selection of Capsule
            where (has_wrapped::( args.\0, \Procedure_Body, \1::_Asset() ))
            default (\Procedure_Body wrap 1::_Asset());
