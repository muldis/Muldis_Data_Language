...
=head2 Excuse::Before_All_Others
        ...
        Excuse::Before_All_Others : (\Function : (
            is_type_definer : True, composes : {\@Excuse, \@Orderable}, value : \@material )),
...
=head2 False ⊥
        ...
        False : (\Function : (
            is_type_definer : True, value : False )),
...
=head2 True ⊤
        ...
        True : (\Function : (
            is_type_definer : True, value : True )),
...
=head2 Excuse::Div_By_Zero
        ...
        Excuse::Div_By_Zero : (\Function : (
            is_type_definer : True, composes : {\@Excuse}, value : \@material )),
...
=head2 Set
        ...
        Set::"" : (\Function : (
            ...
            where : \(Capsule_subtype::( args:.\0, \Set,
                \(Bag args:.\0 and_then guard all_unique args:.\0) )),
            default : {},
        )),
...
=head2 Bag::Empty +∅
        ...
        Bag::Empty : (\Function : (
            is_type_definer : True, value : {0:0} )),
...
=head2 Tuple_Array
        ...
        Tuple_Array::"" : (\Function : (
            ...
            where : \(Capsule_subtype::( args:.\0, \Tuple_Array, \(
                args:.\0 is_a ( heading : \Heading::(), body : \Array::() ) and_then guard
                    args:.\0.\body all \Tuple::() and_then guard
...
=head2 Relation
        ...
        Relation::"" : (\Function : (
            ...
            where : \(Capsule_subtype::( args:.\0, \Relation, \(
                args:.\0 is_a ( heading : \Heading::(), body : \Set::() ) and_then guard
                    args:.\0.\body all \Tuple::() and_then guard
                        args:.\0.\body all \(@args:.\0 = args:.\1) \<-- (args:.\0.\heading)
            ) )),
            default : \(?%@()),
...
=head2 Tuple_Bag
        ...
        Tuple_Bag::"" : (\Function : (
            ...
            where : \(Capsule_subtype::( args:.\0, \Tuple_Bag, \(
                args:.\0 is_a ( heading : \Heading::(), body : \Bag::() ) and_then guard
                    args:.\0.\body all \Tuple::() and_then guard
                        args:.\0.\body all \(@args:.\0 = args:.\1) \<-- (args:.\0.\heading)
            ) )),
            default : \(+%@()),
...
=head2 Interval_Set
        ...
        Interval_Set : (\Function : (
            ...
            where : \(Capsule_subtype::( args:.\0, \Interval_Set,
                \(Interval_Bag args:.\0 and_then guard all_unique args:.\0) )),
            default : ...,
        )),
...
=head2 Interval_Bag
        ...
        Interval_Bag : (\Function : (
            ...
            where : \(Capsule_subtype::( args:.\0, \Interval_Bag, \(
                Tuple_Bag args:.\0 and_then guard ...
            ) )),
            default : ...,
        )),
...
=head2 Quantity
        ...
        Quantity : (\Function : (
            ...
            where : \(Capsule_subtype::( args:.\0, \Quantity, \(
                Relation args:.\0 and_then guard ...
            ) )),
            default : ...,
        )),
...
=head2 Capsule_subtype
        ...
        Capsule_subtype : (\Function : (
            ...
            evaluates : \(
                Capsule args:.\0 and_then guard
                    args:.\0:< = args:.\1 and_then
