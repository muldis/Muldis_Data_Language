...
The semantic contract C<Excuse> is semifinite.  An C<Excuse> value is an
...
=head2 or_else coalesce
        ...
        or_else : (\Function : (
            ...
            is_associative : True,
            is_idempotent : True,
            map : \(if Excuse args.\0 then args.\1 else args.\0),
        )),
...
=head2 and_then
        ...
        and_then : (\Function : (
            ...
            is_associative : True,
            is_idempotent : True,
            map : \(if Excuse args.\0 then args.\0 else args.\1),
        )),
...
The interface contract C<Orderable> is semifinite.  An C<Orderable> value has
...
members a type for which an C<Orderable>-composing contract exists.  The
...
as identity values for chained order-comparisons.
...
The constant C<Excuse::Before_All_Others> represents a type-agnostic
...
The constant C<Excuse::After_All_Others> represents a type-agnostic
...
=head2 min
        ...
        min : (\Function : (
            ...
            map : \(if args.\0 in_order args.\1 then args.\0 else args.\1),
        )),
...
=head2 max
        ...
        max : (\Function : (
            ...
            map : \(if args.\0 in_order args.\1 then args.\1 else args.\0),
        )),
...
=head2 minmax
        ...
        minmax : (\Function : (
            ...
            matches : (\@Orderable, \@Orderable),
            is_commutative : True,
            map : \(if args.\0 in_order args.\1 then args else (args.\1, args.\0)),
        )),
...
The interface contract C<Successable> is semifinite.  A C<Successable> value
...
The interface contract C<Bicessable> is semifinite.  A C<Bicessable> value
...
The interface contract C<Boolable> is semifinite.  A C<Boolable> value has a
...
The selection contract C<Boolean> represents the finite Muldis
...
=head2 nth_pred (Boolean)
        ...
        nth_pred::Boolean : (\Function : (
            ...
            implements : \@folder::"",
            map : \(if args.\1 = 0 then args.\0 else if args.\1 = 1 and args.\0 then False else Excuse::Before_All_Others()),
        )),
...
=head2 nth_succ (Boolean)
        ...
        nth_succ::Boolean : (\Function : (
            ...
            matches : (\@Boolean, \@Integer::NN),
            implements : \@folder::"",
            map : \(if args.\1 = 0 then args.\0 else if args.\1 = 1 and !(args.\0) then True else Excuse::After_All_Others()),
        )),
...
=head2 and ∧
        ...
        and : (\Function : (
            ...
            is_idempotent : True,
            identity : True,
            map : \(if args.\0 then args.\1 else False),
        )),
...
=head2 or ∨
        ...
        or : (\Function : (
            ...
            is_idempotent : True,
            identity : False,
            map : \(if args.\0 then True else args.\1),
        )),
...
=head2 imp implies →
        ...
        imp : (\Function : (
            returns : \@Boolean,
            matches : (\@Boolean, \@Boolean),
            map : \(if args.\0 then args.\1 else True),
        )),
...
The interface contract C<Numerical> is semifinite.  A C<Numerical> value
...
=head2 - −
        ...
        "-" : (\Function : (
            ...
            map : \(args --> (if degree::(args) = 1 then \opposite::() else \minus::())),
        )),
...
The interface contract C<Integral> is semifinite.  An C<Integral> value
...
The selection contract C<Integral::NN> represents the infinite type
...
The selection contract C<Integral::P> represents the infinite type
...
=head2 gcd greatest_common_divisor
        ...
        gcd : (\Function : (
            ...
            is_commutative : True,
            is_idempotent : True,
            map : \((if is_zero args.\1 then args.\0 else guard material::(args.\1, mod::(args.\0, args.\1, To_Zero::())))
...
=head2 lcm least_common_multiple
        ...
        lcm : (\Function : (
            ...
            map : \(if is_zero args.\0 or is_zero args.\1 then zero args.\0
                else guard div::(args.\0 * (args.\1), args.\0 gcd args.\1, To_Zero::())),
        )),
...
The selection contract C<Integer::NN> represents the infinite type
...
The selection contract C<Integer::P> represents the infinite type consisting
...
=head2 in_order (Integer)
        ...
        in_order::Integer : (\Function : (
            ...
            implements : \@folder::"",
            map : \(args --> \foundation::Integer_in_order::()),
        )),
...
=head2 opposite (Integer)
        ...
        opposite::Integer : (\Function : (
            ...
            matches : (\@Integer),
            implements : \@folder::"",
            map : \(args --> \foundation::Integer_opposite::()),
        )),
...
=head2 modulus (Integer)
        ...
        modulus::Integer : (\Function : (
            ...
            matches : (\@Integer),
            implements : \@folder::"",
            map : \(args --> \foundation::Integer_modulus::()),
        )),
...
=head2 plus (Integer)
        ...
        plus::Integer : (\Function : (
            ...
            map : \(args --> \foundation::Integer_plus::()),
        )),
...
=head2 minus (Integer)
        ...
        minus::Integer : (\Function : (
            ...
            matches : (\@Integer, \@Integer),
            implements : \@folder::"",
            map : \(args --> \foundation::Integer_minus::()),
        )),
...
=head2 times (Integer)
        ...
        times::Integer : (\Function : (
            ...
            map : \(args --> \foundation::Integer_times::()),
        )),
...
=head2 fractional_divided_by (Integer)
        ...
        fractional_divided_by::Integer : (\Function : (
            ...
            map : \(
                ...
                q ::= \Fraction >:< (
                    numerator   : div::((if d > 0 then n else -n), gcd, To_Zero::()),
                    denominator : div::((if d > 0 then d else -d), gcd, To_Zero::()),
                );
            ...
            map : \(
                ...
                e3 ::= (
                    ...
                    returns given round_meth
                        when Down::()    then rdn_quotient
                        when Up::()      then rup_quotient
                        when To_Zero::() then rtz_quotient
                        when To_Inf::()  then rti_quotient
                        default
                ...
                e4 ::= (
                    ...
                    returns given round_meth
                        when Half_Down::()    then rdn_quotient
                        when Half_Up::()      then rup_quotient
                        when Half_To_Zero::() then rtz_quotient
                        when Half_To_Inf::()  then rti_quotient
                        when Half_Even::()    then
...
=head2 factorial (Integer)
        ...
        factorial::Integer : (\Function : (
            ...
            matches : (\@Integer::NN),
            implements : \@folder::"",
            map : \(args --> \foundation::Integer_factorial::()),
        )),
...
The interface contract C<Fractional> is semifinite.  A C<Fractional> value
...
The selection contract C<Fractional::NN> represents the infinite type
...
The selection contract C<Fraction::NN> represents the infinite type
...
The interface contract C<Emptyable> is semifinite.  An C<Emptyable> value is
...
The interface contract C<Stringy> is semifinite.  A C<Stringy> value is a
...
The interface contract C<Textual> is semifinite.  A C<Textual> value is a
...
The interface contract C<Accessible> is semifinite.  An C<Accessible> value
...
The interface contract C<Homogeneous> is semifinite.  A C<Homogeneous> value
...
The interface contract C<Unionable> is semifinite.  A C<Unionable> value is a
...
any C<Unionable> type, even a C<Positional> one.  This operation has an
...
The interface contract C<Discrete> is semifinite.  A C<Discrete> value is a
...
The interface contract C<Positional> is semifinite.  A C<Positional> value is
...
The constant C<Excuse::No_Such_Ord_Pos> represents the I<undefined> result of
...
=head2 has_any_at (Positional)
        ...
        has_any_at::Positional : (\Function : (
            ...
            implements : \@folder::"",
            map : \(args.\1 >= first_possible_ord_pos::(args.\0)
...
=head2 has_mapping_at (Positional)
        ...
        has_mapping_at::Positional : (\Function : (
            ...
            implements : \@folder::"",
            map : \(if args.\0 .? (args.\1.\0) then guard args.\0.(args.\1.\0) = (args.\1.\1) else False),
        )),
...
=head2 maybe_at (Positional)
        ...
        maybe_at::Positional : (\Function : (
            ...
            matches : (\@Positional, \@Integer),
            implements : \@folder::"",
            map : \(if args.\0 .? (args.\1) then guard args.\0.(args.\1) else Excuse::No_Such_Ord_Pos()),
        )),
...
=head2 replace_or_insert_at (Positional)
        ...
        replace_or_insert_at::Positional : (\Function : (
            ...
            accepts : \(args.\1 >= first_possible_ord_pos::(args.\0)
                and args.\1 <= first_unused_ord_pos::(args.\0)),
            map : \(if args.\0 .? (args.\1.\0) then guard args.\0 .:= (args.\1.\0) else guard args.\0 .+ (args.\1.\0)),
        )),
...
=head2 shiftless_maybe_remove_at (Positional)
        ...
        shiftless_maybe_remove_at::Positional : (\Function : (
            ...
            accepts : \(args.\1 >= first_possible_ord_pos::(args.\0)
                and args.\1 >= --first_unused_ord_pos::(args.\0)),
            map : \(if args.\1 = --first_unused_ord_pos::(args.\0) then guard nonlast args.\0 else args.\0),
        )),
...
=head2 first_unused_ord_pos
        ...
        first_unused_ord_pos : (\Function : (
            returns : \@Integer,
            matches : (\@Positional),
            map : \(first_possible_ord_pos::(args.\0) + #(args.\0)),
        )),
...
=head2 first_ord_pos
        ...
        first_ord_pos : (\Function : (
            ...
            matches : (\@Positional),
            accepts : \(so args.\0),
            map : \(first_possible_ord_pos::(args.\0)),
        )),
...
=head2 last_ord_pos
        ...
        last_ord_pos : (\Function : (
            ...
            matches : (\@Positional),
            accepts : \(so args.\0),
            map : \(--first_unused_ord_pos::(args.\0)),
        )),
...
=head2 first
        ...
        first : (\Function : (
            ...
            matches : (\@Positional),
            accepts : \(so args.\0),
            map : \(args.\0 . first_ord_pos::(args.\0)),
        )),
...
=head2 nonfirst
        ...
        nonfirst : (\Function : (
            ...
            matches : (\@Positional),
            accepts : \(so args.\0),
            map : \(slice_range::(args.\0, ++first_ord_pos::(args.\0), last_ord_pos::(args.\0))),
        )),
...
=head2 last
        ...
        last : (\Function : (
            ...
            matches : (\@Positional),
            accepts : \(so args.\0),
            map : \(args.\0 . last_ord_pos::(args.\0)),
        )),
...
The constant C<Array::Empty> aka C<~∅> represents the only zero-member
C<Array> value, C<[]>.
...
=head2 substring_of (Array)
        ...
        substring_of::Array : (\Function : (
            ...
            matches : (\@Array, \@Array),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_substring_of::()),
        )),
...
=head2 overlaps_string (Array)
        ...
        overlaps_string::Array : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(args --> \foundation::Array_overlaps_string::()),
        )),
...
=head2 disjoint_string (Array)
        ...
        disjoint_string::Array : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(args --> \foundation::Array_disjoint_string::()),
        )),
...
=head2 catenate (Array)
        ...
        catenate::Array : (\Function : (
            ...
            map : \(args --> \foundation::Array_catenate::()),
        )),
...
=head2 replicate (Array)
        ...
        replicate::Array : (\Function : (
            ...
            implements : \@folder::"",
            map : \(args --> \foundation::Array_replicate::()),
        )),
...
=head2 has_n (Array)
        ...
        has_n::Array : (\Function : (
            ...
            implements : \@folder::"",
            map : \(args --> \foundation::Array_has_n::()),
        )),
...
=head2 multiplicity (Array)
        ...
        multiplicity::Array : (\Function : (
            ...
            matches : (\@Array, \@Any),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_multiplicity::()),
        )),
...
=head2 all_unique (Array)
        ...
        all_unique::Array : (\Function : (
            ...
            matches : (\@Array),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_all_unique::()),
        )),
...
=head2 unique (Array)
        ...
        unique::Array : (\Function : (
            ...
            matches : (\@Array),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_unique::()),
        )),
...
=head2 any (Array)
        ...
        any::Array : (\Function : (
            ...
            implements : \@folder::"",
            map : \((args.\0, Signature_to_Function_Call_But_0::(args.\1)) --> \foundation::Array_any::()),
        )),
...
=head2 insert_n (Array)
        ...
        insert_n::Array : (\Function : (
            ...
            matches : (\@Array, \@Any, \@Integer::NN),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_insert_n::()),
        )),
...
=head2 remove_n (Array)
        ...
        remove_n::Array : (\Function : (
            ...
            matches : (\@Array, \@Any, \@Integer::NN),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_remove_n::()),
        )),
...
=head2 except (Array)
            ...
            matches : (\@Array, \@Array),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_except::()),
        )),
...
=head2 intersect (Array)
        ...
        intersect::Array : (\Function : (
            ...
            is_associative : True,
            is_idempotent : True,
            map : \(args --> \foundation::Array_intersect::()),
        )),
...
=head2 union (Array)
        ...
        union::Array : (\Function : (
            ...
            is_idempotent : True,
            identity : [],
            map : \(args --> \foundation::Array_union::()),
        )),
...
=head2 exclusive (Array)
        ...
        exclusive::Array : (\Function : (
            ...
            implements : \@folder::"",
            identity : [],
            map : \(args --> \foundation::Array_exclusive::()),
        )),
...
=head2 nest (Array)
        ...
        nest::Array : (\Function : (
            ...
            implements : \@folder::"",
            accepts : \(...),
            map : \(args --> \foundation::Array_nest::()),
        )),
...
=head2 unnest (Array)
        ...
        unnest::Array : (\Function : (
            ...
            implements : \@folder::"",
            accepts : \(...),
            map : \(args --> \foundation::Array_unnest::()),
        )),
...
=head2 reduce (Array)
        ...
        reduce::Array : (\Function : (
            ...
            implements : \@folder::"",
            map : \(args --> \foundation::Array_reduce::()),
        )),
...
=head2 to_Bag (Array)
        ...
        to_Bag::Array : (\Function : (
            ...
            matches : (\@Array),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_to_Bag::()),
        )),
...
=head2 count (Array)
        ...
        count::Array : (\Function : (
            ...
            matches : (\@Array),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_count::()),
        )),
...
=head2 order_using (Array)
        ...
        order_using::Array : (\Function : (
            ...
            matches : (\@Array, \@Function_Call_But_0_1),
            implements : \@folder::"",
            map : \(args --> \foundation::Array_order_using::()),
        )),
...
=head2 slice_n (Array)
        ...
        slice_n::Array : (\Function : (
            ...
            map : \(args --> \foundation::Array_slice_n::()),
        )),
...
=head2 ord_pos_succ_all_matches (Array)
        ...
        ord_pos_succ_all_matches::Array : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(args --> \foundation::Array_ord_pos_succ_all_matches::()),
        )),
...
The semantic contract C<Setty> is semifinite.  A C<Setty> value is a
...
The constant C<Set::Empty> aka C<?∅> represents the only zero-member
C<Set> value, C<{}>.
...
=head2 insert_n (Set)
        ...
        insert_n::Set : (\Function : (
            ...
            matches : (\@Set, \@Any, \@Integer::NN),
            implements : \@folder::"",
            map : \(if args.\0 has args.\1 or args.\2 = 0 then args.\0
...
The constant C<Bag::Empty> aka C<+∅> represents the only zero-member
C<Bag> value, C<{0:0}>.
...
=head2 singular (Bag)
        ...
        singular::Bag : (\Function : (
            ...
            matches : (\@Bag),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_singular::()),
        )),
...
=head2 only_member (Bag)
        ...
        only_member::Bag : (\Function : (
            ...
            implements : \@folder::"",
            accepts : \(singular args.\0),
            map : \(args --> \foundation::Bag_only_member::()),
        )),
...
=head2 multiplicity (Bag)
        ...
        multiplicity::Bag : (\Function : (
            ...
            matches : (\@Bag, \@Any),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_multiplicity::()),
        )),
...
=head2 all_unique (Bag)
        ...
        all_unique::Bag : (\Function : (
            ...
            matches : (\@Bag),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_all_unique::()),
        )),
...
=head2 unique (Bag)
        ...
        unique::Bag : (\Function : (
            ...
            matches : (\@Bag),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_unique::()),
        )),
...
=head2 subset_of (Bag)
        ...
        subset_of::Bag : (\Function : (
            ...
            matches : (\@Bag, \@Bag),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_subset_of::()),
        )),
...
=head2 overlaps_members (Bag)
        ...
        overlaps_members::Bag : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(args --> \foundation::Bag_overlaps_members::()),
        )),
...
=head2 disjoint_members (Bag)
        ...
        disjoint_members::Bag : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(args --> \foundation::Bag_disjoint_members::()),
        )),
...
=head2 any (Bag)
        ...
        any::Bag : (\Function : (
            ...
            implements : \@folder::"",
            map : \((args.\0, Signature_to_Function_Call_But_0::(args.\1)) --> \foundation::Bag_any::()),
        )),
...
=head2 insert_n (Bag)
        ...
        insert_n::Bag : (\Function : (
            ...
            matches : (\@Bag, \@Any, \@Integer::NN),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_insert_n::()),
        )),
...
=head2 remove_n (Bag)
        ...
        remove_n::Bag : (\Function : (
            ...
            matches : (\@Bag, \@Any, \@Integer::NN),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_remove_n::()),
        )),
...
=head2 member_plus (Bag)
        ...
        member_plus::Bag : (\Function : (
            ...
            is_commutative : True,
            identity : {0:0},
            map : \(args --> \foundation::Bag_member_plus::()),
        )),
...
=head2 except (Bag)
            ...
            matches : (\@Bag, \@Bag),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_except::()),
        )),
...
=head2 intersect (Bag)
        ...
        intersect::Bag : (\Function : (
            ...
            is_commutative : True,
            is_idempotent : True,
            map : \(args --> \foundation::Bag_intersect::()),
        )),
...
=head2 exclusive (Bag)
        ...
        exclusive::Bag : (\Function : (
            ...
            is_commutative : True,
            identity : {0:0},
            map : \(args --> \foundation::Bag_exclusive::()),
        )),
...
=head2 unnest (Bag)
        ...
        unnest::Bag : (\Function : (
            ...
            implements : \@folder::"",
            accepts : \(...),
            map : \(args --> \foundation::Bag_unnest::()),
        )),
...
=head2 where (Bag)
        ...
        where::Bag : (\Function : (
            ...
            matches : (\@Bag, \@Signature),
            implements : \@folder::"",
            map : \((args.\0, Signature_to_Function_Call_But_0::(args.\1)) --> \foundation::Bag_where::()),
        )),
...
=head2 reduce (Bag)
        ...
        reduce::Bag : (\Function : (
            ...
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_reduce::()),
        )),
...
=head2 unique_count (Bag)
        ...
        unique_count::Bag : (\Function : (
            ...
            matches : (\@Bag),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_unique_count::()),
        )),
...
=head2 order_using (Bag)
        ...
        order_using::Bag : (\Function : (
            ...
            matches : (\@Bag, \@Function_Call_But_0_1),
            implements : \@folder::"",
            map : \(args --> \foundation::Bag_order_using::()),
        )),
...
The interface contract C<Attributive> is semifinite.  An C<Attributive> value
...
The constant C<Excuse::Not_Same_Heading> represents the I<undefined> result
...
=head2 subheading_of ⊆@
        ...
        subheading_of : (\Function : (
            ...
            map : \((@(args.\0), @(args.\1)) --> \foundation::Tuple_subheading_of::()),
        )),
...
=head2 overlaps_heading
        ...
        overlaps_heading : (\Function : (
            ...
            matches : (\@Attributive, \@Attributive),
            is_commutative : True,
            map : \((@(args.\0), @(args.\1)) --> \foundation::Tuple_overlaps_heading::()),
        )),
...
=head2 disjoint_heading
        ...
        disjoint_heading : (\Function : (
            ...
            matches : (\@Attributive, \@Attributive),
            is_commutative : True,
            map : \((@(args.\0), @(args.\1)) --> \foundation::Tuple_disjoint_heading::()),
        )),
...
=head2 except_heading ∖@
        ...
        except_heading : (\Function : (
            returns : \@Heading,
            matches : (\@Attributive, \@Attributive),
            map : \((@(args.\0), @(args.\1)) --> \foundation::Tuple_except_heading::()),
        )),
...
=head2 intersect_heading ∩@
        ...
        intersect_heading : (\Function : (
            ...
            is_commutative : True,
            is_idempotent : True,
            map : \((@(args.\0), @(args.\1)) --> \foundation::Tuple_intersect_heading::()),
        )),
...
=head2 union_heading ∪@
        ...
        union_heading : (\Function : (
            ...
            is_idempotent : True,
            identity : (),
            map : \((@(args.\0), @(args.\1)) --> \foundation::Tuple_union_heading::()),
        )),
...
=head2 exclusive_heading symm_diff_heading ∆@
        ...
        exclusive : (\Function : (
            ...
            is_commutative : True,
            identity : (),
            map : \((@(args.\0), @(args.\1)) --> \foundation::Tuple_exclusive_heading::()),
        )),
...
The interface contract C<Structural> is semifinite.  A C<Structural> value is
...
=head2 can_project_matching (Structural)
        ...
        can_project_matching::Structural : (\Function : (
            ...
            implements : \@folder::"",
            map : \(if args.\0 @? (args.\1) then guard args.\0 %= @(args.\1) = (args.\1) else False),
        )),
...
=head2 maybe_at (Structural)
        ...
        maybe_at::Structural : (\Function : (
            ...
            matches : (\@Structural, \@Attr_Name),
            implements : \@folder::"",
            map : \(if args.\0 .? (args.\1) then guard args.\0.(args.\1) else Excuse::No_Such_Attr_Name()),
        )),
...
The constant C<Tuple::D0> represents the only zero-attribute
C<Tuple> value.
...
The selection contract C<Tuple::D1> represents the infinite type consisting
...
=head2 D1
        ...
        D1 : (\Function : (
            ...
            map : \(args --> \foundation::Tuple_D1_select::()),
        )),
...
=head2 degree (Tuple)
        ...
        degree::Tuple : (\Function : (
            ...
            matches : (\@Tuple),
            implements : \@folder::"",
            map : \(args --> \foundation::Tuple_degree::()),
        )),
...
=head2 heading (Tuple)
        ...
        heading::Tuple : (\Function : (
            ...
            matches : (\@Tuple),
            implements : \@folder::"",
            map : \(args --> \foundation::Tuple_heading::()),
        )),
...
=head2 rename (Tuple)
        ...
        rename::Tuple : (\Function : (
            ...
            implements : \@folder::"",
            accepts : \(...),
            map : \(args --> \foundation::Tuple_rename::()),
        )),
...
=head2 update (Tuple)
        ...
        update::Tuple : (\Function : (
            ...
            implements : \@folder::"",
            accepts : \(args.\0 @? (args.\1)),
            map : \(args --> \foundation::Tuple_update::()),
        )),
...
=head2 extend (Tuple)
        ...
        extend::Tuple : (\Function : (
            ...
            is_commutative : True,
            identity : (),
            map : \(args --> \foundation::Tuple_extend::()),
        )),
...
=head2 attrs_map
        ...
        attrs_map : (\Function : (
            ...
            map : \(args --> \foundation::Tuple_attrs_map::()),
        )),
...
=head2 attrs_reduce
        ...
        attrs_reduce : (\Function : (
            ...
            map : \(args --> \foundation::Tuple_attrs_reduce::()),
        )),
...
The interface contract C<Relational> is semifinite.  A C<Relational> value is
...
=head2 has_n (Relational)
        ...
        has_n::Relational : (\Function : (
            ...
            implements : \@folder::"",
            map : \(if args.\0 =@ (args.\1) then guard has_n::(|(args.\0), args.\1, args.\2)
...
=head2 subset_of (Relational)
        ...
        subset_of::Relational : (\Function : (
            ...
            implements : \@folder::"",
            map : \(if args.\0 =@ (args.\1) then guard |(args.\0) subset_of |(args.\1)
                else Excuse::Not_Same_Heading),
        )),
...
=head2 same_members (Relational)
        ...
        same_members::Relational : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(if args.\0 =@ (args.\1) then guard |(args.\0) same_members |(args.\1)
                else Excuse::Not_Same_Heading),
        )),
...
=head2 overlaps_members (Relational)
        ...
        overlaps_members::Relational : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(if args.\0 =@ (args.\1) then guard |(args.\0) overlaps_members |(args.\1)
                else Excuse::Not_Same_Heading),
        )),
...
=head2 disjoint_members (Relational)
        ...
        disjoint_members::Relational : (\Function : (
            ...
            implements : \@folder::"",
            is_commutative : True,
            map : \(if args.\0 =@ (args.\1) then guard |(args.\0) disjoint_members |(args.\1)
                else Excuse::Not_Same_Heading),
        )),
...
=head2 insert_n (Relational)
        ...
        insert_n::Relational : (\Function : (
            ...
            matches : (\@Relational, \@Structural, \@Integer::NN),
            implements : \@folder::"",
            map : \(if args.\0 =@ (args.\1) then guard select_Relational::
...
arguments.  This operation has an identity value of a collection with zero
...
instances of any distinct tuple are those closest to the end of C<0>.  The
result is only I<defined> when the 2 arguments have the same I<heading>; it
is an C<Excuse> otherwise.  This function implements the C<Unionable>
...
end of C<1>.  This operation has an identity value of a collection with
...
closest to the end of C<0> or C<1> respectively.  This operation has an
identity value of a collection with zero members.  For non-ordered types,
...
The constant C<Tuple_Array::D0C0> represents the only zero-attribute,
...
The constant C<Tuple_Array::D0C1> represents the only zero-attribute,
...
The constant C<Relation::D0C0> represents the only
...
The constant C<Relation::D0C1> represents the only
...
The constant C<Tuple_Bag::D0C0> represents the only zero-attribute,
...
The constant C<Tuple_Bag::D0C1> represents the only zero-attribute,
...
=head2 Interval
        ...
        Interval::"" : (\Selection : (
            of : \@Capsule,
            where : \(has_wrapped::( args.\0, \Interval, \Interval::Attrs() )),
...
=head2 wrap >:<
        ...
        wrap : (\Function : (
            returns : \@Capsule,
            matches : (\@Any, \@Any),
            map : \(args --> \foundation::Capsule_wrap::()),
        )),
...
=head2 wrapper <:
        ...
        wrapper : (\Function : (
            returns : \@Any,
            matches : (\@Capsule),
            map : \(args --> \foundation::Capsule_wrapper::()),
        )),
...
=head2 unwrap :>
        ...
        unwrap : (\Function : (
            returns : \@Any,
            matches : (\@Capsule),
            map : \(args --> \foundation::Capsule_unwrap::()),
        )),
...
The selection contract C<Reference> represents the infinite Muldis D
...
contract) or registered stimulus-response rules etc.  Typically,
...
=head2 External::call_function
        ...
        External::call_function : (\Function : (
            returns : \@Any,
            matches : (\@Any),
            map : \(\foundation::External_call_function::() <-- args),
        )),
...
I<TODO.  Add Enumeration as its own Material kind, or otherwise have a type for it;
Plain_Text does NOT have special syntax for Package or any Material now.>
...
I<TODO.  Still have to figure syntax to handle and-provides-its-default marker.>

=head2 Source_Code::Interface
...
=head2 Source_Code::Function_Body
...
=head2 Source_Code::Procedure_Body
...
=head2 Source_Code::Signature::Set
...
=head2 Source_Code::Signature::Tuple
...
=head2 Source_Code::Named_Expr_List
...
I<TODO.  Actually, rewrite most of the above list.>

=head2 Source_Code::Named_Stmt_List
