...
C<updater upd_invo ($updater : APImperativeNC,
...
C<recipe rcp_invo ($recipe : APImperativeNC,
&$upd_args? : Tuple, $ro_args? : Tuple) {...}>
...
C<procedure proc_invo ($procedure : APImperativeNC,
&$upd_args? : Tuple, $ro_args? : Tuple) {...}>
...
C<< function map_to_topic (Universal <--
$topic : Universal) {...} >>
