...
This document is Muldis::D::Core::Routines_Catalog version 0.65.0.
...
=head2 sys.std.Core.Cat.Order_conditional_reverse

C<< function sys.std.Core.Cat.Order_conditional_reverse (Order <--
Order $topic, Bool $is_reverse_order) >>

This function results in the reverse value of its C<topic> argument as per
C<Order_reverse> iff its C<is_reverse_order> argument is C<Bool:true>;
...
pass the result of that algorithm through C<Order_conditional_reverse>.
