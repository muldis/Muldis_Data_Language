...
$delete_on_unmount?, Bool $we_may_update?, ScaLitExprNodeSet $details?)>
...
(Name $name, Comment $comment?, Cat.(Func|Upd|ProcHead) $head,
Cat.(Func|Upd|Proc $bodyBody))>
...
Cat.(Func|Upd|Proc $headHead), Cat.(Func|Upd|ProcBody) $body)>
