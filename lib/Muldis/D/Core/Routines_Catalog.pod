...
This document is Muldis::D::Core::Routines_Catalog version 0.112.0.
...
the other arguments.  This recipe is analogous to a SQL CREATE
...
is analogous to a SQL DROP FUNCTION|PROCEDURE statement.
