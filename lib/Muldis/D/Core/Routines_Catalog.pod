...
This document is Muldis::D::Core::Routines_Catalog version 0.104.0.
...
=head2 sys.std.Core.Cat.create_[scalar|nonscalar|domain|subset]_type

C<recipe sys.std.Core.Cat.create_[scalar|nonscalar|domain|subset]_type
($depot : Name, $subdepot? : NameChain, $name : Name,
$comment? : Comment, $material : [Scalar|Nonscalar|Domain|Subset]Type)>

This recipe is an abstraction over inserting a tuple into the catalog
relvar C<fed.cat.mounts{name=$depot}.depot
.[scalar|nonscalar|domain|subset]_types>.
...
=head2 sys.std.Core.Cat.drop_[scalar|nonscalar|domain|subset]_type

C<recipe sys.std.Core.Cat.drop_[scalar|nonscalar|domain|subset]_type
($depot : Name, $subdepot? : NameChain, $name : Name)>
