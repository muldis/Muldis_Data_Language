...
This document is Muldis::D::Core::Routines_Catalog version 0.139.0.
...
scm_comment? : Text, is_temporary? : Bool, create_on_mount? : Bool,
...
parent? : NameChain, name : Name, scm_comment? : Text,
...
scm_comment? : Text, scm_vis_ord? : NNInt,
...
C<recipe create_[updater|recipe|procedure] (depot : Name,
subdepot? : NameChain, name : Name,
scm_comment? : Text, scm_vis_ord? : NNInt,
...
C<recipe drop_[updater|recipe|procedure] (depot : Name,
...
subdepot? : NameChain, name : Name, scm_comment? : Text,
