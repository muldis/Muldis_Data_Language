...
C<recipe sys.std.Core.Cat.create_[scalar|nonscalar|union|subset]_type
($depot : Name, $subdepot? : NameChain, $name : Name,
$comment? : Comment, $material : [Scalar|Nonscalar|Union|Subset]Type)>
...
C<recipe sys.std.Core.Cat.drop_[scalar|nonscalar|union|subset]_type
($depot : Name, $subdepot? : NameChain, $name : Name)>
