...
This document is Muldis::D::Core::Routines version 0.76.1.
...
opposite boolean value when given the same arguments.  Note that this
operation is also known as C<!isa>.
...
variables, so they always hold valid values of their declared type.  Note
that this operation is also known as C<d>.
...
I<sys.std.Core.QScalar.static_subst>.
...
=head2 sys.std.Core.QScalar.cmpl_proj

C<< function sys.std.Core.QScalar.cmpl_proj (QTuple <--
...
I<sys.std.Core.QTuple.static_subst>.
...
=head2 sys.std.Core.QTuple.cmpl_proj

C<< function sys.std.Core.QTuple.cmpl_proj (QTuple <-- QTuple $topic,
set_of.Name $attr_names) >>
...
=head2 sys.std.Core.QTuple.static_exten

C<< function sys.std.Core.QTuple.static_exten (QTuple <--
...
exactly one q/tuple.  Note that this operation is also known as C<t>.
...
C<QTuple> that is its argument.  Note that this operation is also known as
C<r>.
...
=head2 sys.std.Core.QRelation.disjoint_ins

C<< function sys.std.Core.QRelation.disjoint_ins (QRelation <--
...
=head2 sys.std.Core.QRelation.cmpl_proj

C<< function sys.std.Core.QRelation.cmpl_proj (QRelation <--
QRelation $topic, set_of.Name $attr_names) >>

This function is the same as C<sys.std.Core.QTuple.cmpl_proj> but
...
=head2 sys.std.Core.QRelation.restr_and_cmpl

C<< function sys.std.Core.QRelation.restr_and_cmpl (QTuple <--
QRelation $topic, FuncRef $func, QTuple $assuming?) >>
...
C<sys.std.Core.QRelation.cmpl_restr>, respectively, would result in
when given the same arguments.

=head2 sys.std.Core.QRelation.cmpl_restr

C<< function sys.std.Core.QRelation.cmpl_restr (QRelation <--
QRelation $topic, FuncRef $func, QTuple $assuming?) >>
...
See also the C<sys.std.Core.QRelation.semidiff> function.

=head2 sys.std.Core.QRelation.extension

C<< function sys.std.Core.QRelation.extension (QRelation <--
...
=head2 sys.std.Core.QRelation.static_exten

C<< function sys.std.Core.QRelation.static_exten (QRelation <--
...
=head2 sys.std.Core.QRelation.count_per_group

C<< function sys.std.Core.QRelation.count_per_group (QRelation <--
QRelation $topic, set_of.Name $group_per, Name $count_attr_name) >>

This function is an alias for
C<sys.std.Core.QRelation.cardinality_per_group>.
...
=head2 sys.std.Core.QRelation.diff

C<< function sys.std.Core.QRelation.diff (QRelation <--
...
=head2 sys.std.Core.QRelation.semidiff

C<< function sys.std.Core.QRelation.semidiff (QRelation <--
QRelation $source, QRelation $filter) >>
...
This function is an alias for C<sys.std.Core.QRelation.semidiff>.
...
C<sys.std.Core.QRelation.semidiff>, respectively, would result in
when given the same arguments.
...
=head2 sys.std.Core.QTuple.assign_static_exten

C<updater sys.std.Core.QTuple.assign_static_exten (QTuple &$topic,
QTuple $attrs)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QTuple.static_exten> function with the same arguments,
...
=head2 sys.std.Core.QTuple.assign_cmpl_proj

C<updater sys.std.Core.QTuple.assign_cmpl_proj (QTuple &$topic,
set_of.Name $attr_names)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QTuple.cmpl_proj> function with the same arguments,
and then assigning the result of that function to C<topic>.  This procedure
...
=head2 sys.std.Core.QRelation.assign_disjoint_ins

C<updater sys.std.Core.QRelation.assign_disjoint_ins (QRelation &$r,
QTuple $t)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.disjoint_ins> function with the same
...
=head2 sys.std.Core.QRelation.assign_cmpl_restr

C<updater sys.std.Core.QRelation.assign_cmpl_restr
(QRelation &$topic, FuncRef $func, QTuple $assuming?)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.cmpl_restr> function with the same arguments, and
...
=head2 sys.std.Core.QRelation.assign_diff

C<updater sys.std.Core.QRelation.assign_diff (QRelation &$source,
QRelation $filter)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.diff> function with the same arguments, and
then assigning the result of that function to C<source>.

=head2 sys.std.Core.QRelation.assign_semidiff

C<updater sys.std.Core.QRelation.assign_semidiff (QRelation &$source,
QRelation $filter)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.semidiff> function with the same arguments,
...
C<sys.std.Core.QRelation.assign_semidiff>.
...
=head2 sys.std.Core.QRelation.assign_static_exten

C<updater sys.std.Core.QRelation.assign_static_exten
(QRelation &$topic, QTuple $attrs)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.static_exten> function with the same
...
=head2 sys.std.Core.QRelation.assign_cmpl_proj

C<updater sys.std.Core.QRelation.assign_cmpl_proj (QRelation &$topic,
set_of.Name $attr_names)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.cmpl_proj> function with the same arguments,
and then assigning the result of that function to C<topic>.  This procedure
