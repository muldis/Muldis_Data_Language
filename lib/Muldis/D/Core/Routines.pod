...
=head2 sys.std.Bool.all

C<< function sys.std.Bool.all (Bool <-- set_of.Bool $topic?) >>

This function is an alias for C<sys.std.Core.Bool.and>.
...
=head2 sys.std.Bool.any

C<< function sys.std.Bool.any (Bool <-- set_of.Bool $topic?) >>

This function is an alias for C<sys.std.Core.Bool.or>.
...
I<not equivalent> (dyadic usage) or C<⊻> or <↮>.  Note that a dyadic (2
