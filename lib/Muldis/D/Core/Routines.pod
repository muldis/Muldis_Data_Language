...
C<< function sys.std.Core.Universal.assertion (Universal <-- is_true(Bool),
result(Universal)) >>
...
C<< function sys.std.Core.QScalar.attr (Universal <-- topic(QScalar),
...
C<< function sys.std.Core.QScalar.update_attr (QScalar <-- topic(QScalar),
...
C<< function sys.std.Core.QScalar.multi_update (QScalar <-- topic(QScalar),
possrep(Name)?, attrs(QTuple)) >>
...
C<< function sys.std.Core.QScalar.projection (QTuple <-- topic(QScalar),
...
topic(QTuple), type(TypeRef), possrep(Name)?) >>
...
C<< function sys.std.Core.QScalar.order (Order <-- topic(QScalar),
other(QScalar), assuming(QTuple)?) >>
...
C<< function sys.std.Core.QScalar.has_possrep (Bool <-- topic(QScalar),
possrep(Name)?) >>
...
C<< function sys.std.Core.QScalar.degree (NNInt <-- topic(QScalar),
possrep(Name)?) >>
...
C<< function sys.std.Core.QScalar.has_attrs (Bool <-- topic(QScalar),
possrep(Name)?, attr_names(set_of.Name)) >>
...
C<< function sys.std.Core.Bool.xor (Bool <-- topic(bag_of.Bool)) >>
...
C<< function sys.std.Core.QTuple.attr (Universal <-- topic(QTuple),
name(Name)) >>
...
C<< function sys.std.Core.QTuple.update_attr (QTuple <-- topic(QTuple),
...
C<< function sys.std.Core.QTuple.multi_update (QTuple <-- topic(QTuple),
attrs(QTuple)) >>
...
C<< function sys.std.Core.QTuple.rename (QTuple <-- topic(QTuple),
map(AttrRenameMap)) >>
...
C<< function sys.std.Core.QTuple.projection (QTuple <-- topic(QTuple),
...
C<< function sys.std.Core.QTuple.cmpl_projection (QTuple <-- topic(QTuple),
attr_names(set_of.Name)) >>
...
C<< function sys.std.Core.QTuple.wrap (QTuple <-- topic(QTuple),
...
C<< function sys.std.Core.QTuple.cmpl_wrap (QTuple <-- topic(QTuple),
cmpl_inner(set_of.Name), outer(Name)) >>
...
C<< function sys.std.Core.QTuple.unwrap (QTuple <-- topic(QTuple),
outer(Name)) >>
...
C<< function sys.std.Core.QRelation.is_member (Bool <-- r(QRelation),
t(QTuple)) >>
...
C<< function sys.std.Core.QRelation.is_not_member (Bool <-- r(QRelation),
t(QTuple)) >>
...
C<< function sys.std.Core.QRelation.insertion (QRelation <-- r(QRelation),
t(QTuple)) >>
...
C<< function sys.std.Core.QRelation.deletion (QRelation <-- r(QRelation),
t(QTuple)) >>
...
C<< function sys.std.Core.QRelation.rename (QRelation <-- topic(QRelation),
map(AttrRenameMap)) >>
...
C<< function sys.std.Core.QRelation.wrap (QRelation <-- topic(QRelation),
inner(set_of.Name), outer(Name)) >>
...
C<< function sys.std.Core.QRelation.unwrap (QRelation <-- topic(QRelation),
...
C<< function sys.std.Core.QRelation.group (QRelation <-- topic(QRelation),
inner(set_of.Name), outer(Name)) >>
...
topic(QRelation), attr_names(set_of.Name), func(FuncRef),
assuming(QTuple)?) >>
...
C<< function sys.std.Core.QRelation.is_subset (Bool <-- look_in(QRelation),
look_for(QRelation)) >>
...
C<updater sys.std.Core.Universal.assign (&target(Universal), v(Universal))>
...
C<updater sys.std.Core.QTuple.assign_rename (&topic(QTuple),
map(AttrRenameMap))>
...
C<updater sys.std.Core.QTuple.assign_static_extension (&topic(QTuple),
attrs(QTuple))>
...
C<updater sys.std.Core.QTuple.assign_projection (&topic(QTuple),
attr_names(set_of.Name))>
...
C<updater sys.std.Core.QTuple.assign_cmpl_projection (&topic(QTuple),
attr_names(set_of.Name))>
...
C<updater sys.std.Core.QRelation.assign_insertion (&r(QRelation),
t(QTuple))>
...
C<updater sys.std.Core.QRelation.assign_disjoint_insertion (&r(QRelation),
t(QTuple))>
...
C<updater sys.std.Core.QRelation.assign_union (&topic(QRelation),
other(QRelation))>
...
C<updater sys.std.Core.QRelation.assign_disjoint_union (&topic(QRelation),
other(QRelation))>
...
C<updater sys.std.Core.QRelation.assign_deletion (&r(QRelation),
t(QTuple))>
...
C<updater sys.std.Core.QRelation.assign_restriction (&topic(QRelation),
...
C<updater sys.std.Core.QRelation.assign_intersection (&topic(QRelation),
other(QRelation))>
...
C<updater sys.std.Core.QRelation.assign_difference (&source(QRelation),
filter(QRelation))>
...
C<updater sys.std.Core.QRelation.assign_semidifference (&source(QRelation),
filter(QRelation))>
...
C<updater sys.std.Core.QRelation.assign_semijoin (&source(QRelation),
filter(QRelation))>
...
C<updater sys.std.Core.QRelation.assign_rename (&topic(QRelation),
map(AttrRenameMap))>
...
C<updater sys.std.Core.QRelation.assign_extension (&topic(QRelation),
attr_names(set_of.Name), func(FuncRef), assuming(QTuple)?)>
...
C<updater sys.std.Core.QRelation.assign_projection (&topic(QRelation),
attr_names(set_of.Name))>
...
C<updater sys.std.Core.QRelation.assign_cmpl_projection (&topic(QRelation),
attr_names(set_of.Name))>
...
C<updater sys.std.Core.Control.upd_invo (updater(ProcRef),
&upd_args(QTuple), ro_args(QTuple)?)>
...
C<system_service sys.std.Core.STDIO.read_Text (&target(Text),
length_in_graphemes(NNInt))>
...
C<system_service sys.std.Core.STDIO.read_Text_line (&target(Text),
...
C<system_service sys.std.Core.STDIO.write_Text (v(Text))>
...
C<system_service sys.std.Core.STDIO.write_Text_line (v(Text))>
...
C<system_service sys.std.Core.STDIO.prompt_Text_line (&target(Text),
...
C<system_service sys.std.Core.STDIO.error_Text (v(Text))>
...
C<system_service sys.std.Core.STDIO.error_Text_line (v(Text))>
...
C<procedure sys.std.Core.Control.try_catch (try(ProcRef),
&try_updating(QTuple)?, try_assuming(QTuple)?, catch(ProcRef),
&catch_updating(QTuple)?, catch_assuming(QTuple)?)>
