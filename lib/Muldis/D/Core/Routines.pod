...
This document is Muldis::D::Core::Routines version 0.22.1.
...
=item C<function sys.std.Core.Bool.or result Bool params { topic(SetOfBool)
}>
...
topic(Tuple), inner(Cat.SetOfName), outer(Cat.Name) }>
...
params { topic(Relation), attrs(Cat.SetOfName) }>
