...
This document is Muldis::D::Core::Routines version 0.21.0.
...
=item C<bootloader_exclusive sys.Core.Control.start_trans read {}>

This system service starts a new child-most transaction.

=item C<bootloader_exclusive sys.Core.Control.commit_trans read {}>

This system service commits the child-most transaction; it will fail if
there isn't one.

=item C<bootloader_exclusive sys.Core.Control.rollback_trans read {}>
