...
when its C<if> argument is C<Bool:false>.  Note that there is no
if-elseif-elsif-...-else function; you would chain several of this current
triadic C<if_then_else> function to get that effect; however, see also the
