...
This document is Muldis::D::Core::Routines version 0.95.0.
...
C<system-service sys.std.Core.STDIO.read_Text (Text &$target,
NNInt $len_in_graphs)>
...
C<system-service sys.std.Core.STDIO.read_Text_line (Text &$target,
...
C<system-service sys.std.Core.STDIO.write_Text (Text $v)>
...
C<system-service sys.std.Core.STDIO.write_Text_line (Text $v)>
...
C<system-service sys.std.Core.STDIO.prompt_Text_line (Text &$target,
...
C<system-service sys.std.Core.STDIO.error_Text (Text $v)>
...
C<system-service sys.std.Core.STDIO.error_Text_line (Text $v)>
