...
=item C<function sys.std.Core.QScalar.attr result ScaTupRel params {
topic(Scalar), possrep(Name)?, name(Name) }>
...
=item C<function sys.std.Core.QScalar.update_attr result Scalar params {
topic(Scalar), possrep(Name)?, name(Name), value(ScaTupRel) }>
...
=item C<function sys.std.Core.QScalar.multi_update result Scalar params {
topic(Scalar), possrep(Name)?, attrs(Tuple) }>
...
=item C<function sys.std.Core.QScalar.projection result Tuple params {
topic(Scalar), possrep(Name)?, attrs(set_of.Name) }>
...
=item C<function sys.std.Core.QScalar.cmpl_projection result Tuple params {
topic(Scalar), possrep(Name)?, attrs(set_of.Name) }>
...
=item C<function sys.std.Core.QScalar.Tuple_from_Scalar result Tuple params
...
=item C<function sys.std.Core.QScalar.Scalar_from_Tuple result Scalar
params { topic(Tuple), type(TypeRef), possrep(Name)? }>
...
topic(Scalar), other(Scalar), assuming(QTuple)? }>
...
=item C<function sys.std.Core.QTuple.attr result ScaTupRel params {
topic(Tuple), name(Name) }>
...
=item C<function sys.std.Core.QTuple.update_attr result Tuple params {
topic(Tuple), name(Name), value(ScaTupRel) }>
...
=item C<function sys.std.Core.QTuple.multi_update result Tuple params {
...
=item C<function sys.std.Core.QTuple.rename result Tuple params {
topic(Tuple), map(AttrRenameMap) }>
...
=item C<function sys.std.Core.QTuple.projection result Tuple params {
topic(Tuple), attrs(set_of.Name) }>
...
=item C<function sys.std.Core.QTuple.cmpl_projection result Tuple params {
topic(Tuple), attrs(set_of.Name) }>
...
=item C<function sys.std.Core.QTuple.wrap result Tuple params {
topic(Tuple), inner(set_of.Name), outer(Name) }>
...
=item C<function sys.std.Core.QTuple.cmpl_wrap result Tuple params {
topic(Tuple), cmpl_inner(set_of.Name), outer(Name) }>
...
=item C<function sys.std.Core.QTuple.unwrap result Tuple params {
topic(Tuple), outer(Name) }>
...
=item C<function sys.std.Core.QTuple.product result Tuple params {
...
C<sys.std.Core.QRelation.is_subset> except that the tuple being looked for
...
=item C<function sys.std.Core.QRelation.Tuple_from_Relation result Tuple
...
=item C<function sys.std.Core.QRelation.Relation_from_Tuple result Relation
params { topic(Tuple) }>

This function results in the C<Relation> value those body has just the one
C<Tuple> that is its argument.

=item C<function sys.std.Core.QRelation.insertion result Relation params {
r(Relation), t(Tuple) }>
...
=item C<function sys.std.Core.QRelation.disjoint_insertion result Relation
...
=item C<function sys.std.Core.QRelation.deletion result Relation params {
r(Relation), t(Tuple) }>
...
=item C<function sys.std.Core.QRelation.rename result Relation params {
topic(Relation), map(AttrRenameMap) }>
...
=item C<function sys.std.Core.QRelation.projection result Relation params {
topic(Relation), attrs(set_of.Name) }>
...
=item C<function sys.std.Core.QRelation.cmpl_projection result Relation
params { topic(Relation), attrs(set_of.Name) }>
...
=item C<function sys.std.Core.QRelation.wrap result Relation params {
...
of its member tuples was transformed as per C<sys.std.Core.QTuple.wrap>.

=item C<function sys.std.Core.QRelation.cmpl_wrap result Relation params {
topic(Relation), cmpl_inner(set_of.Name), outer(Name) }>
...
=item C<function sys.std.Core.QRelation.unwrap result Relation params {
topic(Relation), outer(Name), inner(set_of.Name) }>
...
unlike the C<Tuple> variant of C<unwrap>, this current function requires
...
=item C<function sys.std.Core.QRelation.group result Relation params {
topic(Relation), inner(set_of.Name), outer(Name) }>
...
=item C<function sys.std.Core.QRelation.cmpl_group result Relation params {
topic(Relation), group_per(set_of.Name), outer(Name) }>
...
=item C<function sys.std.Core.QRelation.ungroup result Relation params {
topic(Relation), outer(Name), inner(set_of.Name) }>
...
=item C<function sys.std.Core.QRelation.restriction result Relation params
{ topic(Relation), func(FuncRef), assuming(QTuple)? }>
...
=item C<function sys.std.Core.QRelation.cmpl_restriction result Relation
params { topic(Relation), func(FuncRef), assuming(QTuple)? }>
...
=item C<function sys.std.Core.QRelation.extension result Relation params {
topic(Relation), func(FuncRef), assuming(QTuple)? }>
...
=item C<function sys.std.Core.QRelation.static_extension result Relation
...
=item C<function sys.std.Core.QRelation.summary result Relation params {
topic(Relation), group_per(set_of.Name), summ_func(FuncRef),
...
=item C<function sys.std.Core.QRelation.union result Relation params {
...
=item C<function sys.std.Core.QRelation.disjoint_union result Relation
...
=item C<function sys.std.Core.QRelation.intersection result Relation params
{ topic(set_of.Relation) }>
...
=item C<function sys.std.Core.QRelation.difference result Relation params {
...
=item C<function sys.std.Core.QRelation.semidifference result Relation
...
=item C<function sys.std.Core.QRelation.semijoin result Relation params {
source(Relation), filter(Relation) }>
...
=item C<function sys.std.Core.QRelation.join result Relation params {
...
=item C<function sys.std.Core.QRelation.product result Relation params {
topic(quasi_set_of.Relation) }>
...
=item C<function sys.std.Core.QRelation.quotient result Relation params {
...
=item C<updater sys.std.Core.QTuple.assign_rename update { topic(Tuple) }
...
=item C<updater sys.std.Core.QTuple.assign_product update { topic(Tuple) }
read { other(Tuple) }>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QTuple.product> function such that it has 2 input tuples
...
=item C<updater sys.std.Core.QTuple.assign_projection update { topic(Tuple)
...
topic(Tuple) } read { attrs(set_of.Name) }>
...
statement iff C<topic> is C<Database>-typed; each relation-typed attribute
...
This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.union> function such that it has 2 input relations
...
=item C<updater sys.std.Core.QRelation.assign_deletion update { r(Relation)
} read { t(Tuple) }>
...
topic(Relation) } read { func(FuncRef), assuming(QTuple)? }>
...
topic(Relation) } read { map(AttrRenameMap) }>
...
topic(Relation) } read { attrs(set_of.Name) }>
