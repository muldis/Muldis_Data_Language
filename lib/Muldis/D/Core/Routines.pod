...
This document is Muldis::D::Core::Routines version 0.96.0.
...
C<< function sys.std.Core.Tuple.attr (Universal <-- $topic : Tuple,
$name : Name) >>
...
C<< function sys.std.Core.Tuple.update_attr (Tuple <-- $topic : Tuple,
...
C<< function sys.std.Core.Tuple.multi_update (Tuple <-- $topic : Tuple,
$attrs : Tuple) >>
...
C<< function sys.std.Core.Tuple.rename (Tuple <-- $topic : Tuple,
$map : AttrRenameMap) >>
...
C<< function sys.std.Core.Tuple.projection (Tuple <-- $topic : Tuple,
...
C<< function sys.std.Core.Tuple.cmpl_proj (Tuple <-- $topic : Tuple,
$attr_names : set_of.Name) >>
...
C<< function sys.std.Core.Tuple.wrap (Tuple <-- $topic : Tuple, $outer : Name,
$inner : set_of.Name) >>
...
C<< function sys.std.Core.Tuple.cmpl_wrap (Tuple <-- $topic : Tuple,
...
C<< function sys.std.Core.Tuple.unwrap (Tuple <-- $topic : Tuple,
...
C<< function sys.std.Core.Tuple.product (Tuple <-- $topic : set_of.Tuple) >>
...
C<< function sys.std.Core.Relation.extension (Relation <-- $topic : Relation,
...
$topic : Relation, $group_per : set_of.Name, $summ_attr_names : set_of.Name,
$summ_func : ValMapFuncRef) >>
...
C<updater sys.std.Core.Tuple.assign_rename (&$topic : Tuple,
$map : AttrRenameMap)>
...
C<updater sys.std.Core.Tuple.assign_static_exten (&$topic : Tuple,
$attrs : Tuple)>
...
C<updater sys.std.Core.Tuple.assign_projection (&$topic : Tuple,
$attr_names : set_of.Name)>
...
C<updater sys.std.Core.Tuple.assign_cmpl_proj (&$topic : Tuple,
$attr_names : set_of.Name)>
...
C<updater sys.std.Core.Relation.assign_insertion (&$r : Relation, $t : Tuple)>
...
C<updater sys.std.Core.Relation.assign_deletion (&$r : Relation, $t : Tuple)>
...
C<procedure sys.std.Core.Control.imp_invo ($imperative : ImpRef,
&$upd_args? : Tuple, $ro_args? : Tuple)>
...
($try : ImpRef, &$try_upd_args? : Tuple, $try_ro_args? : Tuple,
$catch? : ImpRef, &$catch_upd_args? : Tuple, $catch_ro_args? : Tuple)>
