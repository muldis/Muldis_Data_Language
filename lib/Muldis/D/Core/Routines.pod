...
doesn't have to be wrapped in a q/relation.  This function will fail|warn if
...
latter.  This function will fail if any input q/relations have attributes
with common names but their most specific types would be fatally
incompatible in a common q/relation value; this function will otherwise warn
with common-named attributes where their declared types are incompatible as
