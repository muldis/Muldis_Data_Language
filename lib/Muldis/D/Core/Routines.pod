...
C<< function sys.std.Core.QRelation.is_member (Bool <-- QRelation $r,
QTuple $t) >>
...
C<< function sys.std.Core.QRelation.is_not_member (Bool <-- QRelation $r,
QTuple $t) >>
...
C<< function sys.std.Core.QRelation.is_subset (Bool <-- QRelation $look_in,
QRelation $look_for) >>
...
QRelation $look_in, QRelation $look_for) >>
...
that it transposes the C<look_in> and C<look_for> arguments.  This function
results in C<Bool:true> iff the set of q/tuples comprising C<look_for> is a
superset of the set of q/tuples comprising C<look_in>, and C<Bool:false>
otherwise.
...
except that it transposes the C<look_in> and C<look_for> arguments.  This
