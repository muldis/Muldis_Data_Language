...
C<< function sys.std.Core.Scalar.attr (Universal <-- QScalar $topic,
...
C<< function sys.std.Core.Scalar.update_attr (QScalar <-- QScalar $topic,
...
C<< function sys.std.Core.Scalar.multi_update (QScalar <-- QScalar $topic,
...
C<< function sys.std.Core.Scalar.projection (QTuple <-- QScalar $topic,
...
C<< function sys.std.Core.Scalar.cmpl_proj (QTuple <--
...
=head2 sys.std.Core.Scalar.QTuple_from_QScalar

C<< function sys.std.Core.Scalar.QTuple_from_QScalar (QTuple <--
...
=head2 sys.std.Core.Scalar.QScalar_from_QTuple

C<< function sys.std.Core.Scalar.QScalar_from_QTuple (QScalar <--
...
C<< function sys.std.Core.Scalar.order (Order <-- QScalar $topic,
...
C<< function sys.std.Core.Scalar.has_possrep (Bool <-- QScalar $topic,
Name $possrep?) >>
...
C<< function sys.std.Core.Scalar.degree (NNInt <-- QScalar $topic,
Name $possrep?) >>
...
C<< function sys.std.Core.Scalar.has_attrs (Bool <-- QScalar $topic,
Name $possrep?, set_of.Name $attr_names) >>
...
C<< function sys.std.Core.Tuple.attr (Universal <-- QTuple $topic,
Name $name) >>
...
C<< function sys.std.Core.Tuple.update_attr (QTuple <-- QTuple $topic,
...
C<< function sys.std.Core.Tuple.multi_update (QTuple <-- QTuple $topic,
QTuple $attrs) >>
...
C<< function sys.std.Core.Tuple.rename (QTuple <-- QTuple $topic,
AttrRenameMap $map) >>
...
C<< function sys.std.Core.Tuple.projection (QTuple <-- QTuple $topic,
...
C<< function sys.std.Core.Tuple.cmpl_proj (QTuple <-- QTuple $topic,
set_of.Name $attr_names) >>
...
C<< function sys.std.Core.Tuple.static_exten (QTuple <--
...
C<< function sys.std.Core.Tuple.wrap (QTuple <-- QTuple $topic,
...
C<< function sys.std.Core.Tuple.cmpl_wrap (QTuple <-- QTuple $topic,
...
C<< function sys.std.Core.Tuple.unwrap (QTuple <-- QTuple $topic,
Name $outer) >>
...
C<< function sys.std.Core.Tuple.product (QTuple <--
...
C<< function sys.std.Core.Relation.count (NNInt <-- QRelation $topic) >>

This function is an alias for C<sys.std.Core.Relation.cardinality>.

=head2 sys.std.Core.Relation.has_member

C<< function sys.std.Core.Relation.has_member (Bool <-- QRelation $r,
QTuple $t) >>
...
C<< function sys.std.Core.Relation.has_not_member (Bool <-- QRelation $r,
QTuple $t) >>
...
=head2 sys.std.Core.Relation.QTuple_from_QRelation

C<< function sys.std.Core.Relation.QTuple_from_QRelation (QTuple <--
QRelation $topic) >>
...
=head2 sys.std.Core.Relation.QRelation_from_QTuple

C<< function sys.std.Core.Relation.QRelation_from_QTuple (QRelation <--
QTuple $topic) >>
...
C<< function sys.std.Core.Relation.insertion (QRelation <-- QRelation $r,
QTuple $t) >>
...
C<< function sys.std.Core.Relation.disjoint_ins (QRelation <--
...
C<< function sys.std.Core.Relation.deletion (QRelation <-- QRelation $r,
QTuple $t) >>
...
C<< function sys.std.Core.Relation.rename (QRelation <-- QRelation $topic,
AttrRenameMap $map) >>
...
C<< function sys.std.Core.Relation.projection (QRelation <--
...
C<< function sys.std.Core.Relation.cmpl_proj (QRelation <--
QRelation $topic, set_of.Name $attr_names) >>
...
C<< function sys.std.Core.Relation.wrap (QRelation <-- QRelation $topic,
set_of.Name $inner, Name $outer) >>
...
C<< function sys.std.Core.Relation.cmpl_wrap (QRelation <--
...
C<< function sys.std.Core.Relation.unwrap (QRelation <-- QRelation $topic,
...
C<< function sys.std.Core.Relation.group (QRelation <-- QRelation $topic,
set_of.Name $inner, Name $outer) >>
...
C<< function sys.std.Core.Relation.cmpl_group (QRelation <--
...
C<< function sys.std.Core.Relation.ungroup (QRelation <--
...
C<< function sys.std.Core.Relation.restriction (QRelation <--
...
C<< function sys.std.Core.Relation.restr_and_cmpl (QTuple <--
QRelation $topic, FuncRef $func, QTuple $assuming?) >>
...
C<< function sys.std.Core.Relation.cmpl_restr (QRelation <--
QRelation $topic, FuncRef $func, QTuple $assuming?) >>
...
C<< function sys.std.Core.Relation.extension (QRelation <--
...
C<< function sys.std.Core.Relation.static_exten (QRelation <--
...
C<< function sys.std.Core.Relation.summary (QRelation <--
...
C<< function sys.std.Core.Relation.cardinality_per_group (QRelation <--
...
C<< function sys.std.Core.Relation.count_per_group (QRelation <--
QRelation $topic, set_of.Name $group_per, Name $count_attr_name) >>
...
C<< function sys.std.Core.Relation.union (QRelation <--
...
C<< function sys.std.Core.Relation.disjoint_union (QRelation <--
quasi_set_of.QRelation $topic) >>
...
C<< function sys.std.Core.Relation.intersection (QRelation <--
quasi_set_of.QRelation $topic) >>
...
C<< function sys.std.Core.Relation.diff (QRelation <--
...
C<< function sys.std.Core.Relation.semidiff (QRelation <--
QRelation $source, QRelation $filter) >>
...
C<< function sys.std.Core.Relation.antijoin (QRelation <--
QRelation $source, QRelation $filter) >>
...
C<< function sys.std.Core.Relation.semijoin_and_diff (QTuple <--
QRelation $source, QRelation $filter) >>
...
C<< function sys.std.Core.Relation.semijoin (QRelation <--
QRelation $source, QRelation $filter) >>
...
C<< function sys.std.Core.Relation.join (QRelation <--
quasi_set_of.QRelation $topic?) >>
...
C<< function sys.std.Core.Relation.product (QRelation <--
quasi_set_of.QRelation $topic?) >>
...
C<< function sys.std.Core.Relation.quotient (QRelation <--
...
C<updater sys.std.Core.Tuple.assign_rename (QTuple &$topic,
AttrRenameMap $map)>
...
C<updater sys.std.Core.Tuple.assign_static_exten (QTuple &$topic,
QTuple $attrs)>
...
C<updater sys.std.Core.Tuple.assign_projection (QTuple &$topic,
set_of.Name $attr_names)>
...
C<updater sys.std.Core.Tuple.assign_cmpl_proj (QTuple &$topic,
set_of.Name $attr_names)>
...
C<updater sys.std.Core.Relation.assign_insertion (QRelation &$r,
QTuple $t)>
...
C<updater sys.std.Core.Relation.assign_disjoint_ins (QRelation &$r,
QTuple $t)>
...
C<updater sys.std.Core.Relation.assign_union (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.Core.Relation.assign_disjoint_union (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.Core.Relation.assign_deletion (QRelation &$r,
QTuple $t)>
...
C<updater sys.std.Core.Relation.assign_restriction (QRelation &$topic,
...
C<updater sys.std.Core.Relation.assign_intersection (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.Core.Relation.assign_diff (QRelation &$source,
QRelation $filter)>
...
C<updater sys.std.Core.Relation.assign_semidiff (QRelation &$source,
QRelation $filter)>
...
C<updater sys.std.Core.Relation.assign_antijoin (QRelation &$source,
QRelation $filter)>
...
C<updater sys.std.Core.Relation.assign_semijoin (QRelation &$source,
QRelation $filter)>
...
C<updater sys.std.Core.Relation.assign_rename (QRelation &$topic,
AttrRenameMap $map)>
...
C<updater sys.std.Core.Relation.assign_extension (QRelation &$topic,
...
C<updater sys.std.Core.Relation.assign_projection (QRelation &$topic,
set_of.Name $attr_names)>
...
C<updater sys.std.Core.Relation.assign_cmpl_proj (QRelation &$topic,
set_of.Name $attr_names)>
