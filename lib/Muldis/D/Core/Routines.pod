...
This document is Muldis::D::Core::Routines version 0.73.0.
...
q/scalar root type; 2. they are both subtypes of a common complete q/tuple
or q/relation type, that is they essentially have the same headings; 3. at
...
arguments.  Note that this operation is also known as I<is not equal> or
C<≠>.
...
C<< function sys.std.Core.QScalar.attr (Universal <-- QScalar $topic,
...
C<< function sys.std.Core.QScalar.update_attr (QScalar <-- QScalar $topic,
...
C<< function sys.std.Core.QScalar.multi_update (QScalar <-- QScalar $topic,
Name $possrep?, QTuple $attrs) >>
...
C<< function sys.std.Core.QScalar.projection (QTuple <-- QScalar $topic,
...
C<< function sys.std.Core.QScalar.cmpl_projection (QTuple <--
QScalar $topic, Name $possrep?, set_of.Name $attr_names) >>
...
C<< function sys.std.Core.QScalar.QTuple_from_QScalar (QTuple <--
QScalar $topic, Name $possrep?) >>
...
C<< function sys.std.Core.QScalar.QScalar_from_QTuple (QScalar <--
QTuple $topic, TypeRef $type, Name $possrep?) >>
...
C<< function sys.std.Core.QScalar.order (Order <-- QScalar $topic,
QScalar $other, QTuple $assuming?, Bool $is_reverse_order?) >>

This C<order_determination> function is the externalization of a q/scalar
...
are not values of a common q/scalar root type that declares a type-default
...
q/tuple argument would be of degree zero.  This function also has a
...
descending order).  The C<assuming> and C<is_reverse_order> parameters are
...
C<< function sys.std.Core.QScalar.has_possrep (Bool <-- QScalar $topic,
Name $possrep?) >>
...
C<< function sys.std.Core.QScalar.possrep_names (set_of.Name <--
QScalar $topic) >>
...
C<< function sys.std.Core.QScalar.degree (NNInt <-- QScalar $topic,
Name $possrep?) >>
...
C<< function sys.std.Core.QScalar.has_attrs (Bool <-- QScalar $topic,
Name $possrep?, set_of.Name $attr_names) >>
...
C<< function sys.std.Core.QScalar.attr_names (set_of.Name <--
QScalar $topic, Name $possrep?) >>
...
this operation is also known as I<all> or I<conjunction> or C<∧>.
...
C<Bool:true>, and C<Bool:false> otherwise.
...
commutative and associative) on them until just one is left, which is the
function's result.  For each pair of input values, the I<or> of that pair
is C<Bool:false> iff both input values are C<Bool:false>, and C<Bool:true>
otherwise.  If C<topic> has zero values, then C<or> results in
C<Bool:false>, which is the identity value for logical inclusive-or.  Note
that this operation is also known as I<any> or I<disjunction> or C<∨>.
...
C<< function sys.std.Core.Bool.xor (Bool <-- bag_of.Bool $topic?) >>
...
I<not equivalent> (dyadic usage) or C<⊻> or C<↮>.  Note that a dyadic (2
input value) invocation of C<xor> is exactly the same operation as a
C<sys.std.Core.Universal.is_not_identical> invocation whose arguments are
both C<Bool>-typed.
...
C<< function sys.std.Core.QTuple.attr (Universal <-- QTuple $topic,
Name $name) >>
...
C<< function sys.std.Core.QTuple.update_attr (QTuple <-- QTuple $topic,
...
C<< function sys.std.Core.QTuple.multi_update (QTuple <-- QTuple $topic,
QTuple $attrs) >>
...
C<< function sys.std.Core.QTuple.rename (QTuple <-- QTuple $topic,
AttrRenameMap $map) >>
...
C<< function sys.std.Core.QTuple.projection (QTuple <-- QTuple $topic,
...
C<< function sys.std.Core.QTuple.cmpl_projection (QTuple <-- QTuple $topic,
set_of.Name $attr_names) >>
...
C<< function sys.std.Core.QTuple.static_extension (QTuple <--
QTuple $topic, QTuple $attrs) >>
...
C<< function sys.std.Core.QTuple.wrap (QTuple <-- QTuple $topic,
...
C<< function sys.std.Core.QTuple.cmpl_wrap (QTuple <-- QTuple $topic,
set_of.Name $cmpl_inner, Name $outer) >>
...
C<< function sys.std.Core.QTuple.unwrap (QTuple <-- QTuple $topic,
Name $outer) >>
...
C<< function sys.std.Core.QTuple.product (QTuple <--
quasi_set_of.QTuple $topic) >>
...
=head2 sys.std.Core.QTuple.is_member

C<< function sys.std.Core.QTuple.is_member (Bool <--
QTuple $t, QRelation $r) >>

This function is an alias for C<sys.std.Core.QRelation.has_member>.  This
function results in C<Bool:true> iff its C<t> argument matches a q/tuple of
...
=head2 sys.std.Core.QTuple.is_not_member

C<< function sys.std.Core.QTuple.is_not_member (Bool <--
QTuple $t, QRelation $r) >>

This function is an alias for C<sys.std.Core.QRelation.has_not_member>.
This function is exactly the same as C<sys.std.Core.QTuple.is_member>
except that it results in the opposite boolean value when given the same
...
C<< function sys.std.Core.QRelation.cardinality (NNInt <--
QRelation $topic) >>

This function results in the cardinality of its argument (that is, the
count of q/tuples its body has).  Note that this operation is also known as
I<count> or C<R#>.

=head2 sys.std.Core.QRelation.count

C<< function sys.std.Core.QRelation.count (NNInt <-- QRelation $topic) >>

This function is an alias for C<sys.std.Core.QRelation.cardinality>.

=head2 sys.std.Core.QRelation.has_member

C<< function sys.std.Core.QRelation.has_member (Bool <-- QRelation $r,
QTuple $t) >>
...
=head2 sys.std.Core.QRelation.has_not_member

C<< function sys.std.Core.QRelation.has_not_member (Bool <-- QRelation $r,
QTuple $t) >>

This function is exactly the same as C<sys.std.Core.QRelation.has_member>
except that it results in the opposite boolean value when given the same
arguments.  Note that this operation is also known as C<∌>.

=head2 sys.std.Core.QRelation.QTuple_from_QRelation

C<< function sys.std.Core.QRelation.QTuple_from_QRelation (QTuple <--
QRelation $topic) >>
...
C<< function sys.std.Core.QRelation.QRelation_from_QTuple (QRelation <--
QTuple $topic) >>
...
C<< function sys.std.Core.QRelation.insertion (QRelation <-- QRelation $r,
QTuple $t) >>
...
C<< function sys.std.Core.QRelation.disjoint_insertion (QRelation <--
QRelation $r, QTuple $t) >>
...
C<< function sys.std.Core.QRelation.deletion (QRelation <-- QRelation $r,
QTuple $t) >>
...
C<< function sys.std.Core.QRelation.rename (QRelation <-- QRelation $topic,
AttrRenameMap $map) >>
...
C<< function sys.std.Core.QRelation.projection (QRelation <--
QRelation $topic, set_of.Name $attr_names) >>
...
C<< function sys.std.Core.QRelation.cmpl_projection (QRelation <--
QRelation $topic, set_of.Name $attr_names) >>
...
C<< function sys.std.Core.QRelation.wrap (QRelation <-- QRelation $topic,
set_of.Name $inner, Name $outer) >>
...
C<< function sys.std.Core.QRelation.cmpl_wrap (QRelation <--
QRelation $topic, set_of.Name $cmpl_inner, Name $outer) >>
...
C<< function sys.std.Core.QRelation.unwrap (QRelation <-- QRelation $topic,
...
C<< function sys.std.Core.QRelation.group (QRelation <-- QRelation $topic,
set_of.Name $inner, Name $outer) >>
...
C<< function sys.std.Core.QRelation.cmpl_group (QRelation <--
QRelation $topic, set_of.Name $group_per, Name $outer) >>
...
C<< function sys.std.Core.QRelation.ungroup (QRelation <--
QRelation $topic, Name $outer, set_of.Name $inner) >>
...
C<< function sys.std.Core.QRelation.restriction (QRelation <--
QRelation $topic, FuncRef $func, QTuple $assuming?) >>
...
C<< function sys.std.Core.QRelation.restriction_and_cmpl (QTuple <--
QRelation $topic, FuncRef $func, QTuple $assuming?) >>
...
C<< function sys.std.Core.QRelation.cmpl_restriction (QRelation <--
QRelation $topic, FuncRef $func, QTuple $assuming?) >>
...
C<< function sys.std.Core.QRelation.extension (QRelation <-- QRelation
$topic, set_of.Name $attr_names, FuncRef $func, QTuple $assuming?) >>
...
C<< function sys.std.Core.QRelation.static_extension (QRelation <--
QRelation $topic, QTuple $attrs) >>
...
C<< function sys.std.Core.QRelation.summary (QRelation <--
QRelation $topic, set_of.Name $group_per, set_of.Name $summ_attr_names,
FuncRef $summ_func, QTuple $summ_assuming?) >>
...
q/tuple-valued attribute, respectively.  As per a function that
C<extension> applies, the function named by C<summ_func> effectively takes
a whole post-grouping input q/tuple and results in a partial q/tuple that
would be joined by C<summary> with the C<per> q/tuple to get the result
q/tuple; the applied
...
=head2 sys.std.Core.QRelation.cardinality_per_group

C<< function sys.std.Core.QRelation.cardinality_per_group (QRelation <--
QRelation $topic, set_of.Name $group_per, Name $count_attr_name) >>
...
C<< function sys.std.Core.QRelation.is_subset (Bool <--
QRelation $topic, QRelation $other) >>

This function results in C<Bool:true> iff the set of q/tuples comprising
C<topic> is a subset of the set of q/tuples comprising C<other>, and
...
C<< function sys.std.Core.QRelation.is_not_subset (Bool <--
QRelation $topic, QRelation $other) >>
...
=head2 sys.std.Core.QRelation.is_superset

C<< function sys.std.Core.QRelation.is_superset (Bool <--
QRelation $topic, QRelation $other) >>

This function is an alias for C<sys.std.Core.QRelation.is_subset> except
that it transposes the C<topic> and C<other> arguments.  This function
results in C<Bool:true> iff the set of q/tuples comprising C<topic> is a
superset of the set of q/tuples comprising C<other>, and C<Bool:false>
otherwise.  Note that this operation is also known as C<⊇>.

=head2 sys.std.Core.QRelation.is_not_superset

C<< function sys.std.Core.QRelation.is_not_superset (Bool <--
QRelation $topic, QRelation $other) >>

This function is an alias for C<sys.std.Core.QRelation.is_not_subset>
except that it transposes the C<topic> and C<other> arguments.  This
function is exactly the same as C<sys.std.Core.QRelation.is_superset>
except that it results in the opposite boolean value when given the same
arguments.  Note that this operation is also known as C<⊉>.

=head2 sys.std.Core.QRelation.union

C<< function sys.std.Core.QRelation.union (QRelation <--
quasi_set_of.QRelation $topic) >>
...
C<< function sys.std.Core.QRelation.disjoint_union (QRelation <--
quasi_set_of.QRelation $topic) >>
...
C<< function sys.std.Core.QRelation.intersection (QRelation <--
quasi_set_of.QRelation $topic) >>
...
C<< function sys.std.Core.QRelation.difference (QRelation <--
QRelation $source, QRelation $filter) >>
...
operation is also known as I<minus> or C<∖>.

=head2 sys.std.Core.QRelation.semidifference

C<< function sys.std.Core.QRelation.semidifference (QRelation <--
QRelation $source, QRelation $filter) >>
...
=head2 sys.std.Core.QRelation.antijoin

C<< function sys.std.Core.QRelation.antijoin (QRelation <--
QRelation $source, QRelation $filter) >>

This function is an alias for C<sys.std.Core.QRelation.semidifference>.
  
=head2 sys.std.Core.QRelation.semijoin_and_diff

C<< function sys.std.Core.QRelation.semijoin_and_diff (QTuple <--
QRelation $source, QRelation $filter) >>
...
C<< function sys.std.Core.QRelation.semijoin (QRelation <--
QRelation $source, QRelation $filter) >>
...
Note that this operation is also known as I<matching> or C<⋉>.

=head2 sys.std.Core.QRelation.join

C<< function sys.std.Core.QRelation.join (QRelation <--
quasi_set_of.QRelation $topic?) >>
...
C<< function sys.std.Core.QRelation.product (QRelation <--
quasi_set_of.QRelation $topic?) >>
...
C<< function sys.std.Core.QRelation.quotient (QRelation <--
QRelation $dividend, QRelation $divisor) >>
...
∖ A){X}>.  Note that this operation is also known as I<divide> or C<÷>.
...
C<updater sys.std.Core.QTuple.assign_rename (QTuple &$topic,
AttrRenameMap $map)>
...
C<updater sys.std.Core.QTuple.assign_static_extension (QTuple &$topic,
QTuple $attrs)>
...
C<updater sys.std.Core.QTuple.assign_projection (QTuple &$topic,
set_of.Name $attr_names)>
...
C<updater sys.std.Core.QTuple.assign_cmpl_projection (QTuple &$topic,
set_of.Name $attr_names)>
...
C<updater sys.std.Core.QRelation.assign_insertion (QRelation &$r,
QTuple $t)>
...
C<updater sys.std.Core.QRelation.assign_disjoint_insertion (QRelation &$r,
QTuple $t)>
...
C<updater sys.std.Core.QRelation.assign_union (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.Core.QRelation.assign_disjoint_union (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.Core.QRelation.assign_deletion (QRelation &$r,
QTuple $t)>
...
C<updater sys.std.Core.QRelation.assign_restriction (QRelation &$topic,
...
C<updater sys.std.Core.QRelation.assign_cmpl_restriction
(QRelation &$topic, FuncRef $func, QTuple $assuming?)>
...
C<updater sys.std.Core.QRelation.assign_intersection (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.Core.QRelation.assign_difference (QRelation &$source,
QRelation $filter)>
...
C<updater sys.std.Core.QRelation.assign_semidifference (QRelation &$source,
QRelation $filter)>
...
=head2 sys.std.Core.QRelation.assign_antijoin

C<updater sys.std.Core.QRelation.assign_antijoin (QRelation &$source,
QRelation $filter)>

This update operator is an alias for
C<sys.std.Core.QRelation.assign_semidifference>.

=head2 sys.std.Core.QRelation.assign_semijoin

C<updater sys.std.Core.QRelation.assign_semijoin (QRelation &$source,
QRelation $filter)>
...
C<updater sys.std.Core.QRelation.assign_rename (QRelation &$topic,
AttrRenameMap $map)>
...
C<updater sys.std.Core.QRelation.assign_extension (QRelation &$topic,
set_of.Name $attr_names, FuncRef $func, QTuple $assuming?)>
...
C<updater sys.std.Core.QRelation.assign_static_extension
(QRelation &$topic, QTuple $attrs)>
...
C<updater sys.std.Core.QRelation.assign_projection (QRelation &$topic,
set_of.Name $attr_names)>
...
C<updater sys.std.Core.QRelation.assign_cmpl_projection (QRelation &$topic,
set_of.Name $attr_names)>
...
C<updater sys.std.Core.Control.upd_invo (ProcRef $updater,
QTuple &$upd_args, QTuple $ro_args?)>
...
C<procedure sys.std.Core.Control.proc_invo (ProcRef $procedure,
QTuple &$upd_args?, QTuple $ro_args?)>
...
C<procedure sys.std.Core.Control.try_catch (ProcRef $try,
QTuple &$try_updating?, QTuple $try_assuming?, ProcRef $catch,
QTuple &$catch_updating?, QTuple $catch_assuming?)>
...
C<bootloader_exclusive sys.std.Core.Control.start_trans ()>

This system service starts a new child-most transaction.

=head2 sys.std.Core.Control.commit_trans

C<bootloader_exclusive sys.std.Core.Control.commit_trans ()>
...
C<bootloader_exclusive sys.std.Core.Control.rollback_trans ()>
