...
This document is Muldis::D::Core::Routines version 0.54.0.
...
a common non-incomplete q/tuple or q/relation type, that is they
essentially have the same headings; 3. at least one type is a generic
(eg-C<Universal>) or incomplete (eg-C<Array>) type, and it is a supertype
of the other.
