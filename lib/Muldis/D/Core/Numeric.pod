...
This document is Muldis::D::Core::Numeric version 0.117.0.
...
C<< function sys.std.Core.Numeric.abs (Numeric <-- $topic@ : Numeric) >>

This virtual function results in the absolute value of its argument.

=head2 sys.std.Core.Numeric.sum

C<< function sys.std.Core.Numeric.sum (Numeric <--
...
type-specific implementing function to dispatch to.

=head2 sys.std.Core.Numeric.diff

C<< function sys.std.Core.Numeric.diff (Numeric <-- $minuend@ : Numeric,
$subtrahend@ : Numeric) >>
...
C<< function sys.std.Core.Numeric.abs_diff (Numeric <-- $topic@ : Numeric,
$other@ : Numeric) >>
...
C<< function sys.std.Core.Numeric.product (Numeric <--
$topic@ : bag_of.Numeric) >>
...
C<< function sys.std.Core.Numeric.frac_quotient (Numeric <--
...
C<< function sys.std.Core.Numeric.whole_quotient (Numeric <--
...
C<< function sys.std.Core.Numeric.remainder (Numeric <--
$dividend@ : Numeric, $divisor@ : Numeric, $round_meth : RoundMeth) >>
...
fail if C<divisor> is zero.

=head2 sys.std.Core.Numeric.quot_and_rem

C<< function sys.std.Core.Numeric.quot_and_rem (Tuple <--
$dividend@ : Numeric, $divisor@ : Numeric, $round_meth : RoundMeth) >>
...
C<< function sys.std.Core.Numeric.range (Numeric <--
$topic@ : set_of.Numeric) >>
...
C<< function sys.std.Core.Numeric.frac_mean (Numeric <--
$topic@ : bag_of.Numeric) >>
...
C<< function sys.std.Core.Numeric.median (set_of.Numeric <--
$topic@ : bag_of.Numeric) >>
...
C<< function sys.std.Core.Numeric.frac_mean_of_median (Numeric <--
$topic@ : bag_of.Numeric) >>
...
C<< function sys.std.Core.Numeric.mode (set_of.Numeric <--
$topic@ : bag_of.Numeric) >>
...
C<< function sys.std.Core.Numeric.power_with_whole_exp (Numeric <--
...
1 if C<radix> and C<exponent> are both zero (rather than failing).
