...
This document is Muldis::D::Core::Interval version 0.136.0.
...
values, this function tests if C<value> is a member of C<coll>.  Note
...
otherwise.  That is, if conceptually the interval represents a set of
values, this function tests if C<value> is a member of C<coll>.  Note
that this operation is also known as C<∈i> or C<in-i>.
