...
This document is Muldis::D::Core::Interval version 0.112.0.
...
that this operation is also known as C<I∋> or C<Ihas>.
...
otherwise.  That is, if conceptually the interval represents a set of
values, this function tests if C<value> is a member of C<interval>.  Note
that this operation is also known as C<I∈> or C<Iin> or C<between>, and
...
that this operation is also known as C<I∉> or C<I!in> or C<Inot-in>
