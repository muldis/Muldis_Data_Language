...
Muldis D Interval specific operators

=head1 VERSION

This document is Muldis::D::Core::Interval version 0.104.0.
...
This document describes generic operators that are specific
...
$interval : Interval, $value : Universal, $func? : OrdDetCFuncNC) >>
...
$value : Universal, $interval : Interval, $func? : OrdDetCFuncNC) >>
