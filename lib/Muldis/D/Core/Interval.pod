...
This document is Muldis::D::Ext::Interval version 0.100.0.
...
C<< function sys.std.Core.Interval.has_member (Bool <-- $interval : Interval,
...
This function is exactly the same as C<sys.std.Core.Interval.has_member> except
...
C<< function sys.std.Core.Interval.value_is_member (Bool <-- $value : Universal,
...
C<< function sys.std.Core.Interval.value_is_not_member (Bool <-- $value : Universal,
$interval : Interval, $func? : OrdDetFuncRef) >>

This function is an alias for C<sys.std.Core.Interval.has_not_member>.  This
function is exactly the same as C<sys.std.Core.Interval.value_is_member> except that it
