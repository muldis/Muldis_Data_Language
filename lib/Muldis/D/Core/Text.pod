...
This document is Muldis::D::Core::Text version 0.129.1.
...
C<< function sys.std.Core.Text.order (Order <-- $topic : Text,
...
C<< function sys.std.Core.Text.cat_with_sep (Text <--
...
C<< function sys.std.Core.Text.marks_stripped (Text <-- $topic : Text)
{...} >>
