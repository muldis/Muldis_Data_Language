...
This document is Muldis::D::Core::Ordered version 0.129.1.
...
C<< function is_before (Bool <-- $topic : Universal,
...
C<< function is_after (Bool <-- $topic : Universal,
$other : Universal, $func? : OrdDetCFuncNC) {...} >>
...
C<< function min (Universal <-- $topic : Set,
$func? : OrdDetCFuncNC) {...} >>
...
C<< function max (Universal <-- $topic : Set,
$func? : OrdDetCFuncNC) {...} >>
...
C<< function minmax (Tuple <-- $topic : Set,
$func? : OrdDetCFuncNC) {...} >>
...
C<updater sys.std.Core.Ordered.Ordinal.assign_pred (&$topic@ : Ordinal)
{...}>
...
C<updater sys.std.Core.Ordered.Ordinal.assign_succ (&$topic@ : Ordinal)
{...}>
