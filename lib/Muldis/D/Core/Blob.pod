...
This document is Muldis::D::Core::Blob version 0.100.0.
...
C<< function sys.std.Core.Blob.catenation (Blob <--
$topic? : array_of.Blob) >>
...
C<< function sys.std.Core.Blob.has_not_substr_bits (Bool <--
$look_in : Blob,
$look_for : Blob, $fixed_start? : Bool, $fixed_end? : Bool) >>
...
C<< function sys.std.Core.Blob.has_substr_octets (Bool <--
$look_in : OctetBlob,
