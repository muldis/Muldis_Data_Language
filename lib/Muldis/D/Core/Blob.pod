...
C<< function sys.std.Blob.replication (Blob <-- $topic : Blob,
$count : NNInt) >>
...
C<< function sys.std.Blob.has_not_substr_bits (Bool <-- $look_in : Blob,
$look_for : Blob, $fixed_start? : Bool, $fixed_end? : Bool) >>
...
C<< function sys.std.Blob.has_substr_octets (Bool <-- $look_in : OctetBlob,
