...
This document is Muldis::D::Core::Blob version 0.130.0.
...
C<< function has_not_substr_bits (Bool <--
look_in : Blob,
look_for : Blob, fixed_start? : Bool, fixed_end? : Bool) {...} >>
...
C<< function has_substr_octets (Bool <--
look_in : OctetBlob,
...
C<< function has_not_substr_octets (Bool <--
