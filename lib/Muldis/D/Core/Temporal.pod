...
Muldis::D::Core::Temporal -
Muldis D extension for Temporal specific operators

=head1 VERSION

This document is Muldis::D::Core::Temporal version 0.100.0.
...
=head2 sys.std.Core.Temporal.Instant.diff

C<< function sys.std.Core.Temporal.Instant.diff (Duration <--
...
=head2 sys.std.Core.Temporal.Instant.abs_diff

C<< function sys.std.Core.Temporal.Instant.abs_diff (Duration <--
...
=head2 sys.std.Core.Temporal.Instant.later

C<< function sys.std.Core.Temporal.Instant.later (Instant <--
...
=head2 sys.std.Core.Temporal.Instant.earlier

C<< function sys.std.Core.Temporal.Instant.earlier (Instant <--
$instant : Instant, $duration : Duration) >>
...
=head2 sys.std.Core.Temporal.Duration.abs

C<< function sys.std.Core.Temporal.Duration.abs (Duration <--
$topic : Duration) >>

This function results in the absolute value of its argument.

=head2 sys.std.Core.Temporal.Duration.sum

C<< function sys.std.Core.Temporal.Duration.sum (Duration <--
...
=head2 sys.std.Core.Temporal.Duration.diff

C<< function sys.std.Core.Temporal.Duration.diff (Duration <--
...
=head2 sys.std.Core.Temporal.Instant.fetch_curr_instant

C<system-service sys.std.Core.Temporal.Instant.fetch_curr_instant
(&$target : Instant)>
