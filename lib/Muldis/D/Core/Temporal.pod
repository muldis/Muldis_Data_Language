...
Muldis D operators for TAI temporal data types

=head1 VERSION

This document is Muldis::D::Core::Temporal version 0.104.0.
...
are specific to the core data types C<Instant> and C<Duration>, which
represent TAI temporal artifacts.
