...
C<< function Tuple_from_Relation (Tuple <--
$topic : Relation) {...} >>
...
C<< function Relation_from_Tuple (Relation <--
$topic : Tuple) {...} >>
...
C<< function Text_from_Int (Text <-- $int : Int,
$radix? : PInt2_36) {...} >>
...
C<< function Text_from_Rat (Text <-- $rat : Rat,
$radix? : PInt2_36) {...} >>
...
C<< function Blob_from_Text (Blob <-- $text : Text,
$size : PInt1_4) {...} >>
...
C<< function Text_from_Blob (Text <-- $blob : Blob,
$size : PInt1_4) {...} >>
