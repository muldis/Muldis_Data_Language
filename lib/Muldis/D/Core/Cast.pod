...
Muldis::D::Core::Cast -
Muldis D extension for explicit type-casting operators

=head1 VERSION

This document is Muldis::D::Core::Cast version 0.100.0.
...
C<< function sys.std.Core.Cast.Tuple_from_Relation (Tuple <--
$topic : Relation) >>
...
C<< function sys.std.Core.Cast.Relation_from_Tuple (Relation <--
$topic : Tuple) >>
...
C<< function sys.std.Core.Cast.Set_from_Bag (Set <-- $topic : Bag) >>
...
C<< function sys.std.Core.Cast.Bag_from_Set (Bag <-- $topic : Set) >>
...
C<< function sys.std.Core.Cast.Int_from_Rat (Int <-- $rat : Rat,
...
C<< function sys.std.Core.Cast.Rat_from_Int (Rat <-- $int : Int) >>
...
C<< function sys.std.Core.Cast.Int_from_Text (Int <-- $text : Text,
$radix : PInt2_36) >>
...
C<< function sys.std.Core.Cast.Text_from_Int (Text <-- $int : Int,
$radix : PInt2_36) >>
...
C<< function sys.std.Core.Cast.Rat_from_Text (Rat <-- $text : Text,
$radix : PInt2_36) >>
...
C<< function sys.std.Core.Cast.Text_from_Rat (Text <-- $rat : Rat,
$radix : PInt2_36) >>
...
C<< function sys.std.Core.Cast.Blob_from_Text (Blob <-- $text : Text,
$size : PInt1_4) >>
...
C<< function sys.std.Core.Cast.Text_from_Blob (Text <-- $blob : Blob,
$size : PInt1_4) >>
...
C<< function sys.std.Core.Cast.Int_from_Blob_S_VBE (Int <-- $blob : Blob)
>>
...
C<< function sys.std.Core.Cast.Blob_S_VBE_from_Int (Blob <-- $int : Int) >>
...
C<< function sys.std.Core.Cast.Int_from_Blob_U_VBE (NNInt <-- $blob : Blob)
>>
...
C<< function sys.std.Core.Cast.Blob_U_VBE_from_Int (NNInt <-- $blob : Blob)
>>
