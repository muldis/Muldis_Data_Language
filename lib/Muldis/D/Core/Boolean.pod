...
This document is Muldis::D::Core::Boolean version 0.123.0.
...
C<< function sys.std.Core.Boolean.order (Order <-- $topic : Bool,
...
C<< function sys.std.Core.Boolean.pred (Bool <-- $topic : Bool)
...
C<< function sys.std.Core.Boolean.succ (Bool <-- $topic : Bool)
...
C<< function sys.std.Core.Boolean.not (Bool <-- $topic : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.and (Bool <-- $topic? : set_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.all (Bool <-- $topic? : set_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.nand (Bool <-- $topic : Bool,
$other : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.or (Bool <-- $topic? : set_of.Bool) {...}
>>
...
C<< function sys.std.Core.Boolean.any (Bool <-- $topic? : set_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.nor (Bool <-- $topic : Bool,
$other : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.xnor (Bool <-- $topic? : bag_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.iff (Bool <-- $topic? : bag_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.xor (Bool <-- $topic? : bag_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.imp (Bool <-- $topic : Bool,
$other : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.implies (Bool <-- $topic : Bool,
$other : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.nimp (Bool <-- $topic : Bool,
$other : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.if (Bool <-- $topic : Bool,
$other : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.nif (Bool <-- $topic : Bool,
$other : Bool) {...} >>
...
C<< function sys.std.Core.Boolean.not_all (Bool <-- $topic? : set_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.none (Bool <-- $topic? : set_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.not_any (Bool <-- $topic? : set_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.one (Bool <-- $topic? : bag_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.not_one (Bool <-- $topic? : bag_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.exactly (Bool <-- $topic? : bag_of.Bool,
$count : NNInt) {...} >>
...
C<< function sys.std.Core.Boolean.not_exactly (Bool <--
...
C<< function sys.std.Core.Boolean.true (NNInt <-- $topic? : bag_of.Bool)
{...} >>
...
C<< function sys.std.Core.Boolean.false (NNInt <-- $topic? : bag_of.Bool)
{...} >>
...
C<updater sys.std.Core.Boolean.assign_pred (&$topic : Bool)
...
C<updater sys.std.Core.Boolean.assign_succ (&$topic : Bool)
