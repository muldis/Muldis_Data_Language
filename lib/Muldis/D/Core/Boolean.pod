...
This document is Muldis::D::Core::Boolean version 0.130.0.
...
C<< function nand (Bool <-- topic : Bool,
other : Bool) {...} >>
...
C<< function nor (Bool <-- topic : Bool,
other : Bool) {...} >>
...
C<< function imp (Bool <-- topic : Bool,
other : Bool) {...} >>
...
C<< function implies (Bool <-- topic : Bool,
other : Bool) {...} >>
...
C<< function nimp (Bool <-- topic : Bool,
other : Bool) {...} >>
...
C<< function nif (Bool <-- topic : Bool,
other : Bool) {...} >>
...
C<< function exactly (Bool <-- topic? : bag_of.Bool,
count : NNInt) {...} >>
