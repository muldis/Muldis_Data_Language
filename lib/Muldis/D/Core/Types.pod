...
This document is Muldis::D::Core::Types version 0.74.0.
...
system-defined possrep named C<nfd_codepoints> which consists of 1
C<UCPString>-typed attribute whose name is the empty string; each element
of C<nfd_codepoints> represents a Unicode standard version 5.1.0 character
...
aka I<empty set>, aka I<∅>, which serves as
