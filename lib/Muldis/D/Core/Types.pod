...
The C<SPInterval> type only represents a single-piece interval, but a
multi-piece interval may be effectively represented by a set of
C<SPInterval> values, either a relation-from-C<SPInterval> or a
C<set_of.SPInterval>.
