...
This document is Muldis::D::Core::Types version 0.53.0.
...
This is an enumeration data type.  An C<OString> (octet string) is a proper
subtype of C<String> where all member value elements are between zero and
...
This is an enumeration data type.  An C<OctetBlob> is a proper subtype of
