...
This document is Muldis::D::Core::Types version 0.22.1.
...
relationships:
    ...
    sys.std.Core.Type.Universal
        ...
        sys.std.Core.Type.Tuple
            ...
            sys.std.Core.Type.SetElem
            sys.std.Core.Type.SeqElem
            sys.std.Core.Type.BagElem
        ...
        sys.std.Core.Type.QuasiTuple
            ...
            sys.std.Core.Type.QuasiSetElem
            sys.std.Core.Type.QuasiSeqElem
            sys.std.Core.Type.QuasiBagElem
...
C<sys.std.Core.Type.(Set|Maybe|Seq|Bag)OfBool>.

Note that C<sys.std.Core.Universal.Empty> is a proper subtype of all of the
...
=head2 sys.std.Core.Universal.Universal
...
=head2 sys.std.Core.Universal.Empty
...
=item C<sys.std.Core.Type.(Set|Maybe|Seq|Bag)OfBool>
