...
This document is Muldis::D::Core::Types version 0.93.0.
...
C<order_determination> function must explicitly be employed.
...
C<order_determination> function is used with the interval; that function
...
With respect to each compatible C<order_determination> function, an
I<Interval> is considered empty iff at least one of the following is true:
