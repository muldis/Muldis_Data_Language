...
This document is Muldis::D::Core::Types version 0.24.0.
...
A C<Array> is a proper subtype of C<Relation> that has 2 attributes, and
...
any declared type).  A Array is considered dense, and all C<index> values
in one are numbered consecutively from 0 to 1 less than the count of
tuples, like array indices in typical programming languages.  A C<Array>
...
ordering for C<value>.  Its default value has zero tuples.
