...
This is an enumeration data type.  C<QuasiTupleD0> is a proper subtype of
...
This is an enumeration data type.  C<QuasiRelationD0> is a proper subtype
...
This is an enumeration data type.  C<QuasiSet> is a proper subtype of
...
This is an enumeration data type.  C<QuasiMaybe> is a proper subtype of
...
This is an enumeration data type.  C<QuasiNothing> is a proper subtype of
...
This is an enumeration data type.  C<QuasiSingle> is a proper subtype of
...
This is an enumeration data type.  C<QuasiArray> is a proper subtype of
C<QuasiRelation> in the corresponding manner to C<Array> being a proper
subtype of C<Relation>.  Its cardinality is infinite.

=head2 sys.std.Core.Type.QuasiBag

This is an enumeration data type.  C<QuasiBag> is a proper subtype of
