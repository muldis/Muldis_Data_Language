...
types, including: C<Bool>, C<Int>, C<Rat>, C<Blob>, C<Unicode_Text>.  The
...
the C<Unicode_Text> value empty string.  The C<Stringy> type is not itself
...
the C<Unicode_Text> value empty string.  The C<Text> type is not itself
