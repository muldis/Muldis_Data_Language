...
folded first.  A C<Text> has 1 system-defined possrep named C<codepoints>
which consists of 1 C<UCPString>-typed attribute whose name is
the empty string; each element of C<codepoints> represents a
