...
Muldis::D::Core::Scalar -
Muldis D operators for all scalar types

=head1 VERSION

This document is Muldis::D::Core::Scalar version 0.116.0.
...
C<< function sys.std.Core.Scalar.attr (Universal <-- $topic : ScalarWP,
...
C<< function sys.std.Core.Scalar.update_attr (ScalarWP <--
$topic : ScalarWP, $possrep? : Name, $name? : Name, $value : Universal) >>
...
C<< function sys.std.Core.Scalar.multi_update (ScalarWP <--
...
C<< function sys.std.Core.Scalar.projection (Tuple <-- $topic : ScalarWP,
...
C<< function sys.std.Core.Scalar.Scalar_from_Tuple (ScalarWP <--
...
C<< function sys.std.Core.Scalar.has_possrep (Bool <-- $topic : ScalarWP,
$possrep? : Name) >>
...
C<< function sys.std.Core.Scalar.degree (NNInt <-- $topic : ScalarWP,
$possrep? : Name) >>
...
C<< function sys.std.Core.Scalar.has_attrs (Bool <-- $topic : ScalarWP,
$possrep? : Name, $attr_names : set_of.Name) >>
