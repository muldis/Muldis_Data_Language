...
This document is Muldis::D::Core::Tuple version 0.109.0.
...
C<Bool:False> otherwise.  Note that this operation is also known as C<∈> or
C<imem>.
...
arguments.  Note that this operation is also known as C<∉> or C<!imem> or
C<not-imem>.
