...
This function is exactly the same as C<sys.std.Core.Tuple.is_nullary> except
...
C<< function sys.std.Core.Tuple.attr_from_Tuple (Universal <-- $topic : Tuple)
>>
...
C<< function sys.std.Core.Tuple.order_by_attr_names (Order <-- $topic : Tuple,
