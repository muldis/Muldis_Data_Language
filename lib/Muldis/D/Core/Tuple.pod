...
Muldis::D::Core::Tuple -
Muldis D generic tuple operators

=head1 VERSION

This document is Muldis::D::Core::Tuple version 0.114.0.
...
C<< function sys.std.Core.Tuple.D0 (Tuple <--) >>
...
C<< function sys.std.Core.Tuple.degree (NNInt <-- $topic : Tuple) >>
...
C<< function sys.std.Core.Tuple.is_nullary (Bool <-- $topic : Tuple) >>
...
C<< function sys.std.Core.Tuple.is_not_nullary (Bool <-- $topic : Tuple) >>
...
C<< function sys.std.Core.Tuple.has_attrs (Bool <-- $topic : Tuple,
...
C<< function sys.std.Core.Tuple.attr_names (set_of.Name <-- $topic : Tuple)
>>
...
arguments.  Note that this operation is also known as C<∉r> or C<!in-r> or
C<not-in-r>.

=head2 sys.std.Core.Tuple.attr_from_Tuple

C<< function sys.std.Core.Tuple.attr_from_Tuple (Universal <--
$topic : Tuple) >>
...
C<< function sys.std.Core.Tuple.Tuple_from_attr (Tuple <-- $name : Name,
$value : Universal) >>
...
C<< function sys.std.Core.Tuple.order_by_attr_names (Order <--
$topic : Tuple, $other : Tuple, $order_by : array_of.OrderByName,
...
C<< function sys.std.Core.Tuple.subst_in_default (Tuple <-- $of : APTypeNC,
$subst : Tuple) >>
...
=head1 GENERIC UPDATERS FOR TUPLE VARIABLES
