...
This document is Muldis::D::Ext::Tuple version 0.100.0.
...
=head2 sys.std.Tuple.d0

C<< function sys.std.Tuple.d0 (Tuple <--) >>
...
=head2 sys.std.Tuple.degree

C<< function sys.std.Tuple.degree (NNInt <-- $topic : Tuple) >>

This function results in the degree of its argument (that is, the count of
attributes it has).

=head2 sys.std.Tuple.is_nullary

C<< function sys.std.Tuple.is_nullary (Bool <-- $topic : Tuple) >>
...
=head2 sys.std.Tuple.is_not_nullary

C<< function sys.std.Tuple.is_not_nullary (Bool <-- $topic : Tuple) >>

This function is exactly the same as C<sys.std.Tuple.is_nullary> except
that it results in the opposite boolean value when given the same argument.

=head2 sys.std.Tuple.has_attrs

C<< function sys.std.Tuple.has_attrs (Bool <-- $topic : Tuple,
...
=head2 sys.std.Tuple.attr_names

C<< function sys.std.Tuple.attr_names (set_of.Name <-- $topic : Tuple) >>
...
=head2 sys.std.Tuple.attr_from_Tuple

C<< function sys.std.Tuple.attr_from_Tuple (Universal <-- $topic : Tuple)
>>
...
=head2 sys.std.Tuple.Tuple_from_attr

C<< function sys.std.Tuple.Tuple_from_attr (Tuple <-- $name : Name,
$value : Universal) >>
...
=head2 sys.std.Tuple.order_by_attr_names

C<< function sys.std.Tuple.order_by_attr_names (Order <-- $topic : Tuple,
$other : Tuple, $order_by : array_of.OrderByName,
...
elements is the result of invoking C<sys.std.Core.Scalar.order> on the
...
=head2 sys.std.Tuple.subst_in_default

C<< function sys.std.Tuple.subst_in_default (Tuple <-- $of : TypeRef,
$subst : Tuple) >>
