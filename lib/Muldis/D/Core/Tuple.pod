...
C<< function has_attrs (Bool <-- topic : Tuple,
...
C<< function attr (Universal <-- topic : Tuple,
name : Name) {...} >>
...
C<< function multi_update (Tuple <-- topic : Tuple,
attrs : Tuple) {...} >>
...
C<< function rename (Tuple <-- topic : Tuple,
map : AttrRenameMap) {...} >>
...
C<< function projection (Tuple <-- topic : Tuple,
attr_names : set_of.Name) {...} >>
...
C<< function cmpl_proj (Tuple <-- topic : Tuple,
attr_names : set_of.Name) {...} >>
...
C<< function wrap (Tuple <-- topic : Tuple,
...
C<< function unwrap (Tuple <-- topic : Tuple,
...
C<< function attr_from_Tuple (Universal <--
topic : Tuple) {...} >>
...
C<< function order_by_attr_names (Order <--
...
C<updater assign_rename (&topic : Tuple,
map : AttrRenameMap) {...}>
...
C<updater assign_static_exten (&topic : Tuple,
attrs : Tuple) {...}>
...
C<updater assign_projection (&topic : Tuple,
attr_names : set_of.Name) {...}>
...
C<updater assign_cmpl_proj (&topic : Tuple,
attr_names : set_of.Name) {...}>
