...
This document is Muldis::D::Core::Array version 0.112.0.
...
C<< function sys.std.Core.Array.order (Order <-- $topic : Array,
...
C<Array> values, especially for homogeneous ones such as C<String>.  Iff
...
result; if it is C<Bool:True>, then it reverses the result.  This function
provides default semantics for ordering these scalar types:  C<Blob>,
C<Text>, C<NameChain>, and any others defined over those or C<String>.
