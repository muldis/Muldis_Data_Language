...
This document is Muldis::D::Ext::Array version 0.100.0.
...
C<< function sys.std.Array.value (Universal <-- $topic : Array,
$index : NNInt) >>
...
C<< function sys.std.Array.update_value (Array <-- $topic : Array,
...
C<< function sys.std.Array.insertion (Array <-- $topic : Array,
$index : NNInt, $value : Universal) >>
...
C<< function sys.std.Array.deletion (Array <-- $topic : Array,
$index : NNInt) >>
...
C<< function sys.std.Array.has_elem (Bool <-- $topic : Array,
$value : Universal) >>
...
C<< function sys.std.Array.has_not_elem (Bool <-- $topic : Array,
$value : Universal) >>
...
C<< function sys.std.Array.reduction (Universal <-- $topic : Array,
...
C<< function sys.std.Array.maybe_reduction (Maybe <-- $topic : Array,
$func : ValRedFuncRef) >>
...
C<< function sys.std.Array.slice (Array <-- $topic : Array,
$index_interval : interval_of.NNInt) >>
...
C<< function sys.std.Array.catenation (Array <-- $topic? : array_of.Array)
>>
...
C<< function sys.std.Array.replication (Array <-- $topic : Array,
$count : NNInt) >>
...
C<< function sys.std.Array.reverse (Array <-- $topic : Array) >>
...
C<< function sys.std.Array.has_subarray (Bool <-- $look_in : Array,
$look_for : Array) >>
...
C<< function sys.std.Array.has_not_subarray (Bool <-- $look_in : Array,
$look_for : Array) >>
...
$topic : Relation, $ord_func : OrdDetFuncRef, $is_reverse_order? : Bool) >>
...
$topic : Relation, $ord_func : OrdDetFuncRef,
$is_reverse_order? : Bool, $index_interval : interval_of.NNInt) >>
...
C<< function sys.std.Array.Array_from_attr (Array <-- $topic : Relation,
