...
This document is Muldis::D::Core::Array version 0.129.1.
...
C<< function catenation (Array <--
$topic? : array_of.Array) implements sys.std.Core.Stringy.catenation {...}
>>
...
C<< function value (Universal <-- $topic : Array,
$index : NNInt) {...} >>
...
C<< function deletion (Array <-- $topic : Array,
$index : NNInt) {...} >>
...
C<< function has_elem (Bool <-- $topic : Array,
$value : Universal) {...} >>
...
C<< function has_not_elem (Bool <-- $topic : Array,
$value : Universal) {...} >>
...
C<< function Array_from_wrap (array_of.Tuple <--
...
C<< function Array_from_attr (Array <--
$topic : Relation, $name : Name, $ord_func? : OrdDetCFuncNC,
