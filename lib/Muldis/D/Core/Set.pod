...
This document is Muldis::D::Ext::Set version 0.100.0.
...
This function is exactly the same as C<sys.std.Core.Set.has_member> except that
...
This function is an alias for C<sys.std.Core.Set.has_member>.  This function
...
This function is an alias for C<sys.std.Core.Set.has_not_member>.  This function
is exactly the same as C<sys.std.Core.Set.value_is_member> except that it
...
C<< function sys.std.Core.Set.insertion (Set <-- $set : Set, $value : Universal)
>>
...
This function is exactly the same as C<sys.std.Core.Set.insertion> except that
it will fail if C<value> already exists in C<set>.

=head2 sys.std.Core.Set.deletion

C<< function sys.std.Core.Set.deletion (Set <-- $set : Set, $value : Universal)
>>
...
This function is exactly the same as C<sys.std.Core.Set.reduction> except that
...
$topic? : array_of.Maybe, $default : TypeRef) >>
...
$other : Maybe, $treat_nothing_as_max : Bool, $ord_func? : OrdDetFuncRef,
...
C<order-determination> function given in its C<ord_func> argument, as
