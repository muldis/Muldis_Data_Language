...
$other : Maybe, $treat_Nothing_as_max : Bool, $ord_func? : OrdDetCFuncNC,
...
C<Maybe> is used analogously to a SQL nullable value and this function is
analogous to the dyadic comparison underlying a SQL "ORDER BY", then
