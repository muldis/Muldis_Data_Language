...
C<< function has_member (Bool <-- $set : Set,
$value : Universal) {...} >>
...
C<< function has_not_member (Bool <-- $set : Set,
$value : Universal) {...} >>
...
C<< function insertion (Set <-- $set : Set,
$value : Universal) {...} >>
...
C<< function disjoint_ins (Set <-- $set : Set,
$value : Universal) {...} >>
...
C<< function deletion (Set <-- $set : Set,
$value : Universal) {...} >>
...
C<< function Set_from_wrap (set_of.Tuple <--
$topic : Relation) {...} >>
...
C<< function Set_from_attr (Set <-- $topic : Relation,
$name : Name) {...} >>
...
argument is a C<Single>.  Note that this operation is also known as C<.{}>.
