...
This document is Muldis::D::Core::Set version 0.130.0.
...
other : Maybe, J_ord_func? : OrdDetCFuncNC, J_is_reverse_order? : Bool,
...
curried by its C<J_is_reverse_order> argument; to be specific, the
