        ...
        sys.std.Core.Type.Scalar
            sys.std.Core.Type.DHScalar
                ...
                sys.std.Core.Type.Cat.String
                    ...
                    sys.std.Core.Type.Cat.MCPString
...
the C<Minimal_Text> type.  The cardinality of this type is infinity.
...
=head2 sys.std.Core.Type.Cat.MCPString

C<MCPString> (minimal abstract codepoint string) is a proper subtype of
C<String> where all member value elements are between zero and 63
inclusive.  One can be used to represent a string of characters of a
64-character repertoire.  Considering the low-level type system, for every
C<MCPString> value, its second C<Structure> element is the C<Int> value
C<-6> (text with Muldis D proprietary minimal repertoire like base64url).
