...
This document is Muldis::D::Core::Types_Catalog version 0.24.1.
        ...
        sys.Core.Type.Relation
            ...
            sys.Core.Type.Set
                ...
                sys.Core.Type.Maybe
                    ...
                    sys.Core.Type.Cat.SingleOfComment
...
=head2 sys.Core.Type.Cat.SysSpecTypeSet
...
=head2 sys.Core.Type.Cat.SysScaNPRTypeSet
...
=head2 sys.Core.Type.Cat.ExprNodeSet
...
=head2 sys.Core.Type.Cat.InnerUpdBody
...
=head2 sys.Core.Type.Cat.InnerProcBody
...
=head2 sys.Core.Type.Cat.(Scalar|Domain)Type
...
=head2 sys.Core.Type.Cat.InnerScalarType
...
=head2 sys.Core.Type.Cat.PossrepSet
...
=head2 sys.Core.Type.Cat.PossrepMapSet
...
=head2 sys.Core.Type.Cat.InnerDomainType

A C<Cat.InnerDomainType> is a C<Tuple>.  It defines a new data (sub-)type
simply in terms of its values being an explicit subset of the values of a
specified single other type (and it has its own default value).  It does
not define any changes or supplements to the interfaces available for
...
A C<Cat.InnerDomainType> has these 4 attributes:

=over

=item C<comment> - C<Cat.Comment>

This is an optional programmer comment about the inner domain type as a whole.

=item C<base_type> - C<Cat.NameChain>

This is the name of the other type that the current type is defined as
an explicit restriction / subtype of; it can be any type at all.

=item C<constraint> - C<Cat.InnerFuncBody>

This defines the entire (main) body of a C<type_constraint> function that
determines what supertype values are part of the domain type.  The implicit
function heading that this goes with has a single C<topic> parameter whose
declared type is of the supertype and whose argument is the value to test;
the function's implicit result type is C<Bool>.
...
=head2 sys.Core.Type.Cat.SingleOfComment
