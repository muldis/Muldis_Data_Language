...
A C<FuncBody> is a C<DHTuple>.  It specifies the entire body or
...
A C<ProcBody> is a C<DHTuple>.  It specifies the entire body or
...
A C<Type> is a C<DHTuple>.  Its purpose is as per
