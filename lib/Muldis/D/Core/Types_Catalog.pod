...
This document is Muldis::D::Core::Types_Catalog version 0.69.0.
...
root namespace as their parent, spelled C<.>, that isn't also declared
here), C<.sys.[cat|std|imp].>, C<.[mnt|tpc].cat.>,
