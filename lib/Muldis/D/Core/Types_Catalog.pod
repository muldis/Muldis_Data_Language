...
A C<Function> has these 5 attributes, of which the 3 C<result_type>,
C<params>, C<opt_params> define the I<heading> and the 1 C<expr> defines
the I<body>:
...
An C<Updater> has these 6 attributes, of which the 3 C<upd_params>,
C<ro_params>, C<opt_params> define the I<heading> and the 2 C<exprs>,
...
A C<Procedure> has these 9 attributes, of which the 6 C<upd_params>,
C<ro_params>, C<opt_params>, C<is_recipe>, C<is_system_service>,
C<is_transaction> define the
