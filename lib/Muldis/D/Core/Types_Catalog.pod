    ...
    sys.std.Core.Type.Universal
        ...
        sys.std.Core.Type.Relation
            sys.std.Core.Type.DHRelation
                ...
                sys.std.Core.Type.Cat.Sys[Union|Restr]TypeSet
                ...
                sys.std.Core.Type.Cat.[Scalar|Nonscalar|Union|Restr]TypeSet
...
=item C<[scalar|nonscalar|union|restr]_types> -
C<Sys[Scalar|Nonscalar|Union|Restr]TypeSet>
...
=head2 sys.std.Core.Type.Cat.Sys[Scalar|Nonscalar|Union|Restr]TypeSet

A C<Sys[Scalar|Nonscalar|Union|Restr]TypeSet> is a C<DHRelation> that
specifies a set of scalar|nonscalar|union|restriction system-defined types.

A C<Sys[Scalar|Nonscalar|Union|Restr]TypeSet> has these 4 attributes:
...
=item C<[scalar|nonscalar|union|restr]_types> -
C<[Scalar|Nonscalar|Union|Restr]TypeSet>
...
=head2 sys.std.Core.Type.Cat.[Scalar|Nonscalar|Union|Restr]TypeSet

An C<[Scalar|Nonscalar|Union|Restr]TypeSet> is a C<DHRelation> that
specifies a set of scalar|nonscalar|union|restriction types that a
[|sub]depot might directly contain; each type may be either public for the
DBMS as a whole or private to the subdepot.

An C<[Scalar|Nonscalar|Union|Restr]TypeSet> has these 5 attributes:
...
An C<[Scalar|Nonscalar|Union|Restr]TypeSet> has a binary primary key on the
