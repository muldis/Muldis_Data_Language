...
scalar types with possreps, and complete nonscalar types,
...
A C<Dep[Func|Upd|Proc]Set> is a C<DHRelation> that specifies a set of
...
A C<DepTypeSet> is a C<DHRelation> that specifies a set of types that a
...
These are all the definitions that this package contains of scalar
types with possreps, and complete nonscalar types, and union
...
A C<Pkg[Func|Upd|Proc]Set> is a C<DHRelation> that specifies a set of
...
A C<PkgTypeSet> is a C<DHRelation> that specifies a set of types that a
