...
=item C<data> - C<single_of.Cat.NameChain>

This is the declared data type of the dbvar that this (|sub)depot contains.

=back

The default value of C<Cat.Depot> defines an empty (|sub)depot whose
declared dbvar data type is simply C<sys.std.Core.Type.Database>.
...
This is the declared data type of the dbvar that this package contains.

=back

The default value of C<Cat.Package> defines an empty package whose declared
dbvar data type is simply C<sys.std.Core.Type.Database>.
