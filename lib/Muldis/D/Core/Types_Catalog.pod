...
expression nodes, or aliases of other expression nodes.
...
of another expression node, or is simply an alias for another expression
node, defined in terms of a C<NameChain> in the C<lex> top-level namespace.
...
attribute thereof being accessed or aliased.
