...
This document is Muldis::D::Core::Types_Catalog version 0.65.1.
...
applicable and is a C<Nothing>.  Iff the type being defined is a proper
...
not applicable and is a C<Nothing>.  Iff the type being defined is a
