...
C<Text>, C<Name>, C<NameChain>, C<Order>,
...
=item C<scm_comment> - C<just_of.Text>
...
C<Text>), and C<scm_vis_ord> (a C<NNInt>); the C<name> is the name of
...
C<scm_comment> (a C<Text>), and C<scm_vis_ord> (a C<NNInt>); the C<type>
...
C<Text>), and C<scm_vis_ord> (a C<NNInt>); the C<name> is the
