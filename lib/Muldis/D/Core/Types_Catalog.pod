...
This document is Muldis::D::Core::Types_Catalog version 0.102.0.
...
C<DeclNameChain>, C<Comment>, C<Order>, C<RatRoundMeth>, C<RatRoundRule>,
...
C<NameChain> where every member value's chain starts with one of the
