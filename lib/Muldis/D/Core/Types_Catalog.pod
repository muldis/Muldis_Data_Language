...
A C<OVLScaValExprNodeSet> is a C<DHRelation> that specifies a set of value
...
A C<OVLScaValExprNodeSet> has these 3 attributes:
...
A C<OVLScaValExprNodeSet> has a unary primary key on the C<name>
