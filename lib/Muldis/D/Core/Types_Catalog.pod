...
This document is Muldis::D::Core::Types_Catalog version 0.24.2.
...
more or less:
    ...
    sys.std.Core.Type.Universal
        ...
        sys.std.Core.Type.Scalar
            ...
            sys.std.Core.Type.Cat.E_TK
            sys.std.Core.Type.Cat.E_TDM
        ...
        sys.std.Core.Type.Relation
            ...
            sys.std.Core.Type.Set
                ...
                sys.std.Core.Type.Cat.SetOfName
                sys.std.Core.Type.Cat.SetOfNameExprMap
                sys.std.Core.Type.Cat.SetOfSetOfName
                sys.std.Core.Type.Cat.SetOfNameChain

                sys.std.Core.Type.Maybe
                    sys.std.Core.Type.Single

                    # The following are all regular single types.

                    sys.std.Core.Type.Cat.SingleOfComment

            sys.std.Core.Type.Seq

                # The following are all regular sequence types.

                sys.std.Core.Type.Cat.SeqOfProcStmt
    ...
    sys.std.Core.Type.Universal
        ...
        sys.std.Core.Type.Relation
            sys.std.Core.Type.Set
                ...
                sys.std.Core.Type.QuasiCat.SetOfTuple
                sys.std.Core.Type.QuasiCat.SetOfRelation
                    sys.std.Core.Type.QuasiCat.SetOfBag

                sys.std.Core.Type.Maybe

                    # The following are all nonscalar type factories.

                    sys.std.Core.Type.QuasiCat.MaybeOfTuple

            sys.std.Core.Type.Seq

                # The following are all nonscalar type factories.

                sys.std.Core.Type.QuasiCat.SeqOfSeq

            sys.std.Core.Type.Bag

                # The following are all nonscalar type factories.

                sys.std.Core.Type.QuasiCat.BagOfTuple
                sys.std.Core.Type.QuasiCat.BagOfRelation
        ...
        sys.std.Core.Type.QuasiRelation
            sys.std.Core.Type.QuasiSet
                ...
                sys.std.Core.Type.QuasiCat.QuasiSetOfTuple
                sys.std.Core.Type.QuasiCat.QuasiSetOfRelation
...
=item C<comment> - C<Cat.SingleOfComment>
...
=head2 sys.std.Core.Type.Cat.SeqOfProcStmt
...
=head2 sys.std.Core.Type.Cat.(Scalar|Domain)Type

A C<Cat.(Scalar|Domain)Type> is a C<Tuple>.  Its purpose is as per
C<Cat.Inner(Scalar|Domain)Type>, one of which it is a wrapper for along
with other inner types that are composed into it.

A C<Cat.(Scalar|Domain)Type> has these N attributes:
...
=item C<main_type> - C<Cat.Inner(Scalar|Domain)Type>

This defines the actual main type, which a C<Cat.(Scalar|Domain)Type> is
just a wrapper for, namely what's left of the updater body after parts of
it are optionally factored out into inner routines or inner types.

=item C<inner_types> - C<Cat.InnerTypeSet>

These are all the inner type definitions that this type contains.
...
There is a distributed (unique) key over the C<name> attributes of
C<inner_(types|funcs)>.

The default value of C<Cat.(Scalar|Domain)Type> is as per
C<Cat.Inner(Scalar|Domain)Type>.
...
=item C<base_type> - C<Cat.MaybeOfNameChain>
...
These are the possrep definitions that comprise this type such that each
one fully defines a set of attributes plus restrictions on their collective
values whereby it defines a representation of all values of this type.
Note that if multiple (|quasi-)scalar types are related to each other such
that more than one declares possreps for at least one common value, then
the C<name> attribute of the C<possreps> attributes of all of those types'
definitions have a distributed (unique) key over them.  I<Details of this
policy are subject to be revised, but it must still ensure that diamond
subtype/supertype relationships are taken properly into account.>
...
default value of the (|sub-)type; it has zero parameters and its result
...
=item C<sources> - C<Cat.SetOfNameChain>
...
=item C<filters> - C<Cat.SetOfNameChain>
...
=head2 sys.std.Core.Type.Cat.SetOfName

A C<Cat.SetOfName> is a C<Set> whose C<value> attribute has a declared type
of C<Cat.Name>.

=head2 sys.std.Core.Type.Cat.SetOfNameExprMap

A C<Cat.SetOfNameExprMap> is a C<Set> whose C<value> attribute has a
declared type of C<Cat.NameExprMap>.

=head2 sys.std.Core.Type.Cat.SetOfNameChain

A C<Cat.SetOfNameChain> is a C<Set> whose C<value> attribute has a declared
type of C<Cat.NameChain>.

=head2 sys.std.Core.Type.Cat.MaybeOfNameChain

A C<Cat.MaybeOfNameChain> is a C<Maybe> whose C<value> attribute has a
declared type of C<Cat.NameChain>.

=head2 sys.std.Core.Type.Cat.SingleOfComment

A C<Cat.SingleOfComment> is a C<Single> whose C<value> attribute has a
declared type of C<Cat.Comment>.
...
=item C<sys.std.Core.Type.QuasiCat.(Set|Bag)Of(Tuple|Relation)>
...
=item C<sys.std.Core.Type.QuasiCat.SetOfBag>
...
=item C<sys.std.Core.Type.QuasiCat.MaybeOfTuple>
...
the parameter type of the C<sys.std.Nonscalar.Relation.maybe_reduction>
operator.

=item C<sys.std.Core.Type.QuasiCat.SeqOfSeq>
...
parameter type of the N-ary C<sys.std.Sequence.catenation> operator.

=item C<sys.std.Core.Type.QuasiCat.QuasiSetOf(Tuple|Relation)>
...
C<sys.std.Core.Tuple.product> and C<sys.std.Core.Relation.(join|product)>
operators.
