...
This document is Muldis::D::Core::Types_Catalog version 0.137.0.
...
C<String> where all member value elements are between zero and x;D7FF
inclusive or x;E000 and x;10FFFF inclusive.  As of the Unicode standard
...
There are no Unicode abstract codepoints between x;D800 and x;DFFF
...
[|sub]depot contains, iff C<data> is a C<Just>; if C<data> is C<Nothing>
