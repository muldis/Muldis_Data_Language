...
more or less:
    ...
    sys.Core.Type.Universal
        ...
        sys.Core.Type.Tuple
            ...
            sys.Core.Type.Cat.MountControlCat
        ...
        sys.Core.Type.Relation
            ...
            sys.Core.Type.Cat.SysTypeSet
            sys.Core.Type.Cat.SysCatSet
            sys.Core.Type.Cat.MountControlSet
            ...
            sys.Core.Type.Cat.DepTypeSet
            sys.Core.Type.Cat.Pkg(Func|Upd|Proc)Set
            sys.Core.Type.Cat.PkgTypeSet
...
A C<Cat.ExprNodeSet> is a C<Tuple> that specifies a set of named value
