...
more or less:
    ...
    sys.std.Core.Type.Universal
        ...
        sys.std.Core.Type.Tuple
            ...
            sys.std.Core.Type.Cat.(Scalar|Nonscalar|Domain)Type
        ...
        sys.std.Core.Type.Relation
            ...
            sys.std.Core.Type.Cat.Sys(Sca|NonSca|Dom)TypeSet
            ...
            sys.std.Core.Type.Cat.Dep(Sca|NonSca|Dom)TypeSet
            sys.std.Core.Type.Cat.Pkg(Func|Upd|Proc)Set
            sys.std.Core.Type.Cat.Pkg(Sca|NonSca|Dom)TypeSet
...
A C<Cat.(Scalar|Nonscalar|Domain)Type> has these 4 attributes:
