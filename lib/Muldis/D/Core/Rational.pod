...
C<< function sys.std.Core.Rational.abs_diff (Rat <-- $topic : Rat, $other : Rat)
>>
...
This function is exactly the same as C<sys.std.Core.Rational.quotient> except
...
This function is exactly the same as C<sys.std.Core.Rational.mean> except that
...
C<< function sys.std.Core.Rational.median (set_of.Rat <-- $topic : bag_of.Rat)
>>
...
C<< function sys.std.Core.Rational.mean_of_median (Rat <-- $topic : bag_of.Rat)
>>

This function is a wrapper over C<sys.std.Core.Rational.median> that will result
in the mean of its result elements; it will fail if there are zero
elements.

=head2 sys.std.Core.Rational.mode

C<< function sys.std.Core.Rational.mode (set_of.Rat <-- $topic : bag_of.Rat) >>
...
C<< function sys.std.Core.Rational.log (Rat <-- $topic : PRat, $radix : PRat,
$round_rule : RatRoundRule) >>
