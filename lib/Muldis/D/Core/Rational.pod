...
This document is Muldis::D::Core::Rational version 0.121.0.
...
C<< function sys.std.Core.Rational.frac_quotient (Rat <-- $dividend : Rat,
...
C<< function sys.std.Core.Rational.whole_quotient (Int <--
...
C<< function sys.std.Core.Rational.remainder (Rat <--
$dividend : Rat, $divisor : Rat, $round_meth : RoundMeth)
...
C<< function sys.std.Core.Rational.quot_and_rem (Tuple <--
$dividend : Rat, $divisor : Rat, $round_meth : RoundMeth)
...
C<< function sys.std.Core.Rational.frac_mean (Rat <-- $topic : bag_of.Rat)
...
C<< function sys.std.Core.Rational.frac_mean_of_median (Rat <--
$topic : bag_of.Rat) implements sys.std.Core.Numeric.frac_mean_of_median
{...} >>
...
C<< function sys.std.Core.Rational.power_with_whole_exp (Rat <--
