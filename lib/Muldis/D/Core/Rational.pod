...
This document is Muldis::D::Ext::Rational version 0.100.0.
...
C<< function sys.std.Rational.diff (Rat <-- $minuend : Rat,
$subtrahend : Rat) >>
...
C<< function sys.std.Rational.power (PRat <-- $radix : PRat,
