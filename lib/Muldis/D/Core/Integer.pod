...
This document is Muldis::D::Core::Integer version 0.122.0.
...
$subtrahend : Int) implements sys.std.Core.Numeric.diff {...} >>
...
$other : Int) implements sys.std.Core.Numeric.abs_diff {...} >>
...
C<< function sys.std.Core.Integer.frac_quotient (Rat <-- $dividend : Int,
$divisor : Int) implements sys.std.Core.Numeric.frac_quotient {...} >>
...
C<< function sys.std.Core.Integer.whole_quotient (Int <--
...
C<< function sys.std.Core.Integer.remainder (Int <--
$dividend : Int, $divisor : Int, $round_meth : RoundMeth)
...
C<< function sys.std.Core.Integer.frac_mean (Rat <-- $topic : bag_of.Int)
...
$topic : bag_of.Int) implements sys.std.Core.Numeric.median {...} >>
...
C<< function sys.std.Core.Integer.frac_mean_of_median (Rat <--
$topic : bag_of.Int) implements sys.std.Core.Numeric.frac_mean_of_median
{...} >>
...
C<< function sys.std.Core.Integer.power_with_whole_exp (Rat <--
...
C<updater sys.std.Core.Integer.assign_pred (&$topic : Int)
...
C<updater sys.std.Core.Integer.assign_succ (&$topic : Int)
