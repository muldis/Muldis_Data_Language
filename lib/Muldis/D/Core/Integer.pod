...
C<< function diff (Int <-- $minuend : Int,
...
C<< function abs_diff (Int <-- $topic : Int,
...
C<< function frac_quotient (Rat <-- $dividend : Int,
...
C<< function frac_mean_of_median (Rat <--
...
C<< function power (Int <-- $radix : Int,
$exponent : NNInt) {...} >>
