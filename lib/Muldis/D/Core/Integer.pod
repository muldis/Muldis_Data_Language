...
This document is Muldis::D::Ext::Integer version 0.100.0.
...
C<< function sys.std.Integer.diff (Int <-- $minuend : Int,
$subtrahend : Int) >>
...
C<< function sys.std.Integer.quotient (Int <-- $dividend : Int,
$divisor : Int) >>
...
C<< function sys.std.Integer.power (Int <-- $radix : Int,
$exponent : NNInt) >>
