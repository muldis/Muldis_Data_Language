...
This document is Muldis::D::Core::Relation version 0.100.0.
...
These core routines are general-purpose in nature and are intended
for use in working with normal user data.
