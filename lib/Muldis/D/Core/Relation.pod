...
Muldis::D::Core::Relation -
Muldis D generic relational operators

=head1 VERSION

This document is Muldis::D::Core::Relation version 0.116.0.
...
C<< function sys.std.Core.Relation.D0C0 (Relation <--) >>
...
C<< function sys.std.Core.Relation.D0C1 (Relation <--) >>
...
C<< function sys.std.Core.Relation.degree (NNInt <-- $topic : Relation) >>
...
C<< function sys.std.Core.Relation.is_nullary (Bool <-- $topic : Relation)
>>
...
C<< function sys.std.Core.Relation.is_not_nullary (Bool <--
$topic : Relation) >>
...
C<< function sys.std.Core.Relation.has_attrs (Bool <-- $topic : Relation,
...
C<< function sys.std.Core.Relation.attr_names (set_of.Name <--
$topic : Relation) >>
...
C<< function sys.std.Core.Relation.count (NNInt <-- $topic : Relation) >>

This function is an alias for C<sys.std.Core.Relation.cardinality>.

=head2 sys.std.Core.Relation.is_empty

C<< function sys.std.Core.Relation.is_empty (Bool <-- $topic : Relation) >>
...
C<< function sys.std.Core.Relation.is_not_empty (Bool <--
$topic : Relation) >>
...
C<< function sys.std.Core.Relation.has_member (Bool <-- $r : Relation,
$t : Tuple) >>
...
known as C<r∋> or C<r-has>.

=head2 sys.std.Core.Relation.has_not_member

C<< function sys.std.Core.Relation.has_not_member (Bool <-- $r : Relation,
$t : Tuple) >>

This function is exactly the same as C<sys.std.Core.Relation.has_member>
except that it results in the opposite boolean value when given the same
arguments.  Note that this operation is also known as C<r∌> or C<r-!has> or
C<r-not-has>.

=head2 sys.std.Core.Relation.tuple_is_member

C<< function sys.std.Core.Relation.tuple_is_member (Bool <--
$t : Tuple, $r : Relation) >>
...
C<Bool:False> otherwise.  Note that this operation is also known as C<∈r>
or C<in-r>.

=head2 sys.std.Core.Relation.tuple_is_not_member

C<< function sys.std.Core.Relation.tuple_is_not_member (Bool <--
$t : Tuple, $r : Relation) >>
...
operation is also known as C<∉r> or C<!in-r> or C<not-in-r>.

=head2 sys.std.Core.Relation.has_key

C<< function sys.std.Core.Relation.has_key (Bool <-- $topic : Relation,
$attr_names : set_of.Name) >>
...
C<< function sys.std.Core.Relation.empty (Relation <-- $topic : Relation)
>>
...
C<< function sys.std.Core.Relation.insertion (Relation <-- $r : Relation,
$t : Tuple) >>
...
C<< function sys.std.Core.Relation.deletion (Relation <-- $r : Relation,
$t : Tuple) >>
...
C<< function sys.std.Core.Relation.rename (Relation <-- $topic : Relation,
$map : AttrRenameMap) >>
...
C<< function sys.std.Core.Relation.wrap (Relation <-- $topic : Relation,
...
C<< function sys.std.Core.Relation.unwrap (Relation <-- $topic : Relation,
...
C<< function sys.std.Core.Relation.group (Relation <-- $topic : Relation,
$outer : Name, $inner : set_of.Name) >>
...
C<< function sys.std.Core.Relation.power_set (set_of.Relation <--
$topic : Relation) >>
...
C<< function sys.std.Core.Relation.tclose (Relation <-- $topic : Relation)
>>
...
$topic : Relation, $func : ValFiltCFuncNC) >>
...
C<< function sys.std.Core.Relation.classification (Relation <--
$topic : Relation, $func : ValMapCFuncNC, $class_attr_name : Name,
...
C<< function sys.std.Core.Relation.extension (Relation <--
$topic : Relation, $attr_names : set_of.Name, $func : ValMapCFuncNC) >>
...
C<< function sys.std.Core.Relation.map (Relation <-- $topic : Relation,
$result_attr_names : set_of.Name, $func : ValMapCFuncNC) >>
...
$summ_attr_names : set_of.Name, $summ_func : ValMapCFuncNC) >>
...
C<< function sys.std.Core.Relation.reduction (Tuple <-- $topic : Relation,
$func : ValRedCFuncNC, $identity : Tuple) >>
...
=head2 sys.std.Core.Relation.maybe_reduction

C<< function sys.std.Core.Relation.maybe_reduction (maybe_of.Tuple <--
$topic : Relation, $func : ValRedCFuncNC) >>

This function is exactly the same as C<sys.std.Core.Relation.reduction>
except that it does not take an C<identity> argument, and it results in a
...
C<is_identical>.  Note that this operation is also known as C<⊆> or C<sub>.
...
arguments.  Note that this operation is also known as C<⊈> or C<!sub> or
C<not-sub>.
...
otherwise.  Note that this operation is also known as C<⊇> or C<super>.
...
arguments.  Note that this operation is also known as C<⊉> or C<!super> or
C<not-super>.

=head2 sys.std.Core.Relation.is_proper_subset

C<< function sys.std.Core.Relation.is_proper_subset (Bool <--
$topic : Relation, $other : Relation) >>

This function is exactly the same as C<sys.std.Core.Relation.is_subset>
except that it results in C<Bool:False> if its 2 arguments are identical.
Note that this operation is also known as C<⊂> or C<psub>.

=head2 sys.std.Core.Relation.is_not_proper_subset

C<< function sys.std.Core.Relation.is_not_proper_subset (Bool <--
$topic : Relation, $other : Relation) >>

This function is exactly the same as
C<sys.std.Core.Relation.is_proper_subset>
except that it results in the opposite boolean value when given the same
arguments.  Note that this operation is also known as C<⊄> or C<!psub> or
C<not-psub>.

=head2 sys.std.Core.Relation.is_proper_superset

C<< function sys.std.Core.Relation.is_proper_superset (Bool <--
$topic : Relation, $other : Relation) >>
...
operation is also known as C<⊃> or C<psuper>.

=head2 sys.std.Core.Relation.is_not_proper_superset

C<< function sys.std.Core.Relation.is_not_proper_superset (Bool <--
$topic : Relation, $other : Relation) >>
...
arguments.  Note that this operation is also known as C<⊅> or C<!psuper> or
C<not-psuper>.

=head2 sys.std.Core.Relation.is_disjoint

C<< function sys.std.Core.Relation.is_disjoint (Bool <-- $topic : Relation,
$other : Relation) >>
...
C<< function sys.std.Core.Relation.is_not_disjoint (Bool <--
$topic : Relation, $other : Relation) >>
...
C<< function sys.std.Core.Relation.exclusion (Relation <--
...
C<< function sys.std.Core.Relation.symmetric_diff (Relation <--
$topic : bag_of.Relation) >>
...
C<< function sys.std.Core.Relation.composition (Relation <--
$topic : Relation, $other : Relation) >>
...
C<< function sys.std.Core.Relation.join_with_group (Relation <--
...
C<< function sys.std.Core.Relation.rank (Relation <-- $topic : Relation,
...
curried by the C<is_reverse_order> argument.  The C<order-determination>
...
than just adding an attribute to them.

=head2 sys.std.Core.Relation.rank_by_attr_names

C<< function sys.std.Core.Relation.rank_by_attr_names (Relation <--
...
the latter is curried with this function's C<order_by> argument.

=head2 sys.std.Core.Relation.limit

C<< function sys.std.Core.Relation.limit (Relation <-- $topic : Relation,
...
C<< function sys.std.Core.Relation.limit_by_attr_names (Relation <--
...
C<< function sys.std.Core.Relation.substitution (Relation <--
$topic : Relation, $attr_names : set_of.Name, $func : ValMapCFuncNC) >>
...
C<< function sys.std.Core.Relation.static_subst (Relation <--
$topic : Relation, $attrs : Tuple) >>
...
C<< function sys.std.Core.Relation.subst_in_restr (Relation <--
$topic : Relation, $restr_func : ValFiltCFuncNC,
$subst_attr_names : set_of.Name, $subst_func : ValMapCFuncNC) >>
...
C<< function sys.std.Core.Relation.static_subst_in_restr (Relation <--
$topic : Relation, $restr_func : ValFiltCFuncNC, $subst : Tuple) >>
...
C<< function sys.std.Core.Relation.subst_in_semijoin (Relation <--
$topic : Relation, $restr : Relation, $subst_attr_names : set_of.Name,
$subst_func : ValMapCFuncNC) >>
...
C<< function sys.std.Core.Relation.static_subst_in_semijoin (Relation <--
...
C<< function sys.std.Core.Relation.outer_join_with_group (Relation <--
$primary : Relation, $secondary : Relation, $group_attr : Name) >>
...
C<< function sys.std.Core.Relation.outer_join_with_maybes (Relation <--
...
C<< function sys.std.Core.Relation.outer_join_with_defaults (Relation <--
...
C<< function sys.std.Core.Relation.outer_join_with_static_exten
(Relation <-- $primary : Relation, $secondary : Relation, $filler : Tuple)
>>
...
C<< function sys.std.Core.Relation.outer_join_with_exten (Relation <--
$primary : Relation, $secondary : Relation, $exten_func : ValMapCFuncNC) >>
...
C<updater sys.std.Core.Relation.assign_rename (&$topic : Relation,
$map : AttrRenameMap)>
...
C<updater sys.std.Core.Relation.assign_extension (&$topic : Relation,
$attr_names : set_of.Name, $func : ValMapCFuncNC)>
...
C<updater sys.std.Core.Relation.assign_projection (&$topic : Relation,
$attr_names : set_of.Name)>
...
C<updater sys.std.Core.Relation.assign_cmpl_proj (&$topic : Relation,
$attr_names : set_of.Name)>
...
C<updater sys.std.Core.Relation.assign_insertion (&$r : Relation,
$t : Tuple)>
...
C<updater sys.std.Core.Relation.assign_disjoint_ins (&$r : Relation,
$t : Tuple)>
...
C<updater sys.std.Core.Relation.assign_union (&$topic : Relation,
$other : Relation)>
...
result of that function to C<topic>.  This updater is analogous to the
general case of the multiple-row SQL "INSERT" statement.

=head2 sys.std.Core.Relation.assign_disjoint_union

C<updater sys.std.Core.Relation.assign_disjoint_union (&$topic : Relation,
$other : Relation)>
...
C<updater sys.std.Core.Relation.assign_empty (&$topic : Relation)>
...
C<updater sys.std.Core.Relation.assign_deletion (&$r : Relation,
$t : Tuple)>
...
C<updater sys.std.Core.Relation.assign_restriction (&$topic : Relation,
$func : ValFiltCFuncNC)>
...
C<updater sys.std.Core.Relation.assign_intersection (&$topic : Relation,
$other : Relation)>
...
C<updater sys.std.Core.Relation.assign_diff (&$source : Relation,
$filter : Relation)>
...
C<updater sys.std.Core.Relation.assign_semidiff (&$source : Relation,
$filter : Relation)>
...
C<updater sys.std.Core.Relation.assign_antijoin (&$source : Relation,
$filter : Relation)>
...
C<updater sys.std.Core.Relation.assign_semijoin (&$source : Relation,
$filter : Relation)>
...
C<updater sys.std.Core.Relation.assign_exclusion (&$topic : Relation,
$other : Relation)>
...
C<updater sys.std.Core.Relation.assign_substitution (&$topic : Relation,
$attr_names : set_of.Name, $func : ValMapCFuncNC)>
...
C<updater sys.std.Core.Relation.assign_static_subst (&$topic : Relation,
$attrs : Tuple)>
...
C<updater sys.std.Core.Relation.assign_subst_in_restr (&$topic : Relation,
$restr_func : ValFiltCFuncNC, $subst_attr_names : set_of.Name,
$subst_func : ValMapCFuncNC)>
...
C<updater sys.std.Core.Relation.assign_static_subst_in_restr
(&$topic : Relation, $restr_func : ValFiltCFuncNC, $subst : Tuple)>
...
C<updater sys.std.Core.Relation.assign_subst_in_semijoin
(&$topic : Relation, $restr : Relation, $subst_attr_names : set_of.Name,
$subst_func : ValMapCFuncNC)>
...
C<updater sys.std.Core.Relation.assign_static_subst_in_semijoin
(&$topic : Relation, $restr : Relation, $subst : Tuple)>
