...
This document is Muldis::D::Core::Relation version 0.129.1.
...
C<< function is_not_nullary (Bool <--
topic : Relation) {...} >>
...
C<< function has_member (Bool <-- r : Relation,
t : Tuple) {...} >>
...
C<< function has_not_member (Bool <-- r : Relation,
t : Tuple) {...} >>
...
C<< function insertion (Relation <-- r : Relation,
t : Tuple) {...} >>
...
C<< function disjoint_ins (Relation <--
r : Relation, t : Tuple) {...} >>
...
C<< function deletion (Relation <-- r : Relation,
t : Tuple) {...} >>
...
C<< function rename (Relation <-- topic : Relation,
map : AttrRenameMap) {...} >>
...
C<< function wrap (Relation <-- topic : Relation,
...
C<< function unwrap (Relation <-- topic : Relation,
...
C<< function power_set (set_of.Relation <--
topic : Relation) {...} >>
...
C<< function static_exten (Relation <--
...
C<< function disjoint_union (Relation <--
topic : set_of.Relation) {...} >>
...
C<< function symmetric_diff (Relation <--
topic : bag_of.Relation) {...} >>
...
C<< function intersection (Relation <--
topic : set_of.Relation) {...} >>
...
C<< function outer_join_with_static_exten
...
C<< function outer_join_with_exten (Relation <--
...
C<updater assign_rename (&topic : Relation,
map : AttrRenameMap) {...}>
...
C<updater assign_projection (&topic : Relation,
attr_names : set_of.Name) {...}>
...
C<updater assign_cmpl_proj (&topic : Relation,
attr_names : set_of.Name) {...}>
...
C<updater assign_insertion (&r : Relation,
t : Tuple) {...}>
...
C<updater assign_disjoint_ins (&r : Relation,
t : Tuple) {...}>
...
C<updater assign_union (&topic : Relation,
other : Relation) {...}>
...
C<updater assign_deletion (&r : Relation,
t : Tuple) {...}>
...
C<updater assign_intersection (&topic : Relation,
other : Relation) {...}>
...
C<updater assign_diff (&source : Relation,
filter : Relation) {...}>
...
C<updater assign_semidiff (&source : Relation,
filter : Relation) {...}>
...
C<updater assign_antijoin (&source : Relation,
filter : Relation) {...}>
...
C<updater assign_semijoin (&source : Relation,
filter : Relation) {...}>
...
C<updater assign_exclusion (&topic : Relation,
other : Relation) {...}>
...
C<updater assign_static_subst (&topic : Relation,
attrs : Tuple) {...}>
...
C<updater assign_subst_in_semijoin
(&topic : Relation, restr : Relation, subst_attr_names : set_of.Name,
subst_func : ValMapCFuncNC) {...}>
