...
C<< function sys.std.Relation.degree (NNInt <-- $topic : Relation) >>
...
C<< function sys.std.Relation.is_nullary (Bool <-- $topic : Relation) >>
...
C<< function sys.std.Relation.is_not_nullary (Bool <-- $topic : Relation)
>>
...
C<< function sys.std.Relation.has_attrs (Bool <-- $topic : Relation,
...
C<< function sys.std.Relation.is_empty (Bool <-- $topic : Relation) >>
...
C<< function sys.std.Relation.is_not_empty (Bool <-- $topic : Relation) >>
...
C<< function sys.std.Relation.has_key (Bool <-- $topic : Relation,
$attr_names : set_of.Name) >>
...
C<< function sys.std.Relation.empty (Relation <-- $topic : Relation) >>
...
C<< function sys.std.Relation.tclose (Relation <-- $topic : Relation) >>
...
C<< function sys.std.Relation.classification (Relation <--
...
C<< function sys.std.Relation.map (Relation <-- $topic : Relation,
...
C<< function sys.std.Relation.reduction (Tuple <-- $topic : Relation,
...
C<< function sys.std.Relation.is_disjoint (Bool <-- $topic : Relation,
$other : Relation) >>
...
C<< function sys.std.Relation.is_not_disjoint (Bool <-- $topic : Relation,
$other : Relation) >>
...
C<< function sys.std.Relation.composition (Relation <-- $topic : Relation,
$other : Relation) >>
...
C<< function sys.std.Relation.rank (Relation <-- $topic : Relation,
...
C<< function sys.std.Relation.limit (Relation <-- $topic : Relation,
...
C<< function sys.std.Relation.substitution (Relation <-- $topic : Relation,
...
C<< function sys.std.Relation.subst_in_restr (Relation <--
...
C<updater sys.std.Relation.assign_empty (&$topic : Relation)>
...
C<updater sys.std.Relation.assign_exclusion (&$topic : Relation,
$other : Relation)>
...
C<updater sys.std.Relation.assign_substitution (&$topic : Relation,
$attr_names : set_of.Name, $func : ValMapFuncRef)>
...
C<updater sys.std.Relation.assign_static_subst (&$topic : Relation,
$attrs : Tuple)>
...
C<updater sys.std.Relation.assign_subst_in_restr (&$topic : Relation,
...
C<updater sys.std.Relation.assign_subst_in_semijoin (&$topic : Relation,
