...
This document is Muldis::D::Core::Bag version 0.114.0.
...
arguments.  Note that this operation is also known as C<b∌> or C<b-!has> or
C<b-not-has>.
...
that this operation is also known as C<∉b> or C<!in-b> or C<not-in-b>.
