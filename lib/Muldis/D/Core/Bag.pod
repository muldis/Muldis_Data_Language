...
C<< function has_member (Bool <-- bag : Bag,
value : Universal) {...} >>
...
C<< function has_not_member (Bool <-- bag : Bag,
value : Universal) {...} >>
...
C<< function value_is_member (Bool <-- value : Universal,
bag : Bag) {...} >>
...
C<< function count (NNInt <-- bag : Bag,
value : Universal) {...} >>
...
C<< function insertion (Bag <-- bag : Bag,
value : Universal) {...} >>
...
C<< function deletion (Bag <-- bag : Bag,
value : Universal) {...} >>
...
C<< function Bag_from_wrap (bag_of.Tuple <--
topic : Relation) {...} >>
...
C<< function Bag_from_attr (Bag <-- topic : Relation,
name : Name) {...} >>
...
C<< function is_subset (Bool <-- topic : Bag,
other : Bag) {...} >>
...
C<< function is_not_subset (Bool <-- topic : Bag,
other : Bag) {...} >>
...
C<< function is_superset (Bool <-- topic : Bag,
other : Bag) {...} >>
...
C<< function is_not_superset (Bool <-- topic : Bag,
other : Bag) {...} >>
...
C<< function is_proper_subset (Bool <-- topic : Bag,
other : Bag) {...} >>
