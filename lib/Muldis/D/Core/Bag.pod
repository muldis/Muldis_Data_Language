...
C<< function sys.std.Core.Bag.cardinality (NNInt <-- $topic : Bag) >>
...
C<< function sys.std.Core.Bag.has_member (Bool <-- $bag : Bag,
$value : Universal) >>
...
C<< function sys.std.Core.Bag.has_not_member (Bool <-- $bag : Bag,
$value : Universal) >>

This function is exactly the same as C<sys.std.Core.Bag.has_member> except that
...
C<< function sys.std.Core.Bag.value_is_member (Bool <--
$value : Universal, $bag : Bag) >>

This function is an alias for C<sys.std.Core.Bag.has_member>.  This function is
the same as C<sys.std.Core.Set.value_is_member>, including that matching of
...
C<< function sys.std.Core.Bag.value_is_not_member (Bool <--
$value : Universal, $bag : Bag) >>

This function is an alias for C<sys.std.Core.Bag.has_not_member>.  This function
...
C<< function sys.std.Core.Bag.count (NNInt <-- $bag : Bag, $value : Universal)
>>
...
C<< function sys.std.Core.Bag.insertion (Bag <-- $bag : Bag, $value : Universal)
>>

This function is the same as C<sys.std.Core.Set.insertion> as per C<has_member>
...
semantically the single-tuple case of C<sys.std.Core.Bag.union_sum>, and is
not the single-tuple case of C<sys.std.Core.Bag.union> (which is the direct
analogy to set union).

=head2 sys.std.Core.Bag.deletion

C<< function sys.std.Core.Bag.deletion (Bag <-- $bag : Bag, $value : Universal)
>>

This function is the same as C<sys.std.Core.Set.deletion> as per C<has_member>
...
C<< function sys.std.Core.Bag.reduction (Universal <-- $topic : Bag,
...
=head2 sys.std.Core.Bag.maybe_reduction

C<< function sys.std.Core.Bag.maybe_reduction (Maybe <-- $topic : Bag,
$func : ValRedFuncRef) >>

This function is to C<sys.std.Core.Set.maybe_reduction> as
C<sys.std.Core.Bag.reduction> is to C<sys.std.Core.Set.reduction>.

=head2 sys.std.Core.Bag.Bag_from_wrap

C<< function sys.std.Core.Bag.Bag_from_wrap (bag_of.Tuple <--
$topic : Relation) >>
...
C<< function sys.std.Core.Bag.Bag_from_cmpl_group (bag_of.Tuple <--
...
what C<sys.std.Core.Array.Array_from_wrap> is to C<sys.std.Core.Relation.rank>.

=head2 sys.std.Core.Bag.Bag_from_attr

C<< function sys.std.Core.Bag.Bag_from_attr (Bag <-- $topic : Relation,
$name : Name) >>
...
C<< function sys.std.Core.Bag.is_subset (Bool <-- $topic : Bag, $other : Bag) >>
...
C<< function sys.std.Core.Bag.is_not_subset (Bool <-- $topic : Bag,
$other : Bag) >>
...
C<< function sys.std.Core.Bag.is_superset (Bool <-- $topic : Bag, $other : Bag)
>>
...
C<< function sys.std.Core.Bag.is_not_superset (Bool <-- $topic : Bag,
$other : Bag) >>

This function is an alias for C<sys.std.Core.Bag.is_not_subset> except that it
transposes the C<topic> and C<other> arguments.  This function is like
C<sys.std.Core.Relation.is_not_superset> as per C<is_superset>.

=head2 sys.std.Core.Bag.is_proper_subset

C<< function sys.std.Core.Bag.is_proper_subset (Bool <-- $topic : Bag,
$other : Bag) >>
...
C<< function sys.std.Core.Bag.is_not_proper_subset (Bool <-- $topic : Bag,
$other : Bag) >>
...
C<< function sys.std.Core.Bag.is_proper_superset (Bool <-- $topic : Bag,
$other : Bag) >>

This function is an alias for C<sys.std.Core.Bag.is_proper_subset> except that
...
C<< function sys.std.Core.Bag.is_not_proper_superset (Bool <-- $topic : Bag,
$other : Bag) >>

This function is an alias for C<sys.std.Core.Bag.is_not_proper_subset> except
that it transposes the C<topic> and C<other> arguments.  This function
is like C<sys.std.Core.Relation.is_not_proper_superset> as per C<is_superset>.

=head2 sys.std.Core.Bag.union

C<< function sys.std.Core.Bag.union (Bag <-- $topic : set_of.Bag) >>
...
C<< function sys.std.Core.Bag.union_sum (Bag <-- $topic : bag_of.Bag) >>
...
C<< function sys.std.Core.Bag.intersection (Bag <-- $topic : set_of.Bag) >>
...
C<< function sys.std.Core.Bag.diff (Bag <-- $source : Bag, $filter : Bag) >>
