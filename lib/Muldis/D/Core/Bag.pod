...
Muldis::D::Core::Bag -
Muldis D Bag specific operators

=head1 VERSION

This document is Muldis::D::Core::Bag version 0.111.0.
...
arguments.  Note that this operation is also known as C<B∌> or C<B!hmem> or
C<Bnot-hmem>.
...
that this operation is also known as C<B∉> or C<B!imem> or C<Bnot-imem>.
