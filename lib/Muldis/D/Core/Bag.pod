...
This document is Muldis::D::Core::Bag version 0.100.0.
...
arguments.  Note that this operation is also known as C<B∌>.

=head2 sys.std.Core.Bag.value_is_member

C<< function sys.std.Core.Bag.value_is_member (Bool <-- $value : Universal,
$bag : Bag) >>
...
C<< function sys.std.Core.Bag.count (NNInt <-- $bag : Bag,
$value : Universal) >>
...
C<< function sys.std.Core.Bag.insertion (Bag <-- $bag : Bag,
$value : Universal) >>
...
C<< function sys.std.Core.Bag.deletion (Bag <-- $bag : Bag,
$value : Universal) >>
...
C<< function sys.std.Core.Bag.is_subset (Bool <-- $topic : Bag,
$other : Bag) >>
...
C<< function sys.std.Core.Bag.is_superset (Bool <-- $topic : Bag,
$other : Bag) >>
...
C<< function sys.std.Core.Bag.is_not_proper_superset (Bool <--
$topic : Bag, $other : Bag) >>
