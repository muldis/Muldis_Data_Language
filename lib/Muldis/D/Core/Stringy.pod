...
This document is Muldis::D::Core::Stringy version 0.127.0.
...
C<< function sys.std.Core.Stringy.catenation (Stringy <--
$topic@ : array_of.Stringy) {...} >>
...
C<< function sys.std.Core.Stringy.replication (Stringy <--
$topic@ : Stringy, $count : NNInt) {...} >>

This virtual function results in the catenation of C<count> instances of
C<topic>.  Note that this operation is also known as C<x>.
