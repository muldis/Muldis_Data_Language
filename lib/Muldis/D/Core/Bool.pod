...
This document is Muldis::D::Core::Bool version 0.100.0.
...
=head2 sys.std.Core.Bool.nand

C<< function sys.std.Core.Bool.nand (Bool <-- $topic : Bool, $other : Bool)
>>
...
=head2 sys.std.Core.Bool.nor

C<< function sys.std.Core.Bool.nor (Bool <-- $topic : Bool, $other : Bool)
>>
...
=head2 sys.std.Core.Bool.xnor

C<< function sys.std.Core.Bool.xnor (Bool <-- $topic? : bag_of.Bool) >>
...
=head2 sys.std.Core.Bool.iff

C<< function sys.std.Core.Bool.iff (Bool <-- $topic? : bag_of.Bool) >>

This function is an alias for C<sys.std.Core.Bool.xnor>.
...
=head2 sys.std.Core.Bool.imp

C<< function sys.std.Core.Bool.imp (Bool <-- $topic : Bool, $other : Bool)
>>
...
=head2 sys.std.Core.Bool.implies

C<< function sys.std.Core.Bool.implies (Bool <-- $topic : Bool,
$other : Bool) >>

This function is an alias for C<sys.std.Core.Bool.imp>.

=head2 sys.std.Core.Bool.nimp

C<< function sys.std.Core.Bool.nimp (Bool <-- $topic : Bool, $other : Bool)
>>

This function is exactly the same as C<sys.std.Core.Bool.imp> except that
it results in the opposite boolean value when given the same arguments.
Note that this operation is also known as I<not implies> or I<material
nonimplication> or C<↛>.

=head2 sys.std.Core.Bool.if

C<< function sys.std.Core.Bool.if (Bool <-- $topic : Bool, $other : Bool)
>>

This function is an alias for C<sys.std.Core.Bool.imp> except that it
...
=head2 sys.std.Core.Bool.nif

C<< function sys.std.Core.Bool.nif (Bool <-- $topic : Bool, $other : Bool)
>>

This function is exactly the same as C<sys.std.Core.Bool.if> except that it
...
=head2 sys.std.Core.Bool.not_all

C<< function sys.std.Core.Bool.not_all (Bool <-- $topic? : set_of.Bool) >>
...
=head2 sys.std.Core.Bool.none

C<< function sys.std.Core.Bool.none (Bool <-- $topic? : set_of.Bool) >>
...
=head2 sys.std.Core.Bool.not_any

C<< function sys.std.Core.Bool.not_any (Bool <-- $topic? : set_of.Bool) >>

This function is an alias for C<sys.std.Core.Bool.none>.

=head2 sys.std.Core.Bool.one

C<< function sys.std.Core.Bool.one (Bool <-- $topic? : bag_of.Bool) >>
...
=head2 sys.std.Core.Bool.not_one

C<< function sys.std.Core.Bool.not_one (Bool <-- $topic? : bag_of.Bool) >>

This function is exactly the same as C<sys.std.Core.Bool.one> except that
it results in the opposite boolean value when given the same argument.

=head2 sys.std.Core.Bool.exactly

C<< function sys.std.Core.Bool.exactly (Bool <-- $topic? : bag_of.Bool,
$count : NNInt) >>
...
=head2 sys.std.Core.Bool.not_exactly

C<< function sys.std.Core.Bool.not_exactly (Bool <-- $topic? : bag_of.Bool,
$count : NNInt) >>

This function is exactly the same as C<sys.std.Core.Bool.exactly> except
that it results in the opposite boolean value when given the same argument.

=head2 sys.std.Core.Bool.true

C<< function sys.std.Core.Bool.true (NNInt <-- $topic? : bag_of.Bool) >>

This function results in the count of its input element values that are
C<Bool:true>.

=head2 sys.std.Core.Bool.false

C<< function sys.std.Core.Bool.false (NNInt <-- $topic? : bag_of.Bool) >>
