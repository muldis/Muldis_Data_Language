...
This document is Muldis::D::Standard_Library version 0.201.0.
...
it contains is C<Muldis_D_Standard_Library http://muldis.com 0.201.0>.
...
C<System http://muldis.com 0.201.0> -
...
should have received copies of the AL2 as part of the MDSL
