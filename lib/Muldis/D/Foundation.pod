...
general purpose integer exact numeric having no explicit limit to its
possible size, which explicitly does not represent any kind of thing in
particular, neither cardinal nor ordinal nor nominal.
