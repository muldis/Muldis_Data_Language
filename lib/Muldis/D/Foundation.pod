...
argument is I<FDN__Tuple_Inf> typed, the latter being the case for most
...
I<FDN__Bag_Inf>, I<FDN__Tuple_Inf>, I<FDN__Capsule>, I<FDN__External>.
...
The I<FDN__Integer_Inf> type is infinite.  A I<FDN__Integer_Inf> value is a
...
The Foundation constant C<FDN__Neg_One> represents the I<FDN__Integer_Inf>
value negative-one.

=head2 FDN__Zero

The Foundation constant C<FDN__Zero> represents the I<FDN__Integer_Inf>
value zero.

=head2 FDN__Pos_One

The Foundation constant C<FDN__Pos_One> represents the I<FDN__Integer_Inf>
value positive-one.
...
Every low-level routine takes a topic of just the I<FDN__Anything> type, so
...
=head2 FDN__is_a_Integer_Inf

The function C<FDN__is_a_Integer_Inf> results in the I<FDN__Boolean> value
I<true> iff its topic is a member of the I<FDN__Integer_Inf> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Array_Inf

The function C<FDN__is_a_Array_Inf> results in the I<FDN__Boolean> value
I<true> iff its topic is a member of the I<FDN__Array_Inf> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Bag_Inf

The function C<FDN__is_a_Bag_Inf> results in the I<FDN__Boolean> value
I<true> iff its topic is a member of the I<FDN__Bag_Inf> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Tuple_Inf

The function C<FDN__is_a_Tuple_Inf> results in the I<FDN__Boolean> value
I<true> iff its topic is a member of the I<FDN__Tuple_Inf> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Capsule

The function C<FDN__is_a_Capsule_Inf> results in the I<FDN__Boolean> value
I<true> iff its topic is a member of the I<FDN__Capsule_Inf> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_External

The function C<FDN__is_a_External_Inf> results in the I<FDN__Boolean> value
I<true> iff its topic is a member of the I<FDN__External_Inf> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__same

The function C<FDN__same> requires its topic to be a I<FDN__Tuple_Inf>
...
I<FDN__Tuple_Inf> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer_Inf> value.  This function
...
I<FDN__Tuple_Inf> value with just 1 attribute/argument named C<0>, where
that argument is a I<FDN__Integer_Inf> value.  This function results in the
I<FDN__Integer_Inf> value that is the I<opposite> of its C<0> argument.
...
I<FDN__Tuple_Inf> value with just 1 attribute/argument named C<0>, where
that argument is a I<FDN__Integer_Inf> value.  This function results in the
non-negative I<FDN__Integer_Inf> value that is the I<absolute value> of its
C<0> argument.
...
I<FDN__Tuple_Inf> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer_Inf> value.  This function
results in the I<FDN__Integer_Inf> I<sum> from performing I<addition> of
...
I<FDN__Integer_Inf> zero; C<FDN__Integer_times> is its repeater function.
...
I<FDN__Tuple_Inf> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer_Inf> value.  This function
results in the I<FDN__Integer_Inf> I<difference> from performing
...
I<FDN__Tuple_Inf> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer_Inf> value.  This function
results in the I<FDN__Integer_Inf> I<product> from performing
...
its identity value is the I<FDN__Integer_Inf> positive one;
...
I<FDN__Tuple_Inf> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer_Inf> value and C<1> must also
...
I<FDN__Tuple_Inf> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer_Inf> value and C<1> must also
be nonzero.  This function results in the I<FDN__Integer_Inf> I<quotient>
...
I<FDN__Tuple_Inf> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer_Inf> value and at least one
of those must also be nonzero and C<1> must also be non-negative.  This
function results in the I<FDN__Integer_Inf> value from performing
...
I<FDN__Tuple_Inf> value with just 1 attribute/argument named C<0>, where
that argument is a non-negative I<FDN__Integer_Inf> value.  This function
results in the positive I<FDN__Integer_Inf> value that is the I<factorial>
of its C<0> argument.
...
language environment.  Its topic and result type are both I<FDN__Anything>.
