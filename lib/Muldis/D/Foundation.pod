...
Muldis::D::Foundation -
Muldis D fundamental architecture, behaviour, and type system
...
it contains is C<Muldis_D_Foundation:"http://muldis.com":"0.201.0.-9">.
...
architecture, behavior, and type system of Muldis D.  For all intents and
...
a variety of general purpose application languages, such as Perl 6.
...
such as Perl 6, functional languages in particular, and various
...
given time, typically because it corresponds to an I<interface contract>.
...
(the latter not valid for the I<empty type>).
...
instructions for mapping a set of input values, its I<domain>, to a set of
output values, its I<codomain>, in a pure and deterministic manner.
...
I<FDN__Tuple> type) and not some other value.  This is for the purpose of
...
former and C<of> or C<asset> for the latter.  However, while the latter are
equivalent to the text characters they look like, the former are officially
equivalent to the Unicode codepoint numbers they look like, rather than the
...
contract for type I<T1>, where the invocation has exactly 1 argument whose
...
were a function of a given contract I<C1>, where the invocation has exactly
...
I<constant> is allowed to be invoked as if it were a function, in both of
the same ways that a contract is allowed to be.  Frequently, it is
appropriate to treat both contracts and constants simply as being special
...
A I<constant> is similar to a I<function> but that it takes no arguments at
all (its I<source> is the sole nullary/zero-attribute I<tuple>) and it
always gives the same result.  A constant may be invoked anywhere that a
function may be, and a constant may invoke functions.  The single value a
constant denotes may be arbitrarily complex, and repeated portions may be
...
values which can possibly exist.  It is a union type over just these 8
low-level types, all of the latter being mutually disjoint:
I<FDN__Boolean>, I<FDN__Integer>, I<FDN__Array>, I<FDN__Bag>,
I<FDN__Tuple>, I<FDN__Capsule>, I<FDN__Reference>, I<FDN__External>.
...
The I<FDN__Array> type is infinite.  A I<FDN__Array> value is a ... I<TODO>.

=head2 FDN__Bag

The I<FDN__Bag> type is infinite.  A I<FDN__Bag> value is a ... I<TODO>.

=head2 FDN__Tuple

The I<FDN__Tuple> type is infinite.  A I<FDN__Tuple> value is a ... I<TODO>.

=head2 FDN__Capsule

The I<FDN__Capsule> type is infinite.  A I<FDN__Capsule> value is a ... I<TODO>.

=head2 FDN__Reference

The I<FDN__Reference> type is infinite.  A I<FDN__Reference> value is a ... I<TODO>.
...
=head2 FDN__default_Reference

The Foundation constant C<FDN__default_Reference> represents the default
value of the I<FDN__Reference> type, ...
...
Every low-level routine takes a source of just the I<FDN__Any> type, so
...
The function C<FDN__is_a_Boolean> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__Boolean> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Integer

The function C<FDN__is_a_Integer> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__Integer> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Array

The function C<FDN__is_a_Array> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__Array> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Bag

The function C<FDN__is_a_Bag> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__Bag> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Tuple

The function C<FDN__is_a_Tuple> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__Tuple> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Capsule

The function C<FDN__is_a_Capsule> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__Capsule> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_Reference

The function C<FDN__is_a_Reference> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__Reference> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__is_a_External

The function C<FDN__is_a_External> requires its source to be a I<FDN__Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the I<FDN__Boolean> value
I<true> iff its C<0> argument is a member of the I<FDN__External> type, and
results in the I<FDN__Boolean> value I<false> otherwise.

=head2 FDN__same

The function C<FDN__same> requires its source to be a I<FDN__Tuple>
...
The function C<FDN__Integer_in_order> requires its source to be a
...
The function C<FDN__Integer_opposite> requires its source to be a
...
The function C<FDN__Integer_modulus> requires its source to be a
I<FDN__Tuple> value with just 1 attribute/argument named C<0>, where
that argument is a I<FDN__Integer> value.  This function results in the
...
The function C<FDN__Integer_plus> requires its source to be a
I<FDN__Tuple> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer> value.  This function
...
The function C<FDN__Integer_minus> requires its source to be a
I<FDN__Tuple> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer> value.  This function
...
The function C<FDN__Integer_times> requires its source to be a
I<FDN__Tuple> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer> value.  This function
...
The function C<FDN__Integer_multiple_of> requires its source to be a
I<FDN__Tuple> value with just 2 attributes/arguments named C<0> and
...
The function C<FDN__Integer_divided_by_rtz> requires its source to be a
I<FDN__Tuple> value with just 2 attributes/arguments named C<0> and
C<1>, where each argument is a I<FDN__Integer> value and C<1> must also
...
The function C<FDN__Integer_nn_power> requires its source to be a
I<FDN__Tuple> value with just 2 attributes/arguments named C<0> and
...
The function C<FDN__Integer_factorial> requires its source to be a
I<FDN__Tuple> value with just 1 attribute/argument named C<0>, where
...
=head2 FDN__Array_substring_of

I<TODO.>

=head2 FDN__Array_overlaps_string

I<TODO.>

=head2 FDN__Array_disjoint_string
...
=head2 FDN__Array_replicate

I<TODO.>

=head2 FDN__Array_has_n

I<TODO.>

=head2 FDN__Array_multiplicity

I<TODO.>

=head2 FDN__Array_all_unique

I<TODO.>

=head2 FDN__Array_unique
...
=head2 FDN__Array_insert_n

I<TODO.>

=head2 FDN__Array_remove_n

I<TODO.>

=head2 FDN__Array_except

I<TODO.>

=head2 FDN__Array_intersect

I<TODO.>

=head2 FDN__Array_union

I<TODO.>

=head2 FDN__Array_exclusive
...
=head2 FDN__Bag_singular

I<TODO.>

=head2 FDN__Bag_only_member

I<TODO.>

=head2 FDN__Bag_has_n

I<TODO.>

=head2 FDN__Bag_multiplicity

I<TODO.>

=head2 FDN__Bag_all_unique

I<TODO.>

=head2 FDN__Bag_unique

I<TODO.>

=head2 FDN__Bag_subset_of

I<TODO.>

=head2 FDN__Bag_overlaps_members

I<TODO.>

=head2 FDN__Bag_disjoint_members
...
=head2 FDN__Bag_insert_n

I<TODO.>

=head2 FDN__Bag_remove_n

I<TODO.>

=head2 FDN__Bag_member_plus

I<TODO.>

=head2 FDN__Bag_except

I<TODO.>

=head2 FDN__Bag_intersect

I<TODO.>

=head2 FDN__Bag_union

I<TODO.>

=head2 FDN__Bag_exclusive
...
=head2 FDN__Bag_unique_count

I<TODO.>

=head2 FDN__Bag_order_using

I<TODO.>

=head2 FDN__Tuple_D1_select
...
=head2 FDN__Tuple_heading

I<TODO.>

=head2 FDN__Tuple_subheading_of

I<TODO.>

=head2 FDN__Tuple_overlaps_heading

I<TODO.>

=head2 FDN__Tuple_disjoint_heading

I<TODO.>

=head2 FDN__Tuple_except_heading

I<TODO.>

=head2 FDN__Tuple_intersect_heading

I<TODO.>

=head2 FDN__Tuple_union_heading

I<TODO.>

=head2 FDN__Tuple_exclusive_heading

I<TODO.>

=head2 FDN__Tuple_rename
...
The function C<FDN__External_call_function> requires its source to be a
I<FDN__Tuple> value with just 1 attribute/argument named C<0>, where that
...
C<0> attribute as its source/arguments.  Its result type is I<FDN__Any>.

=head1 FOUNDATION PROCEDURES

I<TODO.>

I<TODO.  Practically all Reference ops are procedures.>
...
MDF is Copyright © 2002-2016, Muldis Data Systems, Inc.
...
should have received copies of the GPL as part of the MDF distribution, in
