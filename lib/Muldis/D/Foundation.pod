...
L<Muldis::D::Packages::Muldis_D> for the details of high-level Muldis D.
...
partly to help distinguish them; the low-level names are also purposefully
verbose / less user-friendly to help discourage their direct use by users.
...
The I<FDN_Any_Thing> type is the I<universal type> of the Muldis D type
system, and consists of all possible values.  It is a union type over just
these 6 low-level types, all of the latter being mutually disjoint:
I<FDN_2VL_Bool>, I<FDN_Big_Int>, I<FDN_Inf_Array_of_Any>,
I<FDN_Inf_Bag_of_Any>, I<FDN_Inf_Struct_of_Any>, I<FDN_External>.
...
=head2 FDN_Inf_Array_of_Any

I<TODO.>

=head2 FDN_Inf_Bag_of_Any

I<TODO.>

=head2 FDN_Inf_Struct_of_Any
...
Every low-level routine takes an argument of just the I<FDN_Any_Thing>
