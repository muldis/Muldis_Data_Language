...
it contains is C<Muldis_D_Foundation https://muldis.com 0.201.0>.
...
support the C<Muldis_D Plain_Text https://muldis.com 0.201.0> language,
need to provide.
...
should have received a copy of the AL2 as part of the MDF
