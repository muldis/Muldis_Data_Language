...
C<Boolean>, C<Integer>, C<Array>, C<Bag>,
C<Tuple>, C<Capsule>, C<Reference>, C<External>.
...
The C<Capsule> type is infinite.  A C<Capsule> value is a ... I<TODO>.

=head2 Reference

The C<Reference> type is infinite.  A C<Reference> value is a ... I<TODO>.
...
The Foundation constant C<False> represents the C<Boolean>
value I<false>.

=head2 True

The Foundation constant C<True> represents the C<Boolean>
value I<true>.

=head2 Neg_One

The Foundation constant C<Neg_One> represents the C<Integer>
value negative-one.

=head2 Zero

The Foundation constant C<Zero> represents the C<Integer>
value zero.

=head2 Pos_One

The Foundation constant C<Pos_One> represents the C<Integer>
value positive-one.

=head2 default_Reference

The Foundation constant C<default_Reference> represents the default
value of the C<Reference> type, ...

=head2 default_External

The Foundation constant C<default_External> represents the default
value of the C<External> type, which exists soley that said type has a
...
The function C<is_a_Boolean> requires its source to be a C<Tuple>
...
The function C<is_a_Integer> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<is_a_Array> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<is_a_Bag> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<is_a_Tuple> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<is_a_Capsule> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
I<true> iff its C<0> argument is a member of the C<Capsule> type, and
results in the C<Boolean> value I<false> otherwise.

=head2 is_a_Reference

The function C<is_a_Reference> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
I<true> iff its C<0> argument is a member of the C<Reference> type, and
results in the C<Boolean> value I<false> otherwise.

=head2 is_a_External

The function C<is_a_External> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<same> requires its source to be a C<Tuple>
...
its identity value is the C<Integer> positive one;
...
=head2 Array_index_succ_all_matches
...
=head2 Capsule_wrapper

I<TODO.>

=head2 Capsule_unwrap
