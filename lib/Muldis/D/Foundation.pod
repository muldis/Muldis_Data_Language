...
The I<FDN_Any_Thing> type is the infinite I<universal type> of the Muldis D
type system, and consists of all possible values.  It is a union type over
just these 6 low-level types, all of the latter being mutually disjoint:
