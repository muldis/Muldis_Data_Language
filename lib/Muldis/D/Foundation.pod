...
general purpose integer exact numeric, which explicitly does not represent
...
The Foundation constant C<FDN__True> represents the default value of the
I<FDN__External> type, which exists soley that said type has a defined
default value; the actual value of this is implementation-dependent.
...
=head2 FDN__isa_Tuple_Inf

I<TODO.>

=head2 FDN__isa_Capsule
...
=head2 FDN__Capsule_select

I<TODO.>

=head2 FDN__Capsule_tag

I<TODO.>

=head2 FDN__Capsule_asset
