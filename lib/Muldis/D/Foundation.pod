...
C<Boolean>, C<Integer>, C<Array>, C<Bag>, C<Tuple>, C<Capsule>, C<Handle>.
...
=head2 default_Handle

The Foundation singleton type definer C<default_Handle> represents the default
value of the C<Handle> type, ...

=head2 default_Variable

The Foundation singleton type definer C<default_Variable> represents the default
value of the C<Variable> type, ...

=head2 default_Process

The Foundation singleton type definer C<default_Process> represents the default
value of the C<Process> type, ...

=head2 default_Stream

The Foundation singleton type definer C<default_Stream> represents the default
value of the C<Stream> type, ...
...
The function C<is_a_Handle> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<is_a_Variable> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<is_a_Process> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
The function C<is_a_Stream> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
