...
This document is Muldis::D::Foundation version 0.201.0.
...
it contains is C<Muldis_D_Foundation http://muldis.com 0.201.0>.
...
support the C<Muldis_D Plain_Text http://muldis.com 0.201.0> language,
need to provide.
...
The function C<Capsule> requires its source to be a C<Tuple>
value with just 1 attribute/argument named C<0>, where that argument may be
any value.  This function results in the C<Boolean> value
...
should have received copies of the AL2 as part of the MDF
