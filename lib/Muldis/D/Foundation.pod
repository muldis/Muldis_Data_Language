...
of those must also be nonzero.  This function results in the
I<FDN__Integer_Inf> value from performing I<exponentiation> of its 2
arguments C<0> (I<base>) and C<1> (I<exponent> or I<power>).
