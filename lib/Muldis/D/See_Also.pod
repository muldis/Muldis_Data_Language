...
This document is Muldis::D::See_Also version 0.201.0.-9.
...
=item B<Muldis D Reference Engine for Perl 5> - L<Muldis::D::RefEng>
...
licensed under the GNU LGPL version 3 or later.  It is a full-fledged
...
is a Perl 5 module that lets Muldis D be used directly by Perl 5 programs
...
consisting of native Perl 5 data structures.
...
whole separate language (such as Muldis::D::RefEng does).  Rather, it is
...
module may be ported to Perl 6 again to replace it, unless there's no point
in the face of a more useful Muldis::D::RefEng port.
...
the same language that Rakudo Perl 6 is written in, and this would be the
...
general purpose languages, giving them the same benefits that Perl 5
...
B<TODO: Newest is L<http://www.wiscorp.com/sql20nn.zip> for 2011 Jan 3.>
...
Besides the Muldis::D::RefEng framework, other projects exist which attempt
...
as Muldis::D::RefEng is, so you have the freedom to use the software for any
