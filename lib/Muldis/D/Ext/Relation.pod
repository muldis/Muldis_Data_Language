...
C<< function sys.std.Relation.degree (NNInt <-- QRelation $topic) >>
...
C<< function sys.std.Relation.is_nullary (Bool <-- QRelation $topic) >>
...
C<< function sys.std.Relation.is_not_nullary (Bool <-- QRelation $topic)
>>
...
C<< function sys.std.Relation.has_attrs (Bool <-- QRelation $topic,
...
C<< function sys.std.Relation.is_empty (Bool <-- QRelation $topic) >>
...
C<< function sys.std.Relation.is_not_empty (Bool <-- QRelation $topic) >>
...
C<< function sys.std.Relation.has_key (Bool <-- QRelation $topic,
set_of.Name $attr_names) >>
...
C<< function sys.std.Relation.empty (Relation <-- QRelation $topic) >>
...
C<< function sys.std.Relation.power_set (quasi_set_of.QRelation <--
QRelation $topic) >>
...
C<< function sys.std.Relation.tclose (QRelation <-- QRelation $topic) >>
...
C<< function sys.std.Relation.classification (QRelation <--
...
C<< function sys.std.Relation.reduction (QTuple <-- QRelation $topic,
...
C<< function sys.std.Relation.maybe_reduction (quasi_maybe_of.QTuple <--
...
C<< function sys.std.Relation.map (QRelation <-- QRelation $topic,
...
C<< function sys.std.Relation.is_disjoint (Bool <-- QRelation $topic,
QRelation $other) >>
...
C<< function sys.std.Relation.is_not_disjoint (Bool <-- QRelation $topic,
QRelation $other) >>
...
C<< function sys.std.Relation.exclusion (QRelation <--
...
C<< function sys.std.Relation.symmetric_diff (QRelation <--
quasi_bag_of.QRelation $topic) >>
...
C<< function sys.std.Relation.composition (QRelation <-- QRelation $topic,
QRelation $other) >>
...
C<< function sys.std.Relation.join_with_group (QRelation <--
...
C<< function sys.std.Relation.rank (QRelation <-- QRelation $topic,
...
also the C<sys.std.Array.QArray_from_wrap> function, which is the same as
C<sys.std.Relation.rank> but that it wraps the source q/tuples rather than
just adding an attribute to them.

=head2 sys.std.Relation.rank_by_attr_names

C<< function sys.std.Relation.rank_by_attr_names (QRelation <--
...
C<sys.std.Tuple.order_by_attr_names> as its C<ord_func> argument, and the
latter is given C<order_by> in its C<assuming> argument.

=head2 sys.std.Relation.limit

C<< function sys.std.Relation.limit (QRelation <-- QRelation $topic,
...
remain ordered (but see C<sys.std.Array.limit_of_QArray_from_wrap> for an
alternative).

=head2 sys.std.Relation.limit_by_attr_names

C<< function sys.std.Relation.limit_by_attr_names (QRelation <--
...
C<< function sys.std.Relation.substitution (QRelation <--
...
C<< function sys.std.Relation.static_subst (QRelation <--
...
C<< function sys.std.Relation.subst_in_restr (QRelation <--
...
C<< function sys.std.Relation.static_subst_in_restr (QRelation <--
QRelation $topic, FuncRef $restr_func, QTuple $restr_assuming?,
QTuple $subst) >>
...
C<< function sys.std.Relation.subst_in_semijoin (QRelation <--
...
C<< function sys.std.Relation.static_subst_in_semijoin (QRelation <--
...
C<< function sys.std.Relation.outer_join_with_group (QRelation <--
QRelation $primary, QRelation $secondary, Name $group_attr) >>
...
C<< function sys.std.Relation.outer_join_with_maybes (QRelation <--
...
C<< function sys.std.Relation.outer_join_with_defaults (QRelation <--
...
C<< function sys.std.Relation.outer_join_with_static_exten (QRelation <--
...
C<< function sys.std.Relation.outer_join_with_exten (QRelation <--
...
C<updater sys.std.Relation.assign_empty (QRelation &$topic)>
...
C<updater sys.std.Relation.assign_exclusion (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.Relation.assign_substitution (QRelation &$topic,
...
C<updater sys.std.Relation.assign_static_subst (QRelation &$topic,
QTuple $attrs)>
...
C<updater sys.std.Relation.assign_subst_in_restr (QRelation &$topic,
...
C<updater sys.std.Relation.assign_static_subst_in_restr
(QRelation &$topic, FuncRef $restr_func, QTuple $restr_assuming?,
QTuple $subst)>
...
C<updater sys.std.Relation.assign_subst_in_semijoin (QRelation &$topic,
