...
This document is Muldis::D::Ext::Relation version 0.96.0.
...
C<< function sys.std.Relation.classification (Relation <-- $topic : Relation,
$func : ValMapFuncRef, $class_attr_name : Name, $group_attr_name : Name) >>
...
$topic : Relation, $order_by : array_of.OrderByName, $is_reverse_order? : Bool,
$rank_interval : interval_of.NNInt) >>
...
C<< function sys.std.Relation.subst_in_restr (Relation <-- $topic : Relation,
...
C<updater sys.std.Relation.assign_static_subst_in_restr (&$topic : Relation,
$restr_func : ValFiltFuncRef, $subst : Tuple)>
...
$restr : Relation, $subst_attr_names : set_of.Name, $subst_func : ValMapFuncRef)>
