...
=head2 sys.std.Temporal.Instant.difference

C<function sys.std.Temporal.Instant.difference result Duration params {
...
=head2 sys.std.Temporal.Instant.abs_difference

C<function sys.std.Temporal.Instant.abs_difference result Duration params {
...
C<function sys.std.Temporal.Instant.later result Instant params {
...
C<function sys.std.Temporal.Instant.earlier result Instant params {
instant(Instant), duration(Duration) }>
...
C<function sys.std.Temporal.Duration.difference result Duration params {
...
C<function sys.std.Temporal.UTCInstant.difference result UTCDuration
...
C<function sys.std.Temporal.UTCInstant.abs_difference result UTCDuration
params { topic(UTCInstant), other(UTCInstant) }>
...
params { instant(UTCInstant), duration(UTCDuration) }>
...
C<function sys.std.Temporal.FloatInstant.difference result UTCDuration
...
UTCDuration params { topic(FloatInstant), other(FloatInstant) }>
...
params { instant(FloatInstant), duration(UTCDuration) }>
...
C<function sys.std.Temporal.UTCDuration.abs result UTCDuration params {
topic(UTCDuration) }>
...
C<function sys.std.Temporal.UTCDuration.sum result UTCDuration params {
addends(bag_of.UTCDuration) }>
...
=head2 sys.std.Temporal.UTCDuration.difference

C<function sys.std.Temporal.UTCDuration.difference result UTCDuration
params { minuend(UTCDuration), subtrahend(UTCDuration) }>
...
C<function sys.std.Temporal.UTCInstant.UTC_from_TAI result UTCDateTime
params { tai(Instant) }>
...
C<function sys.std.Temporal.UTCInstant.TAI_from_UTC result Instant params {
utc(UTCDateTime) }>
...
=head2 sys.std.Temporal.Instant.fetch_current_instant

C<system_service sys.std.Temporal.Instant.fetch_current_instant update
{ target(Instant) } read {}>
