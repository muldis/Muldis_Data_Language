...
This document is Muldis::D::Ext::Temporal version 0.64.0.
...
C<< function sys.std.Temporal.Instant.difference (Duration <--
Instant $minuend, Instant $subtrahend) >>
...
C<< function sys.std.Temporal.Instant.abs_difference (Duration <--
Instant $topic, Instant $other) >>
...
C<< function sys.std.Temporal.Instant.later (Instant <-- Instant $instant,
Duration $duration) >>
...
C<< function sys.std.Temporal.Duration.abs (Duration <-- Duration $topic)
>>
...
C<< function sys.std.Temporal.Duration.difference (Duration <--
Duration $minuend, Duration $subtrahend) >>
...
C<< function sys.std.Temporal.UTCInstant.difference (UTCDuration <--
UTCInstant $minuend, UTCInstant $subtrahend) >>
...
C<< function sys.std.Temporal.UTCInstant.abs_difference (UTCDuration <--
UTCInstant $topic, UTCInstant $other) >>
...
UTCInstant $instant, UTCDuration $duration) >>
...
C<< function sys.std.Temporal.FloatInstant.difference (UTCDuration <--
FloatInstant $minuend, FloatInstant $subtrahend) >>
...
C<< function sys.std.Temporal.FloatInstant.abs_difference (UTCDuration <--
FloatInstant $topic, FloatInstant $other) >>
...
FloatInstant $instant, UTCDuration $duration) >>
...
C<< function sys.std.Temporal.UTCDuration.difference (UTCDuration <--
UTCDuration $minuend, UTCDuration $subtrahend) >>
...
C<system_service sys.std.Temporal.Instant.fetch_current_instant
(Instant &$target)>
