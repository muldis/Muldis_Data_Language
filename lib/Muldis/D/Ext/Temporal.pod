...
This document is Muldis::D::Ext::Temporal version 0.78.0.
...
C<system_service sys.std.Temporal.Instant.fetch_curr_instant
(Instant &$target)>
...
C<system_service sys.std.Temporal.UTCInstant.fetch_curr_datetime
(UTCDateTime &$target)>
...
C<system_service sys.std.Temporal.UTCInstant.fetch_curr_date
(UTCDate &$target)>
...
C<system_service sys.std.Temporal.UTCInstant.fetch_curr_time
(UTCTime &$target)>
...
C<system_service sys.std.Temporal.FloatInstant.fetch_curr_datetime
...
C<system_service sys.std.Temporal.FloatInstant.fetch_curr_date
(FloatDate &$target)>
...
C<system_service sys.std.Temporal.FloatInstant.fetch_curr_time
(FloatTime &$target)>
