...
params { topic(UTCDuration), other(UTCDuration) }>
...
{ instant(Instant), duration(UTCDuration) }>
...
params { instant(Instant), duration(UTCDuration) }>
...
UTCDuration params { topic(UTCDuration), other(UTCDuration) }>
