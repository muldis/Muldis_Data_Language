...
This document is Muldis::D::Ext::Ordered version 0.62.1.
...
C<< function sys.std.Ordered.reverse_order (Order <-- topic(Universal),
...
C<< function sys.std.Ordered.is_not_before (Bool <-- topic(Universal),
other(Universal), func(OrdDetFuncRef)?, assuming(QTuple)?) >>
...
C<< function sys.std.Ordered.is_inside_range (Bool <-- topic(Universal),
min(Universal), max(Universal), min_is_outside(Bool)?,
...
C<< function sys.std.Ordered.is_outside_range (Bool <-- topic(Universal),
min(Universal), max(Universal), min_is_outside(Bool)?,
max_is_outside(Bool)?, func(OrdDetFuncRef)?, assuming(QTuple)?) >>
...
C<< function sys.std.Ordered.min (Universal <-- topic(QSet),
...
C<< function sys.std.Ordered.max (Universal <-- topic(QSet),
func(OrdDetFuncRef)?, assuming(QTuple)?) >>
...
C<< function sys.std.Ordered.minmax (QTuple <-- topic(QSet),
func(OrdDetFuncRef)?, assuming(QTuple)?) >>
...
C<< function sys.std.Ordered.maybe_min (QMaybe <-- topic(QSet),
func(OrdDetFuncRef)?, assuming(QTuple)?) >>
...
C<< function sys.std.Ordered.maybe_max (QMaybe <-- topic(QSet),
func(OrdDetFuncRef)?, assuming(QTuple)?) >>
...
C<< function sys.std.Ordered.maybe_minmax (QRelation <-- topic(QSet),
func(OrdDetFuncRef)?, assuming(QTuple)?) >>
