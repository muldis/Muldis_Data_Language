...
This document is Muldis::D::Ext::Ordered version 0.53.0.
...
max_is_outside(Bool)?, func(OrdDetFuncRef)?, assuming(QuasiTuple)? }>
...
func(OrdDetFuncRef)?, assuming(QuasiTuple)? }>
...
topic(Set), func(OrdDetFuncRef)?, assuming(QuasiTuple)? }>
