...
This document is Muldis::D::Ext::Ordered version 0.73.0.
...
argument of C<Bool:false>, and C<Bool:false> otherwise.

=head2 sys.std.Ordered.is_not_after

C<< function sys.std.Ordered.is_not_after (Bool <-- Universal $topic,
Universal $other, OrdDetFuncRef $func?, QTuple $assuming?) >>

This function is an alias for C<sys.std.Ordered.is_not_before> except that
...
the opposite boolean value when given the same corresponding 3 arguments.
(It could alternately be called "is before or is identical".)
