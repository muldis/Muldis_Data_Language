...
topic(Universal), other(Universal), func(Cat.OrdDetFuncRef)?,
assuming(QuasiTuple)? }>
...
max_is_outside(Bool)?, func(Cat.OrdDetFuncRef)?, assuming(QuasiTuple)? }>
...
topic(Set), func(Cat.OrdDetFuncRef)?, assuming(QuasiTuple)? }>
