...
This document is Muldis::D::Ext::Ordered version 0.25.0.
...
topic(Universal), other(Universal), func(Cat.OrdDetFuncNameChain)?,
assuming(Tuple)? }>
...
max_is_outside(Bool)?, func(Cat.OrdDetFuncNameChain)?, assuming(Tuple)? }>
...
func(Cat.OrdDetFuncNameChain)?, assuming(Tuple)? }>
...
topic(Set), func(Cat.OrdDetFuncNameChain)?, assuming(Tuple)? }>
