...
This document is Muldis::D::Ext::Ordered version 0.94.0.
...
C<< function sys.std.Ordered.is_member (Bool <-- Universal $value,
Interval $interval, OrdDetFuncRef $func?) >>
...
C<< function sys.std.Ordered.is_not_member (Bool <-- Universal $value,
Interval $interval, OrdDetFuncRef $func?) >>
