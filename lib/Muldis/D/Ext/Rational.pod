...
This document is Muldis::D::Ext::Rational version 0.52.0.
...
This is an enumeration data type.  A C<NNRat> (non-negative rational) is a
...
=item C<function sys.std.Rational.abs result NNRat params { topic(Rat) }>
