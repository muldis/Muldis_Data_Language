...
This document is Muldis::D::Ext::Rational version 0.96.0.
...
C<< function sys.std.Rational.abs (NNRat <-- $topic : Rat) >>

This function results in the absolute value of its argument.  Note that
this operation is also known as C<N||>.

=head2 sys.std.Rational.sum

C<< function sys.std.Rational.sum (Rat <-- $topic? : bag_of.Rat) >>
...
=head2 sys.std.Rational.diff

C<< function sys.std.Rational.diff (Rat <-- $minuend : Rat, $subtrahend : Rat)
>>
...
known as I<subtraction> or I<minus> or C<N->.

=head2 sys.std.Rational.abs_diff

C<< function sys.std.Rational.abs_diff (Rat <-- $topic : Rat, $other : Rat) >>

This symmetric function results in the absolute difference between its 2
arguments.  Note that this operation is also known as C<N|-|>.

=head2 sys.std.Rational.product

C<< function sys.std.Rational.product (Rat <-- $topic? : bag_of.Rat) >>
...
as I<multiply> or I<times> or C<N*>.

=head2 sys.std.Rational.quotient

C<< function sys.std.Rational.quotient (Rat <-- $dividend : Rat,
$divisor : Rat) >>
...
C<< function sys.std.Rational.range (Rat <-- $topic : set_of.Rat) >>
...
C<< function sys.std.Rational.mean (Rat <-- $topic : bag_of.Rat) >>
...
C<< function sys.std.Rational.median (set_of.Rat <-- $topic : bag_of.Rat) >>
...
C<< function sys.std.Rational.mean_of_median (Rat <-- $topic : bag_of.Rat) >>
...
C<< function sys.std.Rational.mode (set_of.Rat <-- $topic : bag_of.Rat) >>
...
C<< function sys.std.Rational.round (Rat <-- $topic : Rat,
...
C<< function sys.std.Rational.power (PRat <-- $radix : PRat, $exponent : Rat,
$round_rule : RatRoundRule) >>
...
is also known as I<exponentiation> or C<N^>.

=head2 sys.std.Rational.log

C<< function sys.std.Rational.log (Rat <-- $topic : PRat, $radix : PRat,
$round_rule : RatRoundRule) >>
...
C<< function sys.std.Rational.natural_power (PRat <-- $exponent : Rat,
$round_rule : RatRoundRule) >>
...
C<< function sys.std.Rational.natural_log (Rat <-- $topic : PRat,
$round_rule : RatRoundRule) >>
...
C<system-service sys.std.Rational.fetch_random (&$target : Rat,
$radix : PInt2_N, $max_denom : PInt, $interval : interval_of.Rat)>
