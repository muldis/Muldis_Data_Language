...
This document is Muldis::D::Ext::Rational version 0.59.1.
...
=head2 sys.std.Rational.Type.NNRat
...
This is an enumeration data type.  A C<RatRoundRule> is a C<Tuple>.  It
specifies a controlled (and typically degrading) coercion of a real number
into a rational number having a specific radix and precision.  It is mainly
used to deterministically massage an operation, whose conceptual result is
...
precise rational.  A C<RatRoundRule> has these 3 attributes: C<radix> (a
C<PInt2_N>), C<max_denom> (a C<PInt>), and C<round_meth> (a
C<RatRoundMeth>).  The rational resulting from the operation is as close as
...
C<max_denom>; if rounding is needed, then C<round_meth> dictates the
rounding method.  The default value of C<RatRoundRule> specifies a coersion
to a whole number using the C<half_up> rounding method (its radix is 2 and
its max denom is 1).
...
C<function sys.std.Rational.abs result NNRat params { topic(Rat) }>

This function results in the absolute value of its argument.

=head2 sys.std.Rational.sum

C<function sys.std.Rational.sum result Rat params { addends(bag_of.Rat) }>
...
C<function sys.std.Rational.difference result Rat params {
...
C<function sys.std.Rational.abs_difference result Rat params {
topic(Rat), other(Rat) }>
...
C<function sys.std.Rational.product result Rat params {
factors(bag_of.Rat) }>
...
C<function sys.std.Rational.quotient result Rat params {
...
C<function sys.std.Rational.maybe_quotient result maybe_of.Rat params
{ dividend(Rat), divisor(Rat) }>
...
C<function sys.std.Rational.range result Rat params { topic(set_of.Rat) }>
...
C<function sys.std.Rational.mean result Rat params { topic(bag_of.Rat) }>
...
C<function sys.std.Rational.maybe_mean result maybe_of.Rat params {
topic(bag_of.Rat) }>
...
C<function sys.std.Rational.median result set_of.Rat params {
topic(bag_of.Rat) }>
...
C<function sys.std.Rational.mean_of_median result Rat params {
topic(bag_of.Rat) }>
...
C<function sys.std.Rational.mode result set_of.Rat params {
topic(bag_of.Rat) }>
...
C<function sys.std.Rational.round result Rat params { topic(Rat),
...
C<function sys.std.Rational.power result PRat params { radix(PRat),
exponent(Rat) }>
...
C<function sys.std.Rational.log result Rat params { topic(PRat),
...
C<function sys.std.Rational.natural_power result PRat params {
...
C<function sys.std.Rational.natural_log result Rat params {
...
C<function sys.std.Rational.Rat_from_Text result Rat params {
...
C<function sys.std.Rational.Text_from_Rat result Text params {
...
C<function sys.std.Rational.Rat_from_Int result Rat params { int(Int) }>
...
C<function sys.std.Rational.Int_from_Rat result Int params {
...
C<system_service sys.std.Rational.fetch_random update { target(Rat) }
