...
This document is Muldis::D::Ext::Rational version 0.22.1.
...
C<sys.std.Rational.Type.(Set|Maybe|Seq|Bag)OfRat>.
...
=item C<sys.std.Rational.Type.(Set|Maybe|Seq|Bag)OfRat>
...
=item C<function sys.std.Rational.sum result Rat params { addends(BagOfRat)
}>
...
=item C<function sys.std.Rational.maybe_quotient result MaybeOfRat params {
dividend(Rat), divisor(Rat) }>
...
=item C<function sys.std.Rational.range result Rat params { topic(SetOfRat)
}>
...
=item C<function sys.std.Rational.mean result Rat params { topic(BagOfRat)
}>
...
=item C<function sys.std.Rational.maybe_mean result MaybeOfRat params {
topic(BagOfRat) }>
...
=item C<function sys.std.Rational.median result SetOfRat params {
topic(BagOfRat) }>
...
=item C<function sys.std.Rational.mode result SetOfRat params {
topic(BagOfRat) }>
