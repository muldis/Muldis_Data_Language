...
This document is Muldis::D::Ext::Rational version 0.94.0.
...
C<< function sys.std.Rational.diff (Rat <-- Rat $minuend, Rat $subtrahend)
>>
...
C<< function sys.std.Rational.abs_diff (Rat <-- Rat $topic, Rat $other) >>
...
C<system-service sys.std.Rational.fetch_random (Rat &$target,
PInt2_N $radix, PInt $max_denom, interval_of.Rat $interval)>
