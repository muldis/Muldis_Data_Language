...
specifies a coersion to a whole number using the C<RatRoundMeth:half_up>
...
mantissa(Int), radix(PInt2_N), exponent(Int) }>
...
=item C<function sys.std.Rational.radix result PInt2_N params {
topic(Rat) }>
