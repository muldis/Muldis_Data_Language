...
This document is Muldis::D::Ext::Rational version 0.62.2.
...
C<< function sys.std.Rational.sum (Rat <-- bag_of.Rat $addends) >>
...
C<< function sys.std.Rational.product (Rat <-- bag_of.Rat $factors) >>
