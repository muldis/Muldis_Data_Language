...
This document is Muldis::D::Ext::QTuple version 0.62.1.
...
C<< function sys.std.QTuple.degree (NNInt <-- topic(QTuple)) >>
...
C<< function sys.std.QTuple.is_nullary (Bool <-- topic(QTuple)) >>
...
C<< function sys.std.QTuple.is_not_nullary (Bool <-- topic(QTuple)) >>
...
C<< function sys.std.QTuple.has_attrs (Bool <-- topic(QTuple),
...
C<< function sys.std.QTuple.attr_names (set_of.Name <-- topic(QTuple)) >>
...
C<< function sys.std.QTuple.attr_from_QTuple (Universal <-- topic(QTuple))
>>
...
C<< function sys.std.QTuple.subst_in_default (QTuple <-- of(TypeRef),
subst(QTuple)) >>
