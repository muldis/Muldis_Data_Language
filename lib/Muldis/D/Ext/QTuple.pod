...
This document is Muldis::D::Ext::QTuple version 0.61.0.
...
C<function sys.std.QTuple.degree result NNInt params { topic(QTuple) }>
...
C<function sys.std.QTuple.is_nullary result Bool params { topic(QTuple) }>
...
C<function sys.std.QTuple.is_not_nullary result Bool params {
topic(QTuple) }>
...
C<function sys.std.QTuple.has_attrs result Bool params { topic(QTuple),
...
C<function sys.std.QTuple.attr_names result set_of.Name params {
topic(QTuple) }>
...
C<function sys.std.QTuple.attr_from_QTuple result Universal params {
topic(QTuple) }>
...
C<function sys.std.QTuple.QTuple_from_attr result QTuple params {
...
C<function sys.std.QTuple.subst_in_default result QTuple params {
