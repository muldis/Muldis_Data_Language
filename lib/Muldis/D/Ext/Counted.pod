...
This document is Muldis::D::Ext::Counted version 0.100.0.
...
C<< function sys.std.Counted.counted_has_not_member (Bool <--
...
$topic : Relation, $func : ValRedFuncRef, $identity : Tuple,
