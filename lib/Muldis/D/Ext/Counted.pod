...
C<< function sys.std.Counted.counted_has_member (Bool <-- $r : Relation,
...
C<< function sys.std.Counted.counted_has_not_member (Bool <-- $r : Relation,
$t : Tuple, $count_attr_name : Name) >>
...
C<< function sys.std.Counted.counted_insertion (Relation <-- $r : Relation,
$t : Tuple, $count_attr_name : Name) >>
...
C<< function sys.std.Counted.counted_deletion (Relation <-- $r : Relation,
$t : Tuple, $count_attr_name : Name) >>
...
$topic : Relation, $attr_names : set_of.Name, $count_attr_name : Name) >>
...
C<< function sys.std.Counted.counted_reduction (Tuple <-- $topic : Relation,
$func : ValRedFuncRef, $identity : Tuple, $count_attr_name : Name) >>
...
$topic : Relation, $func : ValRedFuncRef, $count_attr_name : Name) >>
...
C<< function sys.std.Counted.counted_map (Relation <-- $topic : Relation,
