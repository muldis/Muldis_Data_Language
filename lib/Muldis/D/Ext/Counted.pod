...
This document is Muldis::D::Ext::Counted version 0.80.0.
...
C<< function sys.std.Counted.counted_reduction (Tuple <-- Relation $topic,
ValRedFuncRef $func, Tuple $identity, Name $count_attr_name) >>
...
Relation $topic, ValRedFuncRef $func, Name $count_attr_name) >>
