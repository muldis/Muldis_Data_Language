...
This document is Muldis::D::Ext::Counted version 0.104.0.
...
$topic : Relation, $func : ValRedCFuncNC, $identity : Tuple,
...
$topic : Relation, $func : ValRedCFuncNC, $count_attr_name : Name) >>

This function is to C<sys.std.Core.Relation.maybe_reduction> as
C<sys.std.Counted.counted_reduction> is to
C<sys.std.Core.Relation.reduction>.
