...
This document is Muldis::D::Ext::Counted version 0.77.0.
...
Relation $topic, FuncRef $func, Tuple $assuming?, Tuple $identity,
...
Relation $topic, FuncRef $func, Tuple $assuming?, Name $count_attr_name) >>
...
set_of.Name $result_attr_names, FuncRef $func, Tuple $assuming?,
Name $count_attr_name) >>
