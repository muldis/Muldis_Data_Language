...
This document is Muldis::D::Ext::Counted version 0.71.0.
...
This function is a shorthand for C<sys.std.Core.QRelation.static_extension>
...
This function is a shorthand for C<sys.std.Core.QRelation.cmpl_projection>
...
=head2 sys.std.Counted.counted_is_member

C<< function sys.std.Counted.counted_is_member (Bool <-- QRelation $r,
QTuple $t, Name $count_attr_name) >>

This function is the same as C<sys.std.Core.QRelation.is_member> except
that C<t> must have one fewer attribute than C<r> does, specifically
C<tcount> (and otherwise they must have the same headings).

=head2 sys.std.Counted.counted_is_not_member

C<< function sys.std.Counted.counted_is_not_member (Bool <-- QRelation $r,
QTuple $t, Name $count_attr_name) >>

This function is exactly the same as C<sys.std.Counted.counted_is_member>
...
C<counted_is_member> but that its result differs depending on whether C<t>
...
C<counted_is_member> but that its result differs depending on what the
...
=head2 sys.std.Counted.counted_cmpl_projection

C<< function sys.std.Counted.counted_cmpl_projection (QRelation <--
QRelation $topic, set_of.Name $attr_names, Name $count_attr_name) >>

This function is the same as C<sys.std.Core.QRelation.cmpl_projection>
...
QRelation $look_in, QRelation $look_for, Name $count_attr_name) >>
...
C<look_for> and C<look_in> arguments, both of which have a C<tcount>
attribute; this function returns C<Bool:true> iff the multiplicity of each
C<look_for> value is less than or equal to the multiplicity of its
counterpart C<look_in> value.
...
=head2 sys.std.Counted.counted_difference

C<< function sys.std.Counted.counted_difference (QRelation <--
QRelation $source, QRelation $filter, Name $count_attr_name) >>

This function is like C<sys.std.Core.QRelation.difference> as
...
=head2 sys.std.Counted.counted_static_substitution

C<< function sys.std.Counted.counted_static_substitution (QRelation <--
QRelation $topic, QTuple $attrs, Name $count_attr_name) >>

This function is the same as C<sys.std.QRelation.static_substitution>
except that the C<counted_cardinality> of the result is guaranteed to be
the same as that of C<topic> rather than possibly less.  The C<topic>
