...
This document is Muldis::D::Ext::Counted version 0.78.0.
...
sensitive to special relation attributes that store count meta-data as if
...
C<< function sys.std.Counted.add_count_attr (Relation <--
Relation $topic, Name $count_attr_name) >>
...
C<< function sys.std.Counted.remove_count_attr (Relation <--
Relation $topic, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_has_member (Bool <-- Relation $r,
Tuple $t, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_has_not_member (Bool <-- Relation $r,
Tuple $t, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_insertion (Relation <-- Relation $r,
Tuple $t, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_deletion (Relation <-- Relation $r,
Tuple $t, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_projection (Relation <--
Relation $topic, set_of.Name $attr_names, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_cmpl_proj (Relation <--
Relation $topic, set_of.Name $attr_names, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_reduction (Tuple <--
Relation $topic, ValRedFuncRef $func, Tuple $assuming?, Tuple $identity,
Name $count_attr_name) >>

This function is the same as C<sys.std.Relation.reduction> except that
...
C<< function sys.std.Counted.counted_maybe_reduction (maybe_of.Tuple <--
Relation $topic, ValRedFuncRef $func, Tuple $assuming?,
Name $count_attr_name) >>

This function is to C<sys.std.Core.Relation.maybe_reduction> as
C<sys.std.Counted.counted_reduction> is to C<sys.std.Relation.reduction>.

=head2 sys.std.Counted.counted_map

C<< function sys.std.Counted.counted_map (Relation <-- Relation $topic,
set_of.Name $result_attr_names, ValMapFuncRef $func, Tuple $assuming?,
Name $count_attr_name) >>

This function is the same as C<sys.std.Relation.map> except that the
...
Relation $topic, Relation $other, Name $count_attr_name) >>
...
function is like C<sys.std.Relation.is_proper_superset> as per
C<counted_is_superset>.
...
C<sys.std.Relation.is_not_proper_superset> as per C<counted_is_superset>.

=head2 sys.std.Counted.counted_union

C<< function sys.std.Counted.counted_union (Relation <--
set_of.Relation $topic, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_union_sum (Relation <--
bag_of.Relation $topic, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_intersection (Relation <--
set_of.Relation $topic, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_diff (Relation <--
Relation $source, Relation $filter, Name $count_attr_name) >>
...
C<< function sys.std.Counted.counted_substitution (Relation <--
Relation $topic, set_of.Name $attr_names, ValMapFuncRef $func,
Tuple $assuming?, Name $count_attr_name) >>

This function is the same as C<sys.std.Relation.substitution> except that
...
C<< function sys.std.Counted.counted_static_subst (Relation <--
Relation $topic, Tuple $attrs, Name $count_attr_name) >>

This function is the same as C<sys.std.Relation.static_subst>
except that the C<counted_cardinality> of the result is guaranteed to be
the same as that of C<topic> rather than possibly less.  The C<topic>
