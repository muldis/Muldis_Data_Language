...
C<< function sys.std.Counted.add_count_attr (QRelation <--
...
C<< function sys.std.Counted.remove_count_attr (QRelation <--
QRelation $topic, Name $count_attr_name) >>
...
This function is like C<sys.std.Core.Relation.diff> as
C<counted_union> is like C<sys.std.Core.Relation.union>; for corresponding
