...
This document is Muldis::D::Ext::Integer version 0.96.0.
...
=head2 sys.std.Integer.inc

C<< function sys.std.Integer.inc (Int <-- $topic : Int) >>

This function results in its argument incremented by 1.  Note that this
operation is also known as C<++>.

=head2 sys.std.Integer.dec

C<< function sys.std.Integer.dec (Int <-- $topic : Int) >>
...
C<< function sys.std.Integer.abs (NNInt <-- $topic : Int) >>
...
C<< function sys.std.Integer.sum (Int <-- $topic? : bag_of.Int) >>
...
=head2 sys.std.Integer.diff

C<< function sys.std.Integer.diff (Int <-- $minuend : Int, $subtrahend : Int)
>>
...
=head2 sys.std.Integer.abs_diff

C<< function sys.std.Integer.abs_diff (Int <-- $topic : Int, $other : Int) >>
...
C<< function sys.std.Integer.product (Int <-- $topic? : bag_of.Int) >>
...
C<< function sys.std.Integer.quotient (Int <-- $dividend : Int, $divisor : Int)
>>
...
C<< function sys.std.Integer.remainder (NNInt <-- $dividend : Int,
$divisor : Int) >>
...
=head2 sys.std.Integer.quot_and_rem

C<< function sys.std.Integer.quot_and_rem (Tuple <--
...
=head2 sys.std.Integer.maybe_quot_and_rem

C<< function sys.std.Integer.maybe_quot_and_rem (Relation <--
$dividend : Int, $divisor : Int) >>
...
C<< function sys.std.Integer.range (Int <-- $topic : set_of.Int) >>
...
C<< function sys.std.Integer.median (set_of.Int <-- $topic : bag_of.Int) >>
...
C<< function sys.std.Integer.mode (set_of.Int <-- $topic : bag_of.Int) >>
...
C<< function sys.std.Integer.power (Int <-- $radix : Int, $exponent : NNInt) >>
...
C<< function sys.std.Integer.factorial (PInt <-- $topic : NNInt) >>
...
C<system-service sys.std.Integer.fetch_random (&$target : Int,
