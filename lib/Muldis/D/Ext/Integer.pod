...
and aren't re-described here):
    ...
    sys.Core.Type.Universal
        ...
        sys.Core.Type.Scalar
            ...
            sys.Integer.Type.Int
                sys.Integer.Type.UInt
                    sys.Integer.Type.PInt

                        # These are all finite integer types.

                        sys.Integer.Cat.PInt2_36
...
=head2 sys.Integer.Cat.PInt2_36
...
=item C<function sys.Integer.Int.Int_from_Text result Int params {
...
=item C<function sys.Integer.Int.Text_from_Int result Text params {
...
=item C<function sys.Integer.Int.Blob_S_VBE_from_Int result Blob params {
int(Int) }>
