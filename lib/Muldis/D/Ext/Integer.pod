...
=item C<function sys.std.Integer.abs result UInt params { topic(Int) }>
...
=item C<function sys.std.Integer.remainder result UInt params {
dividend(Int), divisor(Int) }>
...
=item C<function sys.std.Integer.maybe_remainder result maybe_of.UInt
...
=item C<function sys.std.Integer.factorial result PInt params { topic(UInt)
}>
...
=item C<function sys.std.Integer.Int_from_Blob_U_VBE result UInt params {
blob(Blob) }>

This function is the same as C<sys.std.Integer.Int_from_Blob_S_VBE> but
that it does unsigned integers.

=item C<function sys.std.Integer.Blob_U_VBE_from_Int result UInt params {
blob(Blob) }>
