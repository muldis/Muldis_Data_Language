...
This document is Muldis::D::Ext::Integer version 0.51.0.
...
This is an enumeration data type.  A C<PInt2_36> is a proper subtype of
...
=item C<function sys.std.Integer.increment result Int params { topic(Int)
}>

This function results in its argument incremented by 1.

=item C<function sys.std.Integer.decrement result Int params { topic(Int)
}>

This function results in its argument decremented by 1.

=item C<function sys.std.Integer.abs result NNInt params { topic(Int) }>

This function results in the absolute value of its argument.

=item C<function sys.std.Integer.sum result Int params {
addends(bag_of.Int) }>
...
=item C<function sys.std.Integer.difference result Int params {
...
=item C<function sys.std.Integer.abs_difference result Int params {
topic(Int), other(Int) }>

This function results in the absolute difference between its 2 arguments.

=item C<function sys.std.Integer.product result Int params {
factors(bag_of.Int) }>
...
=item C<function sys.std.Integer.quotient result Int params {
...
=item C<function sys.std.Integer.remainder result NNInt params {
dividend(Int), divisor(Int) }>
...
=item C<function sys.std.Integer.maybe_quotient result maybe_of.Int params
{ dividend(Int), divisor(Int) }>
...
=item C<function sys.std.Integer.maybe_remainder result maybe_of.NNInt
...
=item C<function sys.std.Integer.range result Int params {
topic(set_of.Int) }>
...
=item C<function sys.std.Integer.median result set_of.Int params {
topic(bag_of.Int) }>
...
=item C<function sys.std.Integer.mode result set_of.Int params {
topic(bag_of.Int) }>
...
=item C<function sys.std.Integer.power result Int params { radix(Int),
exponent(NNInt) }>
...
=item C<function sys.std.Integer.factorial result PInt params {
topic(NNInt) }>
...
=item C<function sys.std.Integer.Int_from_Text result Int params {
...
=item C<function sys.std.Integer.Text_from_Int result Text params {
...
=item C<function sys.std.Integer.Int_from_Blob_S_VBE result Int params {
blob(Blob) }>
...
=item C<function sys.std.Integer.Blob_S_VBE_from_Int result Blob params {
int(Int) }>
...
=item C<function sys.std.Integer.Int_from_Blob_U_VBE result NNInt params {
blob(Blob) }>

This function is the same as C<sys.std.Integer.Int_from_Blob_S_VBE> but
that it does unsigned integers.

=item C<function sys.std.Integer.Blob_U_VBE_from_Int result NNInt params {
blob(Blob) }>
...
=item C<system_service sys.std.Integer.fetch_random update { target(Int) }
