...
This document is Muldis::D::Ext::Integer version 0.22.1.
...
C<sys.std.Integer.Type.(Set|Maybe|Seq|Bag)Of(Int|UInt)>.
...
=item C<sys.std.Integer.Type.(Set|Maybe|Seq|Bag)Of(Int|UInt)>
...
=item C<function sys.std.Integer.sum result Int params { addends(BagOfInt)
}>
...
=item C<function sys.std.Integer.maybe_quotient result MaybeOfInt params {
dividend(Int), divisor(Int) }>
...
=item C<function sys.std.Integer.maybe_remainder result MaybeOfUInt params
{ dividend(Int), divisor(Int) }>
...
=item C<function sys.std.Integer.range result Int params { topic(SetOfInt)
}>
...
=item C<function sys.std.Integer.median result SetOfInt params {
topic(BagOfInt) }>
...
=item C<function sys.std.Integer.mode result SetOfInt params {
topic(BagOfInt) }>
