...
C<< function sys.std.Integer.increment (Int <-- topic(Int)) >>

This function results in its argument incremented by 1.

=head2 sys.std.Integer.decrement

C<< function sys.std.Integer.decrement (Int <-- topic(Int)) >>
...
C<< function sys.std.Integer.sum (Int <-- addends(bag_of.Int)) >>
...
C<< function sys.std.Integer.difference (Int <-- minuend(Int),
subtrahend(Int)) >>
...
C<< function sys.std.Integer.abs_difference (Int <-- topic(Int),
other(Int)) >>
...
C<< function sys.std.Integer.product (Int <-- factors(bag_of.Int)) >>
...
C<system_service sys.std.Integer.fetch_random (&target(Int), min(Int),
max(Int), exclude_min(Bool)?, exclude_max(Bool)?)>
