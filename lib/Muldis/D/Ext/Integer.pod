...
This document is Muldis::D::Ext::Integer version 0.62.2.
...
C<< function sys.std.Integer.sum (Int <-- bag_of.Int $addends) >>
...
C<< function sys.std.Integer.product (Int <-- bag_of.Int $factors) >>
