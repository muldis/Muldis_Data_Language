...
This document is Muldis::D::Ext::Integer version 0.62.0.
...
C<function sys.std.Integer.increment result Int params { topic(Int) }>

This function results in its argument incremented by 1.

=head2 sys.std.Integer.decrement

C<function sys.std.Integer.decrement result Int params { topic(Int) }>

This function results in its argument decremented by 1.

=head2 sys.std.Integer.abs

C<function sys.std.Integer.abs result NNInt params { topic(Int) }>

This function results in the absolute value of its argument.

=head2 sys.std.Integer.sum

C<function sys.std.Integer.sum result Int params { addends(bag_of.Int) }>
...
C<function sys.std.Integer.difference result Int params {
...
C<function sys.std.Integer.abs_difference result Int params {
topic(Int), other(Int) }>
...
C<function sys.std.Integer.product result Int params {
factors(bag_of.Int) }>
...
C<function sys.std.Integer.quotient result Int params {
...
C<function sys.std.Integer.remainder result NNInt params {
dividend(Int), divisor(Int) }>
...
C<function sys.std.Integer.quotient_and_remainder result Tuple params {
dividend(Int), divisor(Int) }>
...
C<function sys.std.Integer.maybe_quotient result maybe_of.Int params
{ dividend(Int), divisor(Int) }>
...
C<function sys.std.Integer.maybe_remainder result maybe_of.NNInt
...
C<function sys.std.Integer.maybe_quotient_and_remainder result Relation
params { dividend(Int), divisor(Int) }>
...
C<function sys.std.Integer.range result Int params { topic(set_of.Int) }>
...
C<function sys.std.Integer.median result set_of.Int params {
topic(bag_of.Int) }>
...
C<function sys.std.Integer.mode result set_of.Int params {
topic(bag_of.Int) }>
...
C<function sys.std.Integer.power result Int params { radix(Int),
exponent(NNInt) }>

This function results in its C<radix> argument taken to the power of its
(non-negative integer) C<exponent> argument.  This function will fail if
C<radix> and C<exponent> are both zero.

=head2 sys.std.Integer.factorial

C<function sys.std.Integer.factorial result PInt params { topic(NNInt) }>
...
C<function sys.std.Integer.Int_from_Text result Int params {
...
C<function sys.std.Integer.Text_from_Int result Text params {
int(Int), radix(PInt2_36) }>
...
C<function sys.std.Integer.Int_from_Blob_S_VBE result Int params {
blob(Blob) }>
...
C<function sys.std.Integer.Blob_S_VBE_from_Int result Blob params {
int(Int) }>
...
C<function sys.std.Integer.Int_from_Blob_U_VBE result NNInt params {
blob(Blob) }>
...
C<function sys.std.Integer.Blob_U_VBE_from_Int result NNInt params {
blob(Blob) }>
...
C<system_service sys.std.Integer.fetch_random update { target(Int) }
read { min(Int), max(Int), exclude_min(Bool)?, exclude_max(Bool)? }>
