...
Muldis::D::Ext::DateTime -
Muldis D extension for temporal data types and operators

=head1 VERSION

This document is Muldis::D::Ext::DateTime version 0.110.0.
...
This current C<DateTime> document describes the system-defined I<Muldis D
DateTime Extension>, which consists of temporal data types and operators,
...
The I<Muldis D DateTime Extension> is expressly not meant to be complete by
...
UTC on input and from UTC on output with the I<Muldis D DateTime
        ...
        sys.std.Core.Type.Scalar
            sys.std.Core.Type.DHScalar
                sys.std.Core.Type.Cat.OVLScalar
                    ...
                    sys.std.DateTime.Type.TAIInstant
                    sys.std.DateTime.Type.TAIDuration

                    sys.std.DateTime.Type.UTCInstant
                        sys.std.DateTime.Type.UTCDateTime
                        sys.std.DateTime.Type.UTCDate
                        sys.std.DateTime.Type.UTCTime

                    sys.std.DateTime.Type.FloatInstant
                        sys.std.DateTime.Type.FloatDateTime
                        sys.std.DateTime.Type.FloatDate
                        sys.std.DateTime.Type.FloatTime

                    sys.std.DateTime.Type.UTCDuration
                    ...
                    sys.std.Core.Type.Int
                        ...
                        sys.std.Core.Type.NNInt
                            ...
                            sys.std.Core.Type.PInt
                                ...
                                sys.std.DateTime.Type.PInt[12|31]

                            # These are all finite non-negative int types.

                            sys.std.DateTime.Type.NNInt[23|59]
                    ...
                    sys.std.Core.Type.Rat
                        sys.std.Core.Type.NNRat
                            ...
                            sys.std.DateTime.Type.NNRatLT62
...
=head2 sys.std.DateTime.Type.PInt[12|31]
...
=head2 sys.std.DateTime.Type.NNInt[23|59]
...
=head2 sys.std.DateTime.Type.NNRatLT62
...
=head2 sys.std.DateTime.Type.TAIInstant

This is a structure data type.  A C<TAIInstant> is a single point in time
...
=head2 sys.std.DateTime.Type.TAIDuration

This is a structure data type.  A C<TAIDuration> is a single amount of
...
human-specified calendar based artifacts; again see the I<Muldis D DateTime
Extension> for alternatives.

=head2 sys.std.DateTime.Type.UTCInstant
...
=head2 sys.std.DateTime.Type.UTCDateTime
...
=head2 sys.std.DateTime.Type.UTCDate
...
=head2 sys.std.DateTime.Type.UTCTime
...
=head2 sys.std.DateTime.Type.FloatInstant
...
=head2 sys.std.DateTime.TAIInstant.diff

C<< function sys.std.DateTime.TAIInstant.diff (TAIDuration <--
...
=head2 sys.std.DateTime.TAIInstant.abs_diff

C<< function sys.std.DateTime.TAIInstant.abs_diff (TAIDuration <--
...
=head2 sys.std.DateTime.TAIInstant.later

C<< function sys.std.DateTime.TAIInstant.later (TAIInstant <--
...
=head2 sys.std.DateTime.TAIInstant.earlier

C<< function sys.std.DateTime.TAIInstant.earlier (TAIInstant <--
$instant : TAIInstant, $duration : TAIDuration) >>
...
=head2 sys.std.DateTime.TAIDuration.abs

C<< function sys.std.DateTime.TAIDuration.abs (TAIDuration <--
$topic : TAIDuration) >>

This function results in the absolute value of its argument.

=head2 sys.std.DateTime.TAIDuration.sum

C<< function sys.std.DateTime.TAIDuration.sum (TAIDuration <--
...
=head2 sys.std.DateTime.TAIDuration.diff

C<< function sys.std.DateTime.TAIDuration.diff (TAIDuration <--
...
=head2 sys.std.DateTime.UTCInstant.diff

C<< function sys.std.DateTime.UTCInstant.diff (UTCDuration <--
...
=head2 sys.std.DateTime.UTCInstant.abs_diff

C<< function sys.std.DateTime.UTCInstant.abs_diff (UTCDuration <--
...
=head2 sys.std.DateTime.UTCInstant.later

C<< function sys.std.DateTime.UTCInstant.later (UTCInstant <--
$instant : UTCInstant, $duration : UTCDuration) >>

This function results in the instant that is later than its C<instant>
argument by the amount of time in the C<duration> argument.

=head2 sys.std.DateTime.UTCInstant.earlier

C<< function sys.std.DateTime.UTCInstant.earlier (UTCInstant <--
$instant : UTCInstant, $duration : UTCDuration) >>
...
=head2 sys.std.DateTime.FloatInstant.diff

C<< function sys.std.DateTime.FloatInstant.diff (UTCDuration <--
...
=head2 sys.std.DateTime.FloatInstant.abs_diff

C<< function sys.std.DateTime.FloatInstant.abs_diff (UTCDuration <--
...
=head2 sys.std.DateTime.FloatInstant.later

C<< function sys.std.DateTime.FloatInstant.later (FloatInstant <--
$instant : FloatInstant, $duration : UTCDuration) >>

This function results in the instant that is later than its C<instant>
argument by the amount of time in the C<duration> argument.

=head2 sys.std.DateTime.FloatInstant.earlier

C<< function sys.std.DateTime.FloatInstant.earlier (FloatInstant <--
$instant : FloatInstant, $duration : UTCDuration) >>
...
=head2 sys.std.DateTime.UTCDuration.abs

C<< function sys.std.DateTime.UTCDuration.abs (UTCDuration <--
$topic : UTCDuration) >>

This function results in the absolute value of its argument.

=head2 sys.std.DateTime.UTCDuration.sum

C<< function sys.std.DateTime.UTCDuration.sum (UTCDuration <--
...
=head2 sys.std.DateTime.UTCDuration.diff

C<< function sys.std.DateTime.UTCDuration.diff (UTCDuration <--
...
=head2 sys.std.DateTime.UTCInstant.UTC_from_TAI

C<< function sys.std.DateTime.UTCInstant.UTC_from_TAI (UTCDateTime <--
$tai : TAIInstant) >>
...
=head2 sys.std.DateTime.UTCInstant.TAI_from_UTC

C<< function sys.std.DateTime.UTCInstant.TAI_from_UTC (TAIInstant <--
$utc : UTCDateTime) >>
...
=head2 sys.std.DateTime.TAIInstant.fetch_curr_instant

C<system-service sys.std.DateTime.TAIInstant.fetch_curr_instant
(&$target : TAIInstant)>
...
=head2 sys.std.DateTime.UTCInstant.fetch_curr_datetime

C<system-service sys.std.DateTime.UTCInstant.fetch_curr_datetime
(&$target : UTCDateTime)>
...
=head2 sys.std.DateTime.UTCInstant.fetch_curr_date

C<system-service sys.std.DateTime.UTCInstant.fetch_curr_date
(&$target : UTCDate)>

This system-service routine is the same as
C<sys.std.DateTime.UTCInstant.fetch_curr_date> except that it only
produces an instant value with the date (YMD) attributes set.

=head2 sys.std.DateTime.UTCInstant.fetch_curr_time

C<system-service sys.std.DateTime.UTCInstant.fetch_curr_time
(&$target : UTCTime)>
...
=head2 sys.std.DateTime.FloatInstant.fetch_curr_datetime

C<system-service sys.std.DateTime.FloatInstant.fetch_curr_datetime
...
=head2 sys.std.DateTime.FloatInstant.fetch_curr_date

C<system-service sys.std.DateTime.FloatInstant.fetch_curr_date
(&$target : FloatDate)>

This system-service routine is the same as
C<sys.std.DateTime.FloatInstant.fetch_curr_date> except that it only
produces an instant value with the date (YMD) attributes set.

=head2 sys.std.DateTime.FloatInstant.fetch_curr_time

C<system-service sys.std.DateTime.FloatInstant.fetch_curr_time
(&$target : FloatTime)>
