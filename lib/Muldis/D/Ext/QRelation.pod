...
This document is Muldis::D::Ext::QRelation version 0.75.0.
...
C<< function sys.std.QRelation.degree (NNInt <-- QRelation $topic) >>
...
C<< function sys.std.QRelation.is_nullary (Bool <-- QRelation $topic) >>
...
C<< function sys.std.QRelation.is_not_nullary (Bool <-- QRelation $topic)
>>
...
C<< function sys.std.QRelation.has_attrs (Bool <-- QRelation $topic,
...
C<< function sys.std.QRelation.attr_names (set_of.Name <--
QRelation $topic) >>
...
C<< function sys.std.QRelation.is_empty (Bool <-- QRelation $topic) >>
...
C<< function sys.std.QRelation.is_not_empty (Bool <-- QRelation $topic) >>
...
C<< function sys.std.QRelation.has_key (Bool <-- QRelation $topic,
set_of.Name $attr_names) >>
...
C<< function sys.std.QRelation.empty (Relation <-- QRelation $topic) >>
...
C<< function sys.std.QRelation.power_set (quasi_set_of.QRelation <--
QRelation $topic) >>
...
=head2 sys.std.QRelation.tclose

C<< function sys.std.QRelation.tclose (QRelation <-- QRelation $topic) >>
...
between them, and so each argument q/tuple represents an arc, C<tclose>
will determine all of the node pairs in that graph which have a path
between them (a recursive operation), so each q/tuple of the result
...
=head2 sys.std.QRelation.classification

C<< function sys.std.QRelation.classification (QRelation <--
QRelation $topic, FuncRef $func, QTuple $assuming?, Name $class_attr_name,
Name $group_attr_name) >>

This function conceptually is to C<sys.std.Core.QRelation.restriction> what
C<sys.std.Core.QRelation.group> is to C<sys.std.Core.QRelation.semijoin>.
It classifies the q/tuples of C<topic> into N groups using the function
named by C<func>, such that any distinct q/tuples are in a common group if
the function named by C<func> results in the same value when given either
of those q/tuples as its C<topic> argument, and C<assuming> as its
C<assuming> argument.  This function conceptually is a short-hand for first
...
C<func> and C<assuming>, and then grouping that result q/relation on all of
its original attributes, with the post-group RVA having the name given in
C<group_attr_name>; the result of C<classification> is a binary q/relation
...
partition a q/relation's q/tuples into an arbitrary number of groups using
...
C<< function sys.std.QRelation.reduction (QTuple <-- QRelation $topic,
FuncRef $func, QTuple $assuming?, QTuple $identity) >>
...
C<< function sys.std.QRelation.maybe_reduction (quasi_maybe_of.QTuple <--
...
C<< function sys.std.QRelation.map (QRelation <-- QRelation $topic,
...
0..1 q/tuples.  Now, C<map> requires the extra C<result_attr_names>
argument to prevent ambiguity in the general case where C<topic> might have
zero q/tuples, because in that situation, C<func> would never be invoked,
...
has at least 1 q/tuple and the result of C<func> does not have matching
...
C<< function sys.std.QRelation.is_proper_subset (Bool <--
...
C<< function sys.std.QRelation.is_not_proper_subset (Bool <--
QRelation $topic, QRelation $other) >>
...
=head2 sys.std.QRelation.is_proper_superset

C<< function sys.std.QRelation.is_proper_superset (Bool <--
QRelation $topic, QRelation $other) >>

This function is an alias for C<sys.std.QRelation.is_proper_subset> except
that it transposes the C<topic> and C<other> arguments.  This function
is exactly the same as C<sys.std.Core.QRelation.is_superset> except that it
results in C<Bool:false> if its 2 arguments are identical.  Note that this
operation is also known as C<⊃>.

=head2 sys.std.QRelation.is_not_proper_superset

C<< function sys.std.QRelation.is_not_proper_superset (Bool <--
QRelation $topic, QRelation $other) >>

This function is an alias for C<sys.std.QRelation.is_not_proper_subset>
except that it transposes the C<topic> and C<other> arguments.  This
function is exactly the same as C<sys.std.QRelation.is_proper_superset>
except that it results in the opposite boolean value when given the same
arguments.  Note that this operation is also known as C<⊅>.

=head2 sys.std.QRelation.is_disjoint

C<< function sys.std.QRelation.is_disjoint (Bool <-- QRelation $topic,
QRelation $other) >>

This symmetric function results in C<Bool:true> iff the set of q/tuples
...
C<< function sys.std.QRelation.is_not_disjoint (Bool <-- QRelation $topic,
QRelation $other) >>

This symmetric function is exactly the same as
C<sys.std.QRelation.is_disjoint> except that it results in the opposite
boolean value when given the same arguments.

=head2 sys.std.QRelation.exclusion

C<< function sys.std.QRelation.exclusion (QRelation <--
quasi_bag_of.QRelation $topic) >>
...
=head2 sys.std.QRelation.symmetric_diff

C<< function sys.std.QRelation.symmetric_diff (QRelation <--
quasi_bag_of.QRelation $topic) >>

This function is an alias for C<sys.std.QRelation.exclusion>.

=head2 sys.std.QRelation.composition

C<< function sys.std.QRelation.composition (QRelation <-- QRelation $topic,
QRelation $other) >>
...
C<< function sys.std.QRelation.join_with_group (QRelation <--
QRelation $primary, QRelation $secondary, Name $group_attr) >>
...
C<< function sys.std.QRelation.rank (QRelation <-- QRelation $topic,
Name $name, FuncRef $ord_func, QTuple $ord_assuming?,
...
curried by the C<ord_assuming> and C<is_reverse_order> arguments.  The
C<order_determination>
...
=head2 sys.std.QRelation.rank_by_attr_names

C<< function sys.std.QRelation.rank_by_attr_names (QRelation <--
QRelation $topic, Name $name, array_of.OrderByName $order_by,
Bool $is_reverse_order?) >>

This function is a short-hand for invoking C<rank> with the function
C<sys.std.QTuple.order_by_attr_names> as its C<ord_func> argument, and the
latter is given C<order_by> in its C<assuming> argument.

=head2 sys.std.QRelation.limit

C<< function sys.std.QRelation.limit (QRelation <-- QRelation $topic,
FuncRef $ord_func, QTuple $ord_assuming?, NNInt $min_rank, NNInt $max_rank,
Bool $is_reverse_order?) >>
...
function (using C<ord_func>, C<ord_assuming> and C<is_reverse_order>) and
then keeping just
...
=head2 sys.std.QRelation.limit_by_attr_names

C<< function sys.std.QRelation.limit_by_attr_names (QRelation <--
QRelation $topic, array_of.OrderByName $order_by, NNInt $min_rank,
...
C<< function sys.std.QRelation.substitution (QRelation <-- QRelation
...
least 1 q/tuple and the result of C<func> does not have matching attribute
names to those named by C<attr_names>.

=head2 sys.std.QRelation.static_subst

C<< function sys.std.QRelation.static_subst (QRelation <--
...
C<< function sys.std.QRelation.subst_in_restr (QRelation <-- QRelation
$topic, FuncRef $restr_func, QTuple $restr_assuming?, set_of.Name
$subst_attr_names, FuncRef $subst_func, QTuple $subst_assuming?) >>
...
and C<restr_assuming>) are then transformed (defined by
C<subst_attr_names>, C<subst_func> and C<subst_assuming>), then the result
...
C<< function sys.std.QRelation.static_subst_in_restr (QRelation <--
QRelation $topic, FuncRef $restr_func, QTuple $restr_assuming?,
QTuple $subst) >>

This function is to C<sys.std.QRelation.subst_in_restr> what
C<sys.std.QRelation.static_subst> is to
...
C<< function sys.std.QRelation.subst_in_semijoin (QRelation <--
QRelation $topic, QRelation $restr, set_of.Name $subst_attr_names,
FuncRef $subst_func, QTuple $subst_assuming?) >>
...
C<< function sys.std.QRelation.static_subst_in_semijoin (QRelation <--
QRelation $topic, QRelation $restr, QTuple $subst) >>
...
C<< function sys.std.QRelation.outer_join_with_group (QRelation <--
QRelation $primary, QRelation $secondary, Name $group_attr) >>
...
C<< function sys.std.QRelation.outer_join_with_maybes (QRelation <--
QRelation $primary, QRelation $secondary) >>
...
C<< function sys.std.QRelation.outer_join_with_defaults (QRelation <--
QRelation $primary, QRelation $secondary, TypeRef $filler) >>
...
C<< function sys.std.QRelation.outer_join_with_static_exten (QRelation <--
QRelation $primary, QRelation $secondary, QTuple $filler) >>
...
C<< function sys.std.QRelation.outer_join_with_exten (QRelation <--
QRelation $primary, QRelation $secondary, FuncRef $exten_func,
QTuple $exten_assuming?) >>
...
C<updater sys.std.QRelation.assign_empty (QRelation &$topic)>
...
C<updater sys.std.QRelation.assign_exclusion (QRelation &$topic,
QRelation $other)>
...
C<updater sys.std.QRelation.assign_substitution (QRelation &$topic,
...
=head2 sys.std.QRelation.assign_static_subst

C<updater sys.std.QRelation.assign_static_subst (QRelation &$topic,
QTuple $attrs)>

This update operator is a short-hand for first invoking the
C<sys.std.Core.QRelation.static_subst> function with the same
arguments, and then assigning the result of that function to C<topic>.

=head2 sys.std.QRelation.assign_subst_in_restr

C<updater sys.std.QRelation.assign_subst_in_restr (QRelation &$topic,
FuncRef $restr_func, QTuple $restr_assuming?, FuncRef $subst_func,
QTuple $subst_assuming?)>
...
C<updater sys.std.QRelation.assign_static_subst_in_restr (QRelation
&$topic, FuncRef $restr_func, QTuple $restr_assuming?, QTuple $subst)>
...
C<updater sys.std.QRelation.assign_subst_in_semijoin (QRelation &$topic,
QRelation $restr, FuncRef $subst_func, QTuple $subst_assuming?)>
...
C<updater sys.std.QRelation.assign_static_subst_in_semijoin
(QRelation &$topic, QRelation $restr, QTuple $subst)>
