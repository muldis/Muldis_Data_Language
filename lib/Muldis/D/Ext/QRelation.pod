...
C<< function sys.std.QRelation.substitution (QRelation <--
...
C<< function sys.std.QRelation.subst_in_restr (QRelation <--
QRelation $topic, FuncRef $restr_func, QTuple $restr_assuming?,
set_of.Name $subst_attr_names, FuncRef $subst_func,
...
C<updater sys.std.QRelation.assign_static_subst_in_restr
(QRelation &$topic, FuncRef $restr_func, QTuple $restr_assuming?,
QTuple $subst)>
