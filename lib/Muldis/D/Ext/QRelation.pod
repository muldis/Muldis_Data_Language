...
This document is Muldis::D::Ext::QRelation version 0.73.0.
...
C<< function sys.std.QRelation.transitive_closure (QRelation <--
QRelation $topic) >>
...
C<< function sys.std.QRelation.static_substitution (QRelation <--
...
C<updater sys.std.QRelation.assign_static_substitution (QRelation &$topic,
QTuple $attrs)>
