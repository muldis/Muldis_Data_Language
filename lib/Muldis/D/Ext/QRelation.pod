...
C<function sys.std.QRelation.classification result QRelation params {
...
topic(QRelation), result_attr_names(set_of.Name), func(FuncRef),
assuming(QTuple)? }>
...
subst_attr_names(set_of.Name), subst_func(FuncRef), subst_assuming(QTuple)?
}>
...
params { topic(QRelation), restr(QRelation), subst_attr_names(set_of.Name),
