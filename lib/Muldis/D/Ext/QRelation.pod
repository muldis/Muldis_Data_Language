...
This document is Muldis::D::Ext::QRelation version 0.62.0.
...
C<< function sys.std.QRelation.degree (NNInt <-- topic(QRelation)) >>
...
C<< function sys.std.QRelation.is_nullary (Bool <-- topic(QRelation)) >>
...
C<< function sys.std.QRelation.is_not_nullary (Bool <-- topic(QRelation))
>>
...
C<< function sys.std.QRelation.has_attrs (Bool <-- topic(QRelation),
...
C<< function sys.std.QRelation.is_empty (Bool <-- topic(QRelation)) >>
...
C<< function sys.std.QRelation.is_not_empty (Bool <-- topic(QRelation)) >>
...
C<< function sys.std.QRelation.has_key (Bool <-- topic(QRelation),
attr_names(set_of.Name)) >>
...
C<< function sys.std.QRelation.empty (Relation <-- topic(QRelation)) >>
...
topic(QRelation), func(FuncRef), assuming(QTuple)?, class_attr_name(Name),
...
C<< function sys.std.QRelation.reduction (QTuple <-- topic(QRelation),
func(FuncRef), assuming(QTuple)?, identity(QTuple)) >>
...
C<< function sys.std.QRelation.map (QRelation <-- topic(QRelation),
result_attr_names(set_of.Name), func(FuncRef), assuming(QTuple)?) >>
...
C<< function sys.std.QRelation.is_disjoint (Bool <-- topic(QRelation),
other(QRelation)) >>
...
C<< function sys.std.QRelation.is_not_disjoint (Bool <-- topic(QRelation),
other(QRelation)) >>
...
C<< function sys.std.QRelation.composition (QRelation <-- topic(QRelation),
other(QRelation)) >>
...
C<< function sys.std.QRelation.rank (QRelation <-- topic(QRelation),
name(Name), ord_func(FuncRef), ord_assuming(QTuple)?) >>
...
C<< function sys.std.QRelation.limit (QRelation <-- topic(QRelation),
ord_func(FuncRef), ord_assuming(QTuple)?, min_rank(NNInt), max_rank(NNInt))
>>
...
subst_attr_names(set_of.Name), subst_func(FuncRef),
...
topic(QRelation), restr(QRelation), subst_attr_names(set_of.Name),
...
topic(QRelation), restr(QRelation), subst(QTuple)) >>
...
primary(QRelation), secondary(QRelation)) >>
...
primary(QRelation), secondary(QRelation), filler(TypeRef)) >>
...
primary(QRelation), secondary(QRelation), filler(QTuple)) >>
...
primary(QRelation), secondary(QRelation), exten_func(FuncRef),
...
C<updater sys.std.QRelation.assign_empty (&topic(QRelation))>
...
C<updater sys.std.QRelation.assign_exclusion (&topic(QRelation),
other(QRelation))>
...
C<updater sys.std.QRelation.assign_substitution (&topic(QRelation),
...
C<updater sys.std.QRelation.assign_static_substitution (&topic(QRelation),
attrs(QTuple))>
...
C<updater sys.std.QRelation.assign_subst_in_restr (&topic(QRelation),
restr_func(FuncRef), restr_assuming(QTuple)?, subst_func(FuncRef),
subst_assuming(QTuple)?)>
...
C<updater sys.std.QRelation.assign_subst_in_semijoin (&topic(QRelation),
restr(QRelation), subst_func(FuncRef), subst_assuming(QTuple)?)>
