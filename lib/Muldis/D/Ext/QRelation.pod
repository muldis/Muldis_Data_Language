...
C<sys.std.QRelation.outer_join_with_static_extension> but that the filler
...
C<outer_join_with_static_extension> with the result from invoking
C<sys.std.Core.Universal.default>.

=item C<function sys.std.QRelation.outer_join_with_static_extension result
QRelation params { primary(QRelation), secondary(QRelation), filler(QTuple)
}>
...
This function is the same as
C<sys.std.QRelation.outer_join_with_static_extension> but that the result
