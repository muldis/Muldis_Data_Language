...
=item C<function sys.std.QRelation.subst_in_restr result QRelation params {
...
=item C<function sys.std.QRelation.static_subst_in_restr result QRelation
...
=item C<function sys.std.QRelation.subst_in_semijoin result QRelation
...
=item C<function sys.std.QRelation.static_subst_in_semijoin result
...
=item C<function sys.std.QRelation.outer_join_with_static_exten result
...
=item C<function sys.std.QRelation.outer_join_with_exten result QRelation
...
=item C<updater sys.std.QRelation.assign_subst_in_restr update {
...
=item C<updater sys.std.QRelation.assign_static_subst_in_restr update {
topic(QRelation) } read { restr_func(FuncRef), restr_assuming(QTuple)?,
subst(QTuple) }>
...
=item C<updater sys.std.QRelation.assign_subst_in_semijoin update {
...
=item C<updater sys.std.QRelation.assign_static_subst_in_semijoin update {
