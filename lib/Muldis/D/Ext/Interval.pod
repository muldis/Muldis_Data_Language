...
This document is Muldis::D::Ext::Interval version 0.94.0.
...
C<order_determination> function defined for it, and all system-defined
...
Universal $value, OrdDetFuncRef $func?) >>
...
C<< function sys.std.Interval.has_not_member (Bool <-- Interval $interval,
Universal $value, OrdDetFuncRef $func?) >>
