...
=item C<function sys.std.Nonscalar.Relation.power_set result SetOfRelation
params { topic(Relation) }>
...
MaybeOfTuple params { topic(Relation), func(Cat.NameChain), assuming(Tuple)
}>
