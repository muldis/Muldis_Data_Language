...
This document is Muldis::D::Ext::Text version 0.72.0.
...
=head2 sys.std.Text.catenation

C<< function sys.std.Text.catenation (Text <-- array_of.Text $topic?) >>
...
=head2 sys.std.Text.repeat

C<< function sys.std.Text.repeat (Text <-- Text $topic, NNInt $count) >>

This function results in the catenation of C<count> instances of C<topic>.

=head2 sys.std.Text.length_in_codepoints

C<< function sys.std.Text.length_in_codepoints (NNInt <-- Text $topic) >>

This function results in the length of its argument in abstract codepoints,
or in other words, in the actual length of the argument since Muldis D
explicitly works natively at the abstract codepoint abstraction level.

=head2 sys.std.Text.length_in_graphemes

C<< function sys.std.Text.length_in_graphemes (NNInt <-- Text $topic) >>

This function results in the length of its argument in language-independent
graphemes.

=head2 sys.std.Text.is_substr

C<< function sys.std.Text.is_substr (Bool <-- Text $look_in,
Text $look_for, Bool $fixed_start?, Bool $fixed_end?) >>
...
=head2 sys.std.Text.is_not_substr

C<< function sys.std.Text.is_not_substr (Bool <-- Text $look_in,
Text $look_for, Bool $fixed_start?, Bool $fixed_end?) >>
...
=head2 sys.std.Text.folded_to_NF[C|D]

C<< function sys.std.Text.folded_to_NF[C|D] (Text <-- Text $topic) >>
...
=head2 sys.std.Text.case_folded_to_upper

C<< function sys.std.Text.case_folded_to_upper (Text <-- Text $topic) >>
...
=head2 sys.std.Text.case_folded_to_lower

C<< function sys.std.Text.case_folded_to_lower (Text <-- Text $topic) >>

This function results in the normalization of its argument where any
letters considered to be (capital) uppercase are folded to (small)
lowercase.

=head2 sys.std.Text.accents_stripped

C<< function sys.std.Text.accents_stripped (Text <-- Text $topic) >>
...
=head2 sys.std.Text.ASCII

C<< function sys.std.Text.ASCII (Text <-- Text $topic, Text $mark?) >>
...
=head2 sys.std.Text.whitespace_trimmed

C<< function sys.std.Text.whitespace_trimmed (Text <-- Text $topic) >>
...
=head2 sys.std.Text.is_match_using_like

C<< function sys.std.Text.is_match_using_like (Bool <-- Text $look_in,
Text $look_for, Text $escape) >>
...
=head2 sys.std.Text.is_not_match_using_like

C<< function sys.std.Text.is_not_match_using_like (Bool <-- Text $look_in,
Text $look_for, Text $escape) >>
