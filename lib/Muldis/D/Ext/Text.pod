...
This document is Muldis::D::Ext::Text version 0.77.0.
...
=head2 sys.std.Text.replication

C<< function sys.std.Text.replication (Text <-- Text $topic, NNInt $count)
>>

This function results in the catenation of C<count> instances of C<topic>.
Note that this operation is also known as C<Tx>.

=head2 sys.std.Text.len_in_nfd_codes

C<< function sys.std.Text.len_in_nfd_codes (NNInt <-- Text $topic) >>
...
=head2 sys.std.Text.len_in_graphs

C<< function sys.std.Text.len_in_graphs (NNInt <-- Text $topic) >>
...
=head2 sys.std.Text.upper

C<< function sys.std.Text.upper (Text <-- Text $topic) >>
...
=head2 sys.std.Text.lower

C<< function sys.std.Text.lower (Text <-- Text $topic) >>
...
=head2 sys.std.Text.trim

C<< function sys.std.Text.trim (Text <-- Text $topic) >>
...
=head2 sys.std.Text.is_like

C<< function sys.std.Text.is_like (Bool <-- Text $look_in,
...
=head2 sys.std.Text.is_not_like

C<< function sys.std.Text.is_not_like (Bool <-- Text $look_in,
Text $look_for, Text $escape?) >>

This function is exactly the same as C<sys.std.Text.is_like>
except that it results in the opposite boolean value when given the same
arguments; it implements SQL's "NOT LIKE".  Note that this operation is
also known as I<is not match using like> or C<not like>.
