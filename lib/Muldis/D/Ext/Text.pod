...
C<< function sys.std.Text.replication (Text <-- $topic : Text, $count : NNInt)
>>
...
C<< function sys.std.Text.len_in_nfd_codes (NNInt <-- $topic : Text) >>
...
C<< function sys.std.Text.len_in_graphs (NNInt <-- $topic : Text) >>
...
C<< function sys.std.Text.has_substr (Bool <-- $look_in : Text,
...
C<< function sys.std.Text.has_not_substr (Bool <-- $look_in : Text,
$look_for : Text, $fixed_start? : Bool, $fixed_end? : Bool) >>
...
C<< function sys.std.Text.upper (Text <-- $topic : Text) >>
...
C<< function sys.std.Text.lower (Text <-- $topic : Text) >>
...
C<< function sys.std.Text.trim (Text <-- $topic : Text) >>
...
C<< function sys.std.Text.is_like (Bool <-- $look_in : Text,
...
C<< function sys.std.Text.is_not_like (Bool <-- $look_in : Text,
$look_for : Text, $escape? : Text) >>
