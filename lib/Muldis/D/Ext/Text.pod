...
This document is Muldis::D::Ext::Text version 0.74.0.
...
=head2 sys.std.Text.length_in_nfd_codepoints

C<< function sys.std.Text.length_in_nfd_codepoints (NNInt <-- Text $topic)
>>
...
=head2 sys.std.Text.has_substr

C<< function sys.std.Text.has_substr (Bool <-- Text $look_in,
...
=head2 sys.std.Text.has_not_substr

C<< function sys.std.Text.has_not_substr (Bool <-- Text $look_in,
Text $look_for, Bool $fixed_start?, Bool $fixed_end?) >>

This function is exactly the same as C<sys.std.Text.has_substr> except that
