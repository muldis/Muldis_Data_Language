...
This document is Muldis::D::Ext::Text version 0.59.1.
...
C<function sys.std.Text.catenation result Text params {
topic(array_of.Text) }>
...
C<function sys.std.Text.repeat result Text params { topic(Text),
count(NNInt) }>
...
C<function sys.std.Text.length_in_codepoints result NNInt params {
topic(Text) }>
...
C<function sys.std.Text.length_in_graphemes result NNInt params {
topic(Text) }>
...
C<function sys.std.Text.is_substr result Bool params { look_in(Text),
...
C<function sys.std.Text.is_not_substr result Bool params {
...
C<function sys.std.Text.folded_to_NF(C|D) result Text { topic(Text) }>
...
C<function sys.std.Text.case_folded_to_upper result Text { topic(Text) }>
...
C<function sys.std.Text.case_folded_to_lower result Text { topic(Text) }>
...
C<function sys.std.Text.accents_stripped result Text { topic(Text) }>
...
C<function sys.std.Text.ASCII result Text { topic(Text), mark(Text)? }>
...
C<function sys.std.Text.whitespace_trimmed result Text { topic(Text) }>
...
C<function sys.std.Text.is_match_using_like result Bool params {
...
C<function sys.std.Text.is_not_match_using_like result Bool params {
look_in(Text), look_for(Text), escape(Text) }>
