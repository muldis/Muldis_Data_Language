...
This document is Muldis::D::Ext::Tuple version 0.93.0.
...
C<< function sys.std.Tuple.degree (NNInt <-- Tuple $topic) >>
...
C<< function sys.std.Tuple.is_nullary (Bool <-- Tuple $topic) >>
...
C<< function sys.std.Tuple.is_not_nullary (Bool <-- Tuple $topic) >>
...
C<< function sys.std.Tuple.has_attrs (Bool <-- Tuple $topic,
...
C<< function sys.std.Tuple.attr_names (set_of.Name <-- Tuple $topic) >>
...
C<< function sys.std.Tuple.attr_from_Tuple (Universal <-- Tuple $topic) >>
...
C<< function sys.std.Tuple.order_by_attr_names (Order <-- Tuple $topic,
Tuple $other, array_of.OrderByName $order_by, Bool $is_reverse_order?) >>
...
type-default C<order_determination> function, which is used to order on
...
C<< function sys.std.Tuple.subst_in_default (Tuple <-- TypeRef $of,
Tuple $subst) >>
