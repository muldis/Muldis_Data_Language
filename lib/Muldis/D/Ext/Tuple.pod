...
C<< function sys.std.Tuple.degree (NNInt <-- QTuple $topic) >>
...
C<< function sys.std.Tuple.is_nullary (Bool <-- QTuple $topic) >>
...
C<< function sys.std.Tuple.is_not_nullary (Bool <-- QTuple $topic) >>
...
C<< function sys.std.Tuple.has_attrs (Bool <-- QTuple $topic,
...
C<< function sys.std.Tuple.attr_names (set_of.Name <-- QTuple $topic) >>

This function results in the set of the names of the attributes of its
argument.

=head2 sys.std.Tuple.attr_from_QTuple

C<< function sys.std.Tuple.attr_from_QTuple (Universal <-- QTuple $topic)
>>
...
=head2 sys.std.Tuple.QTuple_from_attr

C<< function sys.std.Tuple.QTuple_from_attr (QTuple <-- Name $name,
Universal $value) >>
...
C<< function sys.std.Tuple.order_by_attr_names (Order <-- QTuple $topic,
...
C<< function sys.std.Tuple.subst_in_default (QTuple <-- TypeRef $of,
QTuple $subst) >>
