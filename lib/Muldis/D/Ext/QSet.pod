...
=item C<function sys.std.QSet.is_member result Bool params { set(Set),
value(ScaTupRel) }>
...
=item C<function sys.std.QSet.is_not_member result Bool params { set(Set),
value(ScaTupRel) }>
...
=item C<function sys.std.QSet.insertion result Set params { set(Set),
value(ScaTupRel) }>
...
=item C<function sys.std.QSet.disjoint_insertion result Set params {
...
=item C<function sys.std.QSet.deletion result Set params { set(Set),
value(ScaTupRel) }>
...
=item C<function sys.std.QSet.reduction result ScaTupRel params {
topic(Set), func(FuncRef), assuming(QuasiTuple)?, identity(ScaTupRel) }>
...
=item C<function sys.std.QSet.maybe_reduction result Maybe params {
topic(Set), func(FuncRef), assuming(QuasiTuple)? }>
...
=item C<function sys.std.QSet.Set_from_wrap result set_of.Tuple params {
topic(Relation) }>
...
=item C<function sys.std.QSet.Set_from_attr result Set params {
...
=item C<function sys.std.QSet.QMaybe.single result Single params {
value(ScaTupRel) }>
...
=item C<function sys.std.QSet.QMaybe.attr result ScaTupRel params {
topic(Single) }>
...
=item C<function sys.std.QSet.QMaybe.attr_or_default result ScaTupRel
params { topic(Maybe), default(TypeRef) }>
...
=item C<function sys.std.QSet.QMaybe.attr_or_value result ScaTupRel params
...
ord_func(OrdDetFuncRef)?, ord_assuming(QuasiTuple)?,
