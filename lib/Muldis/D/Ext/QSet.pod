...
C<< function sys.std.QSet.is_member (Bool <-- set(QSet), value(Universal))
>>
...
C<< function sys.std.QSet.is_not_member (Bool <-- set(QSet),
value(Universal)) >>
...
C<< function sys.std.QSet.insertion (QSet <-- set(QSet), value(Universal))
>>
...
C<< function sys.std.QSet.disjoint_insertion (QSet <-- set(QSet),
value(Universal)) >>
...
C<< function sys.std.QSet.deletion (QSet <-- set(QSet), value(Universal))
>>
...
C<< function sys.std.QSet.reduction (Universal <-- topic(QSet),
...
C<< function sys.std.QSet.maybe_reduction (QMaybe <-- topic(QSet),
...
C<< function sys.std.QSet.QSet_from_attr (QSet <-- topic(QRelation),
name(Name)) >>
...
C<< function sys.std.QSet.QMaybe.single (QSingle <-- value(Universal)) >>
...
C<< function sys.std.QSet.QMaybe.attr (Universal <-- topic(QSingle)) >>
...
C<< function sys.std.QSet.QMaybe.order (Order <-- topic(QMaybe),
