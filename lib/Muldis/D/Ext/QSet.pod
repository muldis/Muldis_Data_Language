...
C<function sys.std.QSet.is_member result Bool params { set(QSet),
value(Universal) }>
...
C<function sys.std.QSet.is_not_member result Bool params { set(QSet),
value(Universal) }>
...
C<function sys.std.QSet.insertion result QSet params { set(QSet),
value(Universal) }>
...
C<function sys.std.QSet.disjoint_insertion result QSet params {
...
C<function sys.std.QSet.deletion result QSet params { set(QSet),
value(Universal) }>
...
C<function sys.std.QSet.reduction result Universal params {
...
C<function sys.std.QSet.maybe_reduction result QMaybe params {
...
C<function sys.std.QSet.QSet_from_wrap result set_of.QTuple params {
topic(QRelation) }>
...
C<function sys.std.QSet.QSet_from_attr result QSet params {
...
C<function sys.std.QSet.QMaybe.nothing result Nothing params {}>

This selector function results in the only zero-tuple QMaybe value.

=head2 sys.std.QSet.QMaybe.single

C<function sys.std.QSet.QMaybe.single result QSingle params {
value(Universal) }>
...
C<function sys.std.QSet.QMaybe.attr result Universal params {
topic(QSingle) }>
...
C<function sys.std.QSet.QMaybe.attr_or_default result Universal
...
C<function sys.std.QSet.QMaybe.attr_or_value result Universal params
...
C<function sys.std.QSet.QMaybe.order result Order params { topic(QMaybe),
other(QMaybe), treat_nothing_as_max(Bool), ord_func(OrdDetFuncRef)?,
ord_assuming(QTuple)?, reverse_order_of_singles(Bool)? }>
