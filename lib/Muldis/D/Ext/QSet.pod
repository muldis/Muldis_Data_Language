...
This document is Muldis::D::Ext::QSet version 0.75.0.
...
=head2 sys.std.QSet.has_member

C<< function sys.std.QSet.has_member (Bool <-- QSet $set, Universal $value)
>>
...
=head2 sys.std.QSet.has_not_member

C<< function sys.std.QSet.has_not_member (Bool <-- QSet $set,
Universal $value) >>

This function is exactly the same as C<sys.std.QSet.has_member> except that
...
=head2 sys.std.QSet.disjoint_ins

C<< function sys.std.QSet.disjoint_ins (QSet <-- QSet $set,
Universal $value) >>
...
C<< function sys.std.QSet.QMaybe.nothing (Maybe <--) >>
