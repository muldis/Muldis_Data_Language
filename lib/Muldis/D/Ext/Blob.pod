...
This document is Muldis::D::Ext::Blob version 0.22.1.
...
C<sys.std.Blob.Type.(Set|Maybe|Seq|Bag)OfBlob>.
...
=item C<sys.std.Blob.Type.(Set|Maybe|Seq|Bag)OfBlob>
...
=item C<function sys.std.Blob.and result Blob params { topic(SetOfBlob) }>
...
=item C<function sys.std.Blob.or result Blob params { topic(SetOfBlob) }>
...
=item C<function sys.std.Blob.xor result Blob params { topic(BagOfBlob) }>
