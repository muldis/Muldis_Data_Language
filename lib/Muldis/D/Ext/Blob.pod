...
This document is Muldis::D::Ext::Blob version 0.64.0.
...
C<< function sys.std.Blob.is_not_substr_bits (Bool <-- Blob $look_in,
Blob $look_for, Bool $fixed_start?, Bool $fixed_end?) >>
...
C<< function sys.std.Blob.is_substr_octets (Bool <-- OctetBlob $look_in,
