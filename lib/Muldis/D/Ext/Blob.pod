...
=item C<function sys.std.Blob.is_substr result Bool params { look_in(Blob),
...
=item C<function sys.std.Blob.is_not_substr result Bool params {
look_in(Blob), look_for(Blob), fixed_start(Bool)?, fixed_end(Bool)? }>

This function is exactly the same as C<sys.std.Blob.is_substr> except that
