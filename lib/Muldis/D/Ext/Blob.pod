...
This document is Muldis::D::Ext::Blob version 0.62.0.
...
C<function sys.std.Blob.catenation result Blob params {
topic(array_of.Blob) }>
...
=head2 sys.std.Blob.repeat

C<function sys.std.Blob.repeat result Blob params { topic(Blob),
count(NNInt) }>

This function results in the catenation of C<count> instances of C<topic>.

=head2 sys.std.Blob.length_in_bits

C<function sys.std.Blob.length_in_bits result NNInt params { topic(Blob) }>

This function results in the length of its argument in bits.

=head2 sys.std.Blob.length_in_octets

C<function sys.std.Blob.length_in_octets result NNInt params {
topic(OctetBlob) }>

This function results in the length of its argument in octets.

=head2 sys.std.Blob.is_substr_bits

C<function sys.std.Blob.is_substr_bits result Bool params {
...
=head2 sys.std.Blob.is_not_substr_bits

C<function sys.std.Blob.is_not_substr_bits result Bool params {
look_in(Blob), look_for(Blob), fixed_start(Bool)?, fixed_end(Bool)? }>

This function is exactly the same as C<sys.std.Blob.is_substr_bits> except
that it results in the opposite boolean value when given the same
arguments.

=head2 sys.std.Blob.is_substr_octets

C<function sys.std.Blob.is_substr_octets result Bool params {
look_in(OctetBlob), look_for(OctetBlob), fixed_start(Bool)?,
fixed_end(Bool)? }>
...
=head2 sys.std.Blob.is_not_substr_octets

C<function sys.std.Blob.is_not_substr_octets result Bool params {
look_in(OctetBlob), look_for(OctetBlob), fixed_start(Bool)?,
fixed_end(Bool)? }>

This function is to C<is_substr_octets> as C<is_not_substr_bits> is to
C<is_substr_bits>.

=head2 sys.std.Blob.not

C<function sys.std.Blob.not result Blob params { topic(Blob) }>

This function results in the bitwise I<not> of its argument.

=head2 sys.std.Blob.and

C<function sys.std.Blob.and result Blob params { topic(set_of.Blob) }>
...
C<function sys.std.Blob.or result Blob params { topic(set_of.Blob) }>
...
C<function sys.std.Blob.xor result Blob params { topic(bag_of.Blob) }>
...
C<function sys.std.Blob.Blob_from_Text result Blob params {
text(Text), size(PInt1_4) }>
...
C<function sys.std.Blob.Text_from_Blob result Text params {
blob(Blob), size(PInt1_4) }>
