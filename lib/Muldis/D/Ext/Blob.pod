...
This document is Muldis::D::Ext::Blob version 0.62.1.
...
C<< function sys.std.Blob.catenation (Blob <-- topic(array_of.Blob)) >>
...
C<< function sys.std.Blob.is_not_substr_bits (Bool <-- look_in(Blob),
look_for(Blob), fixed_start(Bool)?, fixed_end(Bool)?) >>
...
C<< function sys.std.Blob.is_substr_octets (Bool <-- look_in(OctetBlob),
...
C<< function sys.std.Blob.is_not_substr_octets (Bool <--
...
C<< function sys.std.Blob.not (Blob <-- topic(Blob)) >>

This function results in the bitwise I<not> of its argument.

=head2 sys.std.Blob.and

C<< function sys.std.Blob.and (Blob <-- topic(set_of.Blob)) >>
...
C<< function sys.std.Blob.or (Blob <-- topic(set_of.Blob)) >>
...
C<< function sys.std.Blob.xor (Blob <-- topic(bag_of.Blob)) >>
