...
This document is Muldis::D::Ext::QBag version 0.75.0.
...
=head2 sys.std.QBag.diff

C<< function sys.std.QBag.diff (QBag <-- QBag $source, QBag $filter) >>

This function is like C<sys.std.Core.QRelation.diff> as C<union> is
