...
This document is Muldis::D::Ext::QBag version 0.73.0.
...
C<< function sys.std.QBag.is_member (Bool <-- QBag $bag, Universal $value)
>>
...
C<< function sys.std.QBag.is_not_member (Bool <-- QBag $bag,
Universal $value) >>
...
C<< function sys.std.QBag.is_subset (Bool <-- QBag $look_in,
QBag $look_for) >>
...
C<< function sys.std.QBag.is_not_subset (Bool <-- QBag $look_in,
QBag $look_for) >>
...
C<< function sys.std.QBag.is_superset (Bool <-- QBag $look_in,
QBag $look_for) >>

This function is an alias for C<sys.std.QBag.is_subset> except that it
transposes the C<look_in> and C<look_for> arguments.  This function is like
...
returns C<Bool:true> iff the multiplicity of each C<look_for> value is less
than or equal to the multiplicity of its counterpart C<look_in> value.

=head2 sys.std.QBag.is_not_superset

C<< function sys.std.QBag.is_not_superset (Bool <-- QBag $look_in,
QBag $look_for) >>
...
C<< function sys.std.QBag.is_proper_subset (Bool <-- QBag $look_in,
QBag $look_for) >>
...
C<< function sys.std.QBag.is_not_proper_subset (Bool <-- QBag $look_in,
QBag $look_for) >>
...
C<< function sys.std.QBag.is_proper_superset (Bool <-- QBag $look_in,
QBag $look_for) >>

This function is an alias for C<sys.std.QBag.is_proper_subset> except that
it transposes the C<look_in> and C<look_for> arguments.  This function is
like C<sys.std.QRelation.is_proper_superset> as per C<is_superset>.

=head2 sys.std.QBag.is_not_proper_superset

C<< function sys.std.QBag.is_not_proper_superset (Bool <-- QBag $look_in,
QBag $look_for) >>
