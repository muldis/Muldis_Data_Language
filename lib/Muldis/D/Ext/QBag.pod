...
This document is Muldis::D::Ext::QBag version 0.62.1.
...
C<< function sys.std.QBag.cardinality (NNInt <-- topic(QBag)) >>
...
C<< function sys.std.QBag.is_member (Bool <-- bag(QBag), value(Universal))
>>
...
C<< function sys.std.QBag.is_not_member (Bool <-- bag(QBag),
value(Universal)) >>
...
C<< function sys.std.QBag.count (NNInt <-- bag(QBag), value(Universal)) >>
...
C<< function sys.std.QBag.insertion (QBag <-- bag(QBag), value(Universal))
>>
...
C<< function sys.std.QBag.deletion (QBag <-- bag(QBag), value(Universal))
>>
...
C<< function sys.std.QBag.reduction (Universal <-- topic(QBag),
...
C<< function sys.std.QBag.maybe_reduction (QMaybe <-- topic(QBag),
...
C<< function sys.std.QBag.QSet_from_QBag (QSet <-- topic(QBag)) >>
...
C<< function sys.std.QBag.QBag_from_QSet (QBag <-- topic(QSet)) >>
...
C<< function sys.std.QBag.QBag_from_attr (QBag <-- topic(QRelation),
name(Name)) >>
...
C<< function sys.std.QBag.is_subset (Bool <-- look_in(QBag),
look_for(QBag)) >>
...
C<< function sys.std.QBag.is_not_subset (Bool <-- look_in(QBag),
look_for(QBag)) >>
...
C<< function sys.std.QBag.is_proper_subset (Bool <-- look_in(QBag),
look_for(QBag)) >>
...
C<< function sys.std.QBag.is_not_proper_subset (Bool <-- look_in(QBag),
look_for(QBag)) >>
...
C<< function sys.std.QBag.union (QBag <-- topic(quasi_set_of.QBag)) >>
...
C<< function sys.std.QBag.intersection (QBag <-- topic(quasi_set_of.QBag))
>>
...
C<< function sys.std.QBag.difference (QBag <-- source(QBag), filter(QBag))
>>
