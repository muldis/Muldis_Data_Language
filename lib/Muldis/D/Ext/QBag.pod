...
This document is Muldis::D::Ext::QBag version 0.55.0.
...
=item C<function sys.std.QBag.QSet_from_QBag result QSet params {
topic(QBag) }>

This function results in the C<QSet> that is the projection of the C<value>
attribute of its C<QBag> argument.

=item C<function sys.std.QBag.QBag_from_QSet result QBag params {
topic(QSet) }>
...
=item C<function sys.std.QBag.QBag_from_wrap result quasi_bag_of.QTuple
...
=item C<function sys.std.QBag.union result QBag params {
