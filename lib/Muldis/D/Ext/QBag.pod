...
C<function sys.std.QBag.cardinality result NNInt params { topic(QBag) }>
...
=head2 sys.std.QBag.is_member

C<function sys.std.QBag.is_member result Bool params { bag(QBag),
value(Universal) }>
...
=head2 sys.std.QBag.is_not_member

C<function sys.std.QBag.is_not_member result Bool params { bag(QBag),
value(Universal) }>
...
C<function sys.std.QBag.count result NNInt params { bag(QBag),
value(Universal) }>
...
C<function sys.std.QBag.insertion result QBag params { bag(QBag),
value(Universal) }>
...
C<function sys.std.QBag.deletion result QBag params { bag(QBag),
value(Universal) }>
...
C<function sys.std.QBag.reduction result Universal params {
...
C<function sys.std.QBag.maybe_reduction result QMaybe params {
...
C<function sys.std.QBag.QSet_from_QBag result QSet params { topic(QBag) }>
...
C<function sys.std.QBag.QBag_from_QSet result QBag params { topic(QSet) }>
...
C<function sys.std.QBag.QBag_from_wrap result quasi_bag_of.QTuple
...
C<function sys.std.QBag.QBag_from_attr result QBag params {
...
C<function sys.std.QBag.is_subset result Bool params { look_in(QBag),
look_for(QBag) }>
...
C<function sys.std.QBag.is_not_subset result Bool params {
...
C<function sys.std.QBag.is_proper_subset result Bool params {
look_in(QBag), look_for(QBag) }>
...
C<function sys.std.QBag.is_not_proper_subset result Bool params {
look_in(QBag), look_for(QBag) }>
...
C<function sys.std.QBag.union result QBag params {
...
C<function sys.std.QBag.intersection result QBag params {
topic(quasi_set_of.QBag) }>
...
C<function sys.std.QBag.difference result QBag params { source(QBag),
filter(QBag) }>
