...
This document is Muldis::D::Ext::Set version 0.96.0.
...
C<< function sys.std.Set.has_member (Bool <-- $set : Set, $value : Universal)
>>
...
C<< function sys.std.Set.insertion (Set <-- $set : Set, $value : Universal) >>
...
C<< function sys.std.Set.deletion (Set <-- $set : Set, $value : Universal) >>
...
C<< function sys.std.Set.reduction (Universal <-- $topic : Set,
...
C<< function sys.std.Set.maybe_reduction (Maybe <-- $topic : Set,
$func : ValRedFuncRef) >>
...
C<< function sys.std.Set.Set_from_attr (Set <-- $topic : Relation,
$name : Name) >>
...
C<< function sys.std.Set.Maybe.single (Single <-- $value : Universal) >>
...
C<< function sys.std.Set.Maybe.attr (Universal <-- $topic : Single) >>
...
C<< function sys.std.Set.Maybe.order (Order <-- $topic : Maybe,
