...
This document is Muldis::D::Ext::Set version 0.78.0.
...
This selector function results in the only zero-tuple Maybe value, which
...
Tuple $ord_assuming?, Bool $reverse_order_of_singles?) >>
