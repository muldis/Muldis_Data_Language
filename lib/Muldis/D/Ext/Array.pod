...
interval_of.NNInt $index_interval) >>
...
the lowest and highest source-C<index> specified by C<rank_interval> to be
...
Bool $is_reverse_order?, interval_of.NNInt $index_interval) >>
