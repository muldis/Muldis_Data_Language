...
This document is Muldis::D::Ext::Array version 0.86.0.
...
element, then the result will always have at least 1 element.  Note that
this operation is also known as C<[..]>.
...
Relation $topic, OrdDetFuncRef $ord_func, Bool $is_reverse_order?) >>
...
Relation $topic, OrdDetFuncRef $ord_func,
