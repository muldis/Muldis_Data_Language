...
This document is Muldis::D::Ext::Array version 0.76.1.
...
=head2 sys.std.Array.value

C<< function sys.std.Array.value (Universal <-- QArray $topic,
NNInt $index) >>
...
=head2 sys.std.Array.update_value

C<< function sys.std.Array.update_value (QArray <-- QArray $topic,
NNInt $index, Universal $value) >>
...
=head2 sys.std.Array.insertion

C<< function sys.std.Array.insertion (QArray <-- QArray $topic,
NNInt $index, Universal $value) >>
...
=head2 sys.std.Array.deletion

C<< function sys.std.Array.deletion (QArray <-- QArray $topic,
NNInt $index) >>
...
=head2 sys.std.Array.has_elem

C<< function sys.std.Array.has_elem (Bool <-- QArray $topic,
Universal $value) >>
...
=head2 sys.std.Array.has_not_elem

C<< function sys.std.Array.has_not_elem (Bool <-- QArray $topic,
Universal $value) >>

This function is exactly the same as C<sys.std.Array.has_elem> except that
it results in the opposite boolean value when given the same arguments.

=head2 sys.std.Array.reduction

C<< function sys.std.Array.reduction (Universal <-- QArray $topic,
...
=head2 sys.std.Array.maybe_reduction

C<< function sys.std.Array.maybe_reduction (QMaybe <-- QArray $topic,
...
=head2 sys.std.Array.slice

C<< function sys.std.Array.slice (QArray <-- QArray $topic,
NNInt $first_index, NNInt $last_index) >>
...
=head2 sys.std.Array.catenation

C<< function sys.std.Array.catenation (QArray <--
quasi_array_of.QArray $topic?) >>
...
=head2 sys.std.Array.replication

C<< function sys.std.Array.replication (QArray <-- QArray $topic,
NNInt $count) >>

This function results in the catenation of C<count> instances of C<topic>.
Note that this operation is also known as C<Ax>.

=head2 sys.std.Array.reverse

C<< function sys.std.Array.reverse (QArray <-- QArray $topic) >>
...
=head2 sys.std.Array.has_subarray

C<< function sys.std.Array.has_subarray (Bool <-- QArray $look_in,
QArray $look_for) >>
...
=head2 sys.std.Array.has_not_subarray

C<< function sys.std.Array.has_not_subarray (Bool <-- QArray $look_in,
QArray $look_for) >>

This function is exactly the same as C<sys.std.Array.has_subarray> except
that it results in the opposite boolean value when given the same
arguments.

=head2 sys.std.Array.QArray_from_wrap

C<< function sys.std.Array.QArray_from_wrap (quasi_array_of.QTuple <--
QRelation $topic, FuncRef $ord_func, QTuple $ord_assuming?,
...
latter function is curried by its C<ord_assuming> and C<is_reverse_order>
arguments; this wrapped
...
C<sys.std.Relation.rank> function, which is the same as
C<sys.std.Array.QArray_from_wrap> but that it just adds an attribute to
the source q/tuples and does not wrap them.

=head2 sys.std.Array.QArray_from_wrap_by_attr_names

C<< function sys.std.Array.QArray_from_wrap_by_attr_names
(quasi_array_of.QTuple <-- QRelation $topic,
array_of.OrderByName $order_by, Bool $is_reverse_order?) >>

This function is to C<QArray_from_wrap> what
C<sys.std.Relation.rank_by_attr_names> is to C<sys.std.Relation.rank>.
...
C<QArray_from_wrap> that is the analogy to the general case of "ORDER BY"
that may contain any arbitrary value expression.

=head2 sys.std.Array.limit_of_QArray_from_wrap

C<< function sys.std.Array.limit_of_QArray_from_wrap
(quasi_array_of.QTuple <-- QRelation $topic, FuncRef $ord_func,
QTuple $ord_assuming?, Bool $is_reverse_order?, NNInt $first_index,
NNInt $last_index) >>

This function is a short-hand for invoking first
C<sys.std.Array.QArray_from_wrap> and then C<sys.std.Array.slice> on its
result.  This function is to C<sys.std.Array.QArray_from_wrap> what the
C<sys.std.Relation.limit> function is to C<sys.std.Relation.rank>.

=head2 sys.std.Array.limit_of_QArray_from_wrap_by_attr_names

C<< function sys.std.Array.limit_of_QArray_from_wrap_by_attr_names
(quasi_array_of.QTuple <-- QRelation $topic,
array_of.OrderByName $order_by, Bool $is_reverse_order?,
NNInt $first_index, NNInt $last_index) >>

This function is to C<limit_of_QArray_from_wrap> what
C<QArray_from_wrap_by_attr_names> is to C<QArray_from_wrap>.

=head2 sys.std.Array.QArray_from_attr

C<< function sys.std.Array.QArray_from_attr (QArray <-- QRelation $topic,
Name $name, OrdDetFuncRef $ord_func?, QTuple $ord_assuming?,
Bool $is_reverse_order?) >>
...
same as C<sys.std.Array.QArray_from_wrap>.  Each of the C<ord_func> and
C<ord_assuming> and C<is_reverse_order> parameters is optional and defaults
to C<sys.std.Core.Scalar.order> or the zero-attribute tuple or
