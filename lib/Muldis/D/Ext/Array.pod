...
This document is Muldis::D::Ext::Array version 0.52.0.
...
topic(Array), func(Cat.FuncRef), assuming(QuasiTuple)?, identity(ScaTupRel)
}>
...
topic(Array), func(Cat.FuncRef), assuming(QuasiTuple)? }>
...
array_of.Tuple params { topic(Relation), ord_func(Cat.FuncRef),
...
topic(Relation), name(Cat.Name), ord_func(Cat.OrdDetFuncRef)?,
...
C<sys.std.Core.Scalar.order> or the zero-attribute tuple, respectively, if
