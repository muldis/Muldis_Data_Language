...
except that it works with a C<Array> rather than a C<Set>.  Also, the
...
This function results in a C<Array> whose C<value> attribute is tuple-typed
...
which is the same as C<sys.std.Array.Array_from_wrap> but that it just
...
This function results in a C<Array> consisting of all the values of the
