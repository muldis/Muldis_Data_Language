...
C<< function sys.std.Bag.cardinality (NNInt <-- QBag $topic) >>
...
C<< function sys.std.Bag.has_member (Bool <-- QBag $bag, Universal $value)
>>
...
C<< function sys.std.Bag.has_not_member (Bool <-- QBag $bag,
Universal $value) >>
...
C<< function sys.std.Bag.count (NNInt <-- QBag $bag, Universal $value) >>
...
C<< function sys.std.Bag.insertion (QBag <-- QBag $bag, Universal $value)
>>
...
semantically the single-q/tuple case of C<sys.std.Bag.union_sum>, and is
not the single-q/tuple case of C<sys.std.Bag.union> (which is the direct
analogy to set union).

=head2 sys.std.Bag.deletion

C<< function sys.std.Bag.deletion (QBag <-- QBag $bag, Universal $value)
>>
...
C<< function sys.std.Bag.reduction (Universal <-- QBag $topic,
...
C<< function sys.std.Bag.maybe_reduction (QMaybe <-- QBag $topic,
...
=head2 sys.std.Bag.QSet_from_QBag

C<< function sys.std.Bag.QSet_from_QBag (QSet <-- QBag $topic) >>

This function results in the C<QSet> that is the projection of the C<value>
attribute of its C<QBag> argument.

=head2 sys.std.Bag.QBag_from_QSet

C<< function sys.std.Bag.QBag_from_QSet (QBag <-- QSet $topic) >>
...
=head2 sys.std.Bag.QBag_from_wrap

C<< function sys.std.Bag.QBag_from_wrap (quasi_bag_of.QTuple <--
QRelation $topic) >>
...
=head2 sys.std.Bag.QBag_from_cmpl_group

C<< function sys.std.Bag.QBag_from_cmpl_group (quasi_bag_of.QTuple <--
...
what C<sys.std.Array.QArray_from_wrap> is to C<sys.std.Relation.rank>.

=head2 sys.std.Bag.QBag_from_attr

C<< function sys.std.Bag.QBag_from_attr (QBag <-- QRelation $topic,
Name $name) >>
...
C<< function sys.std.Bag.is_subset (Bool <-- QBag $topic, QBag $other) >>
...
C<< function sys.std.Bag.is_not_subset (Bool <-- QBag $topic, QBag $other)
>>
...
C<< function sys.std.Bag.is_superset (Bool <-- QBag $topic, QBag $other)
>>
...
C<< function sys.std.Bag.is_not_superset (Bool <-- QBag $topic,
QBag $other) >>
...
C<< function sys.std.Bag.is_proper_subset (Bool <-- QBag $topic,
QBag $other) >>
...
C<< function sys.std.Bag.is_not_proper_subset (Bool <-- QBag $topic,
QBag $other) >>
...
C<< function sys.std.Bag.is_proper_superset (Bool <-- QBag $topic,
QBag $other) >>
...
C<< function sys.std.Bag.is_not_proper_superset (Bool <-- QBag $topic,
QBag $other) >>
...
C<< function sys.std.Bag.union (QBag <-- quasi_set_of.QBag $topic) >>
...
C<< function sys.std.Bag.union_sum (QBag <-- quasi_bag_of.QBag $topic) >>
...
C<< function sys.std.Bag.intersection (QBag <-- quasi_set_of.QBag $topic)
>>
...
C<< function sys.std.Bag.diff (QBag <-- QBag $source, QBag $filter) >>

This function is like C<sys.std.Core.Relation.diff> as C<union> is
like C<sys.std.Core.Relation.union>; for corresponding input q/tuples, the
