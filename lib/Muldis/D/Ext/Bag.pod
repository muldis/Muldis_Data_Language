...
This document is Muldis::D::Ext::Bag version 0.22.1.
...
=item C<function sys.std.Bag.Bag_from_wrap result BagOfTuple params {
topic(Relation) }>
...
=item C<function sys.std.Bag.union result Bag params { topic(SetOfBag) }>
