...
This document is Muldis::D::Ext::QArray version 0.75.0.
...
C<< function sys.std.QArray.value (Universal <-- QArray $topic,
NNInt $index) >>
...
C<< function sys.std.QArray.update_value (QArray <-- QArray $topic,
...
C<< function sys.std.QArray.insertion (QArray <-- QArray $topic,
NNInt $index, Universal $value) >>
...
C<< function sys.std.QArray.deletion (QArray <-- QArray $topic,
NNInt $index) >>
...
=head2 sys.std.QArray.has_elem

C<< function sys.std.QArray.has_elem (Bool <-- QArray $topic,
Universal $value) >>
...
=head2 sys.std.QArray.has_not_elem

C<< function sys.std.QArray.has_not_elem (Bool <-- QArray $topic,
Universal $value) >>

This function is exactly the same as C<sys.std.QArray.has_elem> except that
it results in the opposite boolean value when given the same arguments.

=head2 sys.std.QArray.reduction

C<< function sys.std.QArray.reduction (Universal <-- QArray $topic,
...
C<< function sys.std.QArray.maybe_reduction (QMaybe <-- QArray $topic,
...
C<< function sys.std.QArray.slice (QArray <-- QArray $topic,
...
=head2 sys.std.QArray.replication

C<< function sys.std.QArray.replication (QArray <-- QArray $topic,
NNInt $count) >>
...
C<< function sys.std.QArray.reverse (QArray <-- QArray $topic) >>
...
=head2 sys.std.QArray.has_subarray

C<< function sys.std.QArray.has_subarray (Bool <-- QArray $look_in,
QArray $look_for) >>
...
=head2 sys.std.QArray.has_not_subarray

C<< function sys.std.QArray.has_not_subarray (Bool <-- QArray $look_in,
QArray $look_for) >>

This function is exactly the same as C<sys.std.QArray.has_subarray> except
...
=head2 sys.std.QArray.QArray_from_wrap_by_attr_names

C<< function sys.std.QArray.QArray_from_wrap_by_attr_names
...
C<sys.std.QRelation.rank_by_attr_names> is to C<sys.std.QRelation.rank>.
...
=head2 sys.std.QArray.limit_of_QArray_from_wrap_by_attr_names

C<< function sys.std.QArray.limit_of_QArray_from_wrap_by_attr_names
(quasi_array_of.QTuple <-- QRelation $topic,
array_of.OrderByName $order_by, Bool $is_reverse_order?,
NNInt $first_index, NNInt $last_index) >>
...
C<< function sys.std.QArray.QArray_from_attr (QArray <-- QRelation $topic,
...
to C<sys.std.Core.QScalar.order> or the zero-attribute tuple or
