...
topic(Array), func(FuncRef), assuming(QTuple)?, identity(ScaTupRel) }>
...
topic(Array), func(FuncRef), assuming(QTuple)? }>
...
params { topic(Relation), ord_func(FuncRef), ord_assuming(QTuple)? }>
