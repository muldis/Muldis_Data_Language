...
This document is Muldis::D::Ext::QArray version 0.71.0.
...
C<< function sys.std.QArray.is_element (Bool <-- QArray $topic,
Universal $value) >>
...
C<< function sys.std.QArray.is_not_element (Bool <-- QArray $topic,
Universal $value) >>
...
C<< function sys.std.QArray.is_subarray (Bool <-- QArray $look_in,
QArray $look_for) >>
...
C<< function sys.std.QArray.is_not_subarray (Bool <-- QArray $look_in,
QArray $look_for) >>
