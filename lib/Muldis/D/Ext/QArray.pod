...
This document is Muldis::D::Ext::QArray version 0.74.0.
...
=head2 sys.std.QArray.has_element

C<< function sys.std.QArray.has_element (Bool <-- QArray $topic,
Universal $value) >>
...
=head2 sys.std.QArray.has_not_element

C<< function sys.std.QArray.has_not_element (Bool <-- QArray $topic,
Universal $value) >>

This function is exactly the same as C<sys.std.QArray.has_element> except
...
C<< function sys.std.QArray.repeat (QArray <-- QArray $topic, NNInt $count)
>>
