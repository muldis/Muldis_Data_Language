...
This document is Muldis::D::Ext::QArray version 0.57.0.
...
=item C<function sys.std.QArray.slice result QArray params { topic(QArray),
...
=item C<function sys.std.QArray.repeat result QArray params {
topic(QArray), count(NNInt) }>

This function results in the catenation of C<count> instances of C<topic>.

=item C<function sys.std.QArray.reverse result QArray params {
topic(QArray) }>
...
=item C<function sys.std.QArray.QArray_from_wrap result
