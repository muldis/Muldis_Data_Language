...
This document is Muldis::D::Ext::QArray version 0.61.0.
...
C<function sys.std.QArray.value result Universal params {
...
C<function sys.std.QArray.update_value result QArray params {
...
C<function sys.std.QArray.insertion result QArray params {
topic(QArray), index(NNInt), value(Universal) }>
...
C<function sys.std.QArray.deletion result QArray params {
topic(QArray), index(NNInt) }>
...
C<function sys.std.QArray.is_element result Bool params {
...
C<function sys.std.QArray.is_not_element result Bool params {
topic(QArray), value(Universal) }>
...
C<function sys.std.QArray.reduction result Universal params {
...
C<function sys.std.QArray.maybe_reduction result QMaybe params {
...
C<function sys.std.QArray.slice result QArray params { topic(QArray),
...
C<function sys.std.QArray.catenation result QArray params {
...
C<function sys.std.QArray.repeat result QArray params {
topic(QArray), count(NNInt) }>

This function results in the catenation of C<count> instances of C<topic>.

=head2 sys.std.QArray.reverse

C<function sys.std.QArray.reverse result QArray params { topic(QArray) }>
...
C<function sys.std.QArray.is_subarray result Bool params {
...
C<function sys.std.QArray.is_not_subarray result Bool params {
look_in(QArray), look_for(QArray) }>
...
C<function sys.std.QArray.QArray_from_wrap result quasi_array_of.QTuple
...
C<function sys.std.QArray.limit_of_QArray_from_wrap result
...
C<function sys.std.QArray.QArray_from_attr result QArray params {
