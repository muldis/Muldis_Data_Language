...
This document is Muldis::D::Dialect::HDMD_Perl6_Tiny version 0.57.0.
...
C<Bool>, C<Int>, C<String>, C<Blob>, C<Text>, C<Name>, C<NameChain>,
C<DeclNameChain>, C<Comment>, C<Order>, C<(Q|)Scalar>, C<(Q|)Tuple>,
C<(Q|)Relation>, C<(Q|)Set>, C<Nothing>, C<(Q|)Single>, C<(Q|)Array>,
C<(Q|)Bag>, C<Rat>, C<RatRoundMeth>, C<(UTC|Float)Instant>, C<Duration>.
All of the non-value-literal PHMD node kinds currently defined are these 2:
C<Muldis_D>, C<boot_stmt>.
