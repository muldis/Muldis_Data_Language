...
This document is Muldis::D::Dialect::HDMD_Perl6_Tiny version 0.54.0.
...
C<(|Q)Scalar>, C<Bool>, C<Int>, C<String>, C<Blob>, C<Text>,
...
Perl C<Str> value C<Q> prepended.  So PHMD nodes whose first elements
each are [C<QScalar>, C<QTuple>, C<QRelation>, C<QSet>,
C<QNothing>, C<QSingle>, C<QArray>, C<QBag>] are
interpreted as Muldis D [C<sys.std.Core.Type.QScalar>,
