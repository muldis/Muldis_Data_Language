...
This document is Muldis::D::Dialect::HDMD_Perl6_Tiny version 0.52.0.
...
A PHMD value is composed mainly of a tree of Perl 6 Array, such that each
Array is a tree node.  The elements of each node/Array include typically a
native Perl 6 payload value, which may be a PHMD value itself, plus
...
It should be emphasized that no Perl 6 undefined values are allowed
...
supplying a Perl 6 undef will result in an error.  If you genuinely want to
