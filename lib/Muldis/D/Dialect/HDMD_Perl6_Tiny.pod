...
C<Bool>, C<Int>, C<String>, C<Blob>, C<Text>, C<Rat>, C<Name>,
C<NameChain>, C<DeclNameChain>, C<Comment>, C<Order>, C<RatRoundMeth>,
C<(Q|)Scalar>, C<(Q|)Tuple>, C<(Q|)Relation>, C<(Q|)Set>, C<Nothing>,
C<(Q|)Single>, C<(Q|)Array>, C<(Q|)Bag>, C<(UTC|Float)Instant>,
