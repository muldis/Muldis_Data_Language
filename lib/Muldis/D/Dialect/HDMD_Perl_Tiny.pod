...
Format; one of: C<md_enum>, C<perl_bool>.
...
as another option under Perl 5, the number 0 may be used to mean false.
...
Format; one of: C<md_int>, C<perl_int>.
...
Format; one of: C<md_rat>, C<perl_rat>.
...
Format; one of: C<md_num>, C<perl_num>.
