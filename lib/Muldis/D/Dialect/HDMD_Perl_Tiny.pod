...
This document is Muldis::D::Dialect::HDMD_Perl_Tiny version 0.14.0.
...
[C<sys.Core.Type.QuasiTuple>, C<sys.Core.Type.QuasiRelation>,
C<sys.Core.Type.QuasiSet>, C<sys.Core.Type.QuasiNothing>,
C<sys.Core.Type.QuasiSingle>, C<sys.Core.Type.QuasiSeq>,
C<sys.Core.Type.QuasiBag>] values, respectively.
