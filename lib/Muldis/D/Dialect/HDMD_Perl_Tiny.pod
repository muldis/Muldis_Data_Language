...
This document is Muldis::D::Dialect::HDMD_Perl_Tiny version 0.15.0.
...
Examples:
    ...
    [
        ...
        [ 'boot_call', 'sys.Core.Cat.create_public_relvar', { ... } ],
    ]
...
Possrep name: a Perl C<Str> as per a C<Cat.Name> PHMD node.
...
This node is interpreted as a Muldis D C<sys.Core.Type.Scalar> subtype
...
Examples:
    ...
    [ 'Scalar', 'sys.Rational.Type.Rat', 'float', {
...
This node is interpreted as a Muldis D C<sys.Core.Type.Bool> value as
follows:
...
This node is interpreted as a Muldis D C<sys.Core.Type.Int> value as
follows:
...
This node is interpreted as a Muldis D C<sys.Core.Type.Blob> value as
follows:
...
This node is interpreted as a Muldis D C<sys.Core.Type.Text> value by
...
This node is interpreted as a Muldis D C<sys.Core.Type.Tuple> value whose
...
This node is interpreted as a Muldis D C<sys.Core.Type.Relation> value
...
This node is interpreted as a Muldis D C<sys.Core.Type.Set> value whose
...
D C<sys.Core.Type.Nothing>.  It has 1 element, which is the Perl C<Str>
value C<Nothing>.
...
This node is interpreted as a Muldis D C<sys.Core.Type.Single> value
...
This node is interpreted as a Muldis D C<sys.Core.Type.Seq> value whose
elements are defined by the payload.  Each element of the payload defines a
...
This node is interpreted as a Muldis D C<sys.Core.Type.Bag> value whose
...
C<QuasiNothing>, C<QuasiSingle>, C<QuasiSeq>, C<QuasiBag>] are interpreted
as Muldis D [C<sys.Core.Type.QuasiScalar>, C<sys.Core.Type.QuasiTuple>,
C<sys.Core.Type.QuasiRelation>, C<sys.Core.Type.QuasiSet>,
C<sys.Core.Type.QuasiNothing>, C<sys.Core.Type.QuasiSingle>,
C<sys.Core.Type.QuasiSeq>, C<sys.Core.Type.QuasiBag>] values, respectively.
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.Name> value by
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.NameChain> value
as follows:
...
defines an element of the C<seq> possrep's attribute of a C<Cat.NameChain>.
...
attribute of a C<Cat.NameChain>.
...
Examples:
    ...
    [ 'Cat.NameChain',
        ['fed','data','the_db','gene','sorted_person_name'] ]

    [ 'Cat.NameChain', 'fed.data.the_db.stats.samples_by_order' ]
...
Node type: the Perl C<Str> value C<Cat.DeclNameChain>.
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.DeclNameChain>
value as follows:
...
payload for a C<Cat.Name> PHMD node (that is, any Perl character string).
Each element of the payload, in order, defines an element of the C<seq>
possrep's attribute of a C<Cat.DeclNameChain>.
...
the C<flat> possrep's attribute of a C<Cat.DeclNameChain>.

=back

Examples:

    [ 'Cat.DeclNameChain', ['gene','sorted_person_name'] ]

    [ 'Cat.DeclNameChain', '.stats.samples_by_order.' ]
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.Comment> value
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.E_TK> value by
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.E_TDM> value by
directly mapping the payload.  The payload must be a Perl C<Str> having one
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.E_ENK> value by
directly mapping the payload.  The payload must be a Perl C<Str> having one
of the 10 values C<scalar>, C<tuple>, C<relation>, C<quasi_scalar>,
C<quasi_tuple>, C<quasi_relation>, C<param>, C<upd_param>, C<ro_param>,
C<func>.
...
This node is interpreted as a Muldis D C<sys.Core.Type.Cat.E_PSAK> value by
directly mapping the payload.  The payload must be a Perl C<Str> having one
of the 4 values C<upd_param>, C<ro_param>, C<inner_var>, C<outer_var>.
...
This node is interpreted as a Muldis D C<sys.Rational.Type.Rat> value as
follows:
...
This node is interpreted as a Muldis D C<sys.Rational.Type.E_RM> value by
directly mapping the payload.  The payload must be a Perl C<Str> having one
