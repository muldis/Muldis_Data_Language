...
This node is interpreted as a Muldis D C<sys.Integer.Type.Int> value as
follows:
...
This node is interpreted as a Muldis D C<sys.Blob.Type.Blob> value as
follows:
...
This node is interpreted as a Muldis D C<sys.Text.Type.Text> value by
