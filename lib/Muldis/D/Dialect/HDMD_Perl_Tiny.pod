...
Muldis D code by saving them the difficulty and overhead of handling plain
text Muldis D code; it is expected that a Muldis D implementation written
in Perl will natively accept input in both the C<PTMD_Tiny> and
...
dialects; this current file will mainly focus on the differences.
