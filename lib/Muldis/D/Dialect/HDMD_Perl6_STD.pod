...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.111.0.
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.111.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.111.0', 'HDMD_Perl6_STD', {
...
C<sys.std.DateTime.Type.TAIInstant> value as follows:  The payload must be
...
node is interpreted as a Muldis D C<sys.std.DateTime.Type.TAIDuration>
