...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.123.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.123.0',
'HDMD_Perl6_STD' ]>.
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.123.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.123.0', 'HDMD_Perl6_STD', {
...
having at least one element which is a C<proc_stmt>, and each other element
of said Perl C<Seq|Array> must be either a C<with_clause> or a C<proc_var>
or a C<proc_stmt>.
