...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.113.0.
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.113.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.113.0', 'HDMD_Perl6_STD', {
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.113.0', 'HDMD_Perl6_STD', {
        catalog_abstraction_level => 'rtn_inv_alt_syn',
        op_char_repertoire => 'extended',
        standard_syntax_extensions => Set.new('temporal')
    } ]
