...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.139.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.139.0',
'HDMD_Perl6_STD' ]>.
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.139.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.139.0', 'HDMD_Perl6_STD', {
...
is one of the 3 Perl C<Str> values [C<i-op>, C<pre-op>, C<post-op>],
depending on whether it represents infix, prefix, or postfix syntax,
respectively.  The second element is a Perl C<Str> value,
...
Examples:
    ...
    [ 'i-op', '[<=>]', [ Order::Same, Order::Increase, Order::Decrease ] ]
