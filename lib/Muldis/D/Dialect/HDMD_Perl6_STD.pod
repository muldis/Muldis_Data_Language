...
C<Str> value C<d>.  The second element is a C<Name_payload>.
...
Examples:
    ...
    ['$.',['func-invo','nlx.lib.tuple_res_func',[:d<arg>]],'quux_attr']
...
Examples:
    ...
    [ 'if-else-expr',
        [
            ['func-invo','is_empty',[:d<ary>]] => :d<empty_result>,
        ],
        [ 'op', '.[]', [:d<ary>, 0] ]
    ]
...
Examples:
    ...
    [ 'if-else-stmt',
        [
            :d<out_of_options> => :iproc-imp-invo<nlx.lib.give_up>,
        ],
...
Examples:
    ...
    [ 'op', 'round', [:d<foo>, :RatRoundRule[10,-2,'HalfEven']] ]
