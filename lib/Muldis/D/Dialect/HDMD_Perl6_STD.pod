...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.143.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.143.0',
'HDMD_Perl6_STD' ]>.
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.143.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.143.0', 'HDMD_Perl6_STD', {
...
Examples:
    ...
    [ 'procedure', 'print_curr_time', {} => [
        [ 'var', 'now', 'Instant' ],
        [ 'iproc-imp-invo', 'fetch_trans_instant', [ ['&',:d<now>] ] ],
        [ 'var', 'message', 'Text' ],
        :atomic-stmt[
            [ 'i-op', ':=', [ :d<message>, [ 'i-op', '~', [
                'The current time is: ',
