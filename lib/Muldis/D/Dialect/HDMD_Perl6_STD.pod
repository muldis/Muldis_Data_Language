...
Examples:
    ...
    [ 'if_else_expr',
        ...
        [ 'func_invo_alt_syntax', 'QArray.value', :expr_name<ary>, 0 ]
    ]
...
is a C<expr> node that defines an input value for the operator.
...
Perl C<Seq|Array> having at least 2 elements; each element is a C<expr>
