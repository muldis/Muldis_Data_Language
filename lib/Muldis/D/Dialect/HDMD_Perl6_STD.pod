...
Examples:
    ...
    [ 'try-catch',
        :iproc-imp-invo<attempt_the_work>,
        :iproc-imp-invo<deal_with_failure>
    ]
...
Examples:
    ...
    [ 'if-else-stmt',
        [
            ['$','out_of_options'] => :iproc-imp-invo<give_up>,
        ],
        :iproc-imp-invo<keep_going>
    ]
...
Examples:
    ...
    [ 'given-when-def-stmt',
        ['$','picked_menu_item'],
        [
            'v' => :iproc-imp-invo<screen_view_record>,
            'a' => :iproc-imp-invo<screen_add_record>,
            'd' => :iproc-imp-invo<screen_delete_record>,
        ],
        :iproc-imp-invo<display_bad_choice_error>,
    ]
