...
value, respectively, of the new single-piece interval.  Each of the
C<excludes_min> and C<excludes_max> of the Range maps directly with the
single-piece interval.
