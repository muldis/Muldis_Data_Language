...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.109.0.
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.109.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.109.0', 'HDMD_Perl6_STD', {
...
of the 7 values C<HalfDown>, C<HalfUp>, C<HalfEven>, C<ToFloor>,
C<ToCeiling>, C<ToZero>, C<ToInf>.
