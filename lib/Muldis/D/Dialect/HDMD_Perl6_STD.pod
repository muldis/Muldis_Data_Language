...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.74.0.
...
Examples (for now sans any use of extra op args, which are atypical):
    ...
    [ 'op', 'min', [ :expr_name<foo>, :expr_name<bar>, :expr_name<baz> ] ]

    [ 'op', 'max', [ :expr_name<foo>, :expr_name<bar>, :expr_name<baz> ] ]
