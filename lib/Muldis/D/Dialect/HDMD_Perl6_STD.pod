...
This document is Muldis::D::Dialect::HDMD_Perl6_STD version 0.133.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.133.0',
'HDMD_Perl6_STD' ]>.
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.133.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.133.0', 'HDMD_Perl6_STD', {
...
This is a Perl C<Str> value of the format
C<< <[A..Z]> <[ a..z A..Z ]>+ | '$'|'%'|'@' >>;
...
Between the various kinds of C<value> node, these 43 values are allowed for
C<value_kind>:  C<Singleton>, C<Bool>, C<Order>, C<RoundMeth>,
C<[|NN|P]Int>, C<[|NN|P]Rat>, C<[|Octet]Blob>, C<Text>, C<Name>,
C<[|PNSQ]NameChain>, C<Comment>, C<RatRoundRule>, C<[|DH]Scalar|$>,
...
Examples I<TODO: What is the actual syntax for the P6 Blob type?>:
    ...
    :Blob( Blob.new( 'b' => '00101110100010' ) ) # binary #

     Blob.new( 4 => '' )

     Blob.new( 'x' => 'A705E' ) # hexadecimal #

     Blob.new( 'o' => '523504376' )
