...
This document is Muldis::D::Dialect::PTMD_STD version 0.121.0.
...
standard dialect is C<Muldis_D:"http://muldis.com":0.121.0:PTMD_STD>.
...
C<ln_base_authority>; it is typically a character string like C<0.121.0>.
...
Examples:
    ...
    Muldis_D:"http://muldis.com":0.121.0:PTMD_STD:{
...
Examples:
    ...
    if $val isa T->Int then $val exp 3
        else if $val isa T->Text then $val x 5
        else True
