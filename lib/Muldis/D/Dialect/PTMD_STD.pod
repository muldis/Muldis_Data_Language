...
This table indicates which function is invoked by each keyword:
    ...
    ∪    -> Core.Relation.union( QSet:{ $expr[0], ..., $expr[n] } )
    ∩    -> Core.Relation.intersection( QSet:{ $expr[0], ..., $expr[n] } )
    ∆    -> Relation.exclusion( QBag:{ $expr[0], ..., $expr[n] } )
    ⋈    -> Core.Relation.join( QSet:{ $expr[0], ..., $expr[n] } )
    ×    -> Core.Relation.product( QSet:{ $expr[0], ..., $expr[n] } )
...
This table indicates which function is invoked by each keyword:
    ...
    A~    -> Array.catenation( QArray:{ $expr[0], ..., $expr[n] } )
...
This table indicates which function is invoked by each keyword:
    ...
    t   -> Core.Relation.QTuple_from_QRelation( $expr )
    r   -> Core.Relation.QRelation_from_QTuple( $expr )
