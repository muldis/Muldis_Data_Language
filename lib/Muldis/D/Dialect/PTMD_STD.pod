...
This document is Muldis::D::Dialect::PTMD_STD version 0.130.0.
...
standard dialect is C<Muldis_D:"http://muldis.com":0.130.0:PTMD_STD>.
...
C<ln_base_authority>; it is typically a character string like C<0.130.0>.
