...
C<sys>, C<mnt>, C<fed>, C<dep>, C<sdp>, C<lex>.
(Actually, C<type> is a 7th option, but that will be treated separately in
...
existing first chain element isn't one of the other 7 top-level namespaces,
