...
must be one of these 8 C<Name> values, which is a top-level namespace:
C<sys>, C<mnt>, C<tpc>, C<fed>, C<dep>, C<sdp>, C<inn>, C<lex>.
(Actually, C<type> is a 9th option, but that will be treated separately in
