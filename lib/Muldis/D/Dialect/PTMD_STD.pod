...
This document is Muldis::D::Dialect::PTMD_STD version 0.146.0.
...
standard dialect is C<Muldis_D:"http://muldis.com":0.146.0:PTMD_STD>.
...
Examples:
    ...
    Muldis_D:"http://muldis.com":0.146.0:PTMD_STD:{
...
Grammar:
    ...
    <if_else_stmt> ::=
        ...
        [<ws> else <ws> if <ws> <if_expr> <ws> then <ws> <then_stmt>]*
...
sequential 1..N C<if_expr> + C<then_stmt> elements specifies the
...
that while an C<IfElseStmtNodeSet> tuple can represent zero C<if_expr>
