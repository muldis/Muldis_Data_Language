...
This document is Muldis::D::Dialect::PTMD_STD version 0.140.0.
...
standard dialect is C<Muldis_D:"http://muldis.com":0.140.0:PTMD_STD>.
...
C<ln_base_authority>; it is typically a character string like C<0.140.0>.
...
Examples:
    ...
    Muldis_D:"http://muldis.com":0.140.0:PTMD_STD:{
...
The meanings of the simple escape sequences are:
    ...
    \`  | x;60      | GRAVE ACCENT    | `   | delim for code comments
...
C<sys.std.Core.Type.Cat.SysScaValStmtNodeSet> value, and the declared type
...
second lexical element is a tuple of a C<SysScaValStmtNodeSet>; in either
...
variable, as a tuple of a C<SysScaValStmtNodeSet> or
