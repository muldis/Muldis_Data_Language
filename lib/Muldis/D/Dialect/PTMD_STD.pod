...
C<sys>, C<mnt>, C<fed>, C<nlx>, C<lex>.
(Actually, C<type> is a 6th option, but that will be treated separately in
...
existing first chain element isn't one of the other 5 top-level namespaces,
