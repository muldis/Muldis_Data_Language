...
This document is Muldis::D::Dialect::PTMD_STD version 0.118.0.
...
standard dialect is C<Muldis_D:"http://muldis.com":0.118.0:PTMD_STD>.
...
Examples:
    ...
    Muldis_D:"http://muldis.com":0.118.0:PTMD_STD:{
