...
Grammar:
    ...
    <nonsym_dyadic_infix_op> ::=
        ...
        | '∈' | imem | '∉' | '!imem' | 'not-imem'
        | '∋' | hmem | '∌' | '!hmem' | 'not-hmem'
        | 'S∈' | Simem | 'S∉' | 'S!imem' | 'Snot-imem'
        | 'S∋' | Shmem | 'S∌' | 'S!hmem' | 'Snot-hmem'
        | 'B∈' | Bimem | 'B∉' | 'B!imem' | 'Bnot-imem'
        | 'B∋' | Bhmem | 'B∌' | 'B!hmem' | 'Bnot-hmem'
        | '⊆' | sub | '⊈' | '!sub' | 'not-sub'
        | '⊇' | super | '⊉' | '!super' | 'not-super'
        | '⊂' | psub | '⊄' | '!psub' | 'not-psub'
        | '⊃' | psuper | '⊅' | '!psuper' | 'not-psuper'
        | '∖' | 'R-' | minus | except
...
Grammar:
    ...
    <interval_membership_op> ::=
          'I∈' | Iimem | between
        | 'I∉' | 'I!imem' | 'Inot-imem' | '!between' | 'not-between'
        | 'I∋' | Ihmem
        | 'I∌' | 'I!hmem' | 'Inot-hmem'
