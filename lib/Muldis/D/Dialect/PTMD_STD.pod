...
This document is Muldis::D::Dialect::PTMD_STD version 0.128.0.
...
standard dialect is C<Muldis_D:"http://muldis.com":0.128.0:PTMD_STD>.
...
C<ln_base_authority>; it is typically a character string like C<0.128.0>.
...
Grammar:
    ...
    <possrep_map> ::=
        'possrep-map' <ws>
        '{' <ws>?
            <p2> <ws> from <ws> <p1> <ws> using <ws> <routine_name>
            <ws>
            <p1> <ws> from <ws> <p2> <ws> using <ws> <routine_name>
        <ws>? '}'
...
I<TODO: Description and Examples.>
...
Grammar:
    ...
    <constraint_clause> ::=
        [constraint | where] <ws> <routine_name>
