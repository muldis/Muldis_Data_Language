...
31: C<(|Quasi)Scalar>, C<Bool>, C<Int>, C<String>, C<Blob>, C<Text>,
...
Perl character string C<Quasi> prepended.  So PHMD nodes whose first
elements each are [C<QuasiScalar>, C<QuasiTuple>, C<QuasiRelation>,
C<QuasiSet>, C<QuasiNothing>, C<QuasiSingle>, C<QuasiArray>, C<QuasiBag>]
are interpreted as Muldis D [C<sys.std.Core.Type.QuasiScalar>,
