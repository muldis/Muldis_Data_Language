...
30: C<(|Q)Scalar>, C<Bool>, C<Int>, C<String>, C<Blob>, C<Text>,
C<(|Q)Tuple>, C<(|Q)Relation>, C<(|Q)Set>, C<Nothing>, C<(|Q)Single>,
C<(|Q)Array>, C<(|Q)Bag>, C<Name>, C<NameChain>, C<DeclNameChain>,
C<Comment>, C<Order>, C<Rat>, C<RatRoundMeth>, C<(UTC|Float)Instant>,
C<Duration>.  All of the non-value-literal PHMD node kinds currently
defined are these 2: C<Muldis_D>, C<boot_call>.
...
Perl character string C<Q> prepended.  So PHMD nodes whose first elements
each are [C<QScalar>, C<QTuple>, C<QRelation>, C<QSet>, C<QSingle>,
C<QArray>, C<QBag>] are interpreted as Muldis D
[C<sys.std.Core.Type.QScalar>, C<sys.std.Core.Type.QTuple>,
C<sys.std.Core.Type.QRelation>, C<sys.std.Core.Type.QSet>,
