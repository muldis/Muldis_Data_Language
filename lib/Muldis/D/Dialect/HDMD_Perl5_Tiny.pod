...
31: C<Bool>, C<Order>, C<RatRoundMeth>, C<Int>, C<Rat>, C<Blob>, C<Text>,
...
Extensions: optional; a Perl hash ref as per the payload of a C<Tuple>
node; see the L</MULDIS D TINY DIALECT PRAGMAS> pod section for more
details.
