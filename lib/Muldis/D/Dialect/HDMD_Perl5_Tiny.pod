...
30: C<Bool>, C<Int>, C<String>, C<Blob>, C<Text>, C<Name>, C<NameChain>,
...
node payload, respectively.  The C<Scalar> PHMD node kind can only be used
for scalar types that have at least 1 possrep, and the I<possrep attrs> is
interpreted specifically as attributes of the declared type's possrep which
is specified by the I<possrep name>.  Each key+value pair of the second
