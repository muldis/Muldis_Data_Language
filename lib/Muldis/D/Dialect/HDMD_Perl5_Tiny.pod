...
This document is Muldis::D::Dialect::HDMD_Perl5_Tiny version 0.67.0.
...
A C<HDMD_Perl5_Tiny> Muldis D code file is actually a Perl 5 code file that
...
scalar or something else, and so C<HDMD_Perl5_Tiny> Muldis D code is
...
C<HDMD_Perl5_Tiny> code is embedded or constructed in one or more files of
...
written in.  The C<HDMD_Perl5_Tiny> dialect formats this name as a
...
format specifically is what the C<PTMD_Tiny> grammar uses as its
...
A..Z ]>+]+ >>.  This format specifically is what the C<PTMD_Tiny>
...
0..9 A..F ]>* >>.  This format specifically is what the C<PTMD_Tiny>
