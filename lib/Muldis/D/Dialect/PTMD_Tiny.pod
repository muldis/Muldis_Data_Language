...
This document is Muldis::D::Dialect::PTMD_Tiny version 0.20.0.
...
at least.>  Any remaining errors should be corrected as soon as possible.
    ...
    # grammar Muldis_D_PTMD_Tiny:auth<http://muldis.com>:ver<0.20.0>;
    grammar Muldis_D_PTMD_Tiny-0.20.0-http://muldis.com;
    ...
    token nc_seq {
        <ord_list_open>
            ((<cat_name>) (\s* <nc_elem_sep> \s* (<cat_name>))+)
        <ord_list_close>
    }
