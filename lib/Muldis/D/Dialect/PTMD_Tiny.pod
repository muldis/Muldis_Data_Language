...
This document is Muldis::D::Dialect::PTMD_Tiny version 0.65.1.
...
Grammar:
    ...
    token utc_instant {
        UTCInstant <value_node_elem_sep>
        [<type_name> <value_node_elem_sep>]?
        <utc_instant_payload>
    }
    ...
    token float_instant {
        FloatInstant <value_node_elem_sep>
        [<type_name> <value_node_elem_sep>]?
        <utc_instant_payload>
    }

    token float_instant_payload {
        <utc_instant_payload>
    }
