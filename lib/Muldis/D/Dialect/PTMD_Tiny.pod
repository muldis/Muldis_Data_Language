...
This document is Muldis::D::Dialect::PTMD_Tiny version 0.18.0.
...
execution.  Any remaining errors should be corrected as soon as possible.
    ...
    # grammar Muldis_D_PTMD_Tiny:auth<http://muldis.com>:ver<0.18.0>;
    grammar Muldis_D_PTMD_Tiny-0.18.0-http://muldis.com;
    ...
    token scalar_type_name { <cat_name_chain_body> }

    token possrep_name { <cat_name> }
    ...
    token cat_decl_name_chain {
        (Cat.DeclNameChain)
        <spec_sep>
        <cat_decl_name_chain_body>
    }

    token cat_decl_name_chain_body {
          dnc_seq
        | dnc_flat
    }
...
The following are fragments of actual Plain Text Muldis D code.
    ...
    Cat.NameChain:['fed'.'data'.'the_db'.'gene'.'sorted_person_name']
