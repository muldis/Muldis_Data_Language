...
This document is Muldis::D::Dialect::PTMD_Tiny version 0.62.0.
...
With just the 5 data types [C<Bool>, C<Int>, C<Blob>, C<Text>, C<Rat>], the
...
characters of the C<payload>, which for each of said 5 data types has a
