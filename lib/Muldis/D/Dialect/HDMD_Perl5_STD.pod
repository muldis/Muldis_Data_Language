...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.86.0.
...
Examples:
    ...
    ['$.',[ 'func_invo', 'inn.tuple_res_func', [['$','arg']] ],'quux_attr']
...
Examples:
    ...
    [ 'func_invo', 'inn.barfunc', [ ['$','mand_arg'] ],
...
Examples:
    ...
    [ 'op', '//d', [ ['$','a'], ['$','b'], ['type_ref','inn.foo_type'] ] ]
...
Examples:
    ...
    [ 'op', 'isa', [ ['$','bar'], ['type_ref','inn.foo_type'] ] ]
