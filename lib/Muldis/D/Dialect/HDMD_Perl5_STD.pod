...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.111.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.111.0',
'HDMD_Perl5_STD' ]>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.111.0', 'HDMD_Perl5_STD', {
...
D C<sys.std.DateTime.Type.TAIInstant> value by directly mapping the
...
C<sys.std.DateTime.Type.TAIDuration> value by directly mapping the payload,
