...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.115.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.115.0',
'HDMD_Perl5_STD' ]>.
...
C<ln_base_authority>; it is typically a character string like C<0.115.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.115.0', 'HDMD_Perl5_STD', {
...
Between the various kinds of C<value> node, these 39 values are allowed for
...
Examples:
    ...
    [ 'op', 'r*', [ 69.3, [ 'Rat', [15,2,6] ], [ 'Rat', [49,23] ] ] ]
...
Examples:
    ...
    [ 'op', 'r^', [ 2.0, 0.5, [ 'RatRoundRule', [2,-7,'ToZero'] ] ] ]
