...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.146.0.
...
C<ln_base_authority>; it is typically a character string like C<0.146.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.146.0', 'HDMD_Perl5_STD', {
...
one of these 2 Perl character strings:
