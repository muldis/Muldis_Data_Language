...
=head2 Material Reference Selector

A C<material_ref_selector> node has 2 ordered elements:  The first element
is the Perl character string value C<< -> >>.  The second element is a
