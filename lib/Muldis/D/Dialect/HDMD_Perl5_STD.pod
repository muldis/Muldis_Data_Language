...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.73.0.
...
A C<comm_dyadic_infix_op_invo> node has exactly 2 main op args, each of
...
A C<noncomm_dyadic_infix_op_invo> node has exactly 2 main op args, each of
