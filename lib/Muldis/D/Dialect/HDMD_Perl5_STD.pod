...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.113.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.113.0',
'HDMD_Perl5_STD' ]>.
...
C<ln_base_authority>; it is typically a character string like C<0.113.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.113.0', 'HDMD_Perl5_STD', {
...
There are 22 main varieties of C<value> node, each of which is a named node
kind of its own:  C<Bool>, C<Order>, C<RoundMeth>, C<Int>, C<Rat>,
...
Between the various kinds of C<value> node, these 38 values are allowed for
C<value_kind>:  C<Bool>, C<Order>, C<RoundMeth>, C<[|NN|P]Int>,
C<[|NN|P]Rat>, C<[|Octet]Blob>, C<Text>, C<Name>, C<NameChain>,
C<PNSQNameChain>, C<Comment>, C<RatRoundRule>, C<[|DH]Scalar>,
...
There are 9 main varieties of C<material> node, each of which is a named
