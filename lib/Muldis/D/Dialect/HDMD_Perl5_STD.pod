...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.109.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.109.0',
'HDMD_Perl5_STD' ]>.
...
C<ln_base_authority>; it is typically a character string like C<0.109.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.109.0', 'HDMD_Perl5_STD', {
        ...
        [ 'Relation', [
            {
                food => [ 'Scalar', 'Text', [ nfd_codes => {
                    '' => [ 'Relation', [ [ 'index', 'value' ] => [
                        [ ['Scalar','Int.0',{}], ['Scalar','Int.67',{}]  ],
                        [ ['Scalar','Int.1',{}], ['Scalar','Int.97',{}]  ],
                        [ ['Scalar','Int.2',{}], ['Scalar','Int.114',{}] ],
                        [ ['Scalar','Int.3',{}], ['Scalar','Int.114',{}] ],
                        [ ['Scalar','Int.4',{}], ['Scalar','Int.111',{}] ],
                        [ ['Scalar','Int.5',{}], ['Scalar','Int.116',{}] ],
                        [ ['Scalar','Int.6',{}], ['Scalar','Int.115',{}] ]
                    ] ] ]
                } ] ],
                qty => ['Scalar','Int.100',{}]
            },
            {
                food => [ 'Scalar', 'Text', [ nfd_codes => {
                    '' => [ 'Relation', [ [ 'index', 'value' ] => [
                        [ ['Scalar','Int.0',{}], ['Scalar','Int.75',{}]  ],
                        [ ['Scalar','Int.1',{}], ['Scalar','Int.105',{}] ],
                        [ ['Scalar','Int.2',{}], ['Scalar','Int.119',{}] ],
                        [ ['Scalar','Int.3',{}], ['Scalar','Int.105',{}] ],
                        [ ['Scalar','Int.4',{}], ['Scalar','Int.115',{}] ],
                    ] ] ]
                } ] ],
                qty => ['Scalar','Int.30',{}]
            }
...
C<RatRoundRule>, C<Scalar>, C<Tuple>, C<Database>,
C<Relation>, C<Set>, C<Maybe>, C<Array>, C<Bag>, C<[S|M]PInterval>.
...
having one of the 7 values C<HalfDown>, C<HalfUp>, C<HalfEven>,
C<ToFloor>, C<ToCeiling>, C<ToZero>, C<ToInf>.
