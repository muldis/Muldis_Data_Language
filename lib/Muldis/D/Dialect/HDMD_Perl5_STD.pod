...
C<Relation>, C<Set>, C<Maybe>, C<Array>, C<Bag>, C<SPInterval>.
...
C<[|DH][Maybe|Single]>, C<[|DH]Array>, C<[|DH]Bag>, C<[|DH]SPInterval>.
...
An C<SPInterval> node represents a literal or selector invocation for an
