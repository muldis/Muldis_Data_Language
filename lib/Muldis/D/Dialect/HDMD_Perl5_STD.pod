...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.106.0.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.106.0',
'HDMD_Perl5_STD' ]>.
...
C<ln_base_authority>; it is typically a character string like C<0.106.0>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.106.0', 'HDMD_Perl5_STD', {
...
Between the various kinds of C<value> node, these 44 values are allowed for
...
Examples:
    ...
    [ 'MPInterval', [[1,'..',3],[6,'..',6],[8,'..',9]] ]  # 6 elements #
