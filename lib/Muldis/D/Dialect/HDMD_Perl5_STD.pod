...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.81.0.
...
Examples:
    ...
    [ 'op', '{<-}', [['expr_name','pt'], {pnum=>'pno', locale=>'city'}] ]

    [ 'op', '{{<-}}', [['expr_name','pr'], {pnum=>'pno', locale=>'city'}] ]

    [ 'op', '{}', [['expr_name','pt'], ['color','city']] ]

    [ 'op', '{{}}', [['expr_name','pr'], ['color','city']] ]

    [ 'op', '{}', [['expr_name','pt'], []] ]  # null projection #

    [ 'op', '{{}}', [['expr_name','pr'], []] ]  # null projection #

    [ 'op', '{!}', [['expr_name','pt'], ['pno','pname','weight']] ]

    [ 'op', '{{!}}', [['expr_name','pr'], ['pno','pname','weight']] ]

    [ 'op', '{@<-}', [['expr_name','person'], 'name', ['fname','lname']] ]

    [ 'op', '{{@<-}}',
        [['expr_name','people'], 'name', ['fname','lname']] ]

    [ 'op', '{@<-!}',
        [['expr_name','person'], 'all_but_name', ['fname','lname']] ]

    [ 'op', '{{@<-!}}',
        [['expr_name','people'], 'all_but_name', ['fname','lname']] ]

    [ 'op', '{<-@}', [['expr_name','person'], ['fname','lname'], 'name'] ]

    [ 'op', '{{<-@}}',
        [['expr_name','people'], ['fname','lname'], 'name'] ]

    [ 'op', '{{@@<-}}', [['expr_name','orders'], 'vendors', ['vendor']] ]

    [ 'op', '{{@@<-!}}',
        [['expr_name','orders'], 'all_but_vendors', ['vendor']] ]

    [ 'op', '{{<-@@}}', [['expr_name','orders'], ['vendor'], 'vendors'] ]

    [ 'op', '{{#@@<-!}}',
        [['expr_name','people'], 'count_per_age_ctry', ['age','ctry']] ]
...
payload of a C<Tuple> node except that every hash ref is just a Perl
