...
This document is Muldis::D::Dialect::HDMD_Perl5_STD version 0.94.0.
...
C<Tuple> SCVL; see the L</MULDIS D STANDARD DIALECT PRAGMAS> pod section
for more details.
...
C<[func|proc|type|ord-det-func]-ref>.  The second element is a
...
Examples:
    ...
    ['imp-ref','sdp.lib.try_block']

    ['type-ref','sdp.lib.foo_type']

    ['ord-det-func-ref','sdp.lib.order_bars']

=head1 MULDIS D STANDARD DIALECT PRAGMAS

All 3 of the Muldis D standard dialects, C<PTMD_STD> and
C<HDMD_Perl[6|5]_STD>, support these same pragmas, and have the same
semantics: C<with_rtn_inv_alt_syn>.
