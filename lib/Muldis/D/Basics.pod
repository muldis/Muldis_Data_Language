...
This document is Muldis::D::Basics version 0.114.0.
...
order to use all Muldis D features:
    ...
    %   | F;25 | PERCENT SIGN           | sigil rep tuples; modulo/rem op
...
each value conceptually has meta-data naming the declaration type that it
