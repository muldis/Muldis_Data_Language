...
This document is Muldis::D::Basics version 0.111.0.
...
types include: C<Bool.True>, C<Blob>, C<Text>, C<Rat>, C<Name>, C<Comment>,
...
C<Universal>, C<Empty>, C<Scalar>, C<DHScalar>, C<Bool>, C<Reference>,
...
types particularly is doing operator overloading between disjoint types,
...
=head1 Overloading With Virtual Routines
