...
for example C<type.(tuple|relation)_from.dep.data.myrelvar>.
...
C<type.seq_of.sys.std.Core.Type.Int>, the same as you would use the plain
integer type by saying C<sys.std.Core.Type.Int>.  Or for the common
