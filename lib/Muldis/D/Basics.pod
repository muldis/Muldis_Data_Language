...
Strictly speaking, the type of a depot/subdepot/package's self-local dbvar
...
depot/etc with no child subdepots or packages or materials besides that
...
there is a child subdepot or package C<foo>, the situation depends on
