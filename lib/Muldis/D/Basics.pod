...
system-defined, not user-defined.  There are just 3 of these:
...
C<Duration>, C<Name>, C<Comment>, C<Order>.  All user-defined structure
types are scalar or quasi-scalar types.  I<TODO: Further correct this
description.>
...
no possreps (it is a C<String>) or all of its possreps are
