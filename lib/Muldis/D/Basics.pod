...
specifically is a Unicode I<abstract codepoint>.  Two text will only
compare as identical if all of their abstract codepoints are identical, and
any combining character abstract codepoints have the same sequence; if you
want to effectively work at the abstraction level of a
I<language-independent grapheme> or I<language-specific grapheme>, you need
to ensure that your text values are effectively normalized or folded first.
