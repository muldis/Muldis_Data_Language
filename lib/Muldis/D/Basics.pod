...
function kinds is a proper subtype of that maximal type.
...
A C<system-service> is a procedure
that can directly reach outside of the more deterministic DBMS
