...
type.type(.<path-elem-to-type){1,}(.<path-elem-to-attr){0,} >>, for example
C<type.type.dep.mytyp.myattr>.  A similar scenario is taking the declared
result type of a function, which takes the form C<<
type.func_result(.<path-elem-to-func){1,}(.<path-elem-to-attr){0,} >>, for
example C<type.func_result.dep.myfunc>.
