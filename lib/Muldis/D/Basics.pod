...
C<String>, C<Tuple>, C<Relation>, C<QTuple>, C<QRelation>.  I<TODO:
...
C<QMaybe>, C<QBag>, C<UTCDateTime>.  The system-defined types
defined in terms of a union include: C<Universal>, C<Empty>, C<Scalar>,
C<QScalar>, C<Reference>, C<Remnant>, C<ScaTupRel>.  In the case of a
...
C<QScalar>, C<QTuple>, and C<QRelation>, which serve as maximal
...
C<Tuple>, C<Relation>, C<QScalar>, C<QTuple>, C<QRelation>,
