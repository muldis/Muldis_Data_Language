...
This document is Muldis::D::Basics version 0.108.0.
...
C<Duration>, C<Name>, C<Comment>, C<Order.Increase>,
and also the infinite number of
C<Int.*> singleton types.  All user-defined structure types are scalar
...
C<Int>, C<Order>.  In the case of a scalar subset enumeration
