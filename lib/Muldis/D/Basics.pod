...
This document is Muldis::D::Basics version 0.125.0.
...
order to use all Muldis D features:
    ...
    %   | F;25 | PERCENT SIGN           | sigil rep tuples
    ...
    *   | F;2A | ASTERISK               | numeric multiply op, Rat literals
    ...
    -   | F;2D | HYPHEN-MINUS           | num litrls, num diff op, keywords
    ...
    <   | F;3C | LESS-THAN SIGN         | is-less-than op, deli material rf
    =   | F;3D | EQUALS SIGN            | is-identical op, other ops
    >   | F;3E | GREATER-THAN SIGN      | i-greatr-thn op, deli material rf
    ?   | F;3F | QUESTION MARK          | optional param indicator
    @   | F;40 | COMMERCIAL AT          | sigil rep rela, dispat param indc
    ...
    \   | F;5C | REVERSE SOLIDUS        | backslash; str char esc, unspace
    ...
    |   | F;7C | VERTICAL LINE          | sigil f stmt nms, abs-val,mod ops
...
just the 7-bit ASCII repertoire:
    ...
    ∞   | F;221E | INFINITY                   | alias infinity lits
...
type>, the union type doesn't in general know anything about what types it
