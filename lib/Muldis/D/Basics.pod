...
This document is Muldis::D::Basics version 0.19.0.
...
This is the hierarchy of invocation namespaces of DBMS entities:
    ...
    sys  # system-defined types and routines defined by standard Muldis D
        sys.Core
            sys.Core(.<sys-nsp>){0,}
                sys.Core(.<sys-nsp>){0,}.<type>
                sys.Core(.<sys-nsp>){0,}.<routine>
        sys.<extension>
            sys.<extension>(.<sys-nsp>){0,}
                sys.<extension>(.<sys-nsp>){0,}.<type>
                sys.<extension>(.<sys-nsp>){0,}.<routine>
    imp  # sys-def types and routines added by, specific to implementations
        imp.<authority-or-impl-name>
            imp.<authority-or-impl-name>(.<sys-nsp>){0,}
                imp.<authority-or-impl-name>(.<sys-nsp>){0,}.<type>
                imp.<authority-or-impl-name>(.<sys-nsp>){0,}.<routine>
