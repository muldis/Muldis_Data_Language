...
structure types, plus examples of literal syntax:
     ...
     7 | SC_Identifier | \$lit etc - also special syntax "resolved expr" will
                       |    produce Reference from Identifier expr eg "resolved \$foo"
                       |    and $lit is shorthand for Identifier eg $Bag short for "resolved \$Bag"
...
from some wrapping structure value.
...
These are the I<payload> structures for the 11 structure types:
    ...
    Identifier : Universal[5] :
        0 : identifier_kind : LL_Natural in 0..2
            0 : absolute
            1 : relative
            2 : search
        1 : package name base : Universal[0..N] of String-payload - nonempty iff kind=0
        2 : package name extensions : Universal[0..2] of String-payload - nonempty iff kind=0
            0 : authority
            1 : version number
        3 : path beneath package : Universal[0..P] of String-payload
        4 : relative starts K levels up : Integer-payload in 0..J - nonzero iff kind=1
