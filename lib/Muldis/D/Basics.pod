...
This document is Muldis::D::Basics version 0.102.0.
...
indirectly by way of a new try-catch control flow statement in the first
...
C<type.[tuple|relation]_from.var.nlx.data.myrelvar>
or C<type.[tuple|relation]_from.nlx.lib.mytype>.
