...
This document is Muldis::D::Basics version 0.59.1.
...
types include: C<Bool>, C<Blob>, C<Text>, C<Rat>, C<Name>, C<Order>,
...
system-defined root types (C<Int>, C<String>, C<Blob>, C<Text>, C<Rat>,
C<QTuple>, C<QRelation>, etc) are infinite, as are the C<Universal>,
C<QScalar>, C<Reference>, C<Remnant> types.
