...
This document is Muldis::D::Core version 0.108.0.
...
boolean logic, integer and rational numeric, bit and character string, and
TAI-temporal/timestamp data types and all their operators.
