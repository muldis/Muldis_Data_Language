...
Muldis::D::Outdated::Basics -
10,000 Mile View of Muldis D

=head1 VERSION

This document is Muldis::D::Outdated::Basics version 0.148.2.
...
D specific) descriptions occurs in the L<Muldis::D::Outdated::Core>
...
current multi-document: L<Muldis::D::Outdated::Dialect::PTMD_STD>,
L<Muldis::D::Outdated::Dialect::HDMD_Perl6_STD>,
L<Muldis::D::Outdated::Dialect::HDMD_Perl5_STD>.  Other, unofficial Muldis D dialects
...
See also
L<Muldis::D::Outdated::Core::Types_Catalog/sys.std.Core.Type.Cat.MountControlSet>,
...
Muldis::D::RefEng does) which does not include full ACID compliance,
