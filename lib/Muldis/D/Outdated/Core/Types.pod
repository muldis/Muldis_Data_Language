...
Muldis::D::Outdated::Core::Types -
Muldis D general purpose data types

=head1 VERSION

This document is Muldis::D::Outdated::Core::Types version 0.148.1.
...
L<Muldis::D::Outdated::Dialect::HDMD_Perl6_STD> or
L<Muldis::D::Outdated::Dialect::HDMD_Perl5_STD> for a Perl 6|5-based example.  These
...
standard version 6.2.0; the integer codepoint space that Unicode reserves
...
version 6.2.0 character abstract codepoint number.  C<Text.Unicode> values
...
used varies by codepoint as follows: 1 for 0x0..0x7F, 2 for 0x80..0x7FF,
