...
Muldis::D::Outdated::Core::Types_Catalog -
Muldis D catalog-defining data types

=head1 VERSION

This document is Muldis::D::Outdated::Core::Types_Catalog version 0.148.1.
...
relationships.  See L<Muldis::D::Outdated::Core::Types/TYPE SUMMARY> for context.
...
declared in L<Muldis::D::Outdated::Core::Types> instead as their tools.  See also
L<Muldis::D::Outdated::Basics/Low Level Type System> for details of these types'
