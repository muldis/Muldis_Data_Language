...
Muldis::D::Outdated::Ext::Counted -
Muldis D extension for count-sensitive relational operators

=head1 VERSION

This document is Muldis::D::Outdated::Ext::Counted version 0.148.2.
...
operators are defined once for all types in L<Muldis::D::Outdated::Core>.
...
func : ValRedCFuncNC, identity : Tuple, count_attr_name : Name) {...} >>
