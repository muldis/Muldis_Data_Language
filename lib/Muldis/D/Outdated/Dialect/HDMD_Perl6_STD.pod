...
Muldis::D::Outdated::Dialect::HDMD_Perl6_STD -
How to format Perl 6 Hosted Data Muldis D

=head1 VERSION

This document is Muldis::D::Outdated::Dialect::HDMD_Perl6_STD version 0.148.1.
...
standard dialect is C<[ 'Muldis_D', 'http://muldis.com', '0.148.1',
'HDMD_Perl6_STD' ]>.
...
L<PTMD_STD|Muldis::D::Outdated::Dialect::PTMD_STD> using Perl 6.  This dialect
...
L<Muldis::D::Outdated::Dialect::PTMD_STD> file before the current one, so to provide
...
C<ln_base_authority>; it is typically a Perl C<Str> value like C<0.148.1>.
...
Examples:
    ...
    [ 'Muldis_D', 'http://muldis.com', '0.148.1', 'HDMD_Perl6_STD', {
...
be a Perl C<Order>, and so C<Order::Less> and C<Order::Same> and
...
Perl C<Str> value C<if-else-stmt>.  The second element is the I<if>
