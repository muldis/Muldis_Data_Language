...
Muldis::D::Outdated::Dialect::HDMD_Raku_STD - How to format Raku Hosted Data Muldis D

=head1 VERSION

This document is Muldis::D::Outdated::Dialect::HDMD_Raku_STD version 0.148.2.
...
standard dialect is C<[ 'Muldis_D', 'https://muldis.com', '0.148.2',
'HDMD_Raku_STD' ]>.
...
L<PTMD_STD|Muldis::D::Outdated::Dialect::PTMD_STD> using Raku.  This dialect
...
repertoire; it is typically the Perl C<Str> value C<https://muldis.com>.
...
Examples:
    ...
    [ 'Muldis_D', 'https://muldis.com', '0.148.2', 'HDMD_Raku_STD', {
