...
This document is Muldis::D::Outdated::Dialect::PTMD_STD version 0.148.2.
...
B<WARNING: THE RAKU GRAMMAR USED TO DEFINE THE SYNTAX IS OUT OF DATE WITH
THE LATEST RAKU; FOR EXAMPLE, I NEED TO USE '%'|'%%' RATHER THAN OR IN
...
standard dialect is C<Muldis_D:"https://muldis.com":0.148.2:PTMD_STD>.
...
L<HDMD_Raku_STD|Muldis::D::Outdated::Dialect::HDMD_Raku_STD> and
L<HDMD_Perl_STD|Muldis::D::Outdated::Dialect::HDMD_Perl_STD>, which are derived
...
Examples:
    ...
    Muldis_D:"https://muldis.com":0.148.2:PTMD_STD:{
...
L<Muldis::D::Outdated::Basics/SOURCE CODE METADATA>.  Primarily this means preserving
...
L<Muldis::D::Outdated::Basics/Referencing Data Types>.  In such a context, when the
