...
This document is Muldis::D::Object_Notation version 0.201.0.
...
it contains is C<Muldis_D_Object_Notation http://muldis.com 0.201.0>.
...
C<Muldis_D Object_Notation http://muldis.com 0.201.0> (B<MDON>) language.
...
Examples:
    ...
    Muldis_D Object_Notation http://muldis.com 0.201.0
