...
Muldis D Object Notation is designed to respect a variety of mnemonics that
...
I<Some of these carry additional meanings in the larger Muldis D context,
but the meanings given here are restricted to what is significant to MDON itself.>

I<TODO.>

    [] - homogeneous ordered collection of element - arrays/etc - ordinal+universal
    ...
    : - key/asset separator in all pairwise collections
    ? - booleans or unordered sets (and bits and relations)
    + - numbers or unordered bags (and octets and tuple-bags)
    ...
    @ - identifiers / attr names or headings (and chain-identifiers)
