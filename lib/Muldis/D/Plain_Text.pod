...
I<TODO.  These are listed from tightest at the top to loosest at the bottom.>
    ...
    L - generic universal routine call infix: args --> rtn or rtn <-- args or args \--> rtn etc
    ...
    R - why-binding infix ::?=
    R - what-expr-binding infix ::=
    N - "returns" expression prefix
    R - assignment infix := and assignment meta-op :=foo and proc foo()
    R - what-stmt-binding infix ::&=
    L - list separators ; , :
