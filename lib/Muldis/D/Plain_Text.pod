...
Grammar:
    ...
    <pkg_entry_point> ::=
        entry <sp> <entry_point_proc_name>
...
A C<::=> is I<what-binding> while a C<::?=> is I<why-binding>.
    ...
    < - "from" or "readonly" or "before" or "first"
    > - "to" or "after"
...
I<TODO.  These are listed from tightest at the top to loosest at the bottom.>
    ...
    terms - base literals or delimited anything or special selector syntax,
        including inline func/type/etc decls, or foo::bar::etc or func foo::(...) or const foo()
    why-binding infix ::?=
    what-expr-binding infix ::=
    generic universal routine call infix: args --> rtn or rtn <-- args or args -->^ rtn or rtn ^<-- args
