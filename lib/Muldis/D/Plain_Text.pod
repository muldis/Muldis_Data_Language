...
This document is Muldis::D::Plain_Text version 0.201.0.
...
it contains is C<Muldis_D_Plain_Text http://muldis.com 0.201.0>.
...
C<Muldis_D Plain_Text http://muldis.com 0.201.0> (B<MDPT>) language.
...
The meanings of the simple character escape sequences are:
    ...
    ----+-----------+-----------------+-----+------------------------------
    \q  | 0x22      | QUOTATION MARK  | "   | delimit Text/opaque literals
    \a  | 0x27      | APOSTROPHE      | '   | delimit quoted names
