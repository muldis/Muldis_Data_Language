...
the CompUnitRepo concept of Perl 6 (Raku) would be a good precedent.
...
keep in mind that the grammar is inspired by both EBNF and Perl 6 (Raku) rules.>
...
is characterized by an arbitrarily-long sequence of Unicode 11.0 standard
