...
Grammar:
    ...
    <parsing_unit> ::=
        ^ <parsing_unit_predicate> <sp__minimal> <parsing_unit_subject> $

See the sections in this file named L<PARSING UNIT PREDICATES> and
L</PARSING UNIT SUBJECTS> for more details.

=head1 GENERAL STRUCTURE

I<TODO: This section needs to be replaced.>
...
Grammar:
    ...
    <parsing_unit_predicate> ::=
        <shebang_line>?
        <sp__minimal>
        <language_name> <sp__minimal> ';'
        <sp__minimal>
        [<foundational_indicator> | <script_name>] <sp__minimal> ';'

See the sections in this file named L<SHEBANG LINE>, L</LANGUAGE NAME>,
L<FOUNDATIONAL INDICATOR>, and L</SCRIPT NAME> for more details.
...
See the sections in this file named L</GENERIC VALUE EXPRESSIONS> and
...
I<TODO.  These are listed from tightest at the top to loosest at the bottom.>
    ...
    generic universal routine call infix: args --> rtn or rtn <-- args or args \--> rtn etc
