...
Grammar:
    ...
    <foundation_func_name> ::=
        ...
        | FDN__Bag_map
        | FDN__Bag_reduce);
        | FDN__Structure_degree
        | FDN__Structure_field
        | FDN__Structure_has_field
        | FDN__Structure_on_fields
        | FDN__Structure_but_fields
        | FDN__Structure_extend
        | FDN__Structure_any_fields
        | FDN__Structure_fields_where
        | FDN__Structure_fields_map
        | FDN__Structure_fields_reduce);
        | ...
