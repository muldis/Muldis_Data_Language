...
contract for type I<T1> where the argument is value I<V1> is semantically
identical to (and is idiomatic for) testing if I<V1> is a member of the
type I<T1>; the result is I<true> if so and I<false> otherwise.
...
I<TODO.  Meanwhile see 'same' and 'EXTERNAL DATA TYPES' in Muldis_D.pod.>
