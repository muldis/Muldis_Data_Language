...
I<TODO: Any contract name may be referenced in all of the same ways as a function
name, in which case it is semantically equivalent to referencing a monadic
function that tests if its argument is a member of the associated type.>
...
I<TODO: Any contract name may be referenced in all of the same ways as a constant
name, in which case it is semantically equivalent to selecting the default
