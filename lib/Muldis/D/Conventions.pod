...
This document is Muldis::D::Conventions version 0.66.0.
...
When declaring a q/scalar root type that has exactly one possrep, the name
...
empty string as their name.  When declaring a q/scalar subtype that adds
