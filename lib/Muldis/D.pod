...
The B<Muldis D> language aggregate specification assumes that some common
programming languages, Muldis D in particular, can be effectively defined
...
For the official Muldis D by authority C<http://muldis.com>, the 3 default
...
C<Muldis_D_Standard:"http://muldis.com":"0.201.0.-9">.
...
See L<Muldis::D::Package::Core> for the most central package of the
...
I<TODO.  Explain differently for Foundation vs Plain Text vs each package.>
