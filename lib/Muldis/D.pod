...
For the official Muldis D by authority C<http://muldis.com>, the default 3
...
just a top-level index pointing to those 3 primary components, as well as
to some other things in the ecosystem.
...
changes or makes changes to the C<Core> package.
...
Muldis D is Copyright © 2002-2016, Muldis Data Systems, Inc.
...
Note that the B<Muldis D Standard Library> (B<MDSL>) component is also
available separately under a different license.
