...
L<Muldis::D::Foundation>,
L<Muldis::D::Package::Core>, L<Muldis::D::Plain_Text>,
L<Muldis::D::Package::Core::Plain_Text>.
...
C<Muldis_D:Plain_Text:"http://muldis.com":"0.201.0.-9"> (B<MDPT>).  It is the
...
version number C<0.201.0.-9> (this number matches the VERSION pod in this file).
...
C<Muldis_D:Plain_Text:"http://muldis.com":"0.201.0.-9"> which is being regularly
