...
B<Muldis D Object Notation> (B<MDON>) -
C<Muldis_D_Object_Notation 'http://muldis.com' '0.201.0.-9'>.
...
See L<Muldis::D::Object_Notation> for the B<Muldis D Object Notation> specification.
...
that supports the mandatory B<Muldis D Object Notation> can bootstrap
...
name of a concrete grammar it conforms to (either a B<MDON> or B<MDPT>
...
B<MDON> and B<MDPT>, its name is also referred to by each source code
...
The expected fully-qualified name of a B<Muldis D Object Notation> or
...
character strings C<Muldis_D> and C<Object_Notation> respectively, for
B<MDON>; the I<family name> and I<syntax name> are simply the 2
...
Note that a leading MDON/MDPT declaration in source code should be effective
as a "magic number" for identifying it as being MDON/MDPT source code.
...
C<Muldis_D>, C<Muldis_D_Foundation>, C<Muldis_D_Object_Notation>,
