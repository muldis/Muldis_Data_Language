...
This document is Muldis::D version 0.200.1.
...
L<Muldis::D::Overview>, L<Muldis::D::Foundation>,
L<Muldis::D::Package::Muldis_D>, L<Muldis::D::Plain_Text>.
...
C<Muldis_D:Plain_Text:"http://muldis.com":"0.200.1"> (B<MDPT>).  It is the
...
version number C<0.200.1> (this number matches the VERSION pod in this file).
...
began had version number C<0.200.1>; there were no releases by
...
C<Muldis_D:Plain_Text:"http://muldis.com":"0.200.1"> which is being regularly
...
Continue reading the language spec in L<Muldis::D::Overview>.
...
with further ones possible.  Any omitted trailing position is treated as if
