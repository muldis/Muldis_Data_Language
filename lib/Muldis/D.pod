...
This document is Muldis::D version 0.201.0.
...
C<Muldis_D http://muldis.com 0.201.0>.  It is the
...
version number C<0.201.0> (this number matches the VERSION in this file).
...
C<Muldis_D_Foundation http://muldis.com 0.201.0>.

=item *

B<Muldis D Object Notation> (B<MDON>) -
C<Muldis_D_Object_Notation http://muldis.com 0.201.0>.

=item *

B<Muldis D Plain Text> (B<MDPT>) -
C<Muldis_D_Plain_Text http://muldis.com 0.201.0>.

=item *

B<Muldis D Standard Library> (B<MDSL>) -
C<Muldis_D_Standard_Library http://muldis.com 0.201.0>.
...
C<Muldis_D http://muldis.com 0.201.0> which is being regularly
