...
C<Muldis_D https://muldis.com 0.201.0>.  It is the
...
C<Muldis_D_Foundation https://muldis.com 0.201.0>.

=item *

B<Muldis D Plain Text> (B<MDPT>) -
C<Muldis_D_Plain_Text https://muldis.com 0.201.0>.

=item *

B<Muldis D Standard Library> (B<MDSL>) -
C<Muldis_D_Standard_Library https://muldis.com 0.201.0>.
...
C<Muldis_D https://muldis.com 0.201.0> which is being regularly
