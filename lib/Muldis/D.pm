...
{ package Muldis::D; # package
    use version 0.74; our $VERSION = qv('0.71.0');
...
This document is Muldis::D version 0.71.0.
...
C<Muldis_D:"http://muldis.com":"0.71.0">.  It is the official/original (not
embraced and extended) Muldis D language specification by the authority
Darren Duncan (C<http://muldis.com>), version C<0.71.0> (this number
