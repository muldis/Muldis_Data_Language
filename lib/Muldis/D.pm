...
This document is Muldis::D version 0.141.0.
...
C<Muldis_D:"http://muldis.com":0.141.0>.  It is the official/original (not
embraced and extended) Muldis D language specification by the authority
Muldis Data Systems (C<http://muldis.com>), version C<0.141.0> (this number
